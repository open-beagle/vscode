 ...
 *--------------------------------------------------------*/
(function() {
var __m = ["require","exports","vs/base/common/platform","vs/base/common/extpath","vs/base/common/strings","vs/base/common/network","vs/base/common/uri","vs/base/common/path","vs/base/common/resources","vs/base/common/types","vs/workbench/contrib/output/common/outputLinkComputer","vs/editor/common/core/range"];
 ...
 *--------------------------------------------------------------------------------------------*/
define(__m[3/*vs/base/common/extpath*/], __M([0/*require*/,1/*exports*/,2/*vs/base/common/platform*/,4/*vs/base/common/strings*/,7/*vs/base/common/path*/,9/*vs/base/common/types*/]), function (require, exports, platform_1, strings_1, path_1, types_1) {
    "use strict";
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[8/*vs/base/common/resources*/], __M([0/*require*/,1/*exports*/,3/*vs/base/common/extpath*/,7/*vs/base/common/path*/,6/*vs/base/common/uri*/,4/*vs/base/common/strings*/,5/*vs/base/common/network*/,2/*vs/base/common/platform*/]), function (require, exports, extpath, paths, uri_1, strings_1, network_1, platform_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[10/*vs/workbench/contrib/output/common/outputLinkComputer*/], __M([0/*require*/,1/*exports*/,6/*vs/base/common/uri*/,3/*vs/base/common/extpath*/,8/*vs/base/common/resources*/,4/*vs/base/common/strings*/,11/*vs/editor/common/core/range*/,2/*vs/base/common/platform*/,5/*vs/base/common/network*/]), function (require, exports, uri_1, extpath, resources, strings, range_1, platform_1, network_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
