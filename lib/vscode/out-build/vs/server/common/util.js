...
define(["require", "exports"], function (require, exports) {
    ...
    const resolveBase = (base) => {
        ...
        return (0, exports.normalize)(url.pathname);
    };
    ...
    const getOptions = () => {
        ...
        if (queryOpts) {
            options = Object.assign(Object.assign({}, options), JSON.parse(queryOpts));
        }
        options.base = (0, exports.resolveBase)(options.base);
        options.csStaticBase = (0, exports.resolveBase)(options.csStaticBase);
        return options;
    };
