            ...
            if (element instanceof FileElement) {
                if (element.edit.textEdits.length > 0) {
                    if (element.edit.type & 8 /* Rename */ && element.edit.newUri) {
                        return (0, nls_1.localize)(1, null, this._labelService.getUriLabel(element.edit.uri, { relative: true }), this._labelService.getUriLabel(element.edit.newUri, { relative: true }));
                    }
                    else if (element.edit.type & 2 /* Create */) {
                        return (0, nls_1.localize)(2, null, this._labelService.getUriLabel(element.edit.uri, { relative: true }));
                    }
                    else if (element.edit.type & 4 /* Delete */) {
                        return (0, nls_1.localize)(3, null, this._labelService.getUriLabel(element.edit.uri, { relative: true }));
                    }
                    else {
                        return (0, nls_1.localize)(4, null, this._labelService.getUriLabel(element.edit.uri, { relative: true }));
                    }
                }
                else {
                    if (element.edit.type & 8 /* Rename */ && element.edit.newUri) {
                        return (0, nls_1.localize)(5, null, this._labelService.getUriLabel(element.edit.uri, { relative: true }), this._labelService.getUriLabel(element.edit.newUri, { relative: true }));
                    }
                    else if (element.edit.type & 2 /* Create */) {
                        return (0, nls_1.localize)(6, null, this._labelService.getUriLabel(element.edit.uri, { relative: true }));
                    }
                    else if (element.edit.type & 4 /* Delete */) {
                        return (0, nls_1.localize)(7, null, this._labelService.getUriLabel(element.edit.uri, { relative: true }));
                    }
                }
            }
            if (element instanceof TextEditElement) {
        ...
        set(element, score) {
            ...
            if (element.edit.type & 8 /* Rename */ && element.edit.newUri) {
                ...
                this._label.setResource({
                    ...
                    name: (0, nls_1.localize)(11, null, this._labelService.getUriLabel(element.edit.uri, { relative: true }), this._labelService.getUriLabel(element.edit.newUri, { relative: true })),
                }, {
                    fileDecorations: { colors: true, badges: false }
                });
                this._details.innerText = (0, nls_1.localize)(12, null);
            }
            else {
                ...
                if (element.edit.type & 2 /* Create */) {
                    this._details.innerText = (0, nls_1.localize)(13, null);
                }
                else if (element.edit.type & 4 /* Delete */) {
                    this._details.innerText = (0, nls_1.localize)(14, null);
