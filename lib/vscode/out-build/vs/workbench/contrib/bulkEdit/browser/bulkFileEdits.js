...
define(["require", "exports", "vs/platform/files/common/files", "vs/platform/configuration/common/configuration", "vs/workbench/services/workingCopy/common/workingCopyFileService", "vs/platform/undoRedo/common/undoRedo", "vs/platform/instantiation/common/instantiation", "vs/platform/log/common/log", "vs/base/common/cancellation", "vs/base/common/arrays", "vs/workbench/services/textfile/common/textfiles"], function (require, exports, files_1, configuration_1, workingCopyFileService_1, undoRedo_1, instantiation_1, log_1, cancellation_1, arrays_1, textfiles_1) {
    ...
    let RenameOperation = class RenameOperation {
        ...
        get uris() {
            return (0, arrays_1.flatten)(this._edits.map(edit => [edit.newUri, edit.oldUri]));
        }
        async perform(token) {
            const moves = [];
            const undoes = [];
        ...
        async perform(token) {
            ...
            for (const edit of this._edits) {
                ...
                deletes.push({
                    ...
                    useTrash: !edit.options.skipTrashBin && this._fileService.hasCapability(edit.oldUri, 4096 /* Trash */) && this._configurationService.getValue('files.enableTrash')
                });
                ...
                if (!(typeof edit.options.maxSize === 'number' && fileContent && ((fileContent === null || fileContent === void 0 ? void 0 : fileContent.size) > edit.options.maxSize))) {
                    undoes.push(new CreateEdit(edit.oldUri, edit.options, fileContent === null || fileContent === void 0 ? void 0 : fileContent.value));
                }
            }
            if (deletes.length === 0) {
                return new Noop();
    ...
    class FileUndoRedoElement {
        constructor(label, operations, confirmBeforeUndo) {
            this.label = label;
            this.operations = operations;
            this.confirmBeforeUndo = confirmBeforeUndo;
            this.type = 1 /* Workspace */;
            this.resources = [].concat(...operations.map(op => op.uris));
        }
        async undo() {
            await this._reverse();
        }
    ...
    let BulkFileEdits = class BulkFileEdits {
        constructor(_label, _undoRedoGroup, _undoRedoSource, _confirmBeforeUndo, _progress, _token, _edits, _instaService, _undoRedoService) {
            this._label = _label;
