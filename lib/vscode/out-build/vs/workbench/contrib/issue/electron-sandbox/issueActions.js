...
define(["require", "exports", "vs/base/common/actions", "vs/nls!vs/workbench/contrib/issue/electron-sandbox/issueActions", "vs/workbench/services/issue/common/issue"], function (require, exports, actions_1, nls, issue_1) {
    "use strict";
    ...
    OpenProcessExplorer.LABEL = nls.localize(0, null);
    ...
    let ReportPerformanceIssueUsingReporterAction = class ReportPerformanceIssueUsingReporterAction extends actions_1.Action {
        ...
        run() {
            return this.issueService.openReporter({ issueType: 1 /* PerformanceIssue */ });
        }
    };
    ReportPerformanceIssueUsingReporterAction.ID = 'workbench.action.reportPerformanceIssueUsingReporter';
    ReportPerformanceIssueUsingReporterAction.LABEL = nls.localize(1, null);
