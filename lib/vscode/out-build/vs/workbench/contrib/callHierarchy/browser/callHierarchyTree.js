...
define(["require", "exports", "vs/workbench/contrib/callHierarchy/common/callHierarchy", "vs/base/common/cancellation", "vs/base/common/filters", "vs/base/browser/ui/iconLabel/iconLabel", "vs/editor/common/modes", "vs/base/common/strings", "vs/editor/common/core/range", "vs/nls!vs/workbench/contrib/callHierarchy/browser/callHierarchyTree"], function (require, exports, callHierarchy_1, cancellation_1, filters_1, iconLabel_1, modes_1, strings_1, range_1, nls_1) {
    ...
    class DataSource {
        ...
        async getChildren(element) {
            ...
            if (this.getDirection() === "outgoingCalls" /* CallsFrom */) {
    ...
    class CallRenderer {
        ...
        renderElement(node, _index, template) {
            ...
            const deprecated = (_a = element.item.tags) === null || _a === void 0 ? void 0 : _a.includes(1 /* Deprecated */);
