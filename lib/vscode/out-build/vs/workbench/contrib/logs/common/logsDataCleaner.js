...
define(["require", "exports", "vs/base/common/lifecycle", "vs/platform/files/common/files", "vs/base/common/resources", "vs/workbench/services/environment/common/environmentService", "vs/base/common/uri", "vs/workbench/services/lifecycle/common/lifecycle", "vs/base/common/async"], function (require, exports, lifecycle_1, files_1, resources_1, environmentService_1, uri_1, lifecycle_2, async_1) {
    "use strict";
    ...
    let LogsDataCleaner = class LogsDataCleaner extends lifecycle_1.Disposable {
        ...
        cleanUpOldLogsSoon() {
            let handle = setTimeout(async () => {
                ...
                if (stat.children) {
                    const currentLog = (0, resources_1.basename)(logsPath);
