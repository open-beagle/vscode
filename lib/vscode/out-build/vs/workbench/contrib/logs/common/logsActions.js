...
define(["require", "exports", "vs/nls!vs/workbench/contrib/logs/common/logsActions", "vs/base/common/actions", "vs/platform/log/common/log", "vs/platform/quickinput/common/quickInput", "vs/base/common/uri", "vs/platform/files/common/files", "vs/workbench/services/environment/common/environmentService", "vs/base/common/resources", "vs/workbench/services/editor/common/editorService"], function (require, exports, nls, actions_1, log_1, quickInput_1, uri_1, files_1, environmentService_1, resources_1, editorService_1) {
    ...
    let SetLogLevelAction = class SetLogLevelAction extends actions_1.Action {
        ...
        run() {
            ...
            const entries = [
                { label: nls.localize(1, null), level: log_1.LogLevel.Trace, description: this.getDescription(log_1.LogLevel.Trace, current) },
                { label: nls.localize(2, null), level: log_1.LogLevel.Debug, description: this.getDescription(log_1.LogLevel.Debug, current) },
                { label: nls.localize(3, null), level: log_1.LogLevel.Info, description: this.getDescription(log_1.LogLevel.Info, current) },
                { label: nls.localize(4, null), level: log_1.LogLevel.Warning, description: this.getDescription(log_1.LogLevel.Warning, current) },
                { label: nls.localize(5, null), level: log_1.LogLevel.Error, description: this.getDescription(log_1.LogLevel.Error, current) },
                { label: nls.localize(6, null), level: log_1.LogLevel.Critical, description: this.getDescription(log_1.LogLevel.Critical, current) },
                { label: nls.localize(7, null), level: log_1.LogLevel.Off, description: this.getDescription(log_1.LogLevel.Off, current) },
            ];
            return this.quickInputService.pick(entries, { placeHolder: nls.localize(8, null), activeItem: entries[this.logService.getLevel()] }).then(entry => {
                if (entry) {
    ...
    SetLogLevelAction.LABEL = nls.localize(0, null);
    ...
    let OpenWindowSessionLogFileAction = class OpenWindowSessionLogFileAction extends actions_1.Action {
        ...
        async run() {
            const sessionResult = await this.quickInputService.pick(this.getSessions().then(sessions => sessions.map((s, index) => ({
                ...
                description: index === 0 ? nls.localize(13, null) : undefined
            }))), {
                canPickMany: false,
                placeHolder: nls.localize(14, null)
            });
            if (sessionResult) {
    ...
    OpenWindowSessionLogFileAction.LABEL = nls.localize(12, null);
