...
define(["require", "exports", "vs/base/common/event", "vs/base/common/lifecycle", "vs/base/common/resources", "vs/editor/common/services/resolverService", "vs/platform/files/common/files", "vs/workbench/services/textfile/common/textfiles"], function (require, exports, event_1, lifecycle_1, resources_1, resolverService_1, files_1, textfiles_1) {
    "use strict";
    ...
    let CustomTextEditorModel = class CustomTextEditorModel extends lifecycle_1.Disposable {
        constructor(viewType, _resource, _model, textFileService, _fileService) {
            super();
        ...
        isOnReadonlyFileSystem() {
            return this._fileService.hasCapability(this._resource, 2048 /* Readonly */);
        }
        get backupId() {
            return undefined;
        }
        ...
        isOrphaned() {
            var _a;
            return !!((_a = this._textFileModel) === null || _a === void 0 ? void 0 : _a.hasState(4 /* ORPHAN */));
        }
