...
define(["require", "exports", "vs/base/common/uri", "vs/platform/instantiation/common/instantiation", "vs/workbench/contrib/customEditor/browser/customEditorInput", "vs/workbench/contrib/webview/browser/webview", "vs/workbench/contrib/webviewPanel/browser/webviewEditorInputSerializer", "vs/workbench/contrib/webviewPanel/browser/webviewWorkbenchService", "vs/workbench/services/workingCopy/common/workingCopyBackup", "vs/workbench/services/workingCopy/common/workingCopy"], function (require, exports, uri_1, instantiation_1, customEditorInput_1, webview_1, webviewEditorInputSerializer_1, webviewWorkbenchService_1, workingCopyBackup_1, workingCopy_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.customEditorInputFactory = exports.CustomEditorInputSerializer = void 0;
    ...
    function reviveWebview(webviewService, data) {
        const webview = webviewService.createWebviewOverlay(data.id, {
            purpose: "customEditor" /* CustomEditor */,
    ...
    exports.customEditorInputFactory = new class {
        createCustomEditorInput(resource, instantiationService) {
