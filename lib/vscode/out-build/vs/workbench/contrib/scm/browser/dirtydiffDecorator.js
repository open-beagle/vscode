...
define(["require", "exports", "vs/nls!vs/workbench/contrib/scm/browser/dirtydiffDecorator", "vs/base/common/async", "vs/base/common/lifecycle", "vs/base/common/event", "vs/editor/browser/widget/codeEditorWidget", "vs/platform/instantiation/common/instantiation", "vs/editor/common/services/resolverService", "vs/workbench/services/editor/common/editorService", "vs/editor/common/services/editorWorkerService", "vs/platform/configuration/common/configuration", "vs/workbench/contrib/scm/common/scm", "vs/editor/common/model/textModel", "vs/platform/theme/common/themeService", "vs/platform/theme/common/colorRegistry", "vs/base/common/color", "vs/editor/browser/editorExtensions", "vs/editor/contrib/peekView/peekView", "vs/platform/contextkey/common/contextkey", "vs/editor/common/editorContextKeys", "vs/editor/common/core/position", "vs/base/common/numbers", "vs/platform/keybinding/common/keybindingsRegistry", "vs/editor/browser/widget/embeddedCodeEditorWidget", "vs/base/common/actions", "vs/platform/keybinding/common/keybinding", "vs/base/common/resources", "vs/platform/actions/common/actions", "vs/platform/actions/browser/menuEntryActionViewItem", "vs/editor/common/model", "vs/base/common/arrays", "vs/editor/browser/services/codeEditorService", "vs/base/browser/dom", "vs/workbench/services/textfile/common/textfiles", "vs/platform/theme/common/iconRegistry", "vs/base/common/codicons", "vs/css!./media/dirtydiffDecorator"], function (require, exports, nls, async_1, lifecycle_1, event_1, codeEditorWidget_1, instantiation_1, resolverService_1, editorService_1, editorWorkerService_1, configuration_1, scm_1, textModel_1, themeService_1, colorRegistry_1, color_1, editorExtensions_1, peekView_1, contextkey_1, editorContextKeys_1, position_1, numbers_1, keybindingsRegistry_1, embeddedCodeEditorWidget_1, actions_1, keybinding_1, resources_1, actions_2, menuEntryActionViewItem_1, model_1, arrays_1, codeEditorService_1, dom_1, textfiles_1, iconRegistry_1, codicons_1) {
    ...
    let DirtyDiffWidget = class DirtyDiffWidget extends peekView_1.PeekViewWidget {
        ...
        renderTitle() {
            const detail = this.model.changes.length > 1
                ? nls.localize(0, null, this.index + 1, this.model.changes.length)
                : nls.localize(1, null, this.index + 1, this.model.changes.length);
        ...
        _fillHead(container) {
            ...
            this._actionbarWidget.push(new actions_1.Action('peekview.close', nls.localize(2, null), codicons_1.Codicon.close.classNames, true, async () => {
                this.dispose();
    ...
    (0, editorExtensions_1.registerEditorAction)(MoveToPreviousChangeAction);
    ...
    (0, editorExtensions_1.registerEditorAction)(MoveToNextChangeAction);
    ...
    exports.overviewRulerModifiedForeground = (0, colorRegistry_1.registerColor)('editorOverviewRuler.modifiedForeground', { dark: (0, colorRegistry_1.transparent)(exports.editorGutterModifiedBackground, 0.6), light: (0, colorRegistry_1.transparent)(exports.editorGutterModifiedBackground, 0.6), hc: (0, colorRegistry_1.transparent)(exports.editorGutterModifiedBackground, 0.6) }, nls.localize(15, null));
    exports.overviewRulerAddedForeground = (0, colorRegistry_1.registerColor)('editorOverviewRuler.addedForeground', { dark: (0, colorRegistry_1.transparent)(exports.editorGutterAddedBackground, 0.6), light: (0, colorRegistry_1.transparent)(exports.editorGutterAddedBackground, 0.6), hc: (0, colorRegistry_1.transparent)(exports.editorGutterAddedBackground, 0.6) }, nls.localize(16, null));
    exports.overviewRulerDeletedForeground = (0, colorRegistry_1.registerColor)('editorOverviewRuler.deletedForeground', { dark: (0, colorRegistry_1.transparent)(exports.editorGutterDeletedBackground, 0.6), light: (0, colorRegistry_1.transparent)(exports.editorGutterDeletedBackground, 0.6), hc: (0, colorRegistry_1.transparent)(exports.editorGutterDeletedBackground, 0.6) }, nls.localize(17, null));
    ...
    let DirtyDiffModel = class DirtyDiffModel extends lifecycle_1.Disposable {
        constructor(textFileModel, scmService, editorWorkerService, textModelResolverService) {
            super();
            ...
            this._originalURIPromise = this.getOriginalResource().then(originalUri => {
                ...
                return this.textModelResolverService.createModelReference(originalUri).then(ref => {
                    ...
                    if ((0, textfiles_1.isTextFileEditorModel)(this._originalModel)) {
                        ...
                        if (encoding) {
                            this._originalModel.setEncoding(encoding, 1 /* Decode */);
                        }
                    }
