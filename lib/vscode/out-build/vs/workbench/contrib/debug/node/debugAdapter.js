 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "vs/base/node/pfs", "child_process", "vs/nls!vs/workbench/contrib/debug/node/debugAdapter", "net", "vs/base/common/path", "vs/base/common/strings", "vs/base/common/objects", "vs/base/common/platform", "vs/platform/extensionManagement/common/extensionManagement", "../common/abstractDebugAdapter"], function (require, exports, pfs_1, cp, nls, net, path, strings, objects, platform, extensionManagement_1, abstractDebugAdapter_1) {
    "use strict";
