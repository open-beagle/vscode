    ...
    suite('Debug - ANSI Handling', () => {
        ...
        test('calcANSI8bitColor', () => {
            ...
            for (let red = 0; red <= 5; red++) {
                for (let green = 0; green <= 5; green++) {
                    for (let blue = 0; blue <= 5; blue++) {
                        let colorOut = (0, debugANSIHandling_1.calcANSI8bitColor)(16 + red * 36 + green * 6 + blue);
            ...
            for (let i = 232; i <= 255; i++) {
                let grayOut = (0, debugANSIHandling_1.calcANSI8bitColor)(i);
