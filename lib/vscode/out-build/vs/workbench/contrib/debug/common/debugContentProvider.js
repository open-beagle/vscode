...
define(["require", "exports", "vs/nls!vs/workbench/contrib/debug/common/debugContentProvider", "vs/base/common/mime", "vs/editor/common/services/modelService", "vs/editor/common/services/modeService", "vs/editor/common/services/resolverService", "vs/workbench/contrib/debug/common/debug", "vs/workbench/contrib/debug/common/debugSource", "vs/editor/common/services/editorWorkerService", "vs/editor/common/core/editOperation", "vs/editor/common/core/range", "vs/base/common/cancellation"], function (require, exports, nls_1, mime_1, modelService_1, modeService_1, resolverService_1, debug_1, debugSource_1, editorWorkerService_1, editOperation_1, range_1, cancellation_1) {
    "use strict";
            ...
            return session.loadSource(resource).then(response => {
                if (response && response.body) {
                    if (model) {
                        ...
                        // create text model
                        const mime = response.body.mimeType || (0, mime_1.guessMimeTypes)(resource)[0];
