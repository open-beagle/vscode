...
define(["require", "exports", "vs/base/common/resources", "vs/base/common/platform", "vs/base/common/severity", "vs/base/common/event", "vs/base/browser/ui/aria/aria", "vs/workbench/contrib/debug/common/debug", "vs/workbench/contrib/debug/common/debugSource", "vs/base/common/objects", "vs/workbench/contrib/debug/common/debugModel", "vs/workbench/contrib/debug/browser/rawDebugSession", "vs/platform/product/common/productService", "vs/platform/workspace/common/workspace", "vs/base/common/lifecycle", "vs/base/common/async", "vs/base/common/uuid", "vs/workbench/services/host/browser/host", "vs/platform/telemetry/common/telemetry", "vs/base/common/labels", "vs/platform/configuration/common/configuration", "vs/workbench/services/viewlet/browser/viewlet", "vs/workbench/contrib/debug/common/replModel", "vs/base/common/cancellation", "vs/base/common/arrays", "vs/platform/notification/common/notification", "vs/workbench/services/lifecycle/common/lifecycle", "vs/nls!vs/workbench/contrib/debug/browser/debugSession", "vs/base/common/errors", "vs/workbench/contrib/debug/common/debugUtils", "vs/workbench/services/uriIdentity/common/uriIdentity", "vs/platform/instantiation/common/instantiation"], function (require, exports, resources, platform, severity_1, event_1, aria, debug_1, debugSource_1, objects_1, debugModel_1, rawDebugSession_1, productService_1, workspace_1, lifecycle_1, async_1, uuid_1, host_1, telemetry_1, labels_1, configuration_1, viewlet_1, replModel_1, cancellation_1, arrays_1, notification_1, lifecycle_2, nls_1, errors_1, debugUtils_1, uriIdentity_1, instantiation_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.DebugSession = void 0;
    let DebugSession = class DebugSession {
        constructor(id, _configuration, root, model, options, debugService, telemetryService, hostService, configurationService, viewletService, workspaceContextService, productService, notificationService, lifecycleService, uriIdentityService, instantiationService, customEndpointTelemetryService) {
            this.id = id;
        ...
        async breakpointsLocations(uri, lineNumber) {
            if (!this.raw) {
                throw new Error((0, nls_1.localize)(8, null, 'breakpoints locations'));
            }
        ...
        customRequest(request, args) {
            if (!this.raw) {
                throw new Error((0, nls_1.localize)(9, null, request));
            }
            return this.raw.custom(request, args);
        }
        stackTrace(threadId, startFrame, levels, token) {
            if (!this.raw) {
                throw new Error((0, nls_1.localize)(10, null, 'stackTrace'));
            }
        ...
        async exceptionInfo(threadId) {
            if (!this.raw) {
                throw new Error((0, nls_1.localize)(11, null, 'exceptionInfo'));
            }
        ...
        scopes(frameId, threadId) {
            if (!this.raw) {
                throw new Error((0, nls_1.localize)(12, null, 'scopes'));
            }
        ...
        variables(variablesReference, threadId, filter, start, count) {
            if (!this.raw) {
                throw new Error((0, nls_1.localize)(13, null, 'variables'));
            }
        ...
        evaluate(expression, frameId, context) {
            if (!this.raw) {
                throw new Error((0, nls_1.localize)(14, null, 'evaluate'));
            }
            return this.raw.evaluate({ expression, frameId, context });
        }
        async restartFrame(frameId, threadId) {
            if (!this.raw) {
                throw new Error((0, nls_1.localize)(15, null, 'restartFrame'));
            }
            await this.raw.restartFrame({ frameId }, threadId);
        }
        async next(threadId) {
            if (!this.raw) {
                throw new Error((0, nls_1.localize)(16, null, 'next'));
            }
            await this.raw.next({ threadId });
        }
        async stepIn(threadId, targetId) {
            if (!this.raw) {
                throw new Error((0, nls_1.localize)(17, null, 'stepIn'));
            }
            await this.raw.stepIn({ threadId, targetId });
        }
        async stepOut(threadId) {
            if (!this.raw) {
                throw new Error((0, nls_1.localize)(18, null, 'stepOut'));
            }
            await this.raw.stepOut({ threadId });
        }
        async stepBack(threadId) {
            if (!this.raw) {
                throw new Error((0, nls_1.localize)(19, null, 'stepBack'));
            }
            await this.raw.stepBack({ threadId });
        }
        async continue(threadId) {
            if (!this.raw) {
                throw new Error((0, nls_1.localize)(20, null, 'continue'));
            }
            await this.raw.continue({ threadId });
        }
        async reverseContinue(threadId) {
            if (!this.raw) {
                throw new Error((0, nls_1.localize)(21, null, 'reverse continue'));
            }
            await this.raw.reverseContinue({ threadId });
        }
        async pause(threadId) {
            if (!this.raw) {
                throw new Error((0, nls_1.localize)(22, null, 'pause'));
            }
            await this.raw.pause({ threadId });
        }
        async terminateThreads(threadIds) {
            if (!this.raw) {
                throw new Error((0, nls_1.localize)(23, null, 'terminateThreads'));
            }
            await this.raw.terminateThreads({ threadIds });
        }
        setVariable(variablesReference, name, value) {
            if (!this.raw) {
                throw new Error((0, nls_1.localize)(24, null, 'setVariable'));
            }
            return this.raw.setVariable({ variablesReference, name, value });
        }
        gotoTargets(source, line, column) {
            if (!this.raw) {
                throw new Error((0, nls_1.localize)(25, null, 'gotoTargets'));
            }
            return this.raw.gotoTargets({ source, line, column });
        }
        goto(threadId, targetId) {
            if (!this.raw) {
                throw new Error((0, nls_1.localize)(26, null, 'goto'));
            }
            return this.raw.goto({ threadId, targetId });
        }
        loadSource(resource) {
            if (!this.raw) {
                return Promise.reject(new Error((0, nls_1.localize)(27, null, 'loadSource')));
            }
        ...
        async getLoadedSources() {
            if (!this.raw) {
                return Promise.reject(new Error((0, nls_1.localize)(28, null, 'getLoadedSources')));
            }
        ...
        async completions(frameId, threadId, text, position, overwriteBefore, token) {
            if (!this.raw) {
                return Promise.reject(new Error((0, nls_1.localize)(29, null, 'completions')));
            }
        ...
        async stepInTargets(frameId) {
            if (!this.raw) {
                return Promise.reject(new Error((0, nls_1.localize)(30, null, 'stepInTargets')));
            }
        ...
        async cancel(progressId) {
            if (!this.raw) {
                return Promise.reject(new Error((0, nls_1.localize)(31, null, 'cancel')));
            }
        ...
        registerListeners() {
            ...
            this.rawListeners.push(this.raw.onDidInitialize(async () => {
                aria.status((0, nls_1.localize)(32, null));
            ...
            this.rawListeners.push(this.raw.onDidTerminateDebugee(async (event) => {
                aria.status((0, nls_1.localize)(33, null));
