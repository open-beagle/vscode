...
define(["require", "exports", "vs/platform/theme/common/themeService", "vs/nls!vs/workbench/contrib/debug/browser/statusbarColorProvider", "vs/platform/theme/common/colorRegistry", "vs/workbench/services/layout/browser/layoutService", "vs/workbench/contrib/debug/common/debug", "vs/platform/workspace/common/workspace", "vs/workbench/common/theme", "vs/base/common/types", "vs/base/browser/dom"], function (require, exports, themeService_1, nls_1, colorRegistry_1, layoutService_1, debug_1, workspace_1, theme_1, types_1, dom_1) {
    "use strict";
    ...
    let StatusBarColorProvider = class StatusBarColorProvider extends themeService_1.Themable {
        ...
        updateStyles() {
            super.updateStyles();
            const container = (0, types_1.assertIsDefined)(this.layoutService.getContainer("workbench.parts.statusbar" /* STATUSBAR_PART */));
