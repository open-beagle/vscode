...
define(["require", "exports", "vs/base/common/uri", "vs/base/browser/dom", "vs/base/browser/ui/aria/aria", "vs/editor/contrib/suggest/suggestController", "vs/editor/common/core/range", "vs/editor/browser/editorExtensions", "vs/editor/common/services/modelService", "vs/platform/instantiation/common/serviceCollection", "vs/platform/contextkey/common/contextkey", "vs/platform/instantiation/common/instantiation", "vs/platform/storage/common/storage", "vs/platform/theme/common/themeService", "vs/editor/browser/editorBrowser", "vs/base/common/decorators", "vs/base/common/lifecycle", "vs/editor/common/editorContextKeys", "vs/editor/browser/widget/codeEditorWidget", "vs/workbench/contrib/debug/common/debug", "vs/base/common/history", "vs/platform/browser/contextScopedHistoryWidget", "vs/workbench/contrib/codeEditor/browser/simpleEditorOptions", "vs/platform/theme/common/colorRegistry", "vs/editor/browser/services/codeEditorService", "vs/workbench/contrib/debug/browser/debugActionViewItems", "vs/editor/common/modes", "vs/workbench/services/editor/common/editorService", "vs/workbench/contrib/debug/browser/linkDetector", "vs/platform/contextview/browser/contextView", "vs/base/common/strings", "vs/platform/list/browser/listService", "vs/platform/configuration/common/configuration", "vs/editor/common/services/textResourceConfigurationService", "vs/base/common/async", "vs/platform/clipboard/common/clipboardService", "vs/workbench/contrib/debug/browser/replViewer", "vs/nls!vs/workbench/contrib/debug/browser/repl", "vs/workbench/browser/parts/views/viewPane", "vs/platform/keybinding/common/keybinding", "vs/workbench/common/views", "vs/platform/opener/common/opener", "vs/workbench/contrib/debug/common/replModel", "vs/platform/telemetry/common/telemetry", "vs/editor/common/config/editorOptions", "vs/base/browser/ui/mouseCursor/mouseCursor", "vs/workbench/contrib/debug/browser/replFilter", "vs/workbench/contrib/debug/browser/debugIcons", "vs/platform/actions/common/actions", "vs/platform/actions/browser/menuEntryActionViewItem", "vs/css!./media/repl"], function (require, exports, uri_1, dom, aria, suggestController_1, range_1, editorExtensions_1, modelService_1, serviceCollection_1, contextkey_1, instantiation_1, storage_1, themeService_1, editorBrowser_1, decorators_1, lifecycle_1, editorContextKeys_1, codeEditorWidget_1, debug_1, history_1, contextScopedHistoryWidget_1, simpleEditorOptions_1, colorRegistry_1, codeEditorService_1, debugActionViewItems_1, modes_1, editorService_1, linkDetector_1, contextView_1, strings_1, listService_1, configuration_1, textResourceConfigurationService_1, async_1, clipboardService_1, replViewer_1, nls_1, viewPane_1, keybinding_1, views_1, opener_1, replModel_1, telemetry_1, editorOptions_1, mouseCursor_1, replFilter_1, debugIcons_1, actions_1, menuEntryActionViewItem_1) {
    "use strict";
    ...
    let Repl = class Repl extends viewPane_1.ViewPane {
        constructor(options, debugService, instantiationService, storageService, themeService, modelService, contextKeyService, codeEditorService, viewDescriptorService, contextMenuService, configurationService, textResourcePropertiesService, editorService, keybindingService, openerService, telemetryService, menuService) {
        ...
        registerListeners() {
                                        ...
                                        response.body.targets.forEach(item => {
                                            if (item && item.label) {
                                                ...
                                                suggestions.push({
                                                    label: item.label,
                                                    insertText,
                                                    kind: (0, modes_1.completionKindFromString)(item.type || 'property'),
            ...
            this._register(this.onDidChangeBodyVisibility(visible => {
                if (!visible) {
                    (0, lifecycle_1.dispose)(this.model);
                }
                else {
        ...
        onDidStyleChange() {
            if (this.styleElement) {
                ...
                const replInputLineHeight = this.replInput.getOption(55 /* lineHeight */);
        ...
        getActionViewItem(action) {
            ...
            if (action.id === selectReplCommandId) {
                ...
                const filterHistory = JSON.parse(this.storageService.get(FILTER_HISTORY_STORAGE_KEY, 1 /* WORKSPACE */, '[]'));
                this.filterActionViewItem = this.instantiationService.createInstance(replFilter_1.ReplFilterActionViewItem, action, (0, nls_1.localize)(0, null), this.filterState, filterHistory);
        ...
        createReplInput(container) {
            ...
            const { scopedContextKeyService, historyNavigationEnablement } = (0, contextScopedHistoryWidget_1.createAndBindHistoryNavigationWidgetScopedContextKeyService)(this.contextKeyService, { target: container, historyNavigator: this });
            ...
            options.ariaLabel = (0, nls_1.localize)(1, null);
        ...
        updateInputDecoration() {
            ...
            if (this.isReadonly && this.replInput.hasTextFocus() && !this.replInput.getValue()) {
                const transparentForeground = (0, colorRegistry_1.transparent)(colorRegistry_1.editorForeground, 0.4)(this.themeService.getColorTheme());
                decorations.push({
                    range: {
                        startLineNumber: 0,
                        endLineNumber: 0,
                    ...
                    renderOptions: {
                        after: {
                            contentText: (0, nls_1.localize)(2, null),
        ...
        saveState() {
            ...
            if (replHistory.length) {
                this.storageService.store(HISTORY_STORAGE_KEY, JSON.stringify(replHistory), 1 /* WORKSPACE */, 0 /* USER */);
            }
            else {
            ...
            if (this.filterActionViewItem) {
                ...
                if (filterHistory.length) {
                    this.storageService.store(FILTER_HISTORY_STORAGE_KEY, JSON.stringify(filterHistory), 1 /* WORKSPACE */, 0 /* USER */);
                }
                else {
                    this.storageService.remove(FILTER_HISTORY_STORAGE_KEY, 1 /* WORKSPACE */);
                }
            }
            super.saveState();
        }
        ...
        constructor() {
            super({
                ...
                menu: {
                    ...
                    group: 'navigation',
                    when: contextkey_1.ContextKeyEqualsExpr.create('view', debug_1.REPL_VIEW_ID),
                    order: 10
                }
            });
        }
    ...
    (0, actions_1.registerAction2)(class extends viewPane_1.ViewAction {
        constructor() {
            super({
                ...
                menu: {
                    id: actions_1.MenuId.ViewTitle,
                    group: 'navigation',
                    when: contextkey_1.ContextKeyExpr.and(contextkey_1.ContextKeyEqualsExpr.create('view', debug_1.REPL_VIEW_ID), debug_1.CONTEXT_MULTI_SESSION_REPL),
                    order: 20
                }
            });
        }
        async runInView(accessor, view, session) {
            ...
            if (session && session.state !== 0 /* Inactive */ && session !== debugService.getViewModel().focusedSession) {
                if (session.state !== 2 /* Stopped */) {
                    // Focus child session instead if it is stopped #112595
                    const stopppedChildSession = debugService.getModel().getSessions().find(s => s.parentSession === session && s.state === 2 /* Stopped */);
    ...
    (0, actions_1.registerAction2)(class extends viewPane_1.ViewAction {
        ...
        runInView(_accessor, view) {
            view.clearRepl();
            aria.status((0, nls_1.localize)(9, null));
        }
    });
    (0, actions_1.registerAction2)(class extends viewPane_1.ViewAction {
        constructor() {
    ...
    (0, actions_1.registerAction2)(class extends viewPane_1.ViewAction {
        constructor() {
            super({
                ...
                viewId: debug_1.REPL_VIEW_ID,
                precondition: debug_1.CONTEXT_DEBUG_STATE.notEqualsTo((0, debug_1.getStateLabel)(0 /* Inactive */)),
                menu: {
                    id: actions_1.MenuId.DebugConsoleContext,
