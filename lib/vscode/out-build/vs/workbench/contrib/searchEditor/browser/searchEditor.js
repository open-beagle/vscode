...
define(["require", "exports", "vs/base/browser/dom", "vs/base/browser/keyboardEvent", "vs/base/browser/ui/aria/aria", "vs/base/common/async", "vs/base/common/lifecycle", "vs/base/common/types", "vs/editor/common/core/position", "vs/editor/common/core/range", "vs/editor/common/core/selection", "vs/editor/common/services/modelService", "vs/editor/common/services/textResourceConfigurationService", "vs/editor/contrib/gotoSymbol/peek/referencesController", "vs/nls!vs/workbench/contrib/searchEditor/browser/searchEditor", "vs/platform/commands/common/commands", "vs/platform/configuration/common/configuration", "vs/platform/contextkey/common/contextkey", "vs/platform/contextview/browser/contextView", "vs/platform/instantiation/common/instantiation", "vs/platform/instantiation/common/serviceCollection", "vs/platform/label/common/label", "vs/platform/progress/common/progress", "vs/platform/storage/common/storage", "vs/platform/telemetry/common/telemetry", "vs/platform/theme/common/colorRegistry", "vs/platform/theme/common/styler", "vs/platform/theme/common/themeService", "vs/platform/workspace/common/workspace", "vs/workbench/browser/parts/editor/textEditor", "vs/workbench/contrib/search/browser/patternInputWidget", "vs/workbench/contrib/search/browser/searchWidget", "vs/workbench/contrib/search/common/constants", "vs/workbench/contrib/search/common/queryBuilder", "vs/workbench/contrib/search/common/search", "vs/workbench/contrib/search/common/searchModel", "vs/workbench/contrib/searchEditor/browser/constants", "vs/workbench/contrib/searchEditor/browser/searchEditorSerialization", "vs/workbench/services/editor/common/editorGroupsService", "vs/workbench/services/editor/common/editorService", "vs/workbench/services/search/common/search", "vs/workbench/contrib/search/browser/searchIcons", "vs/platform/files/common/files", "vs/base/common/linkedText", "vs/platform/opener/browser/link", "vs/css!./media/searchEditor"], function (require, exports, DOM, keyboardEvent_1, aria_1, async_1, lifecycle_1, types_1, position_1, range_1, selection_1, modelService_1, textResourceConfigurationService_1, referencesController_1, nls_1, commands_1, configuration_1, contextkey_1, contextView_1, instantiation_1, serviceCollection_1, label_1, progress_1, storage_1, telemetry_1, colorRegistry_1, styler_1, themeService_1, workspace_1, textEditor_1, patternInputWidget_1, searchWidget_1, constants_1, queryBuilder_1, search_1, searchModel_1, constants_2, searchEditorSerialization_1, editorGroupsService_1, editorService_1, search_2, searchIcons_1, files_1, linkedText_1, link_1) {
    ...
    let SearchEditor = class SearchEditor extends textEditor_1.BaseTextEditor {
        constructor(telemetryService, themeService, storageService, modelService, contextService, labelService, instantiationService, contextViewService, commandService, contextKeyService, progressService, textResourceService, editorGroupService, editorService, configurationService, fileService) {
        ...
        createQueryEditor(parent) {
            ...
            this.toggleQueryDetailsButton = DOM.append(this.includesExcludesContainer, DOM.$('.expand' + themeService_1.ThemeIcon.asCSSSelector(searchIcons_1.searchDetailsIcon), { tabindex: 0, role: 'button', title: (0, nls_1.localize)(0, null) }));
        ...
        toggleRunAgainMessage(show) {
            ...
            if (show) {
                const runAgainLink = DOM.append(this.messageBox, DOM.$('a.pointer.prominent.message', {}, (0, nls_1.localize)(5, null)));
        ...
        iterateThroughMatches(reverse) {
            ...
            (0, aria_1.alert)((0, nls_1.localize)(6, null, matchText, matchLineText, file.slice(0, file.length - 1)));
        }
        focusNextResult() {
        ...
        async doRunSearch() {
            ...
            if (sortOrder === "modified" /* Modified */) {
            ...
            const results = (0, searchEditorSerialization_1.serializeSearchResultForEditor)(this.searchModel.searchResult, config.filesToInclude, config.filesToExclude, config.contextLines, labelFormatter, sortOrder, exit === null || exit === void 0 ? void 0 : exit.limitHit);
            const { body } = await input.getModels();
            this.modelService.updateModel(body, results.text);
            let warningMessage = '';
            if (exit && exit.limitHit) {
                warningMessage += (0, nls_1.localize)(7, null);
            }
        ...
        loadViewState() {
            var _a;
            const resource = (0, types_1.assertIsDefined)((_a = this.getInput()) === null || _a === void 0 ? void 0 : _a.modelUri);
        ...
        getAriaLabel() {
            var _a, _b;
            return (_b = (_a = this.getInput()) === null || _a === void 0 ? void 0 : _a.getName()) !== null && _b !== void 0 ? _b : (0, nls_1.localize)(8, null);
        }
    };
    ...
    exports.searchEditorTextInputBorder = (0, colorRegistry_1.registerColor)('searchEditor.textInputBorder', { dark: colorRegistry_1.inputBorder, light: colorRegistry_1.inputBorder, hc: colorRegistry_1.inputBorder }, (0, nls_1.localize)(9, null));
