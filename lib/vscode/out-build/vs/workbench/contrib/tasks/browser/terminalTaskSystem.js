 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "vs/base/common/path", "vs/nls!vs/workbench/contrib/tasks/browser/terminalTaskSystem", "vs/base/common/objects", "vs/base/common/types", "vs/base/common/platform", "vs/base/common/async", "vs/base/common/resources", "vs/base/common/collections", "vs/base/common/map", "vs/base/common/severity", "vs/base/common/event", "vs/base/common/lifecycle", "vs/base/common/extpath", "vs/platform/markers/common/markers", "vs/workbench/contrib/tasks/common/problemMatcher", "vs/workbench/contrib/markers/browser/constants", "vs/workbench/contrib/terminal/common/terminal", "vs/workbench/contrib/tasks/common/problemCollectors", "vs/workbench/contrib/tasks/common/tasks", "vs/workbench/contrib/tasks/common/taskSystem", "vs/base/common/uri", "vs/base/common/network", "vs/workbench/contrib/terminal/browser/terminalProcessExtHostProxy"], function (require, exports, path, nls, Objects, Types, Platform, Async, resources, collections_1, map_1, severity_1, event_1, lifecycle_1, extpath_1, markers_1, problemMatcher_1, constants_1, terminal_1, problemCollectors_1, tasks_1, taskSystem_1, uri_1, network_1, terminalProcessExtHostProxy_1) {
    "use strict";
    ...
    class TerminalTaskSystem {
        constructor(terminalService, outputService, panelService, viewsService, markerService, modelService, configurationResolverService, telemetryService, contextService, environmentService, outputChannelId, fileService, terminalProfileResolverService, pathService, viewDescriptorService, logService, configurationService, taskSystemInfoResolver) {
        ...
        run(task, resolver, trigger = taskSystem_1.Triggers.command) {
            ...
            try {
                const executeResult = { kind: 1 /* Started */, task, started: {}, promise: this.executeTask(task, resolver, trigger, new Set()) };
                ...
                if (error instanceof taskSystem_1.TaskError) {
                    ...
                    throw new taskSystem_1.TaskError(severity_1.default.Error, nls.localize(0, null), 7 /* UnknownError */);
                }
            }
        }
        rerun() {
        ...
        revealTask(task) {
            ...
            const isTerminalInPanel = this.viewDescriptorService.getViewLocationById(terminal_1.TERMINAL_VIEW_ID) === 1 /* Panel */;
        ...
        showDependencyCycleMessage(task) {
            this.log(nls.localize(1, null, task._label));
            this.showOutput();
        }
            ...
            if (task.configurationProperties.dependsOn) {
                for (const dependency of task.configurationProperties.dependsOn) {
                    ...
                    if (dependencyTask) {
                        ...
                        this.log(nls.localize(2, null, Types.isString(dependency.task) ? dependency.task : JSON.stringify(dependency.task, undefined, 0), dependency.uri.toString()));
                        this.showOutput();
                    }
                }
            }
        ...
        async executeDependencyTask(task, resolver, trigger, encounteredDependencies, alreadyResolved) {
            ...
            const inactivePromise = new Promise(resolve => {
                const taskInactiveDisposable = this._onDidStateChange.event(taskEvent => {
                    if ((taskEvent.kind === "inactive" /* Inactive */) && (taskEvent.__task === task)) {
        ...
        async acquireInput(taskSystemInfo, workspaceFolder, task, variables, alreadyResolved) {
            ...
            this._onDidStateChange.fire(tasks_1.TaskEvent.create("acquiredInput" /* AcquiredInput */, task));
            return resolved;
        }
        ...
        async executeInTerminal(task, trigger, resolver, workspaceFolder) {
            ...
            if (task.configurationProperties.isBackground) {
                ...
                if ((problemMatchers.length > 0) && !watchingProblemMatcher.isWatching()) {
                    this.appendOutput(nls.localize(3, null, task._label));
                    this.showOutput();
                }
                ...
                this._onDidStateChange.fire(tasks_1.TaskEvent.create("start" /* Start */, task, terminal.instanceId));
                        ...
                        if (exitCode !== undefined) {
                            ...
                            switch (task.command.presentation.panel) {
                                ...
                                case tasks_1.PanelKind.Shared:
                                    this.idleTaskTerminals.set(key, terminal.instanceId.toString(), 1 /* AsOld */);
                                    break;
                            }
                        }
                        let reveal = task.command.presentation.reveal;
                ...
                this._onDidStateChange.fire(tasks_1.TaskEvent.create("start" /* Start */, task, terminal.instanceId, resolver.values));
                const mapKey = task.getMapKey();
                this.busyTasks[mapKey] = task;
                this._onDidStateChange.fire(tasks_1.TaskEvent.create("active" /* Active */, task));
        ...
        async createShellLaunchConfig(task, workspaceFolder, variableResolver, platform, options, command, args, waitOnExit) {
            ...
            const description = nls.localize(4, null);
        ...
        async createTerminal(task, resolver, workspaceFolder) {
            ...
            if (presentationOptions.reveal !== tasks_1.RevealKind.Never || !task.configurationProperties.isBackground) {
                if (presentationOptions.panel === tasks_1.PanelKind.New) {
                    waitOnExit = nls.localize(5, null);
                }
                else if (presentationOptions.showReuseMessage) {
                    waitOnExit = nls.localize(6, null);
                }
                else {
                    waitOnExit = true;
                }
            ...
            if (task.command.runtime === tasks_1.RuntimeType.CustomExecution) {
                ...
                if (launchConfigs === undefined) {
                    return [undefined, undefined, new taskSystem_1.TaskError(severity_1.default.Error, nls.localize(7, null), 7 /* UnknownError */)];
                }
            }
        ...
        collectTaskVariables(variables, task) {
            ...
            if (task.command.runtime === tasks_1.RuntimeType.CustomExecution && tasks_1.CustomTask.is(task)) {
        ...
        async resolveMatchers(resolver, values) {
            ...
            for (const value of values) {
                ...
                if (!matcher) {
                    this.appendOutput(nls.localize(8, null));
                    continue;
                }
