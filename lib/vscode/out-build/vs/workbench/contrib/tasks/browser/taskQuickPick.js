 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "vs/nls!vs/workbench/contrib/tasks/browser/taskQuickPick", "vs/base/common/objects", "vs/workbench/contrib/tasks/common/tasks", "vs/base/common/types", "vs/base/common/lifecycle", "vs/base/common/event", "vs/base/common/codicons", "vs/platform/theme/common/themeService", "vs/platform/theme/common/iconRegistry"], function (require, exports, nls, Objects, tasks_1, Types, lifecycle_1, event_1, codicons_1, themeService_1, iconRegistry_1) {
    "use strict";
    ...
    exports.configureTaskIcon = (0, iconRegistry_1.registerIcon)('tasks-list-configure', codicons_1.Codicon.gear, nls.localize(1, null));
    const removeTaskIcon = (0, iconRegistry_1.registerIcon)('tasks-remove', codicons_1.Codicon.close, nls.localize(2, null));
    class TaskQuickPick extends lifecycle_1.Disposable {
        ...
        createTaskEntry(task, extraButtons = []) {
            ...
            entry.buttons = [{ iconClass: themeService_1.ThemeIcon.asClassName(exports.configureTaskIcon), tooltip: nls.localize(3, null) }, ...extraButtons];
            return entry;
        }
        ...
        async getTopLevelEntries(defaultEntry) {
            ...
            if (recentTasks.length > 0) {
                ...
                this.createEntriesForGroup(this.topLevelEntries, recentTasks, nls.localize(7, null), [removeRecentButton]);
            }
            if (configuredTasks.length > 0) {
                if (dedupedConfiguredTasks.length > 0) {
                    this.createEntriesForGroup(this.topLevelEntries, dedupedConfiguredTasks, nls.localize(8, null));
                }
            }
            if (defaultEntry && (configuredTasks.length === 0)) {
                this.topLevelEntries.push({ type: 'separator', label: nls.localize(9, null) });
        ...
        async getEntriesForProvider(type) {
            ...
            if (tasks.length > 0) {
                ...
                taskQuickPickEntries = [{
                        label: nls.localize(11, null, type),
                        task: null,
                        alwaysShow: true
                    }];
            }
        ...
        async toTask(task) {
            ...
            if (!resolvedTask) {
                this.notificationService.error(nls.localize(12, null, task.type));
            }
            return resolvedTask;
        }
