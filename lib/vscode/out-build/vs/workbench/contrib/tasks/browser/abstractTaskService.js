...
define(["require", "exports", "vs/nls!vs/workbench/contrib/tasks/browser/abstractTaskService", "vs/base/common/severity", "vs/base/common/objects", "vs/base/common/resources", "vs/base/common/json", "vs/base/common/uri", "vs/base/common/actions", "vs/base/common/lifecycle", "vs/base/common/event", "vs/base/common/types", "vs/base/common/parsers", "vs/base/common/uuid", "vs/base/common/platform", "vs/base/common/map", "vs/platform/markers/common/markers", "vs/platform/telemetry/common/telemetry", "vs/platform/configuration/common/configuration", "vs/platform/files/common/files", "vs/workbench/services/extensions/common/extensions", "vs/platform/commands/common/commands", "vs/workbench/contrib/tasks/common/problemMatcher", "vs/platform/storage/common/storage", "vs/platform/progress/common/progress", "vs/platform/opener/common/opener", "vs/platform/notification/common/notification", "vs/platform/dialogs/common/dialogs", "vs/editor/common/services/modelService", "vs/workbench/services/panel/common/panelService", "vs/workbench/contrib/markers/browser/constants", "vs/workbench/services/editor/common/editorService", "vs/workbench/services/configurationResolver/common/configurationResolver", "vs/platform/workspace/common/workspace", "vs/workbench/services/textfile/common/textfiles", "vs/workbench/contrib/output/common/output", "vs/workbench/contrib/terminal/browser/terminal", "vs/workbench/contrib/terminal/common/terminal", "vs/workbench/contrib/tasks/common/taskSystem", "vs/workbench/contrib/tasks/common/tasks", "vs/workbench/contrib/tasks/common/taskService", "vs/workbench/contrib/tasks/common/taskTemplates", "../common/taskConfiguration", "./terminalTaskSystem", "vs/platform/quickinput/common/quickInput", "vs/workbench/contrib/tasks/common/taskDefinitionRegistry", "vs/platform/contextkey/common/contextkey", "vs/workbench/contrib/tasks/browser/runAutomaticTasks", "vs/workbench/services/environment/common/environmentService", "vs/workbench/services/path/common/pathService", "vs/base/common/jsonFormatter", "vs/editor/common/services/resolverService", "vs/base/common/jsonEdit", "vs/workbench/services/preferences/common/preferences", "vs/base/common/cancellation", "vs/workbench/common/views", "vs/workbench/contrib/tasks/browser/taskQuickPick", "vs/platform/log/common/log", "vs/base/common/functional", "vs/platform/theme/common/themeService", "vs/platform/workspace/common/workspaceTrust", "vs/workbench/browser/contextkeys"], function (require, exports, nls, severity_1, Objects, resources, json, uri_1, actions_1, lifecycle_1, event_1, Types, parsers_1, UUID, Platform, map_1, markers_1, telemetry_1, configuration_1, files_1, extensions_1, commands_1, problemMatcher_1, storage_1, progress_1, opener_1, notification_1, dialogs_1, modelService_1, panelService_1, constants_1, editorService_1, configurationResolver_1, workspace_1, textfiles_1, output_1, terminal_1, terminal_2, taskSystem_1, tasks_1, taskService_1, taskTemplates_1, TaskConfig, terminalTaskSystem_1, quickInput_1, taskDefinitionRegistry_1, contextkey_1, runAutomaticTasks_1, environmentService_1, pathService_1, jsonFormatter_1, resolverService_1, jsonEdit_1, preferences_1, cancellation_1, views_1, taskQuickPick_1, log_1, functional_1, themeService_1, workspaceTrust_1, contextkeys_1) {
    ...
    let AbstractTaskService = class AbstractTaskService extends lifecycle_1.Disposable {
        constructor(configurationService, markerService, outputService, panelService, viewsService, commandService, editorService, fileService, contextService, telemetryService, textFileService, modelService, extensionService, quickInputService, configurationResolverService, terminalService, storageService, progressService, openerService, dialogService, notificationService, contextKeyService, environmentService, terminalProfileResolverService, pathService, textModelResolverService, preferencesService, viewDescriptorService, workspaceTrustRequestService, workspaceTrustManagementService, logService) {
            ...
            this.configurationResolverService.contributeVariable('defaultBuildTask', async () => {
                ...
                if (tasks && tasks.length > 0) {
                    entry = await this.showQuickPick(tasks, nls.localize(2, null));
                }
        ...
        showOutput(runSource = 1 /* User */) {
            if ((runSource === 1 /* User */) || (runSource === 3 /* ConfigurationChange */)) {
                this.notificationService.prompt(severity_1.default.Warning, nls.localize(3, null), [{
        ...
        registerTaskSystem(key, info) {
            if (!this._taskSystemInfos.has(key) || info.platform !== 0 /* Web */) {
        ...
        async getTask(folder, identifier, compareId = false) {
            ...
            if (this.ignoredWorkspaceFolders.some(ignored => ignored.name === name)) {
                return Promise.reject(new Error(nls.localize(5, null, name)));
            }
        ...
        async tryResolveTask(configuringTask) {
            ...
            if (!matchingProvider) {
                if (matchingProviderUnavailable) {
                    this._outputChannel.append(nls.localize(6, null, configuringTask.configures.type));
                }
                return;
            }
        ...
        async readRecentTasks() {
            ...
            for (const key of folderToTasksMap.keys()) {
                ...
                await this.computeTasksForSingleConfig((_a = folderMap[key]) !== null && _a !== void 0 ? _a : await this.getAFolder(), {
                    version: '2.0.0',
        ...
        saveRecentlyUsedTasks() {
            ...
            this.storageService.store(AbstractTaskService.RecentlyUsedTasks_KeyV2, JSON.stringify(keyValues), 1 /* WORKSPACE */, 0 /* USER */);
        }
        openDocumentation() {
            ...
            return this.getGroupedTasks().then((tasks) => {
                ...
                if (!runnable || !runnable.task) {
                    if (this.schemaVersion === 1 /* V0_1_0 */) {
                        throw new taskSystem_1.TaskError(severity_1.default.Info, nls.localize(7, null), 2 /* NoBuildTask */);
                    }
                    else {
                        throw new taskSystem_1.TaskError(severity_1.default.Info, nls.localize(8, null), 2 /* NoBuildTask */);
                    }
                }
                return this.executeTask(runnable.task, runnable.resolver, 1 /* User */);
        ...
        runTest() {
            return this.getGroupedTasks().then((tasks) => {
                ...
                if (!runnable || !runnable.task) {
                    if (this.schemaVersion === 1 /* V0_1_0 */) {
                        throw new taskSystem_1.TaskError(severity_1.default.Info, nls.localize(9, null), 3 /* NoTestTask */);
                    }
                    else {
                        throw new taskSystem_1.TaskError(severity_1.default.Info, nls.localize(10, null), 3 /* NoTestTask */);
                    }
                }
                return this.executeTask(runnable.task, runnable.resolver, 1 /* User */);
            }).then(value => value, (error) => {
        ...
        async run(task, options, runSource = 0 /* System */) {
            if (!(await this.trust())) {
                return;
            }
            if (!task) {
                throw new taskSystem_1.TaskError(severity_1.default.Info, nls.localize(11, null), 5 /* TaskNotFound */);
            }
        ...
        attachProblemMatcher(task) {
            ...
            if (entries.length > 0) {
                ...
                entries.unshift({ type: 'separator', label: nls.localize(12, null) });
                let taskType;
                if (tasks_1.CustomTask.is(task)) {
                    let configProperties = task._source.config.element;
                ...
                entries.unshift({ label: nls.localize(13, null), matcher: undefined }, { label: nls.localize(14, null), matcher: undefined, never: true }, { label: nls.localize(15, null, taskType), matcher: undefined, setting: taskType }, { label: nls.localize(16, null), matcher: undefined, learnMore: true });
        ...
        async formatTaskForJson(resource, task) {
            ...
            try {
                ...
                const edits = (0, jsonFormatter_1.format)(JSON.stringify(task), undefined, { eol, tabSize, insertSpaces });
                let stringified = (0, jsonEdit_1.applyEdits)(JSON.stringify(task), edits);
        ...
        async customize(task, properties, openConfig) {
            ...
            if (configuration.hasParseErrors) {
                this.notificationService.warn(nls.localize(18, null));
                return Promise.resolve(undefined);
            }
        ...
        createRunnableTask(tasks, group) {
            ...
            if (workspaceTasks.length > 0) {
                if (workspaceTasks.length > 1) {
                    this._outputChannel.append(nls.localize(20, null));
                }
        ...
        executeTask(task, resolver, runSource) {
            ...
            const promptAsk = async (task, resolver) => {
                const dialogOptions = await this.dialogService.show(severity_1.default.Info, nls.localize(21, null), [nls.localize(22, null), nls.localize(23, null)], {
                    detail: nls.localize(24, null),
                    cancelId: 1
                });
            ...
            if (executeResult.kind === 2 /* Active */) {
                ...
                if (active && active.same) {
                    if ((_a = this._taskSystem) === null || _a === void 0 ? void 0 : _a.isTaskVisible(executeResult.task)) {
                        const message = nls.localize(25, null, executeResult.task.getQualifiedLabel());
                    ...
                    throw new taskSystem_1.TaskError(severity_1.default.Warning, nls.localize(28, null), 1 /* RunningTask */);
                }
            }
        ...
        restart(task) {
            ...
            this._taskSystem.terminate(task).then((response) => {
                if (response.success) {
                    ...
                    this.notificationService.warn(nls.localize(29, null, Types.isString(task) ? task : task.configurationProperties.name));
                }
                return response;
            });
        }
                                ...
                                provider.provideTasks(validTypes).then((taskSet) => {
                                    ...
                                    for (const task of taskSet.tasks) {
                                        if (task.type !== this._providerTypes.get(handle)) {
                                            this._outputChannel.append(nls.localize(30, null, this._providerTypes.get(handle), task.type));
                            ...
                            if (configurations || legacyTaskConfigurations) {
                                ...
                                const unUsedConfigurationPromises = unUsedConfigurationsAsArray.map(async (value) => {
                                    ...
                                    if (requiredTaskProviderUnavailable) {
                                        this._outputChannel.append(nls.localize(31, null, configuringTask.configures.type));
                                    }
                                    else {
                                        this._outputChannel.append(nls.localize(32, null, configuringTask.configures.type, JSON.stringify(configuringTask._source.config.element, undefined, 4)));
                                        this.showOutput();
                                    }
                                });
        ...
        async getWorkspaceTasks(runSource = 1 /* User */) {
            if (!(await this.trust())) {
                return new Map();
            }
        ...
        computeWorkspaceFolderTasks(workspaceFolder, runSource = 1 /* User */) {
            return (this.executionEngine === tasks_1.ExecutionEngine.Process
                ...
                return problemMatcher_1.ProblemMatcherRegistry.onReady().then(async () => {
                    ...
                    let hasErrors = false;
                    if (!parseResult.validationStatus.isOK() && (parseResult.validationStatus.state !== 1 /* Info */)) {
                        hasErrors = true;
                        this.showOutput(runSource);
                    }
                    if (problemReporter.status.isFatal()) {
                        problemReporter.fatal(nls.localize(33, null));
        ...
        testParseExternalConfig(config, location) {
            ...
            if (parseErrors) {
                ...
                if (isAffected) {
                    this._outputChannel.append(nls.localize(34, null, location));
                    this.showOutput();
        ...
        async computeWorkspaceFileTasks(workspaceFolder, runSource = 1 /* User */) {
            ...
            const configuration = this.testParseExternalConfig(this.configurationService.inspect('tasks').workspaceValue, nls.localize(35, null));
            let customizedTasks = {
                byIdentifier: Object.create(null)
            };
            const custom = [];
            ...
            if (engine === tasks_1.ExecutionEngine.Process) {
                this.notificationService.warn(nls.localize(36, null));
                return this.emptyWorkspaceTaskResults(workspaceFolder);
            }
        ...
        async computeUserTasks(workspaceFolder, runSource = 1 /* User */) {
            ...
            const configuration = this.testParseExternalConfig(this.configurationService.inspect('tasks').userValue, nls.localize(37, null));
            let customizedTasks = {
                byIdentifier: Object.create(null)
            };
            const custom = [];
            ...
            const engine = configuration.config ? TaskConfig.ExecutionEngine.from(configuration.config) : tasks_1.ExecutionEngine.Terminal;
            if (engine === tasks_1.ExecutionEngine.Process) {
                this.notificationService.warn(nls.localize(38, null));
                return this.emptyWorkspaceTaskResults(workspaceFolder);
            }
            return { workspaceFolder, set: { tasks: custom }, configurations: customizedTasks, hasErrors: configuration.hasParseErrors };
        }
        ...
        async computeTasksForSingleConfig(workspaceFolder, config, runSource, custom, customized, source, isRecentTask = false) {
            ...
            if (problemReporter.status.isFatal()) {
                problemReporter.fatal(nls.localize(39, null));
                return hasErrors;
            }
            if (parseResult.configured && parseResult.configured.length > 0) {
                for (let task of parseResult.configured) {
                ...
                */
                ...
                for (let workspaceFolder of this.contextService.getWorkspace().folders) {
                    if (schemaVersion === this.computeJsonSchemaVersion(workspaceFolder)) {
                        ...
                        this._outputChannel.append(nls.localize(40, null, workspaceFolder.uri.fsPath));
                    }
                }
            }
        ...
        getConfiguration(workspaceFolder, source) {
            ...
            if (parseErrors) {
                ...
                if (isAffected) {
                    this._outputChannel.append(nls.localize(41, null));
                    this.showOutput();
            ...
            if (err instanceof taskSystem_1.TaskError) {
                ...
                if (needsConfig || needsTerminate) {
                    this.notificationService.prompt(buildError.severity, buildError.message, [{
                            label: needsConfig ? ConfigureTaskAction.TEXT : nls.localize(42, null),
                            run: () => {
                                if (needsConfig) {
                                    this.runConfigureTasks();
                                }
                ...
                this.notificationService.error(nls.localize(43, null));
            }
            if (showOutput) {
                this.showOutput();
            }
        ...
        async createTaskQuickPickEntries(tasks, group = false, sort = false, selectedEntry, includeRecents = true) {
            ...
            function fillEntries(entries, tasks, groupLabel) {
                ...
                for (let task of tasks) {
                    ...
                    entry.buttons = [{ iconClass: themeService_1.ThemeIcon.asClassName(taskQuickPick_1.configureTaskIcon), tooltip: nls.localize(44, null) }];
            ...
            if (group) {
                ...
                if (tasks.length === 1) {
                    ...
                    if (includeRecents) {
                        fillEntries(entries, recent, nls.localize(45, null));
                    }
                    configured = configured.sort((a, b) => sorter.compare(a, b));
                    fillEntries(entries, configured, nls.localize(46, null));
                    detected = detected.sort((a, b) => sorter.compare(a, b));
                    fillEntries(entries, detected, nls.localize(47, null));
                }
            }
            else {
                if (sort) {
        ...
        showIgnoredFoldersMessage() {
            ...
            this.notificationService.prompt(severity_1.default.Info, nls.localize(48, null, this.ignoredWorkspaceFolders.map(f => f.name).join(', ')), [{
                    label: nls.localize(49, null),
                    isSecondary: true,
                    run: () => {
                        this.storageService.store(AbstractTaskService.IgnoreTask010DonotShowAgain_key, true, 1 /* WORKSPACE */, 0 /* USER */);
        ...
        doRunTaskCommand(tasks) {
            ...
            const placeholder = nls.localize(51, null);
            ...
            let promise = this.getWorkspaceTasks().then(tasks => {
                ...
                if (buildTasks.length === 1) {
                    this.tryResolveTask(buildTasks[0]).then(resolvedTask => {
                        this.run(resolvedTask, undefined, 1 /* User */).then(undefined, reason => {
                            // eat the error, it has already been surfaced to the user and we don't care about it here
                        });
                    });
                    return;
                ...
                return this.getTasksForGroup(tasks_1.TaskGroup.Build).then((tasks) => {
                    if (tasks.length > 0) {
                        let { defaults, users } = this.splitPerGroupType(tasks);
                        if (defaults.length === 1) {
                            this.run(defaults[0], undefined, 1 /* User */).then(undefined, reason => {
                                // eat the error, it has already been surfaced to the user and we don't care about it here
                            });
                            return;
                        }
                    ...
                    this.showIgnoredFoldersMessage().then(() => {
                        this.showQuickPick(tasks, nls.localize(55, null), {
        ...
        runTestCommand() {
            ...
            let promise = this.getTasksForGroup(tasks_1.TaskGroup.Test).then((tasks) => {
                ...
                this.showIgnoredFoldersMessage().then(() => {
                    this.showQuickPick(tasks, nls.localize(58, null), {
                        label: nls.localize(59, null),
                        task: null
                    }, true).then((entry) => {
                        let task = entry ? entry.task : undefined;
                        if (task === undefined) {
                        ...
                        this.run(task, undefined, 1 /* User */).then(undefined, reason => {
                            // eat the error, it has already been surfaced to the user and we don't care about it here
                        });
                    });
                });
        ...
        runTerminateCommand(arg) {
            ...
            let runQuickPick = (promise) => {
                this.showQuickPick(promise || this.getActiveTasks(), nls.localize(60, null), {
                    label: nls.localize(61, null),
                    task: undefined
                }, false, true, undefined, [{
                        label: nls.localize(62, null),
                        id: 'terminateAll',
                        task: undefined
                    }]).then(entry => {
                    ...
                    if (active) {
                        this.terminateAll().then((responses) => {
                            ...
                            if (response.code && response.code === 3 /* ProcessNotFound */) {
                                this.notificationService.error(nls.localize(63, null));
                            }
                            else {
                                this.notificationService.error(nls.localize(64, null));
                            }
                        });
                    }
                });
        ...
        runRestartTaskCommand(arg) {
            ...
            let runQuickPick = (promise) => {
                this.showQuickPick(promise || this.getActiveTasks(), nls.localize(65, null), {
        ...
        openTaskFile(resource, taskSource) {
            ...
            this.fileService.resolve(resource).then((stat) => stat, () => undefined).then(async (stat) => {
                ...
                let content;
                if (!tasksExistInFile) {
                    const pickTemplateResult = await this.quickInputService.pick((0, taskTemplates_1.getTemplates)(), { placeHolder: nls.localize(67, null) });
        ...
        handleSelection(selection) {
            ...
            else if (selection.folder && (this.contextService.getWorkbenchState() !== 1 /* EMPTY */)) {
        ...
        async runConfigureTasks() {
            ...
            let createLabel = nls.localize(69, null);
            let openLabel = nls.localize(70, null);
            const tokenSource = new cancellation_1.CancellationTokenSource();
            const cancellationToken = tokenSource.token;
            ...
            this.quickInputService.pick(entries, { placeHolder: nls.localize(71, null) }, cancellationToken).
        ...
        runConfigureDefaultBuildTask() {
            ...
            if (this.schemaVersion === 2 /* V2_0_0 */) {
                this.tasks().then((tasks => {
                    ...
                    if (selectedTask) {
                        selectedEntry = {
                            label: nls.localize(72, null, selectedTask.getQualifiedLabel()),
                            task: selectedTask,
                            detail: this.showDetail() ? selectedTask.configurationProperties.detail : undefined
                        };
                    }
                    this.showIgnoredFoldersMessage().then(() => {
                        this.showQuickPick(tasks, nls.localize(73, null), undefined, true, false, selectedEntry).
                            then((entry) => {
                            let task = entry ? entry.task : undefined;
                            if ((task === undefined) || (task === null)) {
                                return;
        ...
        runConfigureDefaultTestTask() {
            ...
            if (this.schemaVersion === 2 /* V2_0_0 */) {
                this.tasks().then((tasks => {
                    ...
                    if (selectedTask) {
                        selectedEntry = {
                            label: nls.localize(74, null, selectedTask.getQualifiedLabel()),
                            task: selectedTask,
                            detail: this.showDetail() ? selectedTask.configurationProperties.detail : undefined
                        };
                    }
                    this.showIgnoredFoldersMessage().then(() => {
                        this.showQuickPick(tasks, nls.localize(75, null), undefined, true, false, selectedEntry).then((entry) => {
                            let task = entry ? entry.task : undefined;
                            if (!task) {
                                return;
                            }
        ...
        async runShowTasks() {
            ...
            if (activeTasks.length === 1) {
                ...
                this.showQuickPick(this.getActiveTasks(), nls.localize(76, null), {
                    label: nls.localize(77, null),
                    task: null
                }, false, true).then((entry) => {
                    let task = entry ? entry.task : undefined;
                    if (task === undefined || task === null) {
        ...
        async upgrade() {
            ...
            this.notificationService.prompt(severity_1.default.Warning, fileDiffs.length === 1 ?
                ...
                : nls.localize(79, null), [{
                    label: fileDiffs.length === 1 ? nls.localize(80, null) : nls.localize(81, null),
                    run: async () => {
    ...
    AbstractTaskService.OutputChannelLabel = nls.localize(1, null);
    ...
    AbstractTaskService = __decorate([
        ...
        __param(23, terminal_2.ITerminalProfileResolverService),
        __param(24, pathService_1.IPathService),
        __param(25, resolverService_1.ITextModelService),
        __param(26, preferences_1.IPreferencesService),
        __param(27, views_1.IViewDescriptorService),
        __param(28, workspaceTrust_1.IWorkspaceTrustRequestService),
        __param(29, workspaceTrust_1.IWorkspaceTrustManagementService),
