...
define(["require", "exports", "vs/nls!vs/workbench/contrib/tasks/common/tasks", "vs/base/common/types", "vs/base/common/resources", "vs/base/common/objects", "vs/platform/contextkey/common/contextkey", "vs/workbench/contrib/tasks/common/taskDefinitionRegistry", "vs/workbench/contrib/tasks/common/taskService"], function (require, exports, nls, Types, resources, Objects, contextkey_1, taskDefinitionRegistry_1, taskService_1) {
    ...
    exports.TaskDefinition = exports.KeyedTaskIdentifier = exports.TaskEvent = exports.TaskRunSource = exports.TaskRunType = exports.TaskEventKind = exports.TaskSorter = exports.JsonSchemaVersion = exports.ExecutionEngine = exports.InMemoryTask = exports.ContributedTask = exports.ConfiguringTask = exports.CustomTask = exports.CommonTask = exports.RunOptions = exports.RunOnOptions = exports.DependsOrder = exports.GroupType = exports.TaskSourceKind = exports.TaskScope = exports.TaskGroup = exports.CommandString = exports.RuntimeType = exports.PresentationOptions = exports.PanelKind = exports.RevealProblemKind = exports.RevealKind = exports.CommandOptions = exports.CUSTOMIZED_TASK_TYPE = exports.ShellQuoting = exports.TASKS_CATEGORY = exports.TASK_RUNNING_STATE = void 0;
    exports.TASK_RUNNING_STATE = new contextkey_1.RawContextKey('taskRunning', false, nls.localize(0, null));
    exports.TASKS_CATEGORY = { value: nls.localize(1, null), original: 'Tasks' };
    var ShellQuoting;
