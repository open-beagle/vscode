 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "assert", "vs/workbench/contrib/notebook/browser/constants", "vs/workbench/contrib/notebook/common/notebookCommon", "vs/workbench/contrib/notebook/test/testNotebookEditor"], function (require, exports, assert, constants_1, notebookCommon_1, testNotebookEditor_1) {
    "use strict";
    ...
    suite('NotebookCellList', () => {
        ...
        test('revealElementsInView: reveal fully visible cell should not scroll', async function () {
            await (0, testNotebookEditor_1.withTestNotebook)([
                ...
                cellList.layout(210 + constants_1.SCROLLABLE_ELEMENT_PADDING_TOP, 100);
