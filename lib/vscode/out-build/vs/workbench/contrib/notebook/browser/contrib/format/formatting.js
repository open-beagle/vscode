        ...
        async run(accessor) {
            ...
            try {
                ...
                for (const cell of notebook.cells) {
                    ...
                    const formatEdits = await (0, format_1.getDocumentFormattingEditsUntilResult)(editorWorkerService, model, model.getOptions(), cancellation_1.CancellationToken.None);
                    if (formatEdits) {
                ...
                await bulkEditService.apply(edits, { label: (0, nls_1.localize)(1, null) });
            }
            finally {
                disposable.dispose();
            }
