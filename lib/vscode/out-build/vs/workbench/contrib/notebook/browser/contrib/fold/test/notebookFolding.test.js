 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "assert", "vs/workbench/contrib/notebook/common/notebookCommon", "vs/workbench/contrib/notebook/test/testNotebookEditor", "vs/platform/undoRedo/common/undoRedo", "vs/workbench/contrib/notebook/browser/contrib/fold/foldingModel"], function (require, exports, assert, notebookCommon_1, testNotebookEditor_1, undoRedo_1, foldingModel_1) {
    "use strict";
    ...
    suite('Notebook Folding', () => {
        ...
        test('Folding based on markdown cells', async function () {
            await (0, testNotebookEditor_1.withTestNotebook)([
                ...
                ['## header 2.1', 'markdown', notebookCommon_1.CellKind.Markdown, [], {}],
                ['body 2', 'markdown', notebookCommon_1.CellKind.Markdown, [], {}],
                ['body 3', 'markdown', notebookCommon_1.CellKind.Markdown, [], {}],
                ['## header 2.2', 'markdown', notebookCommon_1.CellKind.Markdown, [], {}],
                ['var e = 7;', 'markdown', notebookCommon_1.CellKind.Markdown, [], {}],
            ], (editor) => {
        ...
        test('Top level header in a cell wins', async function () {
            await (0, testNotebookEditor_1.withTestNotebook)([
                ['# header 1', 'markdown', notebookCommon_1.CellKind.Markdown, [], {}],
                ['body', 'markdown', notebookCommon_1.CellKind.Markdown, [], {}],
                ['## header 2.1\n# header3', 'markdown', notebookCommon_1.CellKind.Markdown, [], {}],
                ['body 2', 'markdown', notebookCommon_1.CellKind.Markdown, [], {}],
                ['body 3', 'markdown', notebookCommon_1.CellKind.Markdown, [], {}],
                ['## header 2.2', 'markdown', notebookCommon_1.CellKind.Markdown, [], {}],
                ['var e = 7;', 'markdown', notebookCommon_1.CellKind.Markdown, [], {}],
        ...
        test('Folding', async function () {
            ...
            await (0, testNotebookEditor_1.withTestNotebook)([
                ['# header 1', 'markdown', notebookCommon_1.CellKind.Markdown, [], {}],
                ['body', 'markdown', notebookCommon_1.CellKind.Markdown, [], {}],
                ['## header 2.1\n', 'markdown', notebookCommon_1.CellKind.Markdown, [], {}],
                ['body 2', 'markdown', notebookCommon_1.CellKind.Markdown, [], {}],
                ['body 3', 'markdown', notebookCommon_1.CellKind.Markdown, [], {}],
                ['## header 2.2', 'markdown', notebookCommon_1.CellKind.Markdown, [], {}],
                ['var e = 7;', 'markdown', notebookCommon_1.CellKind.Markdown, [], {}],
