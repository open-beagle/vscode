...
define(["require", "exports", "vs/nls!vs/workbench/contrib/feedback/browser/feedback", "vs/base/common/lifecycle", "vs/base/browser/ui/dropdown/dropdown", "vs/base/browser/dom", "vs/platform/commands/common/commands", "vs/workbench/services/integrity/common/integrity", "vs/platform/theme/common/themeService", "vs/platform/theme/common/styler", "vs/platform/theme/common/colorRegistry", "vs/base/browser/ui/button/button", "vs/platform/telemetry/common/telemetry", "vs/workbench/services/statusbar/common/statusbar", "vs/platform/product/common/productService", "vs/platform/opener/common/opener", "vs/base/browser/keyboardEvent", "vs/base/common/codicons", "vs/css!./media/feedback"], function (require, exports, nls, lifecycle_1, dropdown_1, dom, commands_1, integrity_1, themeService_1, styler_1, colorRegistry_1, button_1, telemetry_1, statusbar_1, productService_1, opener_1, keyboardEvent_1, codicons_1) {
    ...
    let FeedbackWidget = class FeedbackWidget extends dropdown_1.Dropdown {
        constructor(container, options, commandService, telemetryService, integrityService, themeService, statusbarService, productService, openerService) {
            ...
            this.element.title = nls.localize(0, null);
        }
        getAnchor() {
        ...
        renderContents(container) {
            ...
            // Title
            dom.append(this.feedbackForm, dom.$('h2.title')).textContent = nls.localize(1, null);
            // Close Button (top right)
            const closeBtn = dom.append(this.feedbackForm, dom.$('div.cancel' + codicons_1.Codicon.close.cssSelector));
            closeBtn.tabIndex = 0;
            closeBtn.setAttribute('role', 'button');
            closeBtn.title = nls.localize(2, null);
            ...
            disposables.add(dom.addDisposableListener(closeBtn, dom.EventType.MOUSE_OVER, () => {
                ...
                if (darkenFactor) {
                    ...
                    if (backgroundBaseColor) {
                        const backgroundColor = (0, colorRegistry_1.darken)(backgroundBaseColor, darkenFactor)(theme);
                        if (backgroundColor) {
            ...
            if (!this.isPure) {
                dom.append(sentimentContainer, dom.$('span')).textContent = nls.localize(3, null);
                sentimentContainer.appendChild(document.createElement('br'));
                dom.append(sentimentContainer, dom.$('span')).textContent = nls.localize(4, null);
                sentimentContainer.appendChild(document.createElement('br'));
            }
            dom.append(sentimentContainer, dom.$('span')).textContent = nls.localize(5, null);
            ...
            this.smileyInput.setAttribute('aria-label', nls.localize(6, null));
            this.smileyInput.setAttribute('role', 'checkbox');
            this.smileyInput.title = nls.localize(7, null);
            ...
            this.frownyInput.setAttribute('aria-label', nls.localize(8, null));
            this.frownyInput.setAttribute('role', 'checkbox');
            this.frownyInput.title = nls.localize(9, null);
            ...
            dom.append(contactUsContainer, dom.$('span')).textContent = nls.localize(10, null);
            ...
            submitBugLink.textContent = nls.localize(11, null);
            ...
            if (!!this.requestFeatureLink) {
                ...
                requestFeatureLink.textContent = nls.localize(12, null);
            ...
            remainingCharacterCountContainer.textContent = nls.localize(13, null);
            ...
            this.feedbackDescriptionInput.setAttribute('aria-label', nls.localize(14, null));
            ...
            hideButtonLabel.textContent = nls.localize(15, null);
            // Button: Send Feedback
            this.sendButton = new button_1.Button(buttonsContainer);
            this.sendButton.enabled = false;
            this.sendButton.label = nls.localize(16, null);
            dom.prepend(this.sendButton.element, dom.$('span' + codicons_1.Codicon.twitter.cssSelector));
            this.sendButton.element.classList.add('send');
            this.sendButton.element.title = nls.localize(17, null);
