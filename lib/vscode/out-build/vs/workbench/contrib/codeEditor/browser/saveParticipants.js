...
define(["require", "exports", "vs/base/common/strings", "vs/editor/browser/editorBrowser", "vs/editor/browser/services/codeEditorService", "vs/editor/common/commands/trimTrailingWhitespaceCommand", "vs/editor/common/core/editOperation", "vs/editor/common/core/position", "vs/editor/common/core/range", "vs/editor/contrib/codeAction/codeAction", "vs/editor/contrib/codeAction/codeActionCommands", "vs/editor/contrib/codeAction/types", "vs/editor/contrib/format/format", "vs/editor/contrib/snippet/snippetController2", "vs/nls!vs/workbench/contrib/codeEditor/browser/saveParticipants", "vs/platform/configuration/common/configuration", "vs/platform/instantiation/common/instantiation", "vs/platform/progress/common/progress", "vs/workbench/services/textfile/common/textfiles", "vs/base/common/lifecycle", "vs/workbench/common/contributions", "vs/platform/registry/common/platform", "vs/workbench/contrib/format/browser/formatModified"], function (require, exports, strings, editorBrowser_1, codeEditorService_1, trimTrailingWhitespaceCommand_1, editOperation_1, position_1, range_1, codeAction_1, codeActionCommands_1, types_1, format_1, snippetController2_1, nls_1, configuration_1, instantiation_1, progress_1, textfiles_1, lifecycle_1, contributions_1, platform_1, formatModified_1) {
    "use strict";
    ...
    let FormatOnSaveParticipant = class FormatOnSaveParticipant {
        ...
        async participate(model, env, progress, token) {
            ...
            const nestedProgress = new progress_1.Progress(provider => {
                progress.report({
                    message: (0, nls_1.localize)(0, null, provider.displayName || provider.extensionId && provider.extensionId.value || '???')
                });
            });
            ...
            if (mode === 'modifications') {
                ...
                if (ranges) {
                    await this.instantiationService.invokeFunction(format_1.formatDocumentRangesWithSelectedProvider, editorOrModel, ranges, 2 /* Silent */, nestedProgress, token);
                }
            }
            else {
    ...
    let CodeActionOnSaveParticipant = class CodeActionOnSaveParticipant {
        ...
        async applyOnSaveActions(model, codeActionsOnSave, excludes, progress, token) {
            const getActionProgress = new class {
                ...
                _report() {
                    progress.report({
                        message: (0, nls_1.localize)(2, null, [...this._names].map(name => `'${name}'`).join(', '))
                    });
                }
                report(provider) {
        ...
        getActionsToRun(model, codeActionKind, excludes, progress, token) {
            return (0, codeAction_1.getCodeActions)(model, model.getFullModelRange(), {
                type: 2 /* Auto */,
