...
define(["require", "exports", "vs/nls!vs/workbench/contrib/codeEditor/browser/diffEditorHelper", "vs/editor/browser/editorExtensions", "vs/base/common/lifecycle", "vs/workbench/browser/codeeditor", "vs/platform/instantiation/common/instantiation", "vs/platform/configuration/common/configuration", "vs/platform/notification/common/notification"], function (require, exports, nls, editorExtensions_1, lifecycle_1, codeeditor_1, instantiation_1, configuration_1, notification_1) {
    "use strict";
    ...
    let DiffEditorHelperContribution = class DiffEditorHelperContribution extends lifecycle_1.Disposable {
        constructor(_diffEditor, _instantiationService, _configurationService, _notificationService) {
            ...
            this._register(this._diffEditor.onDidUpdateDiff(() => {
                ...
                if (diffComputationResult && diffComputationResult.quitEarly) {
                    this._notificationService.prompt(notification_1.Severity.Warning, nls.localize(0, null, this._diffEditor.maxComputationTime), [{
        ...
        _setState(newState) {
            ...
            if (this._state === 1 /* HintWhitespace */) {
                this._helperWidget = this._instantiationService.createInstance(codeeditor_1.FloatingClickWidget, this._diffEditor.getModifiedEditor(), nls.localize(2, null), null);
