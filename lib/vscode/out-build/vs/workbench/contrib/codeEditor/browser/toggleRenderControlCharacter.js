...
define(["require", "exports", "vs/nls!vs/workbench/contrib/codeEditor/browser/toggleRenderControlCharacter", "vs/base/common/actions", "vs/platform/actions/common/actions", "vs/platform/configuration/common/configuration", "vs/platform/contextkey/common/contextkey", "vs/platform/registry/common/platform", "vs/workbench/common/actions"], function (require, exports, nls, actions_1, actions_2, configuration_1, contextkey_1, platform_1, actions_3) {
    ...
    ToggleRenderControlCharacterAction.LABEL = nls.localize(0, null);
    ...
    registry.registerWorkbenchAction(actions_2.SyncActionDescriptor.from(ToggleRenderControlCharacterAction), 'View: Toggle Control Characters', actions_3.CATEGORIES.View.value);
