...
define(["require", "exports", "vs/nls!vs/workbench/contrib/codeEditor/browser/inspectKeybindings", "vs/editor/browser/editorExtensions", "vs/platform/keybinding/common/keybinding", "vs/workbench/services/editor/common/editorService", "vs/platform/registry/common/platform", "vs/workbench/common/actions", "vs/platform/actions/common/actions", "vs/base/common/actions"], function (require, exports, nls, editorExtensions_1, keybinding_1, editorService_1, platform_1, actions_1, actions_2, actions_3) {
    "use strict";
    ...
    (0, editorExtensions_1.registerEditorAction)(InspectKeyMap);
    ...
    InspectKeyMapJSON.LABEL = nls.localize(1, null);
    InspectKeyMapJSON = __decorate([
        __param(2, keybinding_1.IKeybindingService),
        __param(3, editorService_1.IEditorService)
    ], InspectKeyMapJSON);
    const registry = platform_1.Registry.as(actions_1.Extensions.WorkbenchActions);
    registry.registerWorkbenchAction(actions_2.SyncActionDescriptor.from(InspectKeyMapJSON), 'Developer: Inspect Key Mappings (JSON)', actions_1.CATEGORIES.Developer.value);
});
