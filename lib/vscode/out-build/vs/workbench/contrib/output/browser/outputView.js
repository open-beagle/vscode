...
define(["require", "exports", "vs/nls!vs/workbench/contrib/output/browser/outputView", "vs/platform/telemetry/common/telemetry", "vs/platform/storage/common/storage", "vs/editor/common/services/textResourceConfigurationService", "vs/platform/instantiation/common/instantiation", "vs/platform/contextkey/common/contextkey", "vs/workbench/common/editor", "vs/workbench/browser/parts/editor/textResourceEditor", "vs/workbench/contrib/output/common/output", "vs/platform/theme/common/themeService", "vs/platform/configuration/common/configuration", "vs/workbench/services/editor/common/editorGroupsService", "vs/base/common/cancellation", "vs/workbench/services/editor/common/editorService", "vs/workbench/browser/parts/views/viewPane", "vs/platform/keybinding/common/keybinding", "vs/platform/contextview/browser/contextView", "vs/workbench/common/views", "vs/workbench/common/editor/resourceEditorInput", "vs/platform/opener/common/opener", "vs/workbench/services/output/common/output", "vs/platform/registry/common/platform", "vs/platform/theme/common/styler", "vs/base/common/arrays", "vs/workbench/common/theme", "vs/platform/theme/common/colorRegistry", "vs/base/browser/ui/actionbar/actionViewItems", "vs/base/browser/dom"], function (require, exports, nls, telemetry_1, storage_1, textResourceConfigurationService_1, instantiation_1, contextkey_1, editor_1, textResourceEditor_1, output_1, themeService_1, configuration_1, editorGroupsService_1, cancellation_1, editorService_1, viewPane_1, keybinding_1, contextView_1, views_1, resourceEditorInput_1, opener_1, output_2, platform_1, styler_1, arrays_1, theme_1, colorRegistry_1, actionViewItems_1, dom_1) {
    "use strict";
    ...
    let OutputViewPane = class OutputViewPane extends viewPane_1.ViewPane {
        ...
        setInput(channel) {
            ...
            this.editorPromise = this.editor.setInput(this.createInput(channel), editor_1.EditorOptions.create({ preserveFocus: true }), Object.create(null), cancellation_1.CancellationToken.None)
                .then(() => this.editor);
        }
        clearInput() {
        ...
        createInput(channel) {
            return this.instantiationService.createInstance(resourceEditorInput_1.ResourceEditorInput, channel.uri, nls.localize(0, null, channel.label), nls.localize(1, null, channel.label), undefined);
        }
    };
    ...
    let OutputEditor = class OutputEditor extends textResourceEditor_1.AbstractTextResourceEditor {
        ...
        getAriaLabel() {
            ...
            return channel ? nls.localize(3, null, channel.label) : nls.localize(4, null);
        }
    ...
    let SwitchOutputActionViewItem = class SwitchOutputActionViewItem extends actionViewItems_1.SelectActionViewItem {
        constructor(action, outputService, themeService, contextViewService) {
            super(null, action, [], 0, contextViewService, { ariaLabel: nls.localize(5, null), optionsAsChildren: true });
            this.outputService = outputService;
        ...
        updateOtions() {
            ...
            const options = [...this.outputChannels.map(c => c.label), ...(showSeparator ? [SwitchOutputActionViewItem.SEPARATOR] : []), ...this.logChannels.map(c => nls.localize(6, null, c.label))];
            let selected = 0;
            const activeChannel = this.outputService.getActiveChannel();
            if (activeChannel) {
