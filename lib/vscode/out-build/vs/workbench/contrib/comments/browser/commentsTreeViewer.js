...
define(["require", "exports", "vs/base/browser/dom", "vs/nls!vs/workbench/contrib/comments/browser/commentsTreeViewer", "vs/base/browser/markdownRenderer", "vs/base/common/errors", "vs/base/common/lifecycle", "vs/platform/opener/common/opener", "vs/workbench/contrib/comments/common/commentModel", "vs/platform/accessibility/common/accessibility", "vs/platform/keybinding/common/keybinding", "vs/platform/configuration/common/configuration", "vs/platform/contextkey/common/contextkey", "vs/platform/list/browser/listService", "vs/platform/theme/common/themeService", "vs/platform/instantiation/common/instantiation"], function (require, exports, dom, nls, markdownRenderer_1, errors_1, lifecycle_1, opener_1, commentModel_1, accessibility_1, keybinding_1, configuration_1, contextkey_1, listService_1, themeService_1, instantiation_1) {
    ...
    let CommentNodeRenderer = class CommentNodeRenderer {
        ...
        renderElement(node, index, templateData, height) {
            ...
            const renderedComment = (0, markdownRenderer_1.renderMarkdown)(node.element.comment.body, {
                inline: true,
                actionHandler: {
                    callback: (content) => {
                        this.openerService.open(content, { allowCommands: node.element.comment.body.isTrusted }).catch(errors_1.onUnexpectedError);
                    },
            ...
            for (let i = 0; i < images.length; i++) {
                ...
                textDescription.textContent = image.alt ? nls.localize(0, null, image.alt) : nls.localize(1, null);
                image.parentNode.replaceChild(textDescription, image);
            }
            templateData.commentText.appendChild(renderedComment);
            templateData.commentText.title = (_a = renderedComment.textContent) !== null && _a !== void 0 ? _a : '';
        }
        disposeTemplate(templateData) {
