        ...
        addCommentAtLine(lineNumber, e) {
            ...
            if (newCommentInfos.length > 1) {
                if (e) {
                    ...
                    return this.quickInputService.pick(picks, { placeHolder: nls.localize(0, null), matchOnDescription: true }).then(pick => {
                        if (!pick) {
                            return;
                        }
