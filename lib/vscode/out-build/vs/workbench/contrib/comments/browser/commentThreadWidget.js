...
define(["require", "exports", "vs/base/browser/dom", "vs/base/browser/ui/actionbar/actionbar", "vs/base/common/actions", "vs/base/common/color", "vs/base/common/event", "vs/base/common/lifecycle", "vs/base/common/strings", "vs/base/common/types", "vs/base/common/uri", "vs/base/common/uuid", "vs/editor/common/core/range", "vs/editor/common/modes", "vs/editor/common/services/modelService", "vs/editor/common/services/modeService", "vs/editor/browser/core/markdownRenderer", "vs/editor/contrib/peekView/peekView", "vs/editor/contrib/zoneWidget/zoneWidget", "vs/nls!vs/workbench/contrib/comments/browser/commentThreadWidget", "vs/platform/actions/browser/menuEntryActionViewItem", "vs/platform/contextkey/common/contextkey", "vs/platform/instantiation/common/instantiation", "vs/platform/opener/common/opener", "vs/platform/theme/common/colorRegistry", "vs/platform/theme/common/themeService", "vs/workbench/contrib/comments/browser/commentFormActions", "vs/workbench/contrib/comments/browser/commentGlyphWidget", "vs/workbench/contrib/comments/browser/commentNode", "vs/workbench/contrib/comments/browser/commentService", "vs/workbench/contrib/comments/common/commentContextKeys", "./simpleCommentEditor", "vs/platform/instantiation/common/serviceCollection", "vs/base/browser/keyboardEvent", "vs/base/browser/ui/mouseCursor/mouseCursor", "vs/workbench/common/theme", "vs/platform/theme/common/iconRegistry", "vs/base/common/codicons"], function (require, exports, dom, actionbar_1, actions_1, color_1, event_1, lifecycle_1, strings, types_1, uri_1, uuid_1, range_1, modes, modelService_1, modeService_1, markdownRenderer_1, peekView_1, zoneWidget_1, nls, menuEntryActionViewItem_1, contextkey_1, instantiation_1, opener_1, colorRegistry_1, themeService_1, commentFormActions_1, commentGlyphWidget_1, commentNode_1, commentService_1, commentContextKeys_1, simpleCommentEditor_1, serviceCollection_1, keyboardEvent_1, mouseCursor_1, theme_1, iconRegistry_1, codicons_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.ReviewZoneWidget = exports.COMMENTEDITOR_DECORATION_KEY = void 0;
    const collapseIcon = (0, iconRegistry_1.registerIcon)('review-comment-collapse', codicons_1.Codicon.chevronUp, nls.localize(0, null));
    ...
    let ReviewZoneWidget = class ReviewZoneWidget extends zoneWidget_1.ZoneWidget {
        constructor(editor, _owner, _commentThread, _pendingComment, instantiationService, modeService, modelService, themeService, commentService, openerService, contextKeyService) {
        ...
        _fillHead(container) {
            ...
            this._collapseAction = new actions_1.Action('review.expand', nls.localize(1, null), COLLAPSE_ACTION_CLASS, true, () => this.collapse());
        ...
        _onWidth(widthInPixel) {
            var _a;
            (_a = this._commentReplyComponent) === null || _a === void 0 ? void 0 : _a.editor.layout({ height: 5 * 18, width: widthInPixel - 54 /* margin 20px * 10 + scrollbar 14px*/ });
        }
        ...
        display(lineNumber) {
            ...
            let headHeight = Math.ceil(this.editor.getOption(55 /* lineHeight */) * 1.2);
        ...
        createCommentForm() {
            ...
            const commentEditor = this._scopedInstatiationService.createInstance(simpleCommentEditor_1.SimpleCommentEditor, commentForm, simpleCommentEditor_1.SimpleCommentEditor.getEditorOptions(), this._parentEditor, this);
            const commentEditorIsEmpty = commentContextKeys_1.CommentContextKeys.commentIsEmpty.bindTo(this._contextKeyService);
            ...
            this._disposables.add(commentEditor.getModel().onDidChangeContent(() => {
                ...
                commentEditorIsEmpty === null || commentEditorIsEmpty === void 0 ? void 0 : commentEditorIsEmpty.set(!commentEditor.getValue());
            }));
        ...
        createCommentWidgetActions(container, model) {
            ...
            this._commentFormActions = new commentFormActions_1.CommentFormActions(container, async (action) => {
                ...
                action.run({
                    ...
                    text: (_a = this._commentReplyComponent) === null || _a === void 0 ? void 0 : _a.editor.getValue(),
                    $mid: 8
                });
                this.hideReplyArea();
            }, this.themeService);
        ...
        createNewCommentNode(comment) {
            ...
            this._disposables.add(newCommentNode.onDidClick(clickedNode => this.setFocusedComment(this._commentElements.findIndex(commentNode => commentNode.comment.uniqueIdInThread === clickedNode.comment.uniqueIdInThread))));
        ...
        expandReplyArea() {
            var _a, _b, _c;
            if (!((_a = this._commentReplyComponent) === null || _a === void 0 ? void 0 : _a.form.classList.contains('expand'))) {
                (_b = this._commentReplyComponent) === null || _b === void 0 ? void 0 : _b.form.classList.add('expand');
                (_c = this._commentReplyComponent) === null || _c === void 0 ? void 0 : _c.editor.focus();
            }
        }
        hideReplyArea() {
            var _a;
            ...
            this._pendingComment = '';
            (_a = this._commentReplyComponent) === null || _a === void 0 ? void 0 : _a.form.classList.remove('expand');
            this._error.textContent = '';
            this._error.classList.add('hidden');
        }
        createReplyButton(commentEditor, commentForm) {
            ...
            this._reviewThreadReplyButton.title = ((_a = this._commentOptions) === null || _a === void 0 ? void 0 : _a.prompt) || nls.localize(3, null);
            this._reviewThreadReplyButton.textContent = ((_b = this._commentOptions) === null || _b === void 0 ? void 0 : _b.prompt) || nls.localize(4, null);
        ...
        _refresh() {
            ...
            if (this._isExpanded && this._bodyElement) {
                ...
                if (!this._commentThread.comments || !this._commentThread.comments.length) {
                    (_b = this._commentReplyComponent) === null || _b === void 0 ? void 0 : _b.editor.focus();
                }
        ...
        setCommentEditorDecorations() {
            ...
            if (model) {
                ...
                const placeholder = valueLength > 0
                    ? ''
                    : hasExistingComments
                        ? (((_a = this._commentOptions) === null || _a === void 0 ? void 0 : _a.placeHolder) || nls.localize(5, null))
                        : (((_b = this._commentOptions) === null || _b === void 0 ? void 0 : _b.placeHolder) || nls.localize(6, null));
                const decorations = [{
                        range: {
                            startLineNumber: 0,
                            endLineNumber: 0,
                        ...
                        renderOptions: {
                            after: {
                                ...
                                color: `${(0, colorRegistry_1.transparent)(colorRegistry_1.editorForeground, 0.4)(this.themeService.getColorTheme())}`
                            }
                        }
                    }];
                (_c = this._commentReplyComponent) === null || _c === void 0 ? void 0 : _c.editor.setDecorations(exports.COMMENTEDITOR_DECORATION_KEY, decorations);
            }
        }
        onEditorMouseDown(e) {
            this.mouseDownInfo = null;
        ...
        _applyTheme(theme) {
            ...
            this.style({
                arrowColor: borderColor || color_1.Color.transparent,
                frameColor: borderColor || color_1.Color.transparent
            });
            const content = [];
            if (borderColor) {
