...
define(["require", "exports", "vs/nls!vs/workbench/contrib/preferences/browser/keybindingsEditorContribution", "vs/base/common/async", "vs/base/common/htmlContent", "vs/base/common/keyCodes", "vs/base/common/lifecycle", "vs/platform/keybinding/common/keybinding", "vs/platform/instantiation/common/instantiation", "vs/platform/contextkey/common/contextkey", "vs/editor/common/core/range", "vs/editor/browser/editorExtensions", "vs/editor/contrib/snippet/snippetController2", "vs/workbench/contrib/preferences/common/smartSnippetInserter", "vs/workbench/contrib/preferences/browser/keybindingWidgets", "vs/workbench/browser/codeeditor", "vs/base/common/json", "vs/base/common/scanCode", "vs/editor/common/editorContextKeys", "vs/workbench/services/keybinding/common/windowsKeyboardMapper", "vs/platform/theme/common/themeService", "vs/editor/common/view/editorColorRegistry", "vs/editor/common/model", "vs/base/common/keybindingParser", "vs/base/common/arrays", "vs/base/common/types", "vs/platform/environment/common/environment", "vs/base/common/resources"], function (require, exports, nls, async_1, htmlContent_1, keyCodes_1, lifecycle_1, keybinding_1, instantiation_1, contextkey_1, range_1, editorExtensions_1, snippetController2_1, smartSnippetInserter_1, keybindingWidgets_1, codeeditor_1, json_1, scanCode_1, editorContextKeys_1, windowsKeyboardMapper_1, themeService_1, editorColorRegistry_1, model_1, keybindingParser_1, arrays_1, types_1, environment_1, resources_1) {
    "use strict";
    ...
    const NLS_LAUNCH_MESSAGE = nls.localize(0, null);
    const NLS_KB_LAYOUT_ERROR_MESSAGE = nls.localize(1, null);
        ...
        _createDecoration(isError, uiLabel, usLabel, model, keyNode) {
            ...
            if (isError) {
                ...
                if (usLabel && uiLabel !== usLabel) {
                    msg = new htmlContent_1.MarkdownString(nls.localize(2, null, uiLabel, usLabel));
                    ...
                    msg = new htmlContent_1.MarkdownString(nls.localize(3, null, uiLabel));
        ...
        constructor() {
            super({
                ...
                kbOpts: {
                    ...
                    primary: (0, keyCodes_1.KeyChord)(2048 /* CtrlCmd */ | 41 /* KEY_K */, 2048 /* CtrlCmd */ | 41 /* KEY_K */),
                    weight: 100 /* EditorContrib */
                }
            });
        }
        runEditorCommand(accessor, editor) {
            if (!isInterestingEditorModel(editor, accessor.get(environment_1.IEnvironmentService)) || editor.getOption(77 /* readOnly */)) {
                return;
            }
