...
define(["require", "exports", "vs/base/common/actions", "vs/base/common/uri", "vs/editor/common/services/getIconClasses", "vs/editor/common/services/modelService", "vs/editor/common/services/modeService", "vs/nls!vs/workbench/contrib/preferences/browser/preferencesActions", "vs/platform/quickinput/common/quickInput", "vs/workbench/services/preferences/common/preferences"], function (require, exports, actions_1, uri_1, getIconClasses_1, modelService_1, modeService_1, nls, quickInput_1, preferences_1) {
    "use strict";
    ...
    let ConfigureLanguageBasedSettingsAction = class ConfigureLanguageBasedSettingsAction extends actions_1.Action {
        ...
        async run() {
            ...
            const picks = languages.sort().map((lang, index) => {
                const description = nls.localize(1, null, this.modeService.getModeIdForLanguageName(lang.toLowerCase()));
                ...
                return {
                    label: lang,
                    iconClasses: (0, getIconClasses_1.getIconClasses)(this.modelService, this.modeService, fakeResource),
                    description
                };
            });
            await this.quickInputService.pick(picks, { placeHolder: nls.localize(2, null) })
                .then(pick => {
                if (pick) {
    ...
    ConfigureLanguageBasedSettingsAction.LABEL = { value: nls.localize(0, null), original: 'Configure Language Specific Settings...' };
