...
define(["require", "exports", "vs/base/browser/dom", "vs/base/common/actions", "vs/base/common/async", "vs/base/common/event", "vs/base/common/lifecycle", "vs/editor/common/core/position", "vs/editor/common/core/range", "vs/editor/common/model/textModel", "vs/nls!vs/workbench/contrib/preferences/browser/preferencesRenderers", "vs/platform/configuration/common/configuration", "vs/platform/configuration/common/configurationRegistry", "vs/platform/contextview/browser/contextView", "vs/platform/instantiation/common/instantiation", "vs/platform/registry/common/platform", "vs/platform/telemetry/common/telemetry", "vs/platform/workspace/common/workspace", "vs/workbench/browser/codeeditor", "vs/workbench/contrib/preferences/browser/preferencesWidgets", "vs/workbench/services/preferences/common/preferences", "vs/workbench/services/preferences/common/preferencesModels", "vs/platform/markers/common/markers", "vs/workbench/services/environment/common/environmentService", "vs/editor/contrib/find/findDecorations", "vs/platform/theme/common/themeService", "vs/workbench/contrib/preferences/browser/preferencesIcons", "vs/platform/workspace/common/workspaceTrust", "vs/editor/common/modes", "vs/workbench/services/uriIdentity/common/uriIdentity", "vs/editor/contrib/codeAction/types", "vs/base/common/map"], function (require, exports, dom_1, actions_1, async_1, event_1, lifecycle_1, position_1, range_1, textModel_1, nls, configuration_1, configurationRegistry_1, contextView_1, instantiation_1, platform_1, telemetry_1, workspace_1, codeeditor_1, preferencesWidgets_1, preferences_1, preferencesModels_1, markers_1, environmentService_1, findDecorations_1, themeService_1, preferencesIcons_1, workspaceTrust_1, modes, uriIdentity_1, types_1, map_1) {
    "use strict";
    ...
    let UserSettingsRenderer = class UserSettingsRenderer extends lifecycle_1.Disposable {
        ...
        createHeader() {
            this._register(new preferencesWidgets_1.SettingsHeaderWidget(this.editor, '')).setMessage(nls.localize(0, null));
        }
        render() {
        ...
        updatePreference(key, value, source) {
            const overrideIdentifier = source.overrideOf ? (0, configurationRegistry_1.overrideIdentifierFromKey)(source.overrideOf.key) : null;
    ...
    let WorkspaceSettingsRenderer = class WorkspaceSettingsRenderer extends UserSettingsRenderer {
        ...
        createHeader() {
            this._register(new preferencesWidgets_1.SettingsHeaderWidget(this.editor, '')).setMessage(nls.localize(1, null));
        }
        setAssociatedPreferencesModel(associatedPreferencesModel) {
    ...
    let FolderSettingsRenderer = class FolderSettingsRenderer extends UserSettingsRenderer {
        ...
        createHeader() {
            this._register(new preferencesWidgets_1.SettingsHeaderWidget(this.editor, '')).setMessage(nls.localize(2, null));
        }
    };
    ...
    class FilteredMatchesRenderer extends lifecycle_1.Disposable {
        ...
        createDecoration(range) {
            return {
                range,
                options: findDecorations_1.FindDecorations._FIND_MATCH_DECORATION
            };
        }
    ...
    let EditSettingRenderer = class EditSettingRenderer extends lifecycle_1.Disposable {
        ...
        onConfigurationChanged() {
            if (!this.editor.getOption(46 /* glyphMargin */)) {
                this.editPreferenceWidgetForCursorPosition.hide();
                this.editPreferenceWidgetForMouseMove.hide();
            }
        }
        ...
        showEditPreferencesWidget(editPreferencesWidget, settings) {
            ...
            if (this.editor.getOption(46 /* glyphMargin */) && this.marginFreeFromOtherDecorations(line)) {
                editPreferencesWidget.show(line, nls.localize(3, null), settings);
        ...
        getDefaultActions(setting) {
            if (this.isDefaultSettings()) {
                ...
                return [{
                        id: 'setDefaultValue',
                        label: settingInOtherModel ? nls.localize(4, null) : nls.localize(5, null),
                        enabled: true,
    ...
    let UnsupportedSettingsRenderer = class UnsupportedSettingsRenderer extends lifecycle_1.Disposable {
        constructor(editor, settingsEditorModel, markerService, environmentService, configurationService, workspaceTrustManagementService, uriIdentityService) {
            super();
            this.editor = editor;
                ...
                for (const section of settingsGroup.sections) {
                    for (const setting of section.settings) {
                        ...
                        if (configuration) {
                            ...
                            markerData.push(Object.assign(Object.assign({ severity: markers_1.MarkerSeverity.Hint, tags: [1 /* Unnecessary */] }, setting.range), { message: nls.localize(6, null) }));
                        }
                    }
                }
            }
        ...
        handleLocalUserConfiguration(setting, configuration, markerData) {
            if (this.environmentService.remoteAuthority && (configuration.scope === 2 /* MACHINE */ || configuration.scope === 6 /* MACHINE_OVERRIDABLE */)) {
                markerData.push(Object.assign(Object.assign({ severity: markers_1.MarkerSeverity.Hint, tags: [1 /* Unnecessary */] }, setting.range), { message: nls.localize(7, null) }));
            }
        }
        ...
        handleWorkspaceFolderConfiguration(setting, configuration, markerData) {
            ...
            if (configuration.scope === 3 /* WINDOW */) {
                markerData.push(Object.assign(Object.assign({ severity: markers_1.MarkerSeverity.Hint, tags: [1 /* Unnecessary */] }, setting.range), { message: nls.localize(8, null) }));
            }
            if (!this.workspaceTrustManagementService.isWorkpaceTrusted() && configuration.restricted) {
                const marker = this.generateUntrustedSettingMarker(setting);
                markerData.push(marker);
        ...
        generateUnsupportedApplicationSettingMarker(setting) {
            return Object.assign(Object.assign({ severity: markers_1.MarkerSeverity.Hint, tags: [1 /* Unnecessary */] }, setting.range), { message: nls.localize(9, null) });
        }
        generateUnsupportedMachineSettingMarker(setting) {
            return Object.assign(Object.assign({ severity: markers_1.MarkerSeverity.Hint, tags: [1 /* Unnecessary */] }, setting.range), { message: nls.localize(10, null) });
        }
        generateUntrustedSettingMarker(setting) {
            return Object.assign(Object.assign({ severity: markers_1.MarkerSeverity.Warning }, setting.range), { message: nls.localize(11, null) });
        }
                    ...
                    for (const section of settingsGroup.sections) {
                        for (const setting of section.settings) {
                            if (setting.key === 'folders' || setting.key === 'tasks' || setting.key === 'launch' || setting.key === 'extensions') {
                                ...
                                markerData.push(Object.assign(Object.assign({ severity: markers_1.MarkerSeverity.Hint, tags: [1 /* Unnecessary */] }, setting.range), { message: nls.localize(14, null) }));
                            }
                        }
                    }
                }
