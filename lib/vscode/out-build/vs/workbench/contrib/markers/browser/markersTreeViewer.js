...
define(["require", "exports", "vs/base/browser/dom", "vs/base/common/network", "vs/base/common/path", "vs/base/browser/ui/countBadge/countBadge", "vs/base/browser/ui/highlightedlabel/highlightedLabel", "vs/platform/markers/common/markers", "vs/workbench/contrib/markers/browser/markersModel", "vs/workbench/contrib/markers/browser/messages", "vs/platform/instantiation/common/instantiation", "vs/platform/theme/common/styler", "vs/platform/theme/common/themeService", "vs/base/common/lifecycle", "vs/base/browser/ui/actionbar/actionbar", "vs/workbench/contrib/markers/browser/markersViewActions", "vs/platform/label/common/label", "vs/base/common/resources", "vs/workbench/contrib/markers/browser/markersFilterOptions", "vs/base/common/event", "vs/base/common/types", "vs/base/common/actions", "vs/nls!vs/workbench/contrib/markers/browser/markersTreeViewer", "vs/workbench/browser/dnd", "vs/base/common/async", "vs/editor/common/services/modelService", "vs/editor/common/core/range", "vs/editor/contrib/codeAction/codeAction", "vs/editor/contrib/codeAction/types", "vs/workbench/services/editor/common/editorService", "vs/editor/contrib/codeAction/codeActionCommands", "vs/platform/severityIcon/common/severityIcon", "vs/platform/opener/common/opener", "vs/platform/theme/common/colorRegistry", "vs/platform/configuration/common/configuration", "vs/base/common/platform", "vs/platform/files/common/files", "vs/base/browser/event", "vs/base/browser/keyboardEvent", "vs/platform/progress/common/progress", "vs/base/browser/ui/actionbar/actionViewItems", "vs/base/common/codicons", "vs/platform/theme/common/iconRegistry"], function (require, exports, dom, network, paths, countBadge_1, highlightedLabel_1, markers_1, markersModel_1, messages_1, instantiation_1, styler_1, themeService_1, lifecycle_1, actionbar_1, markersViewActions_1, label_1, resources_1, markersFilterOptions_1, event_1, types_1, actions_1, nls_1, dnd_1, async_1, modelService_1, range_1, codeAction_1, types_2, editorService_1, codeActionCommands_1, severityIcon_1, opener_1, colorRegistry_1, configuration_1, platform_1, files_1, event_2, keyboardEvent_1, progress_1, actionViewItems_1, codicons_1, iconRegistry_1) {
    ...
    const expandedIcon = (0, iconRegistry_1.registerIcon)('markers-view-multi-line-expanded', codicons_1.Codicon.chevronUp, (0, nls_1.localize)(1, null));
    const collapsedIcon = (0, iconRegistry_1.registerIcon)('markers-view-multi-line-collapsed', codicons_1.Codicon.chevronDown, (0, nls_1.localize)(2, null));
    ...
    class MarkerWidget extends lifecycle_1.Disposable {
            ...
            if (marker.source || marker.code) {
                ...
                if (marker.code) {
                    if (typeof marker.code === 'string') {
                        ...
                        const onClick = event_1.Event.chain((0, event_2.domEvent)(this._codeLink, 'click'))
                            .filter(e => ((this._clickModifierKey === 'meta' && e.metaKey) || (this._clickModifierKey === 'ctrl' && e.ctrlKey) || (this._clickModifierKey === 'alt' && e.altKey)))
                            .event;
                        const onEnterPress = event_1.Event.chain((0, event_2.domEvent)(this._codeLink, 'keydown'))
        ...
        _getCodelinkTooltip() {
            const tooltipLabel = (0, nls_1.localize)(5, null);
            const tooltipKeybinding = this._clickModifierKey === 'ctrl'
                ? (0, nls_1.localize)(6, null)
                :
                    this._clickModifierKey === 'meta'
                        ? platform_1.OS === 2 /* Macintosh */ ? (0, nls_1.localize)(7, null) : (0, nls_1.localize)(8, null)
                        : platform_1.OS === 2 /* Macintosh */ ? (0, nls_1.localize)(9, null) : (0, nls_1.localize)(10, null);
    ...
    class Filter {
        ...
        filterMarker(marker, parentVisibility) {
            ...
            if (matched && this.options.textFilter.negate && parentVisibility === 2 /* Recurse */) {
                return false;
            }
                ...
                if (model) {
                    if (!this.codeActionsPromise) {
                        this.codeActionsPromise = (0, async_1.createCancelablePromise)(cancellationToken => {
                            return (0, codeAction_1.getCodeActions)(model, new range_1.Range(this.marker.range.startLineNumber, this.marker.range.startColumn, this.marker.range.endLineNumber, this.marker.range.endColumn), {
                                type: 1 /* Invoke */, filter: { include: types_2.CodeActionKind.QuickFix }
    ...
    class ResourceDragAndDrop {
        ...
        getDragLabel(elements) {
            ...
            return element instanceof markersModel_1.ResourceMarkers ? (0, resources_1.basename)(element.resource) : undefined;
        }
