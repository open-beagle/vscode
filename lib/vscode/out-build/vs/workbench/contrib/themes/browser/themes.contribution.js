...
define(["require", "exports", "vs/nls!vs/workbench/contrib/themes/browser/themes.contribution", "vs/base/common/actions", "vs/base/common/keyCodes", "vs/platform/actions/common/actions", "vs/platform/registry/common/platform", "vs/workbench/common/actions", "vs/workbench/services/themes/common/workbenchThemeService", "vs/workbench/contrib/extensions/common/extensions", "vs/platform/extensionManagement/common/extensionManagement", "vs/workbench/services/viewlet/browser/viewlet", "vs/platform/theme/common/colorRegistry", "vs/workbench/services/editor/common/editorService", "vs/base/common/color", "vs/platform/theme/common/theme", "vs/workbench/services/themes/common/colorThemeSchema", "vs/base/common/errors", "vs/platform/quickinput/common/quickInput", "vs/workbench/services/themes/browser/productIconThemeData"], function (require, exports, nls_1, actions_1, keyCodes_1, actions_2, platform_1, actions_3, workbenchThemeService_1, extensions_1, extensionManagement_1, viewlet_1, colorRegistry_1, editorService_1, color_1, theme_1, colorThemeSchema_1, errors_1, quickInput_1, productIconThemeData_1) {
    "use strict";
    ...
    let SelectColorThemeAction = class SelectColorThemeAction extends actions_1.Action {
        ...
        run() {
            return this.themeService.getColorThemes().then(themes => {
                ...
                const picks = [
                    ...toEntries(themes.filter(t => t.type === theme_1.ColorScheme.LIGHT), (0, nls_1.localize)(1, null)),
                    ...toEntries(themes.filter(t => t.type === theme_1.ColorScheme.DARK), (0, nls_1.localize)(2, null)),
                    ...toEntries(themes.filter(t => t.type === theme_1.ColorScheme.HIGH_CONTRAST), (0, nls_1.localize)(3, null)),
                    ...configurationEntries(this.extensionGalleryService, (0, nls_1.localize)(4, null))
                ];
                ...
                return new Promise((s, _) => {
                    ...
                    quickpick.placeholder = (0, nls_1.localize)(5, null);
    ...
    SelectColorThemeAction.LABEL = (0, nls_1.localize)(0, null);
    ...
    let SelectFileIconThemeAction = class SelectFileIconThemeAction extends AbstractIconThemeAction {
        constructor(id, label, quickInputService, themeService, extensionGalleryService, viewletService) {
            ...
            this.themeService = themeService;
            this.builtInEntry = { id: '', label: (0, nls_1.localize)(7, null), description: (0, nls_1.localize)(8, null) };
            this.installMessage = (0, nls_1.localize)(9, null);
            this.placeholderMessage = (0, nls_1.localize)(10, null);
    ...
    SelectFileIconThemeAction.LABEL = (0, nls_1.localize)(6, null);
    ...
    let SelectProductIconThemeAction = class SelectProductIconThemeAction extends AbstractIconThemeAction {
        constructor(id, label, quickInputService, themeService, extensionGalleryService, viewletService) {
            super(id, label, quickInputService, extensionGalleryService, viewletService);
            this.themeService = themeService;
            this.builtInEntry = { id: productIconThemeData_1.DEFAULT_PRODUCT_ICON_THEME_ID, label: (0, nls_1.localize)(12, null) };
            this.installMessage = (0, nls_1.localize)(13, null);
            this.placeholderMessage = (0, nls_1.localize)(14, null);
    ...
    SelectProductIconThemeAction.LABEL = (0, nls_1.localize)(11, null);
    ...
    GenerateColorThemeAction.LABEL = (0, nls_1.localize)(15, null);
    ...
    const category = (0, nls_1.localize)(16, null);
    const colorThemeDescriptor = actions_2.SyncActionDescriptor.from(SelectColorThemeAction, { primary: (0, keyCodes_1.KeyChord)(2048 /* CtrlCmd */ | 41 /* KEY_K */, 2048 /* CtrlCmd */ | 50 /* KEY_T */) });
    ...
    platform_1.Registry.as(actions_3.Extensions.WorkbenchActions).registerWorkbenchAction(generateColorThemeDescriptor, 'Developer: Generate Color Theme From Current Settings', actions_3.CATEGORIES.Developer.value);
