...
define(["require", "exports", "vs/workbench/common/editor", "vs/editor/common/services/resolverService", "vs/base/common/marked/marked", "vs/base/common/network", "vs/base/common/resources", "vs/workbench/contrib/welcome/walkThrough/common/walkThroughContentProvider"], function (require, exports, editor_1, resolverService_1, marked, network_1, resources_1, walkThroughContentProvider_1) {
    "use strict";
    ...
    let WalkThroughInput = class WalkThroughInput extends editor_1.EditorInput {
        ...
        resolve() {
            if (!this.promise) {
                this.promise = (0, walkThroughContentProvider_1.requireToContent)(this.options.resource)
                    .then(content => {
        ...
        matches(otherInput) {
            ...
            if (otherInput instanceof WalkThroughInput) {
                ...
                return (0, resources_1.isEqual)(otherResourceEditorInput.options.resource, this.options.resource);
            }
            return false;
        }
        dispose() {
