 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "assert", "vs/base/common/platform", "vs/base/common/uri", "vs/base/common/path", "vs/workbench/contrib/files/browser/fileActions", "vs/workbench/contrib/files/common/explorerModel", "vs/base/test/common/utils", "vs/workbench/test/browser/workbenchTestServices"], function (require, exports, assert, platform_1, uri_1, path_1, fileActions_1, explorerModel_1, utils_1, workbenchTestServices_1) {
    "use strict";
    ...
    function createStat(path, name, isFolder, hasChildren, size, mtime) {
        return new explorerModel_1.ExplorerItem(utils_1.toResource.call(this, path), fileService, undefined, isFolder, false, name, mtime);
    }
    suite('Files - View Model', function () {
        ...
        test('Validate File Name (For Create)', function () {
            ...
            s.addChild(sChild);
            assert((0, fileActions_1.validateFileName)(s, null) !== null);
            assert((0, fileActions_1.validateFileName)(s, '') !== null);
            assert((0, fileActions_1.validateFileName)(s, '  ') !== null);
            assert((0, fileActions_1.validateFileName)(s, 'Read Me') === null, 'name containing space');
            if (platform_1.isWindows) {
                assert((0, fileActions_1.validateFileName)(s, 'foo:bar') !== null);
                assert((0, fileActions_1.validateFileName)(s, 'foo*bar') !== null);
                assert((0, fileActions_1.validateFileName)(s, 'foo?bar') !== null);
                assert((0, fileActions_1.validateFileName)(s, 'foo<bar') !== null);
                assert((0, fileActions_1.validateFileName)(s, 'foo>bar') !== null);
            ...
            assert((0, fileActions_1.validateFileName)(s, 'alles.klar') === null);
            assert((0, fileActions_1.validateFileName)(s, '.foo') === null);
            assert((0, fileActions_1.validateFileName)(s, 'foo.bar') === null);
            assert((0, fileActions_1.validateFileName)(s, 'foo') === null);
        });
        ...
        test('Validate Multi-Path File Names', function () {
            ...
            assert((0, fileActions_1.validateFileName)(wsFolder, 'foo/bar') === null);
            assert((0, fileActions_1.validateFileName)(wsFolder, 'foo\\bar') === null);
            assert((0, fileActions_1.validateFileName)(wsFolder, 'all/slashes/are/same') === null);
            assert((0, fileActions_1.validateFileName)(wsFolder, 'theres/one/different\\slash') === null);
            assert((0, fileActions_1.validateFileName)(wsFolder, '/slashAtBeginning') !== null);
            ...
            assert((0, fileActions_1.validateFileName)(wsFolder, '/path/to/stat/fileNested/aChild') !== null);
            // detect if path already exists
            assert((0, fileActions_1.validateFileName)(wsFolder, '/path/to/stat/fileNested') !== null);
            assert((0, fileActions_1.validateFileName)(wsFolder, '/path/to/stat/') !== null);
        });
        test('Merge Local with Disk', function () {
            const merge1 = new explorerModel_1.ExplorerItem(uri_1.URI.file((0, path_1.join)('C:\\', '/path/to')), fileService, undefined, true, false, 'to', Date.now());
            const merge2 = new explorerModel_1.ExplorerItem(uri_1.URI.file((0, path_1.join)('C:\\', '/path/to')), fileService, undefined, true, false, 'to', Date.now());
            // Merge Properties
            ...
            merge2.addChild(new explorerModel_1.ExplorerItem(uri_1.URI.file((0, path_1.join)('C:\\', '/path/to/foo.html')), fileService, undefined, true, false, 'foo.html', Date.now()));
            explorerModel_1.ExplorerItem.mergeLocalWithDisk(merge2, merge1);
            // Merge Child with isDirectoryResolved=true
            const child = new explorerModel_1.ExplorerItem(uri_1.URI.file((0, path_1.join)('C:\\', '/path/to/foo.html')), fileService, undefined, true, false, 'foo.html', Date.now());
