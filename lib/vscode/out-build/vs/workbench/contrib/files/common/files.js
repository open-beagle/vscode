...
define(["require", "exports", "vs/workbench/common/editor", "vs/platform/files/common/files", "vs/platform/contextkey/common/contextkey", "vs/base/common/lifecycle", "vs/editor/common/services/modelService", "vs/editor/common/services/modeService", "vs/workbench/services/textfile/common/textfiles", "vs/platform/contextkey/common/contextkeys", "vs/base/common/functional", "vs/nls!vs/workbench/contrib/files/common/files"], function (require, exports, editor_1, files_1, contextkey_1, lifecycle_1, modelService_1, modeService_1, textfiles_1, contextkeys_1, functional_1, nls_1) {
    "use strict";
     ...
     */
    exports.ExplorerViewletVisibleContext = new contextkey_1.RawContextKey('explorerViewletVisible', true, { type: 'boolean', description: (0, nls_1.localize)(0, null) });
    exports.ExplorerFolderContext = new contextkey_1.RawContextKey('explorerResourceIsFolder', false, { type: 'boolean', description: (0, nls_1.localize)(1, null) });
    exports.ExplorerResourceReadonlyContext = new contextkey_1.RawContextKey('explorerResourceReadonly', false, { type: 'boolean', description: (0, nls_1.localize)(2, null) });
    ...
    exports.ExplorerRootContext = new contextkey_1.RawContextKey('explorerResourceIsRoot', false, { type: 'boolean', description: (0, nls_1.localize)(3, null) });
    exports.ExplorerResourceCut = new contextkey_1.RawContextKey('explorerResourceCut', false, { type: 'boolean', description: (0, nls_1.localize)(4, null) });
    exports.ExplorerResourceMoveableToTrash = new contextkey_1.RawContextKey('explorerResourceMoveableToTrash', false, { type: 'boolean', description: (0, nls_1.localize)(5, null) });
    exports.FilesExplorerFocusedContext = new contextkey_1.RawContextKey('filesExplorerFocus', true, { type: 'boolean', description: (0, nls_1.localize)(6, null) });
    exports.OpenEditorsVisibleContext = new contextkey_1.RawContextKey('openEditorsVisible', false, { type: 'boolean', description: (0, nls_1.localize)(7, null) });
    exports.OpenEditorsFocusedContext = new contextkey_1.RawContextKey('openEditorsFocus', true, { type: 'boolean', description: (0, nls_1.localize)(8, null) });
    exports.ExplorerFocusedContext = new contextkey_1.RawContextKey('explorerViewletFocus', true, { type: 'boolean', description: (0, nls_1.localize)(9, null) });
    // compressed nodes
    exports.ExplorerCompressedFocusContext = new contextkey_1.RawContextKey('explorerViewletCompressedFocus', true, { type: 'boolean', description: (0, nls_1.localize)(10, null) });
    exports.ExplorerCompressedFirstFocusContext = new contextkey_1.RawContextKey('explorerViewletCompressedFirstFocus', true, { type: 'boolean', description: (0, nls_1.localize)(11, null) });
    exports.ExplorerCompressedLastFocusContext = new contextkey_1.RawContextKey('explorerViewletCompressedLastFocus', true, { type: 'boolean', description: (0, nls_1.localize)(12, null) });
