...
define(["require", "exports", "vs/nls!vs/workbench/contrib/files/browser/views/explorerView", "vs/base/common/performance", "vs/base/common/decorators", "vs/workbench/contrib/files/common/files", "vs/workbench/contrib/files/browser/fileActions", "vs/base/browser/dom", "vs/workbench/services/layout/browser/layoutService", "vs/workbench/contrib/files/browser/views/explorerDecorationsProvider", "vs/platform/workspace/common/workspace", "vs/platform/configuration/common/configuration", "vs/platform/keybinding/common/keybinding", "vs/platform/instantiation/common/instantiation", "vs/platform/progress/common/progress", "vs/platform/contextview/browser/contextView", "vs/platform/contextkey/common/contextkey", "vs/workbench/common/resources", "vs/workbench/services/decorations/browser/decorations", "vs/platform/list/browser/listService", "vs/base/browser/dnd", "vs/workbench/services/editor/common/editorService", "vs/workbench/browser/parts/views/viewPane", "vs/platform/label/common/label", "vs/workbench/contrib/files/browser/views/explorerViewer", "vs/platform/theme/common/themeService", "vs/platform/actions/common/actions", "vs/platform/actions/browser/menuEntryActionViewItem", "vs/platform/telemetry/common/telemetry", "vs/workbench/contrib/files/common/explorerModel", "vs/workbench/browser/labels", "vs/platform/storage/common/storage", "vs/platform/clipboard/common/clipboardService", "vs/platform/files/common/files", "vs/base/common/lifecycle", "vs/base/common/event", "vs/platform/theme/common/styler", "vs/platform/theme/common/colorRegistry", "vs/workbench/common/theme", "vs/workbench/common/views", "vs/platform/opener/common/opener", "vs/workbench/services/uriIdentity/common/uriIdentity", "vs/workbench/common/editor", "vs/workbench/contrib/files/browser/files", "vs/base/common/codicons", "vs/platform/commands/common/commands", "vs/workbench/services/viewlet/browser/viewlet"], function (require, exports, nls, perf, decorators_1, files_1, fileActions_1, DOM, layoutService_1, explorerDecorationsProvider_1, workspace_1, configuration_1, keybinding_1, instantiation_1, progress_1, contextView_1, contextkey_1, resources_1, decorations_1, listService_1, dnd_1, editorService_1, viewPane_1, label_1, explorerViewer_1, themeService_1, actions_1, menuEntryActionViewItem_1, telemetry_1, explorerModel_1, labels_1, storage_1, clipboardService_1, files_2, lifecycle_1, event_1, styler_1, colorRegistry_1, theme_1, views_1, opener_1, uriIdentity_1, editor_1, files_3, codicons_1, commands_1, viewlet_1) {
    ...
    let ExplorerView = class ExplorerView extends viewPane_1.ViewPane {
        ...
        renderHeader(container) {
            ...
            const setHeader = () => {
                ...
                titleElement.setAttribute('aria-label', nls.localize(0, null, this.name));
            };
        ...
        isItemVisible(item) {
            return this.filter.filter(item, 1 /* Visible */);
        }
        ...
        createTree(container) {
            ...
            this._register(this.storageService.onWillSaveState(() => {
                this.storageService.store(ExplorerView.TREE_VIEW_STATE_STORAGE_KEY, JSON.stringify(this.tree.getViewState()), 1 /* WORKSPACE */, 1 /* MACHINE */);
            }));
        }
        // React on events
        ...
        focusNeighbourIfItemFocused(item) {
            const focus = this.tree.getFocus();
            if (focus.length !== 1) {
                return;
            }
            ...
            const indexOfItem = (compressedController === null || compressedController === void 0 ? void 0 : compressedController.items.indexOf(item)) || -1;
        ...
        constructor() {
            super({
                ...
                menu: {
                    ...
                    group: 'navigation',
                    when: contextkey_1.ContextKeyEqualsExpr.create('view', files_1.VIEW_ID),
                    order: 10
                }
            });
        }
    ...
    (0, actions_1.registerAction2)(class extends actions_1.Action2 {
        ...
        async run(accessor) {
            ...
            await viewletService.openViewlet(files_1.VIEWLET_ID);
