...
define(["require", "exports", "vs/nls!vs/workbench/contrib/files/browser/editors/textFileEditor", "vs/base/common/errorMessage", "vs/base/common/types", "vs/base/common/extpath", "vs/base/common/resources", "vs/base/common/actions", "vs/workbench/contrib/files/common/files", "vs/workbench/services/textfile/common/textfiles", "vs/workbench/browser/parts/editor/textEditor", "vs/workbench/common/editor", "vs/workbench/common/editor/binaryEditorModel", "vs/workbench/contrib/files/common/editors/fileEditorInput", "vs/workbench/services/viewlet/browser/viewlet", "vs/platform/files/common/files", "vs/platform/telemetry/common/telemetry", "vs/platform/workspace/common/workspace", "vs/platform/storage/common/storage", "vs/editor/common/services/textResourceConfigurationService", "vs/platform/instantiation/common/instantiation", "vs/platform/theme/common/themeService", "vs/workbench/services/editor/common/editorService", "vs/workbench/services/editor/common/editorGroupsService", "vs/base/common/errors", "vs/platform/editor/common/editor", "vs/workbench/services/uriIdentity/common/uriIdentity", "vs/workbench/contrib/files/browser/files"], function (require, exports, nls_1, errorMessage_1, types_1, extpath_1, resources_1, actions_1, files_1, textfiles_1, textEditor_1, editor_1, binaryEditorModel_1, fileEditorInput_1, viewlet_1, files_2, telemetry_1, workspace_1, storage_1, textResourceConfigurationService_1, instantiation_1, themeService_1, editorService_1, editorGroupsService_1, errors_1, editor_2, uriIdentity_1, files_3) {
    "use strict";
    ...
    let TextFileEditor = class TextFileEditor extends textEditor_1.BaseTextEditor {
        ...
        onDidFileSystemProviderChange(scheme) {
            ...
            if (control && (input === null || input === void 0 ? void 0 : input.resource.scheme) === scheme) {
        ...
        async setInput(input, options, context, token) {
            ...
            try {
                ...
                if (options && (0, types_1.isFunction)(options.apply)) {
        ...
        handleSetInputError(error, input, options) {
            ...
            if (error.fileOperationResult === 1 /* FILE_NOT_FOUND */ && (0, extpath_1.isValidBasename)((0, resources_1.basename)(input.preferredResource))) {
                throw (0, errors_1.createErrorWithActions)((0, errorMessage_1.toErrorMessage)(error), {
                    actions: [
                        (0, actions_1.toAction)({
                            id: 'workbench.files.action.createMissingFile', label: (0, nls_1.localize)(2, null), run: async () => {
        ...
        openAsBinary(input, options) {
            ...
            const preservingOptions = { activation: editor_2.EditorActivation.PRESERVE, override: editor_2.EditorOverride.DISABLED };
            if (options) {
