...
define(["require", "exports", "vs/workbench/services/textfile/common/textfiles", "vs/workbench/services/lifecycle/common/lifecycle", "vs/base/common/lifecycle", "vs/base/common/arrays", "vs/workbench/services/host/browser/host", "vs/workbench/services/editor/common/editorService", "vs/base/common/async", "vs/editor/browser/services/codeEditorService", "vs/workbench/services/filesConfiguration/common/filesConfigurationService", "vs/workbench/contrib/files/common/files", "vs/base/common/network", "vs/workbench/services/untitled/common/untitledTextEditorInput"], function (require, exports, textfiles_1, lifecycle_1, lifecycle_2, arrays_1, host_1, editorService_1, async_1, codeEditorService_1, filesConfigurationService_1, files_1, network_1, untitledTextEditorInput_1) {
    "use strict";
    ...
    let TextFileEditorTracker = class TextFileEditorTracker extends lifecycle_2.Disposable {
        ...
        ensureDirtyTextFilesAreOpened(resources) {
            this.doEnsureDirtyTextFilesAreOpened((0, arrays_1.distinct)(resources.filter(resource => {
                ...
                if (this.filesConfigurationService.getAutoSaveMode() === 1 /* AFTER_SHORT_DELAY */ && !(model === null || model === void 0 ? void 0 : model.hasState(5 /* ERROR */))) {
                    // leave models auto saved after short delay unless
                    // the save resulted in an error
                    return false;
                }
                if (this.editorService.isOpened({ resource, typeId: resource.scheme === network_1.Schemas.untitled ? untitledTextEditorInput_1.UntitledTextEditorInput.ID : files_1.FILE_EDITOR_INPUT_ID })) {
