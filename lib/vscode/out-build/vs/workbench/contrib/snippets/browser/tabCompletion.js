...
define(["require", "exports", "vs/platform/contextkey/common/contextkey", "./snippets.contribution", "./snippetsService", "vs/editor/common/core/range", "vs/editor/browser/editorExtensions", "vs/editor/contrib/snippet/snippetController2", "vs/editor/contrib/suggest/suggest", "vs/editor/common/editorContextKeys", "./snippetCompletionProvider", "vs/platform/clipboard/common/clipboardService", "vs/editor/browser/core/editorState"], function (require, exports, contextkey_1, snippets_contribution_1, snippetsService_1, range_1, editorExtensions_1, snippetController2_1, suggest_1, editorContextKeys_1, snippetCompletionProvider_1, clipboardService_1, editorState_1) {
    "use strict";
    ...
    let TabCompletionController = class TabCompletionController {
        constructor(_editor, _snippetService, _clipboardService, contextKeyService) {
            ...
            this._configListener = this._editor.onDidChangeConfiguration(e => {
                if (e.hasChanged(108 /* tabCompletion */)) {
                    this._update();
                }
            });
            this._update();
        ...
        _update() {
            var _a;
            const enabled = this._editor.getOption(108 /* tabCompletion */) === 'onlySnippets';
        ...
        async performSnippetCompletions() {
            ...
            if (this._activeSnippets.length === 1) {
                ...
                (0, suggest_1.showSimpleSuggestions)(this._editor, this._activeSnippets.map(snippet => {
