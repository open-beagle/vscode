...
define(["require", "exports", "vs/nls!vs/workbench/contrib/search/browser/replaceService", "vs/base/common/network", "vs/base/common/lifecycle", "vs/workbench/contrib/search/common/replace", "vs/workbench/services/editor/common/editorService", "vs/editor/common/services/modelService", "vs/editor/common/services/modeService", "vs/workbench/contrib/search/common/searchModel", "vs/editor/common/services/resolverService", "vs/platform/instantiation/common/instantiation", "vs/editor/common/model/textModel", "vs/workbench/services/textfile/common/textfiles", "vs/editor/browser/services/bulkEditService", "vs/editor/common/core/range", "vs/editor/common/core/editOperation", "vs/platform/label/common/label", "vs/base/common/resources", "vs/base/common/async"], function (require, exports, nls, network, lifecycle_1, replace_1, editorService_1, modelService_1, modeService_1, searchModel_1, resolverService_1, instantiation_1, textModel_1, textfiles_1, bulkEditService_1, range_1, editOperation_1, label_1, resources_1, async_1) {
    "use strict";
    ...
    let ReplacePreviewModel = class ReplacePreviewModel extends lifecycle_1.Disposable {
        ...
        async resolve(replacePreviewUri) {
            ...
            const replacePreviewModel = this.modelService.createModel((0, textModel_1.createTextBufferFactoryFromSnapshot)(sourceModel.createSnapshot()), this.modeService.create(sourceModelModeId), replacePreviewUri);
    ...
    let ReplaceService = class ReplaceService {
        ...
        async replace(arg, progress = undefined, resource = null) {
            ...
            return async_1.Promises.settled(edits.map(async (e) => { var _a; return (_a = this.textFileService.files.get(e.resource)) === null || _a === void 0 ? void 0 : _a.save(); }));
        }
        async openReplacePreview(element, preserveFocus, sideBySide, pinned) {
            ...
            const editor = await this.editorService.openEditor({
                ...
                label: nls.localize(0, null, fileMatch.name(), fileMatch.name()),
