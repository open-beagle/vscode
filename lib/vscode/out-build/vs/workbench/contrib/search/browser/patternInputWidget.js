...
define(["require", "exports", "vs/nls!vs/workbench/contrib/search/browser/patternInputWidget", "vs/base/browser/dom", "vs/base/browser/ui/widget", "vs/base/browser/ui/checkbox/checkbox", "vs/base/common/event", "vs/platform/theme/common/themeService", "vs/platform/theme/common/styler", "vs/platform/browser/contextScopedHistoryWidget", "vs/platform/contextkey/common/contextkey", "vs/base/common/codicons", "vs/platform/configuration/common/configuration"], function (require, exports, nls, dom, widget_1, checkbox_1, event_1, themeService_1, styler_1, contextScopedHistoryWidget_1, contextkey_1, codicons_1, configuration_1) {
    ...
    let PatternInputWidget = class PatternInputWidget extends widget_1.Widget {
        constructor(parent, contextViewProvider, options = Object.create(null), themeService, contextKeyService, configurationService) {
            super();
    ...
    let IncludePatternInputWidget = class IncludePatternInputWidget extends PatternInputWidget {
        ...
        renderSubcontrols(controlsDiv) {
            this.useSearchInEditorsBox = this._register(new checkbox_1.Checkbox({
            ...
            this._register((0, styler_1.attachCheckboxStyler)(this.useSearchInEditorsBox, this.themeService));
    ...
    let ExcludePatternInputWidget = class ExcludePatternInputWidget extends PatternInputWidget {
        ...
        renderSubcontrols(controlsDiv) {
            ...
            this._register((0, styler_1.attachCheckboxStyler)(this.useExcludesAndIgnoreFilesBox, this.themeService));
