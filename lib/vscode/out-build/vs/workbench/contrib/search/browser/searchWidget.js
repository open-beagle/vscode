...
define(["require", "exports", "vs/base/browser/dom", "vs/base/browser/ui/actionbar/actionbar", "vs/base/browser/ui/button/button", "vs/base/browser/ui/inputbox/inputBox", "vs/base/browser/ui/widget", "vs/base/common/actions", "vs/base/common/async", "vs/base/common/event", "vs/editor/contrib/find/findModel", "vs/nls!vs/workbench/contrib/search/browser/searchWidget", "vs/platform/clipboard/common/clipboardService", "vs/platform/configuration/common/configuration", "vs/platform/contextkey/common/contextkey", "vs/platform/contextview/browser/contextView", "vs/platform/keybinding/common/keybinding", "vs/platform/keybinding/common/keybindingsRegistry", "vs/platform/theme/common/styler", "vs/platform/theme/common/themeService", "vs/platform/browser/contextScopedHistoryWidget", "vs/workbench/contrib/search/browser/searchActions", "vs/workbench/contrib/search/common/constants", "vs/platform/accessibility/common/accessibility", "vs/base/common/platform", "vs/base/browser/ui/checkbox/checkbox", "vs/workbench/common/views", "vs/workbench/contrib/search/browser/searchIcons", "vs/workbench/contrib/searchEditor/browser/constants"], function (require, exports, dom, actionbar_1, button_1, inputBox_1, widget_1, actions_1, async_1, event_1, findModel_1, nls, clipboardService_1, configuration_1, contextkey_1, contextView_1, keybinding_1, keybindingsRegistry_1, styler_1, themeService_1, contextScopedHistoryWidget_1, searchActions_1, Constants, accessibility_1, platform_1, checkbox_1, views_1, searchIcons_1, constants_1) {
    ...
    let SearchWidget = class SearchWidget extends widget_1.Widget {
        ...
        renderToggleReplaceButton(parent) {
            ...
            this.toggleReplaceButton.element.title = nls.localize(2, null);
        }
        renderSearchInput(parent, options) {
            ...
            this.showContextCheckbox = new checkbox_1.Checkbox({
                isChecked: false,
                title: (0, searchActions_1.appendKeyBindingLabel)(nls.localize(5, null), this.keyBindingService.lookupKeybinding(constants_1.ToggleSearchEditorContextLinesCommandId), this.keyBindingService),
    ...
    SearchWidget.REPLACE_ALL_DISABLED_LABEL = nls.localize(0, null);
    SearchWidget.REPLACE_ALL_ENABLED_LABEL = (keyBindingService2) => {
        ...
        return (0, searchActions_1.appendKeyBindingLabel)(nls.localize(1, null), kb, keyBindingService2);
    };
