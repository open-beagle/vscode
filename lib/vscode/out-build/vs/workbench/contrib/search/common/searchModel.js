...
define(["require", "exports", "vs/base/common/async", "vs/base/common/cancellation", "vs/base/common/errors", "vs/base/common/event", "vs/base/common/labels", "vs/base/common/lifecycle", "vs/base/common/map", "vs/base/common/strings", "vs/base/common/uri", "vs/editor/common/core/range", "vs/editor/common/model", "vs/editor/common/model/textModel", "vs/editor/common/services/modelService", "vs/platform/instantiation/common/instantiation", "vs/workbench/services/search/common/replace", "vs/workbench/services/search/common/search", "vs/platform/telemetry/common/telemetry", "vs/platform/theme/common/colorRegistry", "vs/platform/theme/common/themeService", "vs/workbench/contrib/search/common/replace", "vs/workbench/services/search/common/searchHelpers", "vs/base/common/types", "vs/base/common/decorators", "vs/platform/configuration/common/configuration", "vs/base/common/comparers", "vs/base/common/network", "vs/workbench/services/uriIdentity/common/uriIdentity"], function (require, exports, async_1, cancellation_1, errors, event_1, labels_1, lifecycle_1, map_1, strings_1, uri_1, range_1, model_1, textModel_1, modelService_1, instantiation_1, replace_1, search_1, telemetry_1, colorRegistry_1, themeService_1, replace_2, searchHelpers_1, types_1, decorators_1, configuration_1, comparers_1, network_1, uriIdentity_1) {
    "use strict";
    ...
    let SearchResult = class SearchResult extends lifecycle_1.Disposable {
        constructor(_searchModel, replaceService, telemetryService, instantiationService, modelService, uriIdentityService) {
            super();
            this._searchModel = _searchModel;
            this.replaceService = replaceService;
        ...
        onSearchError(e, duration) {
            if (errors.isPromiseCanceledError(e)) {
                this.onSearchCompleted(this.searchCancelledForNewSearch
                    ? { exit: 1 /* NewSearchStarted */, results: [], messages: [] }
                    : null, duration);
                this.searchCancelledForNewSearch = false;
            }
        }
