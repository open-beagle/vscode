        ...
        suite('parseSearchPaths', () => {
            test('simple includes', () => {
                function testSimpleIncludes(includePattern, expectedPatterns) {
                    assert.deepStrictEqual(queryBuilder.parseSearchPaths(includePattern), {
