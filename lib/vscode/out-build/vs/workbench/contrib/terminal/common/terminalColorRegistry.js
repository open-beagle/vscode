...
define(["require", "exports", "vs/nls!vs/workbench/contrib/terminal/common/terminalColorRegistry", "vs/platform/theme/common/colorRegistry", "vs/workbench/common/theme"], function (require, exports, nls, colorRegistry_1, theme_1) {
    ...
    exports.TERMINAL_BACKGROUND_COLOR = (0, colorRegistry_1.registerColor)('terminal.background', null, nls.localize(0, null));
    exports.TERMINAL_FOREGROUND_COLOR = (0, colorRegistry_1.registerColor)('terminal.foreground', {
        light: '#333333',
        dark: '#CCCCCC',
        hc: '#FFFFFF'
    }, nls.localize(1, null));
    exports.TERMINAL_CURSOR_FOREGROUND_COLOR = (0, colorRegistry_1.registerColor)('terminalCursor.foreground', null, nls.localize(2, null));
    exports.TERMINAL_CURSOR_BACKGROUND_COLOR = (0, colorRegistry_1.registerColor)('terminalCursor.background', null, nls.localize(3, null));
    ...
    function registerColors() {
        for (const id in exports.ansiColorMap) {
            ...
            exports.ansiColorIdentifiers[entry.index] = (0, colorRegistry_1.registerColor)(id, entry.defaults, nls.localize(6, null, colorName));
        }
    }
