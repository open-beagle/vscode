...
define(["require", "exports", "vs/platform/configuration/common/configuration", "vs/workbench/contrib/terminal/common/terminal", "vs/workbench/contrib/terminal/browser/links/terminalLink", "vs/nls!vs/workbench/contrib/terminal/browser/links/terminalWordLinkProvider", "vs/platform/quickinput/common/quickInput", "vs/platform/workspace/common/workspace", "vs/workbench/services/search/common/search", "vs/workbench/services/editor/common/editorService", "vs/workbench/contrib/search/common/queryBuilder", "vs/platform/instantiation/common/instantiation", "vs/workbench/contrib/terminal/browser/links/terminalBaseLinkProvider"], function (require, exports, configuration_1, terminal_1, terminalLink_1, nls_1, quickInput_1, workspace_1, search_1, editorService_1, queryBuilder_1, instantiation_1, terminalBaseLinkProvider_1) {
    ...
    let TerminalWordLinkProvider = class TerminalWordLinkProvider extends terminalBaseLinkProvider_1.TerminalBaseLinkProvider {
        ...
        _createTerminalLink(startX, endX, y, text, activateCallback) {
            // Remove trailing colon if there is one so the link is more useful
            if (text.length > 0 && text.charAt(text.length - 1) === ':') {
                text = text.slice(0, -1);
                endX--;
            }
            return this._instantiationService.createInstance(terminalLink_1.TerminalLink, this._xterm, { start: { x: startX + 1, y }, end: { x: endX, y } }, text, this._xterm.buffer.active.viewportY, activateCallback, this._tooltipCallback, false, (0, nls_1.localize)(0, null));
        }
