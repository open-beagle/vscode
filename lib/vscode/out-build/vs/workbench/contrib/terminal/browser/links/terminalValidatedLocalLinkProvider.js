...
define(["require", "exports", "vs/workbench/contrib/terminal/browser/links/terminalLinkHelpers", "vs/workbench/contrib/terminal/browser/links/terminalLink", "vs/platform/instantiation/common/instantiation", "vs/workbench/services/uriIdentity/common/uriIdentity", "vs/platform/commands/common/commands", "vs/platform/workspace/common/workspace", "vs/workbench/services/host/browser/host", "vs/workbench/contrib/terminal/browser/links/terminalBaseLinkProvider"], function (require, exports, terminalLinkHelpers_1, terminalLink_1, instantiation_1, uriIdentity_1, commands_1, workspace_1, host_1, terminalBaseLinkProvider_1) {
    ...
    let TerminalValidatedLocalLinkProvider = class TerminalValidatedLocalLinkProvider extends terminalBaseLinkProvider_1.TerminalBaseLinkProvider {
        constructor(_xterm, _processOperatingSystem, _activateFileCallback, _wrapLinkHandler, _tooltipCallback, _validationCallback, _instantiationService, _commandService, _workspaceContextService, _hostService, _uriIdentityService) {
            super();
            this._xterm = _xterm;
        ...
        async _provideLinks(y) {
            ...
            while (startLine >= 0 && ((_a = this._xterm.buffer.active.getLine(startLine)) === null || _a === void 0 ? void 0 : _a.isWrapped)) {
                lines.unshift(this._xterm.buffer.active.getLine(startLine - 1));
                startLine--;
            }
            while (endLine < this._xterm.buffer.active.length && ((_b = this._xterm.buffer.active.getLine(endLine + 1)) === null || _b === void 0 ? void 0 : _b.isWrapped)) {
                lines.push(this._xterm.buffer.active.getLine(endLine + 1));
                endLine++;
            }
            const text = (0, terminalLinkHelpers_1.getXtermLineContent)(this._xterm.buffer.active, startLine, endLine, this._xterm.cols);
            ...
            while ((match = rex.exec(text)) !== null) {
                ...
                const bufferRange = (0, terminalLinkHelpers_1.convertLinkRangeToBuffer)(lines, this._xterm.cols, {
                ...
                const validatedLink = await new Promise(r => {
                    this._validationCallback(link, (result) => {
                        if (result) {
                            ...
                            r(this._instantiationService.createInstance(terminalLink_1.TerminalLink, this._xterm, bufferRange, link, this._xterm.buffer.active.viewportY, activateCallback, this._tooltipCallback, true, label));
                        }
                        else {
                            r(undefined);
                        }
...
//# sourceMappingURL=terminalValidatedLocalLinkProvider.js.map