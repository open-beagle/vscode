...
define(["require", "exports", "vs/nls!vs/workbench/contrib/terminal/browser/links/terminalLinkManager", "vs/base/common/uri", "vs/base/common/lifecycle", "vs/platform/opener/common/opener", "vs/platform/configuration/common/configuration", "vs/workbench/contrib/terminal/common/terminal", "vs/workbench/services/editor/common/editorService", "vs/platform/files/common/files", "vs/base/common/network", "vs/base/common/path", "vs/base/common/platform", "vs/base/common/htmlContent", "vs/workbench/contrib/terminal/browser/links/terminalProtocolLinkProvider", "vs/workbench/contrib/terminal/browser/links/terminalValidatedLocalLinkProvider", "vs/workbench/contrib/terminal/browser/links/terminalWordLinkProvider", "vs/platform/instantiation/common/instantiation", "vs/workbench/contrib/terminal/browser/widgets/terminalHoverWidget", "vs/workbench/contrib/terminal/browser/links/terminalExternalLinkProviderAdapter", "vs/platform/remote/common/tunnel"], function (require, exports, nls, uri_1, lifecycle_1, opener_1, configuration_1, terminal_1, editorService_1, files_1, network_1, path_1, platform_1, htmlContent_1, terminalProtocolLinkProvider_1, terminalValidatedLocalLinkProvider_1, terminalWordLinkProvider_1, instantiation_1, terminalHoverWidget_1, terminalExternalLinkProviderAdapter_1, tunnel_1) {
    "use strict";
    ...
    let TerminalLinkManager = class TerminalLinkManager extends lifecycle_1.DisposableStore {
        constructor(_xterm, _processManager, _openerService, _editorService, _configurationService, _fileService, _instantiationService, _tunnelService) {
            super();
            this._xterm = _xterm;
            ...
            const protocolProvider = this._instantiationService.createInstance(terminalProtocolLinkProvider_1.TerminalProtocolLinkProvider, this._xterm, wrappedActivateCallback, this._tooltipCallback.bind(this));
            ...
            if (this._configurationService.getValue(terminal_1.TERMINAL_CONFIG_SECTION).enableFileLinks) {
                ...
                const validatedProvider = this._instantiationService.createInstance(terminalValidatedLocalLinkProvider_1.TerminalValidatedLocalLinkProvider, this._xterm, this._processManager.os || platform_1.OS, wrappedTextLinkActivateCallback, this._wrapLinkHandler.bind(this), this._tooltipCallback.bind(this), async (link, cb) => cb(await this._resolvePath(link)));
                this._standardLinkProviders.push(validatedProvider);
            }
            // Word links
            const wordProvider = this._instantiationService.createInstance(terminalWordLinkProvider_1.TerminalWordLinkProvider, this._xterm, this._wrapLinkHandler.bind(this), this._tooltipCallback.bind(this));
        ...
        _registerStandardLinkProviders() {
            (0, lifecycle_1.dispose)(this._standardLinkProvidersDisposables);
            this._standardLinkProvidersDisposables = [];
        ...
        registerExternalLinkProvider(instance, linkProvider) {
            const wrappedLinkProvider = this._instantiationService.createInstance(terminalExternalLinkProviderAdapter_1.TerminalExternalLinkProviderAdapter, this._xterm, instance, linkProvider, this._wrapLinkHandler.bind(this), this._tooltipCallback.bind(this));
        ...
        async _handleProtocolLink(link) {
            ...
            if (uri.scheme === network_1.Schemas.file) {
                ...
                this._handleLocalLink(((this.osPath.sep === path_1.posix.sep) && platform_1.isWindows) ? fsPath.replace(/\\/g, path_1.posix.sep) : fsPath);
                return;
            }
        ...
        _getLinkHoverString(uri, label) {
            ...
            if (this._tunnelService.canTunnel(uri_1.URI.parse(uri))) {
                fallbackLabel = nls.localize(4, null);
            }
            else {
