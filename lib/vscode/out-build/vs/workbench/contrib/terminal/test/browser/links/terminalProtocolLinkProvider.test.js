 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "assert", "vs/workbench/contrib/terminal/browser/links/terminalProtocolLinkProvider", "xterm", "vs/platform/instantiation/test/common/instantiationServiceMock", "vs/platform/configuration/test/common/testConfigurationService", "vs/platform/configuration/common/configuration"], function (require, exports, assert, terminalProtocolLinkProvider_1, xterm_1, instantiationServiceMock_1, testConfigurationService_1, configuration_1) {
    "use strict";
    ...
    suite('Workbench - TerminalWebLinkProvider', () => {
        ...
        async function assertLink(text, expected) {
            ...
            const provider = instantiationService.createInstance(terminalProtocolLinkProvider_1.TerminalProtocolLinkProvider, xterm, () => { }, () => { });
...
//# sourceMappingURL=terminalProtocolLinkProvider.test.js.map