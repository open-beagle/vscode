 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "assert", "xterm", "vs/workbench/contrib/terminal/browser/links/terminalWordLinkProvider", "vs/platform/instantiation/test/common/instantiationServiceMock", "vs/platform/configuration/test/common/testConfigurationService", "vs/platform/configuration/common/configuration"], function (require, exports, assert, xterm_1, terminalWordLinkProvider_1, instantiationServiceMock_1, testConfigurationService_1, configuration_1) {
    "use strict";
    ...
    suite('Workbench - TerminalWordLinkProvider', () => {
        ...
        async function assertLink(text, expected) {
            ...
            const provider = instantiationService.createInstance(terminalWordLinkProvider_1.TerminalWordLinkProvider, xterm, () => { }, () => { });
...
//# sourceMappingURL=terminalWordLinkProvider.test.js.map