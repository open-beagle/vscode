...
define(["require", "exports", "assert", "vs/workbench/contrib/terminal/browser/terminalConfigHelper", "vs/editor/common/config/editorOptions", "vs/platform/configuration/test/common/testConfigurationService", "vs/workbench/contrib/terminal/common/terminal"], function (require, exports, assert, terminalConfigHelper_1, editorOptions_1, testConfigurationService_1, terminal_1) {
    ...
    suite('Workbench - TerminalConfigHelper', () => {
        ...
        test('TerminalConfigHelper - getFont fontFamily', async () => {
            ...
            const configHelper = new terminalConfigHelper_1.TerminalConfigHelper(configurationService, null, null, null, null, null);
        ...
        test('TerminalConfigHelper - getFont fontFamily (Linux Fedora)', async () => {
            ...
            const configHelper = new terminalConfigHelper_1.TerminalConfigHelper(configurationService, null, null, null, null, null);
            configHelper.setLinuxDistro(terminal_1.LinuxDistro.Fedora);
            configHelper.panelContainer = fixture;
        ...
        test('TerminalConfigHelper - getFont fontFamily (Linux Ubuntu)', async () => {
            ...
            await configurationService.setUserConfiguration('terminal', { integrated: { fontFamily: null } });
            const configHelper = new terminalConfigHelper_1.TerminalConfigHelper(configurationService, null, null, null, null, null);
            configHelper.setLinuxDistro(terminal_1.LinuxDistro.Ubuntu);
            configHelper.panelContainer = fixture;
        ...
        test('TerminalConfigHelper - getFont fontSize', async () => {
            ...
            let configHelper = new terminalConfigHelper_1.TerminalConfigHelper(configurationService, null, null, null, null, null);
            configHelper.panelContainer = fixture;
            ...
            configHelper = new terminalConfigHelper_1.TerminalConfigHelper(configurationService, null, null, null, null, null);
            configHelper.setLinuxDistro(terminal_1.LinuxDistro.Ubuntu);
            configHelper.panelContainer = fixture;
