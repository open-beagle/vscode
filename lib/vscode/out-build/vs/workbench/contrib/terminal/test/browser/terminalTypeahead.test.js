...
define(["require", "exports", "assert", "sinon", "vs/base/common/event", "vs/workbench/contrib/terminal/browser/terminalTypeAheadAddon", "vs/workbench/contrib/terminal/common/terminal"], function (require, exports, assert, sinon_1, event_1, terminalTypeAheadAddon_1, terminal_1) {
    ...
    class TestTypeAheadAddon extends terminalTypeAheadAddon_1.TypeAheadAddon {
        unlockMakingPredictions() {
            this.lastRow = { y: 1, startingX: 100, endingX: 100, charState: 2 /* Validated */ };
        }
        lockMakingPredictions() {
            this.lastRow = undefined;
        }
        unlockNavigating() {
            this.lastRow = { y: 1, startingX: 1, endingX: 1, charState: 2 /* Validated */ };
        }
        reevaluateNow() {
        ...
        get isShowing() {
            var _a;
            return !!((_a = this.timeline) === null || _a === void 0 ? void 0 : _a.isShowingPredictions);
        }
        undoAllPredictions() {
            var _a;
        ...
        physicalCursor(buffer) {
            var _a;
            return (_a = this.timeline) === null || _a === void 0 ? void 0 : _a.physicalCursor(buffer);
        }
        tentativeCursor(buffer) {
            var _a;
            return (_a = this.timeline) === null || _a === void 0 ? void 0 : _a.tentativeCursor(buffer);
        }
    }
