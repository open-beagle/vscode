 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "assert", "vs/base/common/uri", "vs/workbench/api/common/extHostTypes", "vs/base/common/platform", "vs/base/common/types", "vs/workbench/contrib/notebook/common/notebookCommon"], function (require, exports, assert, uri_1, types, platform_1, types_1, notebookCommon_1) {
    "use strict";
    ...
    suite('ExtHostTypes', function () {
        ...
        test('WorkspaceEdit - two edits for one resource', function () {
            ...
            (0, types_1.assertType)(first._type === 2 /* Text */);
            (0, types_1.assertType)(second._type === 2 /* Text */);
        ...
        test('NotebookMetadata - defaults', function () {
            ...
            assert.strictEqual(obj.trusted, notebookCommon_1.notebookDocumentMetadataDefaults.trusted);
        });
