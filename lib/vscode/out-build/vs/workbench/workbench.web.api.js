 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "vs/workbench/browser/web.main", "vs/base/common/uri", "vs/platform/log/common/log", "vs/base/common/event", "vs/base/common/lifecycle", "vs/platform/commands/common/commands", "vs/base/common/performance", "vs/workbench/workbench.web.main"], function (require, exports, web_main_1, uri_1, log_1, event_1, lifecycle_1, commands_1, performance_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.env = exports.commands = exports.LogLevel = exports.Disposable = exports.Emitter = exports.Event = exports.URI = exports.create = void 0;
    ...
    function create(domElement, options) {
        ...
        (0, web_main_1.main)(domElement, options).then(workbench => {
