...
define(["require", "exports", "vs/base/common/lifecycle", "vs/base/common/stopwatch", "vs/base/common/uri", "vs/platform/instantiation/common/instantiation", "vs/platform/log/common/log", "vs/platform/terminal/common/terminalDataBuffering", "vs/workbench/api/common/extHost.protocol", "vs/workbench/api/common/extHostCustomers", "vs/workbench/contrib/terminal/browser/terminal", "vs/workbench/contrib/terminal/browser/terminalProcessExtHostProxy", "vs/workbench/contrib/terminal/common/environmentVariable", "vs/workbench/contrib/terminal/common/environmentVariableShared", "vs/workbench/services/remote/common/remoteAgentService"], function (require, exports, lifecycle_1, stopwatch_1, uri_1, instantiation_1, log_1, terminalDataBuffering_1, extHost_protocol_1, extHostCustomers_1, terminal_1, terminalProcessExtHostProxy_1, environmentVariable_1, environmentVariableShared_1, remoteAgentService_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.MainThreadTerminalService = void 0;
    let MainThreadTerminalService = class MainThreadTerminalService {
        constructor(extHostContext, _terminalService, terminalInstanceService, _remoteAgentService, _instantiationService, _environmentVariableService, _logService) {
             ...
             */
            this._extHostTerminalIds = new Map();
        ...
        $dispose(id) {
            var _a;
            (_a = this._getTerminalInstance(id)) === null || _a === void 0 ? void 0 : _a.dispose();
        }
        $sendText(id, text, addNewLine) {
            var _a;
            (_a = this._getTerminalInstance(id)) === null || _a === void 0 ? void 0 : _a.sendText(text, addNewLine);
        }
        ...
        $sendProcessTitle(terminalId, title) {
            var _a;
            (_a = this._terminalProcessProxies.get(terminalId)) === null || _a === void 0 ? void 0 : _a.emitTitle(title);
        }
        ...
        $sendOverrideDimensions(terminalId, dimensions) {
            var _a;
            (_a = this._terminalProcessProxies.get(terminalId)) === null || _a === void 0 ? void 0 : _a.emitOverrideDimensions(dimensions);
        }
        $sendProcessInitialCwd(terminalId, initialCwd) {
            var _a;
            (_a = this._terminalProcessProxies.get(terminalId)) === null || _a === void 0 ? void 0 : _a.emitInitialCwd(initialCwd);
        }
        $sendProcessCwd(terminalId, cwd) {
            var _a;
            (_a = this._terminalProcessProxies.get(terminalId)) === null || _a === void 0 ? void 0 : _a.emitCwd(cwd);
        }
        $sendResolvedLaunchConfig(terminalId, shellLaunchConfig) {
            var _a;
            (_a = this._getTerminalProcess(terminalId)) === null || _a === void 0 ? void 0 : _a.emitResolvedShellLaunchConfig(shellLaunchConfig);
        }
        ...
        _isPrimaryExtHost() {
            ...
            return this._extHostKind !== 1 /* LocalWebWorker */;
        }
        async _onRequestAvailableProfiles(req) {
    ...
    MainThreadTerminalService = __decorate([
        ...
        __param(2, terminal_1.ITerminalInstanceService),
