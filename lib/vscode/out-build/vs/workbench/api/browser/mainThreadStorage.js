...
define(["require", "exports", "vs/platform/storage/common/storage", "../common/extHost.protocol", "vs/workbench/api/common/extHostCustomers", "vs/platform/userDataSync/common/extensionsStorageSync"], function (require, exports, storage_1, extHost_protocol_1, extHostCustomers_1, extensionsStorageSync_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.MainThreadStorage = void 0;
    let MainThreadStorage = class MainThreadStorage {
        constructor(extHostContext, storageService, extensionsStorageSyncService) {
        ...
        async $setValue(shared, key, value) {
            ...
            try {
                ...
                await this._storageService.store(key, jsonValue, shared ? 0 /* GLOBAL */ : 1 /* WORKSPACE */, 1 /* MACHINE */);
            }
            catch (err) {
    ...
    MainThreadStorage = __decorate([
        ...
        __param(2, extensionsStorageSync_1.IExtensionsStorageSyncService)
    ], MainThreadStorage);
