...
define(["require", "exports", "vs/base/common/event", "vs/base/common/lifecycle", "vs/base/common/uri", "vs/base/common/uuid", "vs/platform/registry/common/platform", "vs/workbench/api/common/extHostCustomers", "vs/workbench/contrib/comments/browser/commentService", "vs/workbench/contrib/comments/browser/commentsView", "../common/extHost.protocol", "vs/workbench/contrib/comments/browser/commentsTreeViewer", "vs/workbench/common/views", "vs/platform/instantiation/common/descriptors", "vs/workbench/browser/parts/views/viewPaneContainer", "vs/base/common/codicons", "vs/platform/theme/common/iconRegistry", "vs/nls!vs/workbench/api/browser/mainThreadComments"], function (require, exports, event_1, lifecycle_1, uri_1, uuid_1, platform_1, extHostCustomers_1, commentService_1, commentsView_1, extHost_protocol_1, commentsTreeViewer_1, views_1, descriptors_1, viewPaneContainer_1, codicons_1, iconRegistry_1, nls_1) {
    "use strict";
    ...
    const commentsViewIcon = (0, iconRegistry_1.registerIcon)('comments-view-icon', codicons_1.Codicon.commentDiscussion, (0, nls_1.localize)(0, null));
