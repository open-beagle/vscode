...
define(["require", "exports", "vs/workbench/api/common/extHostCustomers", "vs/platform/log/common/log", "vs/workbench/api/common/extHost.protocol", "vs/base/common/uri", "vs/platform/log/common/fileLog", "vs/platform/instantiation/common/instantiation", "vs/base/common/path"], function (require, exports, extHostCustomers_1, log_1, extHost_protocol_1, uri_1, fileLog_1, instantiation_1, path_1) {
    ...
    let MainThreadLogService = class MainThreadLogService {
        ...
        $log(file, level, message) {
            ...
            if (!logger) {
                logger = this._instaService.createInstance(fileLog_1.FileLogger, (0, path_1.basename)(file.path), uri_1.URI.revive(file), this._logService.getLevel());
    ...
    MainThreadLogService = __decorate([
        (0, extHostCustomers_1.extHostNamedCustomer)(extHost_protocol_1.MainContext.MainThreadLog),
