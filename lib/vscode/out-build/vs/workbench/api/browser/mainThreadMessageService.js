    ...
    let MainThreadMessageService = class MainThreadMessageService {
        ...
        _showMessage(severity, message, commands, extension) {
            return new Promise(resolve => {
                ...
                if (extension) {
                    source = {
                        label: nls.localize(0, null, extension.displayName || extension.name),
                ...
                if (extension && !extension.isUnderDevelopment) {
                    secondaryActions.push(new ManageExtensionAction(extension.identifier, nls.localize(2, null), this._commandService));
                }
        ...
        async _showModalMessage(severity, message, commands, useCustom) {
            ...
            if (cancelId === undefined) {
                if (buttons.length > 0) {
                    buttons.push(nls.localize(3, null));
                }
                else {
                    buttons.push(nls.localize(4, null));
                }
