    ...
    let MainThreadProgress = class MainThreadProgress {
        ...
        $startProgress(handle, options, extension) {
            ...
            if (options.location === 15 /* Notification */ && extension && !extension.isUnderDevelopment) {
                const notificationOptions = Object.assign(Object.assign({}, options), { location: 15 /* Notification */, secondaryActions: [new ManageExtensionAction(extension.identifier, (0, nls_1.localize)(0, null), this._commandService)] });
