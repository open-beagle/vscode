...
define(["require", "exports", "vs/nls!vs/workbench/services/history/browser/history", "vs/base/common/uri", "vs/workbench/common/editor", "vs/workbench/services/editor/common/editorService", "vs/workbench/services/history/common/history", "vs/platform/files/common/files", "vs/editor/common/core/selection", "vs/platform/workspace/common/workspace", "vs/base/common/lifecycle", "vs/platform/storage/common/storage", "vs/platform/registry/common/platform", "vs/base/common/event", "vs/platform/configuration/common/configuration", "vs/workbench/services/editor/common/editorGroupsService", "vs/editor/browser/editorBrowser", "vs/workbench/services/search/common/search", "vs/platform/instantiation/common/instantiation", "vs/workbench/services/layout/browser/layoutService", "vs/platform/contextkey/common/contextkey", "vs/base/common/arrays", "vs/platform/instantiation/common/extensions", "vs/base/common/types", "vs/base/browser/dom", "vs/platform/workspaces/common/workspaces", "vs/base/common/network", "vs/base/common/errors", "vs/base/common/async", "vs/workbench/common/resources", "vs/workbench/services/path/common/pathService", "vs/workbench/services/uriIdentity/common/uriIdentity", "vs/workbench/services/lifecycle/common/lifecycle"], function (require, exports, nls_1, uri_1, editor_1, editorService_1, history_1, files_1, selection_1, workspace_1, lifecycle_1, storage_1, platform_1, event_1, configuration_1, editorGroupsService_1, editorBrowser_1, search_1, instantiation_1, layoutService_1, contextkey_1, arrays_1, extensions_1, types_1, dom_1, workspaces_1, network_1, errors_1, async_1, resources_1, pathService_1, uriIdentity_1, lifecycle_2) {
    ...
    class TextEditorState {
        ...
        get selection() {
            return (0, types_1.withNullAsUndefined)(this._selection);
        }
    ...
    let HistoryService = class HistoryService extends lifecycle_1.Disposable {
        constructor(editorService, editorGroupService, contextService, storageService, configurationService, fileService, workspacesService, instantiationService, layoutService, contextKeyService, pathService, uriIdentityService, lifecycleService) {
            super();
            ...
            this.editorInputFactory = platform_1.Registry.as(editor_1.EditorExtensions.EditorInputFactories);
            ...
            //#endregion
            //#region Context Keys
            this.canNavigateBackContextKey = (new contextkey_1.RawContextKey('canNavigateBack', false, (0, nls_1.localize)(0, null))).bindTo(this.contextKeyService);
            this.canNavigateForwardContextKey = (new contextkey_1.RawContextKey('canNavigateForward', false, (0, nls_1.localize)(1, null))).bindTo(this.contextKeyService);
            this.canNavigateToLastEditLocationContextKey = (new contextkey_1.RawContextKey('canNavigateToLastEditLocation', false, (0, nls_1.localize)(2, null))).bindTo(this.contextKeyService);
            this.canReopenClosedEditorContextKey = (new contextkey_1.RawContextKey('canReopenClosedEditor', false, (0, nls_1.localize)(3, null))).bindTo(this.contextKeyService);
        ...
        onDidFilesChange(event) {
            ...
            // Internal file changes (e.g. explorer)
                ...
                // Delete
                if (event.isOperation(1 /* DELETE */)) {
                    this.remove(event);
                }
                // Move
                else if (event.isOperation(2 /* MOVE */) && event.target.isFile) {
                    this.move(event);
                }
            }
        }
        ...
        clear() {
            ...
            this.editorStackListeners.forEach(listeners => (0, lifecycle_1.dispose)(listeners));
        ...
        handleEditorEventInNavigationStack(control, event) {
            const codeEditor = control ? (0, editorBrowser_1.getCodeEditor)(control.getControl()) : undefined;
        ...
        preferResourceEditorInput(input) {
            ...
            if (input instanceof editor_1.EditorInput) {
                resource = editor_1.EditorResourceAccessor.getOriginalUri(input);
            }
            else {
            ...
            const validResourceEditorInputScheme = (resource === null || resource === void 0 ? void 0 : resource.scheme) === network_1.Schemas.file ||
                (resource === null || resource === void 0 ? void 0 : resource.scheme) === network_1.Schemas.vscodeRemote ||
                (resource === null || resource === void 0 ? void 0 : resource.scheme) === network_1.Schemas.userData ||
        ...
        matches(arg1, inputB) {
            if (arg1 instanceof files_1.FileChangesEvent || arg1 instanceof files_1.FileOperationEvent) {
                ...
                if (arg1 instanceof files_1.FileChangesEvent) {
                    return arg1.contains(inputB.resource, 2 /* DELETED */);
                }
        ...
        matchesFile(resource, arg2) {
            ...
            if (arg2 instanceof editor_1.EditorInput) {
                ...
                if (this.lifecycleService.phase >= 3 /* Restored */ && !this.fileService.canHandleResource(inputResource)) {
            ...
            return this.uriIdentityService.extUri.isEqual(resourceEditorInput === null || resourceEditorInput === void 0 ? void 0 : resourceEditorInput.resource, resource);
        }
        ...
        async doReopenLastClosedEditor(lastClosedEditor) {
            ...
            const restoredEditor = (_a = this.editorInputFactory.getEditorInputSerializer(lastClosedEditor.serialized.typeId)) === null || _a === void 0 ? void 0 : _a.deserialize(this.instantiationService, lastClosedEditor.serialized.value);
        ...
        clearRecentlyOpened() {
            this.history = [];
            this.editorHistoryListeners.forEach(listeners => (0, lifecycle_1.dispose)(listeners));
        ...
        loadHistory() {
            ...
            if (entriesRaw) {
                try {
                    entries = (0, arrays_1.coalesce)(JSON.parse(entriesRaw));
                }
                catch (error) {
                    (0, errors_1.onUnexpectedError)(error); // https://github.com/microsoft/vscode/issues/99075
                }
            }
            return (0, arrays_1.coalesce)(entries.map(entry => {
                try {
        ...
        safeLoadHistoryEntry(entry) {
            ...
            if (editorInputJSON === null || editorInputJSON === void 0 ? void 0 : editorInputJSON.deserialized) {
                ...
                if (editorSerializer) {
                    ...
                    return (0, types_1.withNullAsUndefined)(input);
                }
            }
            return undefined;
        }
        saveState() {
            ...
            const entries = (0, arrays_1.coalesce)(this.history.map((input) => {
            ...
            this.storageService.store(HistoryService.HISTORY_STORAGE_KEY, JSON.stringify(entries), 1 /* WORKSPACE */, 1 /* MACHINE */);
        }
        //#endregion
