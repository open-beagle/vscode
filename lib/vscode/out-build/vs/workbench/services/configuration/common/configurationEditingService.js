...
define(["require", "exports", "vs/nls!vs/workbench/services/configuration/common/configurationEditingService", "vs/base/common/json", "vs/base/common/jsonEdit", "vs/base/common/async", "vs/editor/common/core/editOperation", "vs/platform/registry/common/platform", "vs/editor/common/core/range", "vs/editor/common/core/selection", "vs/platform/workspace/common/workspace", "vs/platform/environment/common/environment", "vs/workbench/services/textfile/common/textfiles", "vs/platform/configuration/common/configuration", "vs/workbench/services/configuration/common/configuration", "vs/platform/files/common/files", "vs/editor/common/services/resolverService", "vs/platform/configuration/common/configurationRegistry", "vs/workbench/services/editor/common/editorService", "vs/platform/notification/common/notification", "vs/workbench/services/preferences/common/preferences", "vs/base/common/types", "vs/workbench/services/remote/common/remoteAgentService", "vs/workbench/services/uriIdentity/common/uriIdentity"], function (require, exports, nls, json, jsonEdit_1, async_1, editOperation_1, platform_1, range_1, selection_1, workspace_1, environment_1, textfiles_1, configuration_1, configuration_2, files_1, resolverService_1, configurationRegistry_1, editorService_1, notification_1, preferences_1, types_1, remoteAgentService_1, uriIdentity_1) {
    "use strict";
    ...
    let ConfigurationEditingService = class ConfigurationEditingService {
        ...
        onInvalidConfigurationError(error, operation) {
            const openStandAloneConfigurationActionLabel = operation.workspaceStandAloneConfigurationKey === configuration_2.TASKS_CONFIGURATION_KEY ? nls.localize(0, null)
                : operation.workspaceStandAloneConfigurationKey === configuration_2.LAUNCH_CONFIGURATION_KEY ? nls.localize(1, null)
                    : null;
        ...
        onConfigurationFileDirtyError(error, operation, scopes) {
            const openStandAloneConfigurationActionLabel = operation.workspaceStandAloneConfigurationKey === configuration_2.TASKS_CONFIGURATION_KEY ? nls.localize(3, null)
                : operation.workspaceStandAloneConfigurationKey === configuration_2.LAUNCH_CONFIGURATION_KEY ? nls.localize(4, null)
                    : null;
            if (openStandAloneConfigurationActionLabel) {
                this.notificationService.prompt(notification_1.Severity.Error, error.message, [{
        ...
        toErrorMessage(error, target, operation) {
            switch (error) {
                // API constraints
                case 0 /* ERROR_UNKNOWN_KEY */: return nls.localize(8, null, this.stringifyTarget(target), operation.key);
                case 1 /* ERROR_INVALID_WORKSPACE_CONFIGURATION_APPLICATION */: return nls.localize(9, null, operation.key);
                case 2 /* ERROR_INVALID_WORKSPACE_CONFIGURATION_MACHINE */: return nls.localize(10, null, operation.key);
                case 3 /* ERROR_INVALID_FOLDER_CONFIGURATION */: return nls.localize(11, null, operation.key);
                case 4 /* ERROR_INVALID_USER_TARGET */: return nls.localize(12, null, operation.key);
                case 5 /* ERROR_INVALID_WORKSPACE_TARGET */: return nls.localize(13, null, operation.key);
                case 6 /* ERROR_INVALID_FOLDER_TARGET */: return nls.localize(14, null);
                case 7 /* ERROR_INVALID_RESOURCE_LANGUAGE_CONFIGURATION */: return nls.localize(15, null, operation.key);
                case 8 /* ERROR_NO_WORKSPACE_OPENED */: return nls.localize(16, null, this.stringifyTarget(target));
                // User issues
                case 11 /* ERROR_INVALID_CONFIGURATION */: {
                    ...
                    switch (target) {
                        ...
                        case 4 /* WORKSPACE_FOLDER */:
                            ...
                            return nls.localize(22, null, workspaceFolderName);
                        default:
                            return '';
                    }
                }
                case 9 /* ERROR_CONFIGURATION_FILE_DIRTY */: {
                    ...
                    switch (target) {
                        ...
                        case 4 /* WORKSPACE_FOLDER */:
                            ...
                            return nls.localize(28, null, workspaceFolderName);
                        default:
                            return '';
                    }
                }
        ...
        getEdits(model, edit) {
            ...
            return (0, jsonEdit_1.setProperty)(model.getValue(), jsonPath, value, { tabSize, insertSpaces, eol });
        }
        ...
        getConfigurationEditOperation(target, config, overrides) {
            ...
            let key = config.key;
            let jsonPath = overrides.overrideIdentifier ? [(0, configuration_1.keyFromOverrideIdentifier)(overrides.overrideIdentifier), key] : [key];
