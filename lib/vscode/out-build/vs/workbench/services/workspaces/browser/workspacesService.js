...
define(["require", "exports", "vs/platform/instantiation/common/extensions", "vs/platform/workspaces/common/workspaces", "vs/base/common/event", "vs/platform/storage/common/storage", "vs/platform/workspace/common/workspace", "vs/platform/log/common/log", "vs/base/common/lifecycle", "vs/workbench/services/workspaces/browser/workspaces", "vs/platform/files/common/files", "vs/workbench/services/environment/common/environmentService", "vs/base/common/resources", "vs/base/common/buffer", "vs/base/common/platform", "vs/workbench/services/uriIdentity/common/uriIdentity"], function (require, exports, extensions_1, workspaces_1, event_1, storage_1, workspace_1, log_1, lifecycle_1, workspaces_2, files_1, environmentService_1, resources_1, buffer_1, platform_1, uriIdentity_1) {
    ...
    let BrowserWorkspacesService = class BrowserWorkspacesService extends lifecycle_1.Disposable {
        constructor(storageService, workspaceService, logService, fileService, environmentService, uriIdentityService) {
            super();
        ...
        async getRecentlyOpened() {
            ...
            if (recentlyOpenedRaw) {
                return (0, workspaces_1.restoreRecentlyOpened)(JSON.parse(recentlyOpenedRaw), this.logService);
            }
        ...
        async saveRecentlyOpened(data) {
            return this.storageService.store(BrowserWorkspacesService.RECENTLY_OPENED_KEY, JSON.stringify((0, workspaces_1.toStoreData)(data)), 0 /* GLOBAL */, 0 /* USER */);
        }
        ...
        async createUntitledWorkspace(folders, remoteAuthority) {
            ...
            const newUntitledWorkspacePath = (0, resources_1.joinPath)(this.environmentService.untitledWorkspacesHome, `Untitled-${randomId}.${workspaces_1.WORKSPACE_EXTENSION}`);
        ...
        async getWorkspaceIdentifier(workspacePath) {
            return (0, workspaces_2.getWorkspaceIdentifier)(workspacePath);
        }
        //#endregion
