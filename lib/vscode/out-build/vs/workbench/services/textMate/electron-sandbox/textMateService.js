...
define(["require", "exports", "vs/workbench/services/textMate/common/textMateService", "vs/platform/instantiation/common/extensions", "vs/workbench/services/textMate/browser/abstractTextMateService", "vs/editor/common/services/modeService", "vs/workbench/services/themes/common/workbenchThemeService", "vs/platform/notification/common/notification", "vs/platform/log/common/log", "vs/platform/configuration/common/configuration", "vs/editor/common/services/webWorker", "vs/editor/common/services/modelService", "vs/base/common/lifecycle", "vs/base/common/uri", "vs/editor/common/model/tokensStore", "vs/platform/storage/common/storage", "vs/workbench/services/extensionResourceLoader/common/extensionResourceLoader", "vs/workbench/services/environment/common/environmentService", "vs/platform/progress/common/progress", "vs/base/common/network"], function (require, exports, textMateService_1, extensions_1, abstractTextMateService_1, modeService_1, workbenchThemeService_1, notification_1, log_1, configuration_1, webWorker_1, modelService_1, lifecycle_1, uri_1, tokensStore_1, storage_1, extensionResourceLoader_1, environmentService_1, progress_1, network_1) {
    "use strict";
    ...
    let TextMateService = class TextMateService extends abstractTextMateService_1.AbstractTextMateService {
        constructor(modeService, themeService, extensionResourceLoaderService, notificationService, logService, configurationService, storageService, progressService, _modelService, _environmentService) {
        ...
        _onDidCreateGrammarFactory(grammarDefinitions) {
            ...
            if (RUN_TEXTMATE_IN_WORKER) {
                ...
                const worker = (0, webWorker_1.createWebWorker)(this._modelService, {
                    createData: {
                        grammarDefinitions
                    },
    ...
    (0, extensions_1.registerSingleton)(textMateService_1.ITextMateService, TextMateService);
});
