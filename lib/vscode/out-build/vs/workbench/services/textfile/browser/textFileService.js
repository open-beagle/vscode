...
define(["require", "exports", "vs/nls!vs/workbench/services/textfile/browser/textFileService", "vs/workbench/services/textfile/common/textfiles", "vs/workbench/services/lifecycle/common/lifecycle", "vs/platform/files/common/files", "vs/base/common/lifecycle", "vs/workbench/services/environment/common/environmentService", "vs/workbench/services/untitled/common/untitledTextEditorService", "vs/workbench/services/untitled/common/untitledTextEditorModel", "vs/workbench/services/textfile/common/textFileEditorModelManager", "vs/platform/instantiation/common/instantiation", "vs/base/common/network", "vs/editor/common/model/textModel", "vs/editor/common/services/modelService", "vs/base/common/resources", "vs/platform/dialogs/common/dialogs", "vs/base/common/buffer", "vs/editor/common/services/textResourceConfigurationService", "vs/editor/common/modes/modesRegistry", "vs/workbench/services/filesConfiguration/common/filesConfigurationService", "vs/editor/common/services/resolverService", "vs/workbench/common/editor/textEditorModel", "vs/editor/browser/services/codeEditorService", "vs/workbench/services/path/common/pathService", "vs/base/common/extpath", "vs/workbench/services/workingCopy/common/workingCopyFileService", "vs/workbench/services/uriIdentity/common/uriIdentity", "vs/platform/workspace/common/workspace", "vs/platform/workspaces/common/workspaces", "vs/workbench/services/textfile/common/encoding", "vs/base/common/stream", "vs/editor/common/services/modeService", "vs/platform/log/common/log", "vs/base/common/cancellation", "vs/workbench/services/files/common/elevatedFileService"], function (require, exports, nls_1, textfiles_1, lifecycle_1, files_1, lifecycle_2, environmentService_1, untitledTextEditorService_1, untitledTextEditorModel_1, textFileEditorModelManager_1, instantiation_1, network_1, textModel_1, modelService_1, resources_1, dialogs_1, buffer_1, textResourceConfigurationService_1, modesRegistry_1, filesConfigurationService_1, resolverService_1, textEditorModel_1, codeEditorService_1, pathService_1, extpath_1, workingCopyFileService_1, uriIdentity_1, workspace_1, workspaces_1, encoding_1, stream_1, modeService_1, log_1, cancellation_1, elevatedFileService_1) {
    "use strict";
    ...
    let AbstractTextFileService = class AbstractTextFileService extends lifecycle_2.Disposable {
        ...
        async doRead(resource, options) {
            ...
            if ((options === null || options === void 0 ? void 0 : options.acceptTextOnly) && decoder.detected.seemsBinary) {
                throw new textfiles_1.TextFileOperationError((0, nls_1.localize)(0, null), 0 /* FILE_IS_BINARY */, options);
            }
        ...
        async confirmOverwrite(resource) {
            const confirm = {
                ...
                detail: (0, nls_1.localize)(2, null, (0, resources_1.basename)(resource), (0, resources_1.basename)((0, resources_1.dirname)(resource))),
                primaryButton: (0, nls_1.localize)(3, null),
                type: 'warning'
            };
        ...
        async suggestSavePath(resource) {
            ...
            return (0, resources_1.joinPath)(await this.fileDialogService.defaultFilePath(), suggestedFilename);
        }
        suggestFilename(mode, untitledName) {
