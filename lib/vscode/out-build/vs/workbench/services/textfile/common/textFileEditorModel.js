...
define(["require", "exports", "vs/base/common/event", "vs/base/common/types", "vs/workbench/services/textfile/common/textfiles", "vs/workbench/common/editor/textEditorModel", "vs/workbench/services/workingCopy/common/workingCopyBackup", "vs/platform/files/common/files", "vs/editor/common/services/modeService", "vs/editor/common/services/modelService", "vs/base/common/async", "vs/platform/log/common/log", "vs/base/common/path", "vs/workbench/services/workingCopy/common/workingCopyService", "vs/workbench/services/workingCopy/common/workingCopy", "vs/workbench/services/filesConfiguration/common/filesConfigurationService", "vs/platform/label/common/label", "vs/base/common/cancellation", "vs/workbench/services/textfile/common/encoding", "vs/editor/common/model/textModel"], function (require, exports, event_1, types_1, textfiles_1, textEditorModel_1, workingCopyBackup_1, files_1, modeService_1, modelService_1, async_1, log_1, path_1, workingCopyService_1, workingCopy_1, filesConfigurationService_1, label_1, cancellation_1, encoding_1, textModel_1) {
    "use strict";
    ...
    let TextFileEditorModel = class TextFileEditorModel extends textEditorModel_1.BaseTextEditorModel {
        ...
        modeService, modelService, fileService, textFileService, workingCopyBackupService, logService, workingCopyService, filesConfigurationService, labelService) {
        ...
        resolveFromContent(content, dirty, options) {
            ...
            this.setDirty(!!dirty);
            // Emit as event
            this._onDidResolve.fire((_a = options === null || options === void 0 ? void 0 : options.reason) !== null && _a !== void 0 ? _a : 3 /* OTHER */);
        }
            ...
            return this.saveSequentializer.setPending(versionId, (async () => {
                ...
                if (this.isResolved() && !options.skipSaveParticipants) {
                    try {
                        ...
                        if (options.reason === 2 /* AUTO */ && typeof this.lastModelContentChangeFromUndoRedo === 'number') {
                ...
                return this.saveSequentializer.setPending(versionId, (async () => {
                    try {
                        const stat = await this.textFileService.write(lastResolvedFileStat.resource, resolvedTextFileEditorModel.createSnapshot(), {
                            ...
                            etag: (options.ignoreModifiedSince || !this.filesConfigurationService.preventSaveConflicts(lastResolvedFileStat.resource, resolvedTextFileEditorModel.getMode())) ? files_1.ETAG_DISABLED : lastResolvedFileStat.etag,
