...
define(["require", "exports", "vs/base/common/event", "vs/base/common/json", "vs/base/common/lifecycle", "vs/base/common/network", "vs/base/common/uri", "vs/editor/browser/editorBrowser", "vs/editor/common/services/modelService", "vs/editor/common/services/modeService", "vs/editor/common/services/resolverService", "vs/nls!vs/workbench/services/preferences/browser/preferencesService", "vs/platform/configuration/common/configuration", "vs/platform/environment/common/environment", "vs/platform/instantiation/common/instantiation", "vs/platform/keybinding/common/keybinding", "vs/platform/label/common/label", "vs/platform/notification/common/notification", "vs/platform/telemetry/common/telemetry", "vs/platform/workspace/common/workspace", "vs/workbench/services/configuration/common/jsonEditing", "vs/workbench/services/editor/common/editorService", "vs/workbench/services/editor/common/editorGroupsService", "vs/workbench/services/preferences/common/preferences", "vs/workbench/services/preferences/browser/preferencesEditorInput", "vs/workbench/services/preferences/common/preferencesModels", "vs/platform/instantiation/common/extensions", "vs/workbench/services/remote/common/remoteAgentService", "vs/workbench/services/textfile/common/textfiles", "vs/base/common/types", "vs/platform/configuration/common/configurationRegistry", "vs/platform/registry/common/platform", "vs/platform/commands/common/commands", "vs/editor/browser/controller/coreCommands", "vs/base/common/errors", "vs/platform/editor/common/editor"], function (require, exports, event_1, json_1, lifecycle_1, network, uri_1, editorBrowser_1, modelService_1, modeService_1, resolverService_1, nls, configuration_1, environment_1, instantiation_1, keybinding_1, label_1, notification_1, telemetry_1, workspace_1, jsonEditing_1, editorService_1, editorGroupsService_1, preferences_1, preferencesEditorInput_1, preferencesModels_1, extensions_1, remoteAgentService_1, textfiles_1, types_1, configurationRegistry_1, platform_1, commands_1, coreCommands_1, errors_1, editor_1) {
    "use strict";
    ...
    let PreferencesService = class PreferencesService extends lifecycle_1.Disposable {
        ...
        openSettings2(options) {
            ...
            return this.editorService.openEditor(input, options ? preferences_1.SettingsEditorOptions.create(options) : { override: editor_1.EditorOverride.DISABLED })
        ...
        async openRemoteSettings() {
            ...
            if (environment) {
                ...
                return this.editorService.openEditor({ resource: environment.settingsPath, options: { pinned: true, revealIfOpened: true, override: editor_1.EditorOverride.DISABLED } });
            }
            return undefined;
        }
        openWorkspaceSettings(jsonEditor, options, group) {
            ...
            if (!this.workspaceSettingsResource) {
                this.notificationService.info(nls.localize(0, null));
        ...
        switchSettings(target, resource) {
        ...
        async openGlobalKeybindingSettings(textual, options) {
            ...
            if (textual) {
                ...
                if (openDefaultKeybindings) {
                    ...
                    await Promise.all([
                        this.editorService.openEditor({ resource: this.defaultKeybindingsResource, options: { pinned: true, preserveFocus: true, revealIfOpened: true, override: editor_1.EditorOverride.DISABLED }, label: nls.localize(2, null), description: '' }),
                ...
                const editor = (await this.editorService.openEditor(this.instantiationService.createInstance(preferencesEditorInput_1.KeybindingsEditorInput), Object.assign(Object.assign({}, options), { override: editor_1.EditorOverride.DISABLED })));
                if (options.query) {
        ...
        openDefaultKeybindingsFile() {
            return this.editorService.openEditor({ resource: this.defaultKeybindingsResource, label: nls.localize(3, null) });
        }
        ...
        openOrSwitchSettings2(configurationTarget, folderUri, options, group = this.editorGroupService.activeGroup) {
            const settingsOptions = Object.assign(Object.assign({}, options), { target: configurationTarget, folderUri });
        ...
        doOpenSettings(configurationTarget, resource, options, group) {
            ...
            return this.getOrCreateEditableSettingsEditorInput(configurationTarget, resource)
                ...
                if (openDefaultSettings) {
                    ...
                    const sideEditorGroup = this.editorGroupService.addGroup(activeEditorGroup.id, 3 /* RIGHT */);
                    return Promise.all([
                        this.editorService.openEditor({ resource: this.defaultSettingsRawResource, options: { pinned: true, preserveFocus: true, revealIfOpened: true, override: editor_1.EditorOverride.DISABLED }, label: nls.localize(4, null), description: '' }),
                        this.editorService.openEditor(editableSettingsEditorInput, { pinned: true, revealIfOpened: true, override: editor_1.EditorOverride.DISABLED }, sideEditorGroup.id)
                    ]).then(([defaultEditor, editor]) => (0, types_1.withNullAsUndefined)(editor));
                }
                else {
        ...
        getPreferencesEditorInputName(target, resource) {
            const name = (0, preferences_1.getSettingsTargetName)(target, resource, this.contextService);
            return target === 5 /* WORKSPACE_FOLDER */ ? nls.localize(5, null, name) : name;
        }
            ...
            try {
                ...
                if (error.fileOperationResult === 1 /* FILE_NOT_FOUND */) {
                    try {
                        ...
                        throw new Error(nls.localize(6, null, this.labelService.getUriLabel(resource, { relative: true }), (0, errors_1.getErrorMessage)(error2)));
                    }
                }
                else {
                    throw error;
        ...
        async getPositionToReveal(settingKey, edit, settingsModel, codeEditor) {
            ...
            if (!setting && edit) {
                const defaultValue = (type === 'object' || type === 'array') ? this.configurationService.inspect(settingKey).defaultValue : (0, configurationRegistry_1.getDefaultValue)(type);
