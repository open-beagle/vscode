...
define(["require", "exports", "vs/nls!vs/workbench/services/preferences/browser/keybindingsEditorModel", "vs/base/common/arrays", "vs/base/common/strings", "vs/base/common/platform", "vs/base/common/filters", "vs/platform/registry/common/platform", "vs/base/common/keybindingLabels", "vs/platform/actions/common/actions", "vs/workbench/common/actions", "vs/workbench/common/editor", "vs/platform/keybinding/common/keybinding", "vs/platform/keybinding/common/resolvedKeybindingItem", "vs/workbench/services/keybinding/browser/unboundCommands"], function (require, exports, nls_1, arrays_1, strings, platform_1, filters_1, platform_2, keybindingLabels_1, actions_1, actions_2, editor_1, keybinding_1, resolvedKeybindingItem_1, unboundCommands_1) {
    "use strict";
    ...
    const SOURCE_DEFAULT = (0, nls_1.localize)(0, null);
    ...
    class KeybindingItemMatches {
        ...
        wordMatchesAltModifier(word) {
            ...
            if (strings.equalsIgnoreCase((0, nls_1.localize)(5, null), word)) {
                return true;
            }
            return false;
        }
        ...
        wordMatchesMetaModifier(word) {
            ...
            if (strings.equalsIgnoreCase((0, nls_1.localize)(6, null), word)) {
                return true;
            }
            return false;
        }
