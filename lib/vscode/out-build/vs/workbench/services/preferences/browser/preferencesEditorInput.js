...
define(["require", "exports", "vs/base/common/platform", "vs/base/common/uri", "vs/editor/common/services/resolverService", "vs/nls!vs/workbench/services/preferences/browser/preferencesEditorInput", "vs/platform/instantiation/common/instantiation", "vs/workbench/common/editor", "vs/workbench/common/editor/resourceEditorInput", "vs/workbench/services/preferences/browser/keybindingsEditorModel", "vs/workbench/services/preferences/common/preferences", "vs/workbench/services/textfile/common/textfiles", "vs/workbench/services/editor/common/editorService", "vs/workbench/services/editor/common/editorGroupsService", "vs/platform/files/common/files", "vs/platform/label/common/label", "vs/workbench/services/filesConfiguration/common/filesConfigurationService", "vs/base/common/network"], function (require, exports, platform_1, uri_1, resolverService_1, nls, instantiation_1, editor_1, resourceEditorInput_1, keybindingsEditorModel_1, preferences_1, textfiles_1, editorService_1, editorGroupsService_1, files_1, label_1, filesConfigurationService_1, network_1) {
    "use strict";
    ...
    let DefaultPreferencesEditorInput = class DefaultPreferencesEditorInput extends resourceEditorInput_1.ResourceEditorInput {
        constructor(defaultSettingsResource, textModelResolverService, textFileService, editorService, editorGroupService, fileService, labelService, filesConfigurationService) {
            super(defaultSettingsResource, nls.localize(0, null), '', undefined, textModelResolverService, textFileService, editorService, editorGroupService, fileService, labelService, filesConfigurationService);
        }
        get typeId() {
