        ...
        parseConfig(config, result, configurations, settingsGroup, seenSettings) {
            ...
            if (title) {
                if (!settingsGroup) {
                    ...
                    if (!settingsGroup) {
                        settingsGroup = { sections: [{ settings: [] }], id: config.id || '', title: title || '', titleRange: exports.nullRange, range: exports.nullRange, extensionInfo: config.extensionInfo };
            ...
            if (config.properties) {
                if (!settingsGroup) {
                    settingsGroup = { sections: [{ settings: [] }], id: config.id || '', title: config.id || '', titleRange: exports.nullRange, range: exports.nullRange, extensionInfo: config.extensionInfo };
                    result.push(settingsGroup);
                }
        ...
        parseSettings(settingsObject, extensionInfo) {
            ...
            for (const key in settingsObject) {
                ...
                if (this.matchesScope(prop)) {
                    ...
                    const listItemType = prop.type === 'array' && prop.items && !(0, types_1.isArray)(prop.items) && prop.items.type && !(0, types_1.isArray)(prop.items.type)
                        ? prop.items.type
                        : undefined;
