...
define(["require", "exports", "vs/base/common/errors", "vs/base/common/event", "vs/base/common/lifecycle", "vs/workbench/services/environment/common/environmentService", "vs/platform/instantiation/common/instantiation", "vs/workbench/api/common/extHostCustomers", "vs/workbench/api/common/extHost.protocol", "vs/workbench/services/extensions/common/rpcProtocol", "vs/platform/remote/common/remoteAuthorityResolver", "vs/nls!vs/workbench/services/extensions/common/extensionHostManager", "vs/platform/actions/common/actions", "vs/workbench/services/editor/common/editorService", "vs/base/common/stopwatch", "vs/base/common/buffer", "vs/workbench/common/actions", "vs/base/common/async"], function (require, exports, errors, event_1, lifecycle_1, environmentService_1, instantiation_1, extHostCustomers_1, extHost_protocol_1, rpcProtocol_1, remoteAuthorityResolver_1, nls, actions_1, editorService_1, stopwatch_1, buffer_1, actions_2, async_1) {
    "use strict";
    ...
    let ExtensionHostManager = class ExtensionHostManager extends lifecycle_1.Disposable {
        constructor(extensionHost, initialActivationEvents, _instantiationService, _environmentService) {
            ...
            this._proxy.then(() => {
                initialActivationEvents.forEach((activationEvent) => this.activateByEvent(activationEvent, 0 /* Normal */));
        ...
        activateByEvent(activationEvent, activationKind) {
            if (activationKind === 1 /* Immediate */ && !this._hasStarted) {
