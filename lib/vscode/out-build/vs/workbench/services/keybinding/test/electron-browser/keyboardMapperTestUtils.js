 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "assert", "vs/base/common/path", "fs", "vs/base/test/node/testUtils", "vs/base/node/pfs"], function (require, exports, assert, path, fs_1, testUtils_1, pfs_1) {
    "use strict";
    ...
    function readRawMapping(file) {
        return fs_1.promises.readFile((0, testUtils_1.getPathFromAmdModule)(require, `vs/workbench/services/keybinding/test/electron-browser/${file}.js`)).then((buff) => {
    ...
    function assertMapping(writeFileIfDifferent, mapper, file) {
        ...
        return fs_1.promises.readFile(filePath).then((buff) => {
            ...
            if (actual !== expected && writeFileIfDifferent) {
                ...
                (0, pfs_1.writeFile)(destPath, actual);
            }
            assert.deepStrictEqual(actual, expected);
        });
    }
