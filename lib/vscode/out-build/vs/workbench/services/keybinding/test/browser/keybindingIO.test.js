define(["require", "exports", "assert", "vs/base/common/keyCodes", "vs/base/common/keybindingParser", "vs/base/common/scanCode", "vs/platform/keybinding/common/usLayoutResolvedKeybinding", "vs/workbench/services/keybinding/common/keybindingIO"], function (require, exports, assert, keyCodes_1, keybindingParser_1, scanCode_1, usLayoutResolvedKeybinding_1, keybindingIO_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    suite('keybindingIO', () => {
        test('serialize/deserialize', () => {
            function testOneSerialization(keybinding, expected, msg, OS) {
                let usLayoutResolvedKeybinding = new usLayoutResolvedKeybinding_1.USLayoutResolvedKeybinding((0, keyCodes_1.createKeybinding)(keybinding, OS), OS);
            ...
            function testOneDeserialization(keybinding, _expected, msg, OS) {
                ...
                let expected = (0, keyCodes_1.createKeybinding)(_expected, OS);
            ...
            // chords
            testRoundtrip((0, keyCodes_1.KeyChord)(2048 /* CtrlCmd */ | 31 /* KEY_A */, 2048 /* CtrlCmd */ | 31 /* KEY_A */), 'ctrl+a ctrl+a', 'cmd+a cmd+a', 'ctrl+a ctrl+a');
            testRoundtrip((0, keyCodes_1.KeyChord)(2048 /* CtrlCmd */ | 16 /* UpArrow */, 2048 /* CtrlCmd */ | 16 /* UpArrow */), 'ctrl+up ctrl+up', 'cmd+up cmd+up', 'ctrl+up ctrl+up');
            // OEM keys
        ...
        test('deserialize scan codes', () => {
            assert.deepStrictEqual(keybindingParser_1.KeybindingParser.parseUserBinding('ctrl+shift+[comma] ctrl+/'), [new scanCode_1.ScanCodeBinding(true, true, false, false, 60 /* Comma */), new keyCodes_1.SimpleKeybinding(true, false, false, false, 85 /* US_SLASH */)]);
        });
