...
define(["require", "exports", "vs/base/common/keyCodes", "vs/base/common/scanCode", "vs/platform/keybinding/common/baseResolvedKeybinding"], function (require, exports, keyCodes_1, scanCode_1, baseResolvedKeybinding_1) {
    ...
    class NativeResolvedKeybinding extends baseResolvedKeybinding_1.BaseResolvedKeybinding {
        ...
        _isWYSIWYG(binding) {
            ...
            if (scanCode_1.IMMUTABLE_CODE_TO_KEY_CODE[binding.scanCode] !== -1 /* DependsOnKbLayout */) {
                return true;
            }
        ...
        _getSingleModifierDispatchPart(keybinding) {
            if ((keybinding.scanCode === 157 /* ControlLeft */ || keybinding.scanCode === 161 /* ControlRight */) && !keybinding.shiftKey && !keybinding.altKey && !keybinding.metaKey) {
                return 'ctrl';
            }
            if ((keybinding.scanCode === 159 /* AltLeft */ || keybinding.scanCode === 163 /* AltRight */) && !keybinding.ctrlKey && !keybinding.shiftKey && !keybinding.metaKey) {
                return 'alt';
            }
            if ((keybinding.scanCode === 158 /* ShiftLeft */ || keybinding.scanCode === 162 /* ShiftRight */) && !keybinding.ctrlKey && !keybinding.altKey && !keybinding.metaKey) {
                return 'shift';
            }
            if ((keybinding.scanCode === 160 /* MetaLeft */ || keybinding.scanCode === 164 /* MetaRight */) && !keybinding.ctrlKey && !keybinding.shiftKey && !keybinding.altKey) {
                return 'meta';
            }
            return null;
        }
    ...
    class MacLinuxKeyboardMapper {
        constructor(isUSStandard, rawMappings, OS) {
            ...
            for (let scanCode = 0 /* None */; scanCode < 193 /* MAX_VALUE */; scanCode++) {
                ...
                if (keyCode !== -1 /* DependsOnKbLayout */) {
            ...
            const missingLatinLettersOverride = {};
            {
                ...
                for (let strScanCode in rawMappings) {
                    if (rawMappings.hasOwnProperty(strScanCode)) {
                        ...
                        if (scanCode_1.IMMUTABLE_CODE_TO_KEY_CODE[scanCode] !== -1 /* DependsOnKbLayout */) {
                            continue;
                        }
        ...
        getUserSettingsLabelForScanCodeBinding(binding) {
            ...
            if (constantKeyCode !== -1 /* DependsOnKbLayout */) {
        ...
        getElectronAcceleratorLabelForScanCodeBinding(binding) {
            ...
            if (this._OS === 2 /* Macintosh */ && binding.ctrlKey && !binding.metaKey && !binding.altKey && constantKeyCode === 83 /* US_MINUS */) {
        ...
        resolveKeyboardEvent(keyboardEvent) {
            ...
            if ((keyCode === 15 /* LeftArrow */)
                ...
                if (immutableScanCode !== -1 /* DependsOnKbLayout */) {
