...
define(["require", "exports", "vs/nls!vs/workbench/services/mode/common/workbenchModeService", "vs/base/common/mime", "vs/base/common/resources", "vs/editor/common/modes/modesRegistry", "vs/editor/common/services/modeService", "vs/editor/common/services/modeServiceImpl", "vs/platform/configuration/common/configuration", "vs/platform/environment/common/environment", "vs/platform/files/common/files", "vs/workbench/services/extensions/common/extensions", "vs/workbench/services/extensions/common/extensionsRegistry", "vs/platform/instantiation/common/extensions"], function (require, exports, nls, mime, resources, modesRegistry_1, modeService_1, modeServiceImpl_1, configuration_1, environment_1, files_1, extensions_1, extensionsRegistry_1, extensions_2) {
            ...
            exports.languagesExtPoint.setHandler((extensions) => {
                ...
                for (let i = 0, len = extensions.length; i < len; i++) {
                    ...
                    if (!Array.isArray(extension.value)) {
                        extension.collector.error(nls.localize(9, null, exports.languagesExtPoint.name));
                        continue;
                    }
    ...
    function isValidLanguageExtensionPoint(value, collector) {
        if (!value) {
            collector.error(nls.localize(10, null, exports.languagesExtPoint.name));
            return false;
        }
        if (typeof value.id !== 'string') {
            collector.error(nls.localize(11, null, 'id'));
            return false;
        }
        if (!isUndefinedOrStringArray(value.extensions)) {
            collector.error(nls.localize(12, null, 'extensions'));
            return false;
        }
        if (!isUndefinedOrStringArray(value.filenames)) {
            collector.error(nls.localize(13, null, 'filenames'));
            return false;
        }
        if (typeof value.firstLine !== 'undefined' && typeof value.firstLine !== 'string') {
            collector.error(nls.localize(14, null, 'firstLine'));
            return false;
        }
        if (typeof value.configuration !== 'undefined' && typeof value.configuration !== 'string') {
            collector.error(nls.localize(15, null, 'configuration'));
            return false;
        }
        if (!isUndefinedOrStringArray(value.aliases)) {
            collector.error(nls.localize(16, null, 'aliases'));
            return false;
        }
        if (!isUndefinedOrStringArray(value.mimetypes)) {
            collector.error(nls.localize(17, null, 'mimetypes'));
            return false;
        }
        return true;
    }
    (0, extensions_2.registerSingleton)(modeService_1.IModeService, WorkbenchModeServiceImpl);
});
