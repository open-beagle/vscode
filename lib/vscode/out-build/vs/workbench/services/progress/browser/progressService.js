        ...
        updateWindowProgress(idx = 0) {
            ...
            if (idx < this.windowProgressStack.length) {
                ...
                if (this.windowProgressStatusEntry) {
                    ...
                    this.windowProgressStatusEntry = this.statusbarService.addEntry(statusEntryProperties, 'status.progress', (0, nls_1.localize)(4, null), 0 /* LEFT */);
                }
            }
        ...
        withNotificationProgress(options, callback, onDidCancel) {
            ...
            const createWindowProgress = () => {
                ...
                this.withWindowProgress({
                    ...
                    event_1.Event.once(progressStateModel.onWillDispose)(() => promiseResolve());
                    return promise;
                });
                // Dispose means completing our promise
                return (0, lifecycle_1.toDisposable)(() => promiseResolve());
            };
