...
define(["require", "exports", "vs/workbench/common/views", "vs/platform/contextkey/common/contextkey", "vs/platform/storage/common/storage", "vs/workbench/services/extensions/common/extensions", "vs/platform/registry/common/platform", "vs/base/common/lifecycle", "vs/workbench/browser/parts/views/viewPaneContainer", "vs/platform/instantiation/common/descriptors", "vs/platform/instantiation/common/extensions", "vs/base/common/event", "vs/platform/telemetry/common/telemetry", "vs/base/common/uuid", "vs/platform/instantiation/common/instantiation", "vs/workbench/services/views/common/viewContainerModel", "vs/platform/actions/common/actions", "vs/nls!vs/workbench/services/views/browser/viewDescriptorService"], function (require, exports, views_1, contextkey_1, storage_1, extensions_1, platform_1, lifecycle_1, viewPaneContainer_1, descriptors_1, extensions_2, event_1, telemetry_1, uuid_1, instantiation_1, viewContainerModel_1, actions_1, nls_1) {
    ...
    let ViewDescriptorService = class ViewDescriptorService extends lifecycle_1.Disposable {
        ...
        moveViews(views, from, to, visibilityState = views_1.ViewVisibilityState.Expand) {
            ...
            const fromLocation = oldLocation === 1 /* Panel */ ? 'panel' : 'sidebar';
            const toLocation = newLocation === 1 /* Panel */ ? 'panel' : 'sidebar';
        ...
        cleanUpViewContainer(viewContainerId) {
            ...
            this.storageService.remove((0, viewContainerModel_1.getViewsStateStorageId)((viewContainer === null || viewContainer === void 0 ? void 0 : viewContainer.storageId) || getViewContainerStorageId(viewContainerId)), 0 /* GLOBAL */);
        }
        registerGeneratedViewContainer(location, existingId) {
            ...
            const container = this.viewContainersRegistry.registerViewContainer({
                ...
                title: id,
                icon: location === 0 /* Sidebar */ ? views_1.defaultViewIcon : undefined,
        ...
        generateContainerId(location) {
            return `${ViewDescriptorService.COMMON_CONTAINER_ID_PREFIX}.${location === 1 /* Panel */ ? 'panel' : 'sidebar'}.${(0, uuid_1.generateUuid)()}`;
        }
        ...
        setStoredCachedViewPositionsValue(value) {
            this.storageService.store(ViewDescriptorService.CACHED_VIEW_POSITIONS, value, 0 /* GLOBAL */, 0 /* USER */);
        }
        ...
        setStoredCachedViewContainerLocationsValue(value) {
            this.storageService.store(ViewDescriptorService.CACHED_VIEW_CONTAINER_LOCATIONS, value, 0 /* GLOBAL */, 0 /* USER */);
        }
                    ...
                    disposables === null || disposables === void 0 ? void 0 : disposables.add((0, actions_1.registerAction2)(class extends viewPaneContainer_1.ViewPaneContainerAction {
                        constructor() {
                            super({
                                ...
                                precondition: viewDescriptor.canToggleVisibility && (!viewContainerModel.isVisible(viewDescriptor.id) || viewContainerModel.visibleViewDescriptors.length > 1) ? contextkey_1.ContextKeyTrueExpr.INSTANCE : contextkey_1.ContextKeyFalseExpr.INSTANCE,
                                toggled: contextkey_1.ContextKeyDefinedExpr.create(`${viewDescriptor.id}.visible`),
                                title: viewDescriptor.name,
                                menu: [{
                                        id: viewPaneContainer_1.ViewsSubMenu,
                                        group: '1_toggleViews',
                                        when: contextkey_1.ContextKeyAndExpr.create([
                                            contextkey_1.ContextKeyEqualsExpr.create('viewContainer', viewContainerModel.viewContainer.id),
                                            contextkey_1.ContextKeyEqualsExpr.create('viewContainerLocation', (0, views_1.ViewContainerLocationToString)(0 /* Sidebar */)),
                                        ]),
                                        order: index,
                                    }, {
                                        ...
                                        when: contextkey_1.ContextKeyAndExpr.create([
                                            viewContainerModel.visibleViewDescriptors.length > 1 ? contextkey_1.ContextKeyOrExpr.create(viewContainerModel.visibleViewDescriptors.map(v => contextkey_1.ContextKeyEqualsExpr.create('view', v.id))) : contextkey_1.ContextKeyFalseExpr.INSTANCE
                                        ]),
                                        order: index,
                        ...
                        constructor() {
                            super({
                                ...
                                menu: [{
                                        id: actions_1.MenuId.ViewTitleContext,
                                        when: contextkey_1.ContextKeyAndExpr.create([
                                            contextkey_1.ContextKeyEqualsExpr.create('view', viewDescriptor.id),
                                            contextkey_1.ContextKeyDefinedExpr.create(`${viewDescriptor.id}.visible`),
                                        ]),
                                        group: '1_hide',
                                        order: 1
                                    }]
