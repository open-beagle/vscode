...
define(["require", "exports", "vs/nls!vs/workbench/services/themes/browser/fileIconThemeData", "vs/base/common/path", "vs/base/common/resources", "vs/base/common/json", "vs/workbench/services/themes/common/workbenchThemeService", "vs/base/common/jsonErrorMessages", "vs/base/browser/dom"], function (require, exports, nls, Paths, resources, Json, workbenchThemeService_1, jsonErrorMessages_1, dom_1) {
    ...
    class FileIconThemeData {
        ...
        static fromStorageData(storageService) {
            const input = storageService.get(FileIconThemeData.STORAGE_KEY, 0 /* GLOBAL */);
            if (!input) {
                return undefined;
            }
            try {
        ...
        toStorage(storageService) {
            ...
            storageService.store(FileIconThemeData.STORAGE_KEY, data, 0 /* GLOBAL */, 1 /* MACHINE */);
        }
    }
    ...
    function _loadIconThemeDocument(fileService, location) {
        return fileService.readFile(location).then((content) => {
            ...
            if (errors.length > 0) {
                return Promise.reject(new Error(nls.localize(0, null, errors.map(e => (0, jsonErrorMessages_1.getParseErrorMessage)(e.error)).join(', '))));
            }
    ...
    function _processIconThemeDocument(id, iconThemeDocumentLocation, iconThemeDocument) {
        ...
        if (Array.isArray(fonts)) {
            fonts.forEach(font => {
                let src = font.src.map(l => `${(0, dom_1.asCSSUrl)(resolvePath(l.path))} format('${l.format}')`).join(', ');
