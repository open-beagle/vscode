...
define(["require", "exports", "vs/nls!vs/workbench/services/themes/browser/workbenchThemeService", "vs/base/common/types", "vs/workbench/services/extensions/common/extensions", "vs/workbench/services/themes/common/workbenchThemeService", "vs/platform/storage/common/storage", "vs/platform/telemetry/common/telemetry", "vs/platform/registry/common/platform", "vs/base/common/errors", "vs/platform/configuration/common/configuration", "vs/workbench/services/themes/common/colorThemeData", "vs/platform/theme/common/themeService", "vs/base/common/event", "vs/workbench/services/themes/common/fileIconThemeSchema", "vs/base/common/lifecycle", "vs/workbench/services/themes/browser/fileIconThemeData", "vs/base/browser/dom", "vs/workbench/services/environment/common/environmentService", "vs/platform/files/common/files", "vs/base/common/resources", "vs/workbench/services/themes/common/colorThemeSchema", "vs/platform/instantiation/common/extensions", "vs/platform/remote/common/remoteHosts", "vs/workbench/services/layout/browser/layoutService", "vs/workbench/services/extensionResourceLoader/common/extensionResourceLoader", "vs/workbench/services/themes/common/themeExtensionPoints", "vs/workbench/services/themes/common/themeConfiguration", "vs/workbench/services/themes/browser/productIconThemeData", "vs/workbench/services/themes/common/productIconThemeSchema", "vs/platform/log/common/log", "vs/base/common/platform", "vs/platform/theme/common/theme", "vs/workbench/services/themes/common/hostColorSchemeService", "vs/base/common/async", "vs/workbench/services/userData/browser/userDataInit", "vs/platform/theme/browser/iconsStyleSheet"], function (require, exports, nls, types, extensions_1, workbenchThemeService_1, storage_1, telemetry_1, platform_1, errors, configuration_1, colorThemeData_1, themeService_1, event_1, fileIconThemeSchema_1, lifecycle_1, fileIconThemeData_1, dom_1, environmentService_1, files_1, resources, colorThemeSchema_1, extensions_2, remoteHosts_1, layoutService_1, extensionResourceLoader_1, themeExtensionPoints_1, themeConfiguration_1, productIconThemeData_1, productIconThemeSchema_1, log_1, platform_2, theme_1, hostColorSchemeService_1, async_1, userDataInit_1, iconsStyleSheet_1) {
    ...
    let WorkbenchThemeService = class WorkbenchThemeService {
        constructor(extensionService, storageService, configurationService, telemetryService, environmentService, fileService, extensionResourceLoaderService, layoutService, logService, hostColorService, userDataInitializationService) {
            var _a;
            ...
            if (preferredColorScheme && (themeData === null || themeData === void 0 ? void 0 : themeData.type) !== preferredColorScheme && this.storageService.get(PERSISTED_OS_COLOR_SCHEME, 0 /* GLOBAL */) !== preferredColorScheme) {
        ...
        initialize() {
            ...
            const initializeColorTheme = async () => {
                ...
                const preferredColorScheme = this.getPreferredColorScheme();
                const prevScheme = this.storageService.get(PERSISTED_OS_COLOR_SCHEME, 0 /* GLOBAL */);
                if (preferredColorScheme !== prevScheme) {
                    this.storageService.store(PERSISTED_OS_COLOR_SCHEME, preferredColorScheme, 0 /* GLOBAL */, 0 /* USER */);
        ...
        installConfigurationListener() {
            this.configurationService.onDidChangeConfiguration(e => {
                ...
                if (e.affectsConfiguration(workbenchThemeService_1.ThemeSettings.PREFERRED_DARK_THEME) && this.getPreferredColorScheme() === theme_1.ColorScheme.DARK) {
                    this.applyPreferredColorTheme(theme_1.ColorScheme.DARK);
                }
                if (e.affectsConfiguration(workbenchThemeService_1.ThemeSettings.PREFERRED_LIGHT_THEME) && this.getPreferredColorScheme() === theme_1.ColorScheme.LIGHT) {
                    this.applyPreferredColorTheme(theme_1.ColorScheme.LIGHT);
                }
                if (e.affectsConfiguration(workbenchThemeService_1.ThemeSettings.PREFERRED_HC_THEME) && this.getPreferredColorScheme() === theme_1.ColorScheme.HIGH_CONTRAST) {
                    this.applyPreferredColorTheme(theme_1.ColorScheme.HIGH_CONTRAST);
                }
        ...
        async handlePreferredSchemeUpdated() {
            ...
            if (scheme !== prevScheme) {
                this.storageService.store(PERSISTED_OS_COLOR_SCHEME, scheme, 0 /* GLOBAL */, 1 /* MACHINE */);
                if (scheme) {
                    if (!prevScheme) {
        ...
        getPreferredColorScheme() {
            if (this.configurationService.getValue(workbenchThemeService_1.ThemeSettings.DETECT_HC) && this.hostColorService.highContrast) {
                return theme_1.ColorScheme.HIGH_CONTRAST;
            }
        ...
        async applyPreferredColorTheme(type) {
            const settingId = type === theme_1.ColorScheme.DARK ? workbenchThemeService_1.ThemeSettings.PREFERRED_DARK_THEME : type === theme_1.ColorScheme.LIGHT ? workbenchThemeService_1.ThemeSettings.PREFERRED_LIGHT_THEME : workbenchThemeService_1.ThemeSettings.PREFERRED_HC_THEME;
        ...
        setColorTheme(themeId, settingsTarget) {
            return this.colorThemeSequencer.queue(() => {
                ...
                return themeData.ensureLoaded(this.extensionResourceLoaderService).then(_ => {
                    ...
                    var _a;
                    return Promise.reject(new Error(nls.localize(0, null, (_a = themeData.location) === null || _a === void 0 ? void 0 : _a.toString(), error.message)));
                });
            });
        }
        ...
        applyTheme(newTheme, settingsTarget, silent = false) {
            ...
            if (this.currentColorTheme.id) {
                ...
                this.container.classList.remove(workbenchThemeService_1.VS_DARK_THEME, workbenchThemeService_1.VS_LIGHT_THEME, workbenchThemeService_1.VS_HC_THEME);
            }
        ...
        async setFileIconTheme(iconTheme, settingsTarget) {
            return this.fileIconThemeSequencer.queue(async () => {
                ...
                const newThemeData = this.fileIconThemeRegistry.findThemeById(iconTheme) || fileIconThemeData_1.FileIconThemeData.noIconTheme;
                await newThemeData.ensureLoaded(this.fileService);
                this.applyAndSetFileIconTheme(newThemeData);
                // remember theme data for a quick restore
                if (newThemeData.isLoaded && (!newThemeData.location || !(0, remoteHosts_1.getRemoteAuthority)(newThemeData.location))) {
        ...
        async setProductIconTheme(iconTheme, settingsTarget) {
            return this.productIconThemeSequencer.queue(async () => {
                ...
                const newThemeData = this.productIconThemeRegistry.findThemeById(iconTheme) || productIconThemeData_1.ProductIconThemeData.defaultTheme;
