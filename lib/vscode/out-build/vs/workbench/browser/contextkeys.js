...
define(["require", "exports", "vs/nls!vs/workbench/browser/contextkeys", "vs/base/common/event", "vs/base/common/lifecycle", "vs/platform/contextkey/common/contextkey", "vs/platform/contextkey/common/contextkeys", "vs/workbench/common/editor", "vs/base/browser/dom", "vs/workbench/services/editor/common/editorGroupsService", "vs/platform/configuration/common/configuration", "vs/workbench/services/environment/common/environmentService", "vs/workbench/services/editor/common/editorService", "vs/platform/workspace/common/workspace", "vs/workbench/common/viewlet", "vs/workbench/services/layout/browser/layoutService", "vs/workbench/services/viewlet/browser/viewlet", "vs/workbench/common/panel", "vs/platform/remote/common/remoteHosts", "vs/workbench/services/workingCopy/common/workingCopyService", "vs/base/common/platform"], function (require, exports, nls_1, event_1, lifecycle_1, contextkey_1, contextkeys_1, editor_1, dom_1, editorGroupsService_1, configuration_1, environmentService_1, editorService_1, workspace_1, viewlet_1, layoutService_1, viewlet_2, panel_1, remoteHosts_1, workingCopyService_1, platform_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.WorkbenchContextKeysHandler = exports.HasWebFileSystemAccess = exports.IsFullscreenContext = exports.VirtualWorkspaceContext = exports.RemoteNameContext = exports.DirtyWorkingCopiesContext = exports.EmptyWorkspaceSupportContext = exports.WorkspaceFolderCountContext = exports.WorkbenchStateContext = void 0;
    exports.WorkbenchStateContext = new contextkey_1.RawContextKey('workbenchState', undefined, { type: 'string', description: (0, nls_1.localize)(0, null) });
    exports.WorkspaceFolderCountContext = new contextkey_1.RawContextKey('workspaceFolderCount', 0, (0, nls_1.localize)(1, null));
    exports.EmptyWorkspaceSupportContext = new contextkey_1.RawContextKey('emptyWorkspaceSupport', true, true);
    exports.DirtyWorkingCopiesContext = new contextkey_1.RawContextKey('dirtyWorkingCopies', false, (0, nls_1.localize)(2, null));
    exports.RemoteNameContext = new contextkey_1.RawContextKey('remoteName', '', (0, nls_1.localize)(3, null));
    exports.VirtualWorkspaceContext = new contextkey_1.RawContextKey('virtualWorkspace', '', (0, nls_1.localize)(4, null));
    exports.IsFullscreenContext = new contextkey_1.RawContextKey('isFullscreen', false, (0, nls_1.localize)(5, null));
    // Support for FileSystemAccess web APIs (https://wicg.github.io/file-system-access)
    exports.HasWebFileSystemAccess = new contextkey_1.RawContextKey('hasWebFileSystemAccess', false, true);
    let WorkbenchContextKeysHandler = class WorkbenchContextKeysHandler extends lifecycle_1.Disposable {
        constructor(contextKeyService, contextService, configurationService, environmentService, editorService, editorGroupService, layoutService, viewletService, workingCopyService) {
            ...
            exports.RemoteNameContext.bindTo(this.contextKeyService).set((0, remoteHosts_1.getRemoteName)(this.environmentService.remoteAuthority) || '');
            this.vitualWorkspaceContext = exports.VirtualWorkspaceContext.bindTo(this.contextKeyService);
            this.updateVirtualWorkspaceContextKey();
            // Capabilities
            exports.HasWebFileSystemAccess.bindTo(this.contextKeyService).set(dom_1.WebFileSystemAccess.supported(window));
            // Development
            ...
            this.activeEditorIsReadonly = editor_1.ActiveEditorReadonlyContext.bindTo(this.contextKeyService);
            ...
            // Working Copies
            this.dirtyWorkingCopiesContext = exports.DirtyWorkingCopiesContext.bindTo(this.contextKeyService);
            ...
            this.emptyWorkspaceSupportContext = exports.EmptyWorkspaceSupportContext.bindTo(this.contextKeyService);
            ...
            this.panelVisibleContext = panel_1.PanelVisibleContext.bindTo(this.contextKeyService);
            this.panelVisibleContext.set(this.layoutService.isVisible("workbench.parts.panel" /* PANEL_PART */));
            this.panelMaximizedContext = panel_1.PanelMaximizedContext.bindTo(this.contextKeyService);
        ...
        registerListeners() {
            ...
            this._register(this.layoutService.onDidChangePartVisibility(() => {
                this.editorAreaVisibleContext.set(this.layoutService.isVisible("workbench.parts.editor" /* EDITOR_PART */));
                this.panelVisibleContext.set(this.layoutService.isVisible("workbench.parts.panel" /* PANEL_PART */));
                this.panelMaximizedContext.set(this.layoutService.isPanelMaximized());
            }));
        ...
        updateVirtualWorkspaceContextKey() {
            this.vitualWorkspaceContext.set((0, remoteHosts_1.getVirtualWorkspaceScheme)(this.contextService.getWorkspace()) || '');
        }
    };
