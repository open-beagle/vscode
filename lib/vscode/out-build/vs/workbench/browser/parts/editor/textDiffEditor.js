...
define(["require", "exports", "vs/nls!vs/workbench/browser/parts/editor/textDiffEditor", "vs/base/common/objects", "vs/base/common/types", "vs/workbench/browser/parts/editor/textEditor", "vs/workbench/common/editor", "vs/workbench/common/editor/diffEditorInput", "vs/editor/browser/widget/diffNavigator", "vs/editor/browser/widget/diffEditorWidget", "vs/workbench/common/editor/textDiffEditorModel", "vs/platform/telemetry/common/telemetry", "vs/platform/storage/common/storage", "vs/editor/common/services/textResourceConfigurationService", "vs/platform/instantiation/common/instantiation", "vs/platform/theme/common/themeService", "vs/base/common/lifecycle", "vs/platform/registry/common/platform", "vs/base/common/uri", "vs/workbench/services/editor/common/editorGroupsService", "vs/workbench/services/editor/common/editorService", "vs/platform/editor/common/editor", "vs/platform/contextkey/common/contextkey", "vs/base/common/resources", "vs/base/browser/dom", "vs/platform/files/common/files"], function (require, exports, nls_1, objects_1, types_1, textEditor_1, editor_1, diffEditorInput_1, diffNavigator_1, diffEditorWidget_1, textDiffEditorModel_1, telemetry_1, storage_1, textResourceConfigurationService_1, instantiation_1, themeService_1, lifecycle_1, platform_1, uri_1, editorGroupsService_1, editorService_1, editor_2, contextkey_1, resources_1, dom_1, files_1) {
    ...
    let TextDiffEditor = class TextDiffEditor extends textEditor_1.BaseTextEditor {
        ...
        onDidFileSystemProviderChange(scheme) {
            ...
            if (control && input instanceof diffEditorInput_1.DiffEditorInput) {
                if (((_a = input.originalInput.resource) === null || _a === void 0 ? void 0 : _a.scheme) === scheme || ((_b = input.modifiedInput.resource) === null || _b === void 0 ? void 0 : _b.scheme) === scheme) {
        ...
        openAsBinary(input, options) {
            ...
            if (input instanceof diffEditorInput_1.DiffEditorInput) {
                ...
                const binaryDiffInput = this.instantiationService.createInstance(diffEditorInput_1.DiffEditorInput, input.getName(), input.getDescription(), originalInput, modifiedInput, true);
                // Forward binary flag to input if supported
                const fileEditorInputFactory = platform_1.Registry.as(editor_1.EditorExtensions.EditorInputFactories).getFileEditorInputFactory();
        ...
        retrieveTextDiffEditorViewState(resource) {
            const control = (0, types_1.assertIsDefined)(this.getControl());
