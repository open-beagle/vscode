...
define(["require", "exports", "vs/base/browser/dnd", "vs/base/browser/dom", "vs/base/browser/mouseEvent", "vs/base/browser/ui/actionbar/actionbar", "vs/base/browser/ui/toolbar/toolbar", "vs/base/common/lifecycle", "vs/editor/browser/editorBrowser", "vs/nls!vs/workbench/browser/parts/editor/titleControl", "vs/platform/actions/browser/menuEntryActionViewItem", "vs/platform/actions/common/actions", "vs/platform/configuration/common/configuration", "vs/platform/contextkey/common/contextkey", "vs/platform/contextview/browser/contextView", "vs/platform/instantiation/common/instantiation", "vs/platform/keybinding/common/keybinding", "vs/platform/notification/common/notification", "vs/platform/quickinput/common/quickInput", "vs/platform/telemetry/common/telemetry", "vs/platform/theme/common/colorRegistry", "vs/platform/theme/common/themeService", "vs/workbench/browser/dnd", "vs/workbench/browser/parts/editor/editorPane", "vs/workbench/browser/parts/editor/breadcrumbs", "vs/workbench/browser/parts/editor/breadcrumbsControl", "vs/workbench/common/editor", "vs/workbench/common/resources", "vs/platform/files/common/files", "vs/base/common/types", "vs/base/browser/browser", "vs/base/common/errors", "vs/css!./media/titlecontrol"], function (require, exports, dnd_1, dom_1, mouseEvent_1, actionbar_1, toolbar_1, lifecycle_1, editorBrowser_1, nls_1, menuEntryActionViewItem_1, actions_1, configuration_1, contextkey_1, contextView_1, instantiation_1, keybinding_1, notification_1, quickInput_1, telemetry_1, colorRegistry_1, themeService_1, dnd_2, editorPane_1, breadcrumbs_1, breadcrumbsControl_1, editor_1, resources_1, files_1, types_1, browser_1, errors_1) {
    "use strict";
    ...
    let TitleControl = class TitleControl extends themeService_1.Themable {
        constructor(parent, accessor, group, contextMenuService, instantiationService, contextKeyService, keybindingService, telemetryService, notificationService, menuService, quickInputService, themeService, configurationService, fileService) {
            ...
            this.editorPinnedContext = editor_1.ActiveEditorPinnedContext.bindTo(contextKeyService);
            this.editorStickyContext = editor_1.ActiveEditorStickyContext.bindTo(contextKeyService);
        ...
        prepareEditorActions(editorActions) {
            ...
            if (this.accessor.activeGroup === this.group) {
                primaryEditorActions = (0, actionbar_1.prepareActions)(editorActions.primary);
            }
            else {
                primaryEditorActions = [];
            }
            // Secondary actions for all groups
            secondaryEditorActions = (0, actionbar_1.prepareActions)(editorActions.secondary);
        ...
        getEditorActions() {
            ...
            this.contextKeyService.bufferChangeEvents(() => {
                this.resourceContext.set((0, types_1.withUndefinedAsNull)(editor_1.EditorResourceAccessor.getOriginalUri(this.group.activeEditor, { supportSideBySide: editor_1.SideBySideEditor.PRIMARY })));
            ...
            if (activeEditorPane instanceof editorPane_1.EditorPane) {
                ...
                const titleBarMenu = this.menuService.createMenu(actions_1.MenuId.EditorTitle, scopedContextKeyService, true);
            ...
            this._register((0, dom_1.addDisposableListener)(element, dom_1.EventType.DRAG_START, e => {
                ...
                if (this.group.activeEditor) {
                    ...
                    if (this.accessor.partOptions.showTabs && this.group.count > 1) {
                        label = (0, nls_1.localize)(1, null, label, this.group.count - 1);
                    }
            ...
            const editorOptions = {
                viewState: (() => {
                    ...
                    if (this.group.activeEditor === editor) {
                        ...
                        if ((0, editorBrowser_1.isCodeEditor)(activeControl)) {
                            return (0, types_1.withNullAsUndefined)(activeControl.saveViewState());
                        }
                    }
                    return undefined;
                })(),
