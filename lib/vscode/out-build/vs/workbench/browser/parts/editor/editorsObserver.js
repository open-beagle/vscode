...
define(["require", "exports", "vs/workbench/common/editor", "vs/base/common/lifecycle", "vs/platform/storage/common/storage", "vs/platform/registry/common/platform", "vs/base/common/event", "vs/workbench/services/editor/common/editorGroupsService", "vs/base/common/arrays", "vs/base/common/map", "vs/base/common/objects"], function (require, exports, editor_1, lifecycle_1, storage_1, platform_1, event_1, editorGroupsService_1, arrays_1, map_1, objects_1) {
    ...
    let EditorsObserver = class EditorsObserver extends lifecycle_1.Disposable {
        ...
        hasEditor(editor) {
            ...
            return (_a = editors === null || editors === void 0 ? void 0 : editors.has(editor.typeId)) !== null && _a !== void 0 ? _a : false;
        }
        hasEditors(resource) {
        ...
        updateEditorResourcesMap(editor, add) {
            ...
            if (add) {
                ...
                editorsPerResource.set(typeId, ((_a = editorsPerResource.get(typeId)) !== null && _a !== void 0 ? _a : 0) + 1);
            }
            // Remove entry
            else {
                const editorsPerResource = this.editorsPerResourceCounter.get(resource);
                if (editorsPerResource) {
                    const counter = (_b = editorsPerResource.get(typeId)) !== null && _b !== void 0 ? _b : 0;
                    if (counter > 1) {
        ...
        saveState() {
            if (this.mostRecentEditorsMap.isEmpty()) {
                ...
                this.storageService.store(EditorsObserver.STORAGE_KEY, JSON.stringify(this.serialize()), 1 /* WORKSPACE */, 1 /* MACHINE */);
            }
        }
        serialize() {
            const registry = platform_1.Registry.as(editor_1.EditorExtensions.EditorInputFactories);
