...
define(["require", "exports", "vs/workbench/browser/dnd", "vs/base/browser/dom", "vs/workbench/browser/parts/editor/editor", "vs/workbench/common/theme", "vs/platform/theme/common/themeService", "vs/platform/theme/common/colorRegistry", "vs/workbench/common/editor", "vs/base/common/platform", "vs/workbench/services/editor/common/editorGroupsService", "vs/base/common/lifecycle", "vs/platform/instantiation/common/instantiation", "vs/base/common/async", "vs/base/browser/dnd", "vs/base/common/buffer", "vs/platform/dialogs/common/dialogs", "vs/base/common/resources", "vs/workbench/services/editor/common/editorService", "vs/base/common/types", "vs/platform/notification/common/notification", "vs/nls!vs/workbench/browser/parts/editor/editorDropTarget", "vs/platform/files/common/files", "vs/css!./media/editordroptarget"], function (require, exports, dnd_1, dom_1, editor_1, theme_1, themeService_1, colorRegistry_1, editor_2, platform_1, editorGroupsService_1, lifecycle_1, instantiation_1, async_1, dnd_2, buffer_1, dialogs_1, resources_1, editorService_1, types_1, notification_1, nls_1, files_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.EditorDropTarget = void 0;
    let DropOverlay = class DropOverlay extends themeService_1.Themable {
        constructor(accessor, groupView, themeService, instantiationService, fileDialogService, editorService, notificationService, editorGroupService) {
            super(themeService);
        ...
        handleDrop(event, splitDirection) {
            ...
            // Check for editor transfer
                ...
                if (Array.isArray(data)) {
                    ...
                    if (sourceGroup) {
                        ...
                        const options = (0, editor_1.getActiveTextEditorOptions)(sourceGroup, draggedEditor.editor, editor_2.EditorOptions.create({
                            pinned: true,
            ...
            else if (platform_1.isWeb && (0, dnd_1.containsDragType)(event, dnd_2.DataTransfers.FILES)) {
                    ...
                    for (let i = 0; i < files.length; i++) {
                        ...
                        if (file) {
                            ...
                            if (file.size > DropOverlay.MAX_FILE_UPLOAD_SIZE) {
                                this.notificationService.warn((0, nls_1.localize)(0, null));
                                continue;
                            }
                            ...
                            reader.onload = async (event) => {
                                ...
                                if (typeof name === 'string' && ((_a = event.target) === null || _a === void 0 ? void 0 : _a.result) instanceof ArrayBuffer) {
                                    ...
                                    if (defaultFilePath) {
                                        proposedFilePath = (0, resources_1.joinPath)(defaultFilePath, name);
                                    }
        ...
        isCopyOperation(e, draggedEditor) {
            if ((draggedEditor === null || draggedEditor === void 0 ? void 0 : draggedEditor.editor) instanceof editor_2.EditorInput && !draggedEditor.editor.canSplit()) {
                return false;
            }
    ...
    DropOverlay.MAX_FILE_UPLOAD_SIZE = 100 * files_1.ByteSize.MB;
