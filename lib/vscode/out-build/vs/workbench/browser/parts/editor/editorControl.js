...
define(["require", "exports", "vs/base/common/lifecycle", "vs/workbench/common/editor", "vs/base/browser/dom", "vs/platform/registry/common/platform", "vs/workbench/services/layout/browser/layoutService", "vs/platform/instantiation/common/instantiation", "vs/platform/progress/common/progress", "vs/workbench/browser/parts/editor/editor", "vs/base/common/event", "vs/base/common/types"], function (require, exports, lifecycle_1, editor_1, dom_1, platform_1, layoutService_1, instantiation_1, progress_1, editor_2, event_1, types_1) {
    ...
    let EditorControl = class EditorControl extends lifecycle_1.Disposable {
        ...
        async openEditor(editor, options, context) {
            // Editor pane
            const descriptor = platform_1.Registry.as(editor_1.EditorExtensions.Editors).getEditor(editor);
            if (!descriptor) {
