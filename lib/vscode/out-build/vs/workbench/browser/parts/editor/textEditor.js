...
define(["require", "exports", "vs/nls!vs/workbench/browser/parts/editor/textEditor", "vs/base/common/objects", "vs/base/common/event", "vs/base/common/types", "vs/editor/browser/widget/codeEditorWidget", "vs/workbench/common/editor", "vs/workbench/browser/editor", "vs/workbench/browser/parts/editor/editorPane", "vs/platform/storage/common/storage", "vs/platform/instantiation/common/instantiation", "vs/platform/telemetry/common/telemetry", "vs/platform/theme/common/themeService", "vs/editor/common/services/textResourceConfigurationService", "vs/editor/browser/editorBrowser", "vs/workbench/services/editor/common/editorGroupsService", "vs/workbench/services/editor/common/editorService", "vs/base/common/lifecycle", "vs/platform/contextkey/common/contextkey"], function (require, exports, nls_1, objects_1, event_1, types_1, codeEditorWidget_1, editor_1, editor_2, editorPane_1, storage_1, instantiation_1, telemetry_1, themeService_1, textResourceConfigurationService_1, editorBrowser_1, editorGroupsService_1, editorService_1, lifecycle_1, contextkey_1) {
    "use strict";
     ...
     */
    let BaseTextEditor = class BaseTextEditor extends editorPane_1.EditorPane {
        ...
        computeAriaLabel() {
            return this._input ? (0, editor_2.computeEditorAriaLabel)(this._input, undefined, this.group, this.editorGroupService.count) : (0, nls_1.localize)(0, null);
        }
        ...
        setOptions(options) {
            ...
            if (textOptions && (0, types_1.isFunction)(textOptions.apply)) {
        ...
        getViewState() {
            ...
            if (resource) {
                return (0, types_1.withNullAsUndefined)(this.retrieveTextEditorViewState(resource));
            }
            return undefined;
        }
        saveTextEditorViewState(resource, cleanUpOnDispose) {
        ...
        shouldRestoreTextEditorViewState(editor, context) {
            // new editor: check with workbench.editor.restoreViewState setting
            if (context === null || context === void 0 ? void 0 : context.newInGroup) {
                return this.textResourceConfigurationService.getValue(editor_1.EditorResourceAccessor.getOriginalUri(editor, { supportSideBySide: editor_1.SideBySideEditor.PRIMARY }), 'workbench.editor.restoreViewState') === false ? false : true /* restore by default */;
            }
