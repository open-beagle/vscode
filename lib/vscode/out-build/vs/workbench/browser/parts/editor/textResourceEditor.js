...
define(["require", "exports", "vs/nls!vs/workbench/browser/parts/editor/textResourceEditor", "vs/base/common/types", "vs/editor/browser/editorBrowser", "vs/workbench/common/editor/resourceEditorInput", "vs/workbench/common/editor/textEditorModel", "vs/workbench/services/untitled/common/untitledTextEditorInput", "vs/workbench/browser/parts/editor/textEditor", "vs/platform/telemetry/common/telemetry", "vs/platform/storage/common/storage", "vs/editor/common/services/textResourceConfigurationService", "vs/platform/instantiation/common/instantiation", "vs/platform/theme/common/themeService", "vs/workbench/services/editor/common/editorGroupsService", "vs/workbench/services/editor/common/editorService", "vs/editor/common/services/modelService", "vs/editor/common/services/modeService", "vs/editor/common/modes/modesRegistry"], function (require, exports, nls_1, types_1, editorBrowser_1, resourceEditorInput_1, textEditorModel_1, untitledTextEditorInput_1, textEditor_1, telemetry_1, storage_1, textResourceConfigurationService_1, instantiation_1, themeService_1, editorGroupsService_1, editorService_1, modelService_1, modeService_1, modesRegistry_1) {
    "use strict";
    ...
    let TextResourceEditor = class TextResourceEditor extends AbstractTextResourceEditor {
        ...
        onDidEditorPaste(e, codeEditor) {
            ...
            if (codeEditor.getOption(77 /* readOnly */)) {
            ...
            // the paste changed the first line
                ...
                candidateMode = (0, types_1.withNullAsUndefined)(this.modeService.getModeIdByFilepathOrFirstLine(textModel.uri, textModel.getLineContent(1).substr(0, 1000 /* FIRST_LINE_DETECTION_LENGTH_LIMIT */)));
            }
