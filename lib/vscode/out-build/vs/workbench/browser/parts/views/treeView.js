...
define(["require", "exports", "vs/base/common/lifecycle", "vs/platform/instantiation/common/instantiation", "vs/platform/keybinding/common/keybinding", "vs/platform/contextview/browser/contextView", "vs/platform/actions/common/actions", "vs/platform/contextkey/common/contextkey", "vs/workbench/common/views", "vs/platform/configuration/common/configuration", "vs/platform/theme/common/themeService", "vs/workbench/browser/parts/views/viewPane", "vs/platform/registry/common/platform", "vs/platform/opener/common/opener", "vs/platform/telemetry/common/telemetry", "vs/base/common/event", "vs/base/common/actions", "vs/platform/actions/browser/menuEntryActionViewItem", "vs/platform/notification/common/notification", "vs/platform/progress/common/progress", "vs/workbench/services/extensions/common/extensions", "vs/platform/commands/common/commands", "vs/base/browser/dom", "vs/workbench/browser/labels", "vs/base/browser/ui/actionbar/actionbar", "vs/base/common/uri", "vs/base/common/resources", "vs/platform/files/common/files", "vs/platform/list/browser/listService", "vs/nls!vs/workbench/browser/parts/views/treeView", "vs/base/common/async", "vs/platform/theme/common/colorRegistry", "vs/base/common/types", "vs/platform/label/common/label", "vs/base/common/filters", "vs/base/browser/ui/tree/treeDefaults", "vs/base/common/strings", "vs/workbench/common/theme", "vs/workbench/services/hover/browser/hover", "vs/base/browser/ui/actionbar/actionViewItems", "vs/platform/theme/common/theme", "vs/base/browser/markdownRenderer", "vs/workbench/browser/parts/editor/editorCommands", "vs/base/common/codicons", "vs/base/common/cancellation", "vs/base/common/errors", "vs/css!./media/views"], function (require, exports, lifecycle_1, instantiation_1, keybinding_1, contextView_1, actions_1, contextkey_1, views_1, configuration_1, themeService_1, viewPane_1, platform_1, opener_1, telemetry_1, event_1, actions_2, menuEntryActionViewItem_1, notification_1, progress_1, extensions_1, commands_1, DOM, labels_1, actionbar_1, uri_1, resources_1, files_1, listService_1, nls_1, async_1, colorRegistry_1, types_1, label_1, filters_1, treeDefaults_1, strings_1, theme_1, hover_1, actionViewItems_1, theme_2, markdownRenderer_1, editorCommands_1, codicons_1, cancellation_1, errors_1) {
    ...
    let TreeViewPane = class TreeViewPane extends viewPane_1.ViewPane {
        constructor(options, keybindingService, contextMenuService, configurationService, contextKeyService, viewDescriptorService, instantiationService, openerService, themeService, telemetryService) {
            ...
            this._register((0, lifecycle_1.toDisposable)(() => this.treeView.setVisibility(false)));
    ...
    let TreeView = class TreeView extends lifecycle_1.Disposable {
        constructor(id, _title, themeService, instantiationService, commandService, configurationService, progressService, contextMenuService, keybindingService, notificationService, viewDescriptorService, hoverService, contextKeyService) {
            super();
            this.id = id;
            this._title = _title;
            ...
            this.root = new Root();
            this.collapseAllContextKey = new contextkey_1.RawContextKey(`treeView.${this.id}.enableCollapseAll`, false, (0, nls_1.localize)(1, null, this.id));
            this.collapseAllContext = this.collapseAllContextKey.bindTo(contextKeyService);
            this.collapseAllToggleContextKey = new contextkey_1.RawContextKey(`treeView.${this.id}.toggleCollapseAll`, false, (0, nls_1.localize)(2, null, this.id));
            this.collapseAllToggleContext = this.collapseAllToggleContextKey.bindTo(contextKeyService);
            this.refreshContextKey = new contextkey_1.RawContextKey(`treeView.${this.id}.enableRefresh`, false, (0, nls_1.localize)(3, null, this.id));
            ...
            this._register(this.viewDescriptorService.onDidChangeLocation(({ views, from, to }) => {
                ...
                if (views.some(v => v.id === this.id)) {
                    (_a = this.tree) === null || _a === void 0 ? void 0 : _a.updateOptions({ overrideStyles: { listBackground: this.viewLocation === 0 /* Sidebar */ ? theme_1.SIDE_BAR_BACKGROUND : theme_1.PANEL_BACKGROUND } });
                }
            }));
        ...
        createTree() {
            ...
            this.tree = this._register(this.instantiationService.createInstance(Tree, this.id, this.treeContainer, new TreeViewDelegate(), [renderer], dataSource, {
                ...
                overrideStyles: {
                    listBackground: this.viewLocation === 0 /* Sidebar */ ? theme_1.SIDE_BAR_BACKGROUND : theme_1.PANEL_BACKGROUND
                }
            }));
    ...
    let TreeRenderer = class TreeRenderer extends lifecycle_1.Disposable {
        constructor(treeViewId, menus, labels, actionViewItemProvider, aligner, themeService, configurationService, labelService, hoverService) {
            super();
    ...
    let TreeMenus = class TreeMenus extends lifecycle_1.Disposable {
        ...
        getResourceActions(element) {
            return this.getActions(actions_1.MenuId.ViewItemContext, { key: 'viewItem', value: element.contextValue }).primary;
        }
        getResourceContextActions(element) {
            return this.getActions(actions_1.MenuId.ViewItemContext, { key: 'viewItem', value: element.contextValue }).secondary;
        }
    ...
    let CustomTreeView = class CustomTreeView extends TreeView {
        constructor(id, title, themeService, instantiationService, commandService, configurationService, progressService, contextMenuService, keybindingService, notificationService, viewDescriptorService, contextKeyService, hoverService, extensionService) {
