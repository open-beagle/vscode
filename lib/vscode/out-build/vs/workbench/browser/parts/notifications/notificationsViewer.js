        ...
        static render(message, actionHandler) {
            ...
            for (const node of message.linkedText.nodes) {
                if (typeof node === 'string') {
                    ...
                    if (actionHandler) {
                        actionHandler.toDispose.add((0, dom_1.addDisposableListener)(anchor, dom_1.EventType.CLICK, e => {
    ...
    let NotificationTemplateRenderer = class NotificationTemplateRenderer extends lifecycle_1.Disposable {
        ...
        renderSource(notification) {
            if (notification.expanded && notification.source) {
                this.template.source.textContent = (0, nls_1.localize)(2, null, notification.source);
            ...
            if (notification.expanded && (0, arrays_1.isNonEmptyArray)(primaryActions)) {
                ...
                for (const action of primaryActions) {
                    ...
                    const button = this.inputDisposables.add(dropdownActions
                        ? buttonToolbar.addButtonWithDropdown(Object.assign(Object.assign({}, buttonOptions), { contextMenuProvider: this.contextMenuService, actions: dropdownActions, actionRunner }))
