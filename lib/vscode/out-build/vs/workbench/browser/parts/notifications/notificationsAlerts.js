    ...
    class NotificationsAlerts extends lifecycle_1.Disposable {
        ...
        doTriggerAriaAlert(notifiation) {
            ...
            if (notifiation.severity === notification_1.Severity.Error) {
                alertText = (0, nls_1.localize)(0, null, notifiation.message.linkedText.toString());
            }
            else if (notifiation.severity === notification_1.Severity.Warning) {
                alertText = (0, nls_1.localize)(1, null, notifiation.message.linkedText.toString());
            }
            else {
                alertText = (0, nls_1.localize)(2, null, notifiation.message.linkedText.toString());
            }
