...
define(["require", "exports", "vs/nls!vs/workbench/browser/parts/sidebar/sidebarPart", "vs/platform/registry/common/platform", "vs/workbench/browser/parts/compositePart", "vs/workbench/browser/viewlet", "vs/platform/actions/common/actions", "vs/workbench/services/viewlet/browser/viewlet", "vs/workbench/services/layout/browser/layoutService", "vs/workbench/common/viewlet", "vs/platform/storage/common/storage", "vs/platform/contextview/browser/contextView", "vs/platform/telemetry/common/telemetry", "vs/platform/keybinding/common/keybinding", "vs/platform/instantiation/common/instantiation", "vs/base/common/event", "vs/platform/theme/common/themeService", "vs/platform/theme/common/colorRegistry", "vs/workbench/common/theme", "vs/platform/notification/common/notification", "vs/base/browser/dom", "vs/base/browser/mouseEvent", "vs/platform/contextkey/common/contextkey", "vs/workbench/services/extensions/common/extensions", "vs/platform/instantiation/common/extensions", "vs/base/common/types", "vs/workbench/browser/dnd", "vs/workbench/common/views", "vs/workbench/common/actions", "vs/css!./media/sidebarpart"], function (require, exports, nls_1, platform_1, compositePart_1, viewlet_1, actions_1, viewlet_2, layoutService_1, viewlet_3, storage_1, contextView_1, telemetry_1, keybinding_1, instantiation_1, event_1, themeService_1, colorRegistry_1, theme_1, notification_1, dom_1, mouseEvent_1, contextkey_1, extensions_1, extensions_2, types_1, dnd_1, views_1, actions_2) {
    ...
    let SidebarPart = class SidebarPart extends compositePart_1.CompositePart {
        constructor(notificationService, storageService, telemetryService, contextMenuService, layoutService, keybindingService, instantiationService, themeService, viewDescriptorService, contextKeyService, extensionService) {
            super(notificationService, storageService, telemetryService, contextMenuService, layoutService, keybindingService, instantiationService, themeService, platform_1.Registry.as(viewlet_1.Extensions.Viewlets), SidebarPart.activeViewletSettingsKey, viewDescriptorService.getDefaultViewContainer(0 /* Sidebar */).id, 'sideBar', 'viewlet', theme_1.SIDE_BAR_TITLE_FOREGROUND, "workbench.parts.sidebar" /* SIDEBAR_PART */, { hasTitle: true, borderWidth: () => (this.getColor(theme_1.SIDE_BAR_BORDER) || this.getColor(colorRegistry_1.contrastBorder)) ? 1 : 0 });
        ...
        registerListeners() {
            ...
            this._register(this.registry.onDidDeregister(async (viewletDescriptor) => {
                var _a, _b;
                const activeContainers = this.viewDescriptorService.getViewContainersByLocation(0 /* Sidebar */)
                    .filter(container => this.viewDescriptorService.getViewContainerModel(container).activeViewDescriptors.length > 0);
                if (activeContainers.length) {
                    if (((_a = this.getActiveComposite()) === null || _a === void 0 ? void 0 : _a.getId()) === viewletDescriptor.id) {
                        const defaultViewletId = (_b = this.viewDescriptorService.getDefaultViewContainer(0 /* Sidebar */)) === null || _b === void 0 ? void 0 : _b.id;
    ...
    class FocusSideBarAction extends actions_1.Action2 {
        constructor() {
            super({
                ...
                title: { value: (0, nls_1.localize)(0, null), original: 'Focus into Side Bar' },
        ...
        async run(accessor) {
            ...
            // Show side bar
            if (!layoutService.isVisible("workbench.parts.sidebar" /* SIDEBAR_PART */)) {
    ...
    (0, extensions_2.registerSingleton)(viewlet_2.IViewletService, SidebarPart);
});
