...
define(["require", "exports", "vs/nls!vs/workbench/browser/parts/compositeBar", "vs/base/common/actions", "vs/base/common/errors", "vs/base/common/lifecycle", "vs/platform/instantiation/common/instantiation", "vs/base/browser/ui/actionbar/actionbar", "vs/workbench/browser/parts/compositeBarActions", "vs/base/browser/dom", "vs/base/browser/mouseEvent", "vs/platform/contextview/browser/contextView", "vs/base/browser/ui/widget", "vs/base/common/types", "vs/base/common/event", "vs/workbench/browser/dnd"], function (require, exports, nls_1, actions_1, errors_1, lifecycle_1, instantiation_1, actionbar_1, compositeBarActions_1, dom_1, mouseEvent_1, contextView_1, widget_1, types_1, event_1, dnd_1) {
    ...
    class CompositeDragAndDrop {
        ...
        getTargetIndex(targetId, before2d) {
            ...
            const before = this.targetContainerLocation === 1 /* Panel */ ? before2d === null || before2d === void 0 ? void 0 : before2d.horizontallyBefore : before2d === null || before2d === void 0 ? void 0 : before2d.verticallyBefore;
    ...
    let CompositeBar = class CompositeBar extends widget_1.Widget {
        ...
        computeSizes(items) {
            ...
            if (size) {
                ...
                if (compositeSwitcherBar && this.dimension && this.dimension.height !== 0 && this.dimension.width !== 0) {
                    ...
                    items.map((composite, index) => this.compositeSizeInBar.set(composite.id, this.options.orientation === 1 /* VERTICAL */
        ...
        updateCompositeSwitcher() {
            ...
            let size = 0;
            const limit = this.options.orientation === 1 /* VERTICAL */ ? this.dimension.height : this.dimension.width;
