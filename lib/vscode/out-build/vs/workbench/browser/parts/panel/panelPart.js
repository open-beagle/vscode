...
define(["require", "exports", "vs/nls!vs/workbench/browser/parts/panel/panelPart", "vs/base/common/actions", "vs/base/common/event", "vs/platform/registry/common/platform", "vs/workbench/common/panel", "vs/workbench/browser/parts/compositePart", "vs/workbench/browser/panel", "vs/workbench/services/panel/common/panelService", "vs/workbench/services/layout/browser/layoutService", "vs/platform/storage/common/storage", "vs/platform/contextview/browser/contextView", "vs/platform/telemetry/common/telemetry", "vs/platform/keybinding/common/keybinding", "vs/platform/instantiation/common/instantiation", "vs/workbench/browser/parts/panel/panelActions", "vs/platform/theme/common/themeService", "vs/workbench/common/theme", "vs/platform/theme/common/colorRegistry", "vs/workbench/browser/parts/compositeBar", "vs/workbench/browser/parts/compositeBarActions", "vs/platform/notification/common/notification", "vs/base/browser/dom", "vs/base/common/lifecycle", "vs/platform/contextkey/common/contextkey", "vs/base/common/types", "vs/platform/instantiation/common/extensions", "vs/workbench/services/extensions/common/extensions", "vs/workbench/common/views", "vs/workbench/browser/dnd", "vs/css!./media/panelpart"], function (require, exports, nls_1, actions_1, event_1, platform_1, panel_1, compositePart_1, panel_2, panelService_1, layoutService_1, storage_1, contextView_1, telemetry_1, keybinding_1, instantiation_1, panelActions_1, themeService_1, theme_1, colorRegistry_1, compositeBar_1, compositeBarActions_1, notification_1, dom_1, lifecycle_1, contextkey_1, types_1, extensions_1, extensions_2, views_1, dnd_1) {
    ...
    let PanelPart = class PanelPart extends compositePart_1.CompositePart {
        constructor(notificationService, storageService, telemetryService, contextMenuService, layoutService, keybindingService, instantiationService, themeService, viewDescriptorService, contextKeyService, extensionService) {
            ...
            this.dndHandler = new compositeBar_1.CompositeDragAndDrop(this.viewDescriptorService, 1 /* Panel */, (id, focus) => this.openPanel(id, focus).then(panel => panel || null), (from, to, before) => this.compositeBar.move(from, to, before === null || before === void 0 ? void 0 : before.horizontallyBefore), () => this.compositeBar.getCompositeBarItems());
            this.compositeBar = this._register(this.instantiationService.createInstance(compositeBar_1.CompositeBar, this.getCachedPanels(), {
                ...
                activityHoverOptions: {
                    position: () => this.layoutService.getPanelPosition() === 2 /* BOTTOM */ && !this.layoutService.isPanelMaximized() ? 3 /* ABOVE */ : 2 /* BELOW */,
                    delay: () => 0
                },
                openComposite: compositeId => this.openPanel(compositeId, true).then(panel => panel || null),
                getActivityAction: compositeId => this.getCompositeActions(compositeId).activityAction,
                getCompositePinnedAction: compositeId => this.getCompositeActions(compositeId).pinnedAction,
                getOnCompositeClickAction: compositeId => this.instantiationService.createInstance(panelActions_1.PanelActivityAction, (0, types_1.assertIsDefined)(this.getPanel(compositeId))),
                fillExtraContextMenuActions: actions => {
                    actions.push(...[
                        ...
                        this.instantiationService.createInstance(panelActions_1.TogglePanelAction, panelActions_1.TogglePanelAction.ID, (0, nls_1.localize)(0, null))
                    ]);
                },
        ...
        getContextMenuActionsForComposite(compositeId) {
            ...
            if (defaultLocation !== this.viewDescriptorService.getViewContainerLocation(viewContainer)) {
                result.push((0, actions_1.toAction)({ id: 'resetLocationAction', label: (0, nls_1.localize)(1, null), run: () => this.viewDescriptorService.moveViewContainerToLocation(viewContainer, defaultLocation) }));
            }
            else {
                ...
                if (viewContainerModel.allViewDescriptors.length === 1) {
                    ...
                    if (defaultContainer !== viewContainer) {
                        result.push((0, actions_1.toAction)({ id: 'resetLocationAction', label: (0, nls_1.localize)(2, null), run: () => this.viewDescriptorService.moveViewsToContainer([viewToReset], defaultContainer) }));
                    }
                }
            }
            return result;
        ...
        async onDidDeregisterPanel(panelId) {
            ...
            const activeContainers = this.viewDescriptorService.getViewContainersByLocation(1 /* Panel */)
        ...
        createEmptyPanelMessage() {
            ...
            messageElement.innerText = (0, nls_1.localize)(3, null);
        ...
        getCompositeActions(compositeId) {
            ...
            if (!compositeActions) {
                ...
                if (panel) {
                    compositeActions = {
                        activityAction: new panelActions_1.PanelActivityAction((0, types_1.assertIsDefined)(this.getPanel(compositeId)), this),
        ...
        setStoredCachedViewletsValue(value) {
            this.storageService.store(PanelPart.PINNED_PANELS, value, 0 /* GLOBAL */, 0 /* USER */);
        }
        ...
        setStoredPlaceholderViewContainersValue(value) {
            this.storageService.store(PanelPart.PLACEHOLDER_VIEW_CONTAINERS, value, 1 /* WORKSPACE */, 1 /* MACHINE */);
        }
    ...
    (0, extensions_1.registerSingleton)(panelService_1.IPanelService, PanelPart);
});
