...
define(["require", "exports", "vs/base/common/lifecycle", "vs/base/common/event", "vs/base/browser/dom", "vs/base/browser/browser", "vs/workbench/services/workingCopy/common/workingCopyBackup", "vs/platform/registry/common/platform", "vs/base/common/platform", "vs/workbench/common/editor", "vs/workbench/browser/parts/sidebar/sidebarPart", "vs/workbench/browser/parts/panel/panelPart", "vs/workbench/browser/panel", "vs/workbench/services/layout/browser/layoutService", "vs/platform/workspace/common/workspace", "vs/platform/storage/common/storage", "vs/platform/configuration/common/configuration", "vs/workbench/services/viewlet/browser/viewlet", "vs/workbench/services/panel/common/panelService", "vs/workbench/services/title/common/titleService", "vs/workbench/services/lifecycle/common/lifecycle", "vs/platform/windows/common/windows", "vs/workbench/services/host/browser/host", "vs/workbench/services/environment/common/environmentService", "vs/workbench/services/editor/common/editorService", "vs/workbench/services/editor/common/editorGroupsService", "vs/base/browser/ui/grid/grid", "vs/workbench/services/statusbar/common/statusbar", "vs/workbench/services/activityBar/browser/activityBarService", "vs/platform/files/common/files", "vs/editor/browser/editorBrowser", "vs/base/common/arrays", "vs/base/common/types", "vs/platform/notification/common/notification", "vs/platform/theme/common/themeService", "vs/workbench/common/theme", "vs/base/common/uri", "vs/workbench/common/views", "vs/workbench/common/editor/diffEditorInput", "vs/base/common/performance", "vs/workbench/services/extensions/common/extensions", "vs/platform/log/common/log", "vs/base/common/async"], function (require, exports, lifecycle_1, event_1, dom_1, browser_1, workingCopyBackup_1, platform_1, platform_2, editor_1, sidebarPart_1, panelPart_1, panel_1, layoutService_1, workspace_1, storage_1, configuration_1, viewlet_1, panelService_1, titleService_1, lifecycle_2, windows_1, host_1, environmentService_1, editorService_1, editorGroupsService_1, grid_1, statusbar_1, activityBarService_1, files_1, editorBrowser_1, arrays_1, types_1, notification_1, themeService_1, theme_1, uri_1, views_1, diffEditorInput_1, performance_1, extensions_1, log_1, async_1) {
    ...
    (function (Settings) {
        ...
        Settings["PANEL_OPENS_MAXIMIZED"] = "workbench.panel.opensMaximized";
    ...
    (function (Storage) {
        ...
        Storage["PANEL_LAST_IS_MAXIMIZED"] = "workbench.panel.lastIsMaximized";
        ...
        Storage["MENU_VISIBILITY"] = "window.menuBarVisibility";
    })(Storage || (Storage = {}));
    var Classes;
    (function (Classes) {
    ...
    class Layout extends lifecycle_1.Disposable {
        constructor(parent) {
            ...
            this.whenReady = new Promise(resolve => (this.whenReadyResolve = resolve));
        ...
        registerLayoutListeners() {
            ...
            if ((platform_2.isWindows || platform_2.isLinux || platform_2.isWeb) && (0, windows_1.getTitleBarStyle)(this.configurationService) === 'custom') {
        ...
        onMenubarToggled(visible) {
            if (visible !== this.state.menuBar.toggled) {
                ...
                if (platform_2.isWeb && this.state.menuBar.visibility === 'toggle') {
        ...
        onFullscreenChanged() {
            this.state.fullscreen = (0, browser_1.isFullscreen)();
            // Apply as CSS class
        ...
        doUpdateLayoutConfiguration(skipLayout) {
            ...
            // Menubar visibility
            const newMenubarVisibility = (0, windows_1.getMenuBarVisibility)(this.configurationService);
        ...
        updateWindowBorder(skipLayout = false) {
            var _a;
            if (platform_2.isWeb || (0, windows_1.getTitleBarStyle)(this.configurationService) !== 'custom') {
                return;
            }
        ...
        initLayoutState(lifecycleService, fileService) {
            ...
            this.state.fullscreen = (0, browser_1.isFullscreen)();
            // Menubar visibility
            this.state.menuBar.visibility = (0, windows_1.getMenuBarVisibility)(this.configurationService);
            ...
            if (!this.state.sideBar.hidden) {
                ...
                if (!this.environmentService.isBuilt || lifecycleService.startupKind === 3 /* ReloadedWindow */ || platform_2.isWeb) {
                    viewletToRestore = this.storageService.get(sidebarPart_1.SidebarPart.activeViewletSettingsKey, 1 /* WORKSPACE */, (_a = this.viewDescriptorService.getDefaultViewContainer(0 /* Sidebar */)) === null || _a === void 0 ? void 0 : _a.id);
                }
                else {
                    viewletToRestore = (_b = this.viewDescriptorService.getDefaultViewContainer(0 /* Sidebar */)) === null || _b === void 0 ? void 0 : _b.id;
                }
                if (viewletToRestore) {
            ...
            this.state.panel.wasLastMaximized = this.storageService.getBoolean(Storage.PANEL_LAST_IS_MAXIMIZED, 1 /* WORKSPACE */, false);
            // Panel position
            this.updatePanelPosition();
            // Panel to restore
        ...
        applyDefaultLayout(environmentService, storageService) {
            ...
            if (!defaultLayout.force && !storageService.isNew(1 /* WORKSPACE */)) {
                return;
            }
        ...
        getInitialFilesToOpen() {
            ...
            if (((_b = defaultLayout === null || defaultLayout === void 0 ? void 0 : defaultLayout.editors) === null || _b === void 0 ? void 0 : _b.length) && (defaultLayout.force || this.storageService.isNew(1 /* WORKSPACE */))) {
                this._openedDefaultEditors = true;
                return {
                    filesToOpenOrCreate: defaultLayout.editors.map(file => {
                        return { fileUri: uri_1.URI.revive(file.uri), openOnlyIfExists: file.openOnlyIfExists, editorOverrideId: file.openWith };
                    })
                };
            }
        ...
        restoreParts() {
            ...
            const restoreDefaultViewsPromise = (async () => {
                ...
                if ((_a = this.state.views.defaults) === null || _a === void 0 ? void 0 : _a.length) {
                    ...
                    if (locationsRestored[0 /* Sidebar */]) {
                        this.state.sideBar.viewletToRestore = locationsRestored[0 /* Sidebar */].id;
                    }
                    // If we opened a view in the panel, stop any restore there
                    if (locationsRestored[1 /* Panel */]) {
                        this.state.panel.panelToRestore = locationsRestored[1 /* Panel */].id;
                    }
            ...
            layoutReadyPromises.push((async () => {
                ...
                if (!viewlet) {
                    await this.viewletService.openViewlet((_a = this.viewDescriptorService.getDefaultViewContainer(0 /* Sidebar */)) === null || _a === void 0 ? void 0 : _a.id); // fallback to default viewlet as needed
                }
            ...
            async_1.Promises.settled(layoutReadyPromises).finally(() => {
                var _a;
                (_a = this.whenReadyResolve) === null || _a === void 0 ? void 0 : _a.call(this);
        ...
        updatePanelPosition() {
            ...
            this.state.panel.position = (0, layoutService_1.positionFromString)(panelPosition || defaultPanelPosition);
        }
        registerPart(part) {
        ...
        isVisible(part) {
            switch (part) {
                case "workbench.parts.titlebar" /* TITLEBAR_PART */:
                    ...
                    if ((0, windows_1.getTitleBarStyle)(this.configurationService) === 'native') {
                        return false;
                    }
                    ...
                    if (platform_2.isNative && !this.state.fullscreen) {
                        return true;
                    }
                    ...
                    switch (this.state.menuBar.visibility) {
                        ...
                        case 'visible':
                            return true;
                        default:
                            return platform_2.isWeb ? false : !this.state.fullscreen || this.state.menuBar.toggled;
                    }
                case "workbench.parts.sidebar" /* SIDEBAR_PART */:
        ...
        toggleZenMode(skipLayout, restoring = false) {
            ...
            // State
            if (this.state.zenMode.active) {
                this.storageService.store(Storage.ZEN_MODE_ENABLED, true, 1 /* WORKSPACE */, 0 /* USER */);
        ...
        createWorkbenchLayout() {
            ...
            this._register(this.storageService.onWillSaveState(() => {
                ...
                this.storageService.store(Storage.SIDEBAR_SIZE, sideBarSize, 0 /* GLOBAL */, 1 /* MACHINE */);
                ...
                this.storageService.store(Storage.PANEL_SIZE, panelSize, 0 /* GLOBAL */, 1 /* MACHINE */);
                this.storageService.store(Storage.PANEL_DIMENSION, (0, layoutService_1.positionToString)(this.state.panel.position), 0 /* GLOBAL */, 1 /* MACHINE */);
                const gridSize = grid.getViewSize();
                this.storageService.store(Storage.GRID_WIDTH, gridSize.width, 0 /* GLOBAL */, 1 /* MACHINE */);
                this.storageService.store(Storage.GRID_HEIGHT, gridSize.height, 0 /* GLOBAL */, 1 /* MACHINE */);
            }));
        }
        getClientArea() {
        ...
        centerEditorLayout(active, skipLayout) {
            ...
            this.storageService.store(Storage.CENTERED_LAYOUT_ENABLED, active, 1 /* WORKSPACE */, 0 /* USER */);
        ...
        setEditorHidden(hidden, skipLayout) {
            ...
            if (hidden) {
                this.storageService.store(Storage.EDITOR_HIDDEN, true, 1 /* WORKSPACE */, 0 /* USER */);
            }
            else {
        ...
        setSideBarHidden(hidden, skipLayout) {
            ...
            // If sidebar becomes visible, show last active Viewlet or default viewlet
                ...
                if (viewletToOpen) {
                    ...
                    if (!viewlet) {
                        this.viewletService.openViewlet((_a = this.viewDescriptorService.getDefaultViewContainer(0 /* Sidebar */)) === null || _a === void 0 ? void 0 : _a.id, true);
                    }
                }
            }
            // Propagate to grid
            ...
            if (hidden !== defaultHidden) {
                this.storageService.store(Storage.SIDEBAR_HIDDEN, hidden ? 'true' : 'false', 1 /* WORKSPACE */, 0 /* USER */);
            }
            else {
        ...
        setPanelHidden(hidden, skipLayout) {
            ...
            // If panel part becomes visible, show last active panel or default panel
                ...
                let panelToOpen = this.panelService.getLastActivePanelId();
                const hasViews = (id) => {
                ...
                if (!panelToOpen || !hasViews(panelToOpen)) {
                    panelToOpen = (_a = this.viewDescriptorService
                        .getViewContainersByLocation(1 /* Panel */)
                        .find(viewContainer => hasViews(viewContainer.id))) === null || _a === void 0 ? void 0 : _a.id;
                }
                if (panelToOpen) {
            ...
            // Remember in settings
            if (!hidden) {
                this.storageService.store(Storage.PANEL_HIDDEN, 'false', 1 /* WORKSPACE */, 0 /* USER */);
            }
            else {
                ...
                if (this.state.panel.wasLastMaximized) {
                    this.storageService.store(Storage.PANEL_LAST_IS_MAXIMIZED, true, 1 /* WORKSPACE */, 0 /* USER */);
                }
                else {
                    this.storageService.remove(Storage.PANEL_LAST_IS_MAXIMIZED, 1 /* WORKSPACE */);
                }
            }
            if (focusEditor) {
            ...
            if (!this.isPanelMaximized()) {
                if (!this.state.panel.hidden) {
                    if (this.state.panel.position === 2 /* BOTTOM */) {
                        ...
                        this.storageService.store(Storage.PANEL_LAST_NON_MAXIMIZED_HEIGHT, this.state.panel.lastNonMaximizedHeight, 0 /* GLOBAL */, 1 /* MACHINE */);
                    }
                    else {
                        this.state.panel.lastNonMaximizedWidth = size.width;
                        this.storageService.store(Storage.PANEL_LAST_NON_MAXIMIZED_WIDTH, this.state.panel.lastNonMaximizedWidth, 0 /* GLOBAL */, 1 /* MACHINE */);
                    }
                }
         ...
         */
        panelOpensMaximized() {
            const panelOpensMaximized = (0, layoutService_1.panelOpensMaximizedFromString)(this.configurationService.getValue(Settings.PANEL_OPENS_MAXIMIZED));
            const panelLastIsMaximized = this.state.panel.wasLastMaximized;
            return panelOpensMaximized === 0 /* ALWAYS */ || (panelOpensMaximized === 2 /* REMEMBER_LAST */ && panelLastIsMaximized);
        }
        hasWindowBorder() {
        ...
        toggleMenuBar() {
            let currentVisibilityValue = (0, windows_1.getMenuBarVisibility)(this.configurationService);
        ...
        setPanelPosition(position) {
            ...
            const panelPart = this.getPart("workbench.parts.panel" /* PANEL_PART */);
            const oldPositionValue = (0, layoutService_1.positionToString)(this.state.panel.position);
            const newPositionValue = (0, layoutService_1.positionToString)(position);
            this.state.panel.position = position;
            // Save panel position
            this.storageService.store(Storage.PANEL_POSITION, newPositionValue, 1 /* WORKSPACE */, 0 /* USER */);
            // Adjust CSS
            ...
            if (newPositionValue !== oldPositionValue && !this.state.editor.hidden) {
                ...
                else if ((0, layoutService_1.positionFromString)(oldPositionValue) === 2 /* BOTTOM */) {
                    this.state.panel.lastNonMaximizedHeight = size.height;
                }
            }
            if (position === 2 /* BOTTOM */) {
        ...
        createGridDescriptor() {
            ...
            const sideBarSize = this.storageService.getNumber(Storage.SIDEBAR_SIZE, 0 /* GLOBAL */, Math.min(workbenchDimensions.width / 4, 300));
            const panelDimension = (0, layoutService_1.positionFromString)(this.storageService.get(Storage.PANEL_DIMENSION, 0 /* GLOBAL */, 'bottom'));
            const fallbackPanelSize = this.state.panel.position === 2 /* BOTTOM */ ? workbenchDimensions.height / 3 : workbenchDimensions.width / 4;
            const panelSize = panelDimension === this.state.panel.position ? this.storageService.getNumber(Storage.PANEL_SIZE, 0 /* GLOBAL */, fallbackPanelSize) : fallbackPanelSize;
