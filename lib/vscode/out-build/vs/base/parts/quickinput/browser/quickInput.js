 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "vs/base/parts/quickinput/common/quickInput", "vs/base/browser/dom", "vs/base/common/cancellation", "./quickInputList", "./quickInputBox", "vs/base/browser/keyboardEvent", "vs/nls!vs/base/parts/quickinput/browser/quickInput", "vs/base/browser/ui/countBadge/countBadge", "vs/base/browser/ui/progressbar/progressbar", "vs/base/common/event", "vs/base/browser/ui/button/button", "vs/base/common/lifecycle", "vs/base/common/severity", "vs/base/browser/ui/actionbar/actionbar", "vs/base/common/actions", "vs/base/common/arrays", "vs/base/common/async", "vs/base/parts/quickinput/browser/quickInputUtils", "vs/base/common/codicons", "vs/base/common/strings", "vs/base/browser/ui/iconLabel/iconLabels", "vs/base/common/types", "vs/css!./media/quickInput"], function (require, exports, quickInput_1, dom, cancellation_1, quickInputList_1, quickInputBox_1, keyboardEvent_1, nls_1, countBadge_1, progressbar_1, event_1, button_1, lifecycle_1, severity_1, actionbar_1, actions_1, arrays_1, async_1, quickInputUtils_1, codicons_1, strings_1, iconLabels_1, types_1) {
    "use strict";
    ...
    class QuickInput extends lifecycle_1.Disposable {
        ...
        update() {
            ...
            if (this._lastValidationMessage !== validationMessage) {
                ...
                dom.reset(this.ui.message, ...(0, iconLabels_1.renderLabelWithIcons)((0, strings_1.escape)(validationMessage)));
            }
    ...
    class QuickInputController extends lifecycle_1.Disposable {
        ...
        getUI() {
            ...
            const visibleCount = new countBadge_1.CountBadge(visibleCountContainer, { countFormat: (0, nls_1.localize)(5, null) });
            const countContainer = dom.append(filterContainer, $('.quick-input-count'));
            countContainer.setAttribute('aria-live', 'polite');
            const count = new countBadge_1.CountBadge(countContainer, { countFormat: (0, nls_1.localize)(6, null) });
            const okContainer = dom.append(headerContainer, $('.quick-input-action'));
            const ok = new button_1.Button(okContainer);
            ok.label = (0, nls_1.localize)(7, null);
            this._register(ok.onDidClick(e => {
                this.onDidAcceptEmitter.fire();
            }));
            const customButtonContainer = dom.append(headerContainer, $('.quick-input-action'));
            const customButton = new button_1.Button(customButtonContainer);
            customButton.label = (0, nls_1.localize)(8, null);
        ...
        show(controller) {
            ...
            backButton.tooltip = backKeybindingLabel ? (0, nls_1.localize)(9, null, backKeybindingLabel) : (0, nls_1.localize)(10, null);
