 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "vs/base/browser/browser", "vs/base/browser/dom", "vs/base/common/strings", "vs/nls!vs/base/browser/ui/menu/menubar", "vs/base/browser/keyboardEvent", "vs/base/browser/touch", "vs/base/browser/ui/menu/menu", "vs/base/common/actions", "vs/base/common/async", "vs/base/common/event", "vs/base/common/lifecycle", "vs/base/common/types", "vs/base/common/arrays", "vs/base/common/scanCode", "vs/base/common/platform", "vs/base/browser/mouseEvent", "vs/base/common/codicons", "vs/css!./menubar"], function (require, exports, browser, DOM, strings, nls, keyboardEvent_1, touch_1, menu_1, actions_1, async_1, event_1, lifecycle_1, types_1, arrays_1, scanCode_1, platform_1, mouseEvent_1, codicons_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.MenuBar = void 0;
    const $ = DOM.$;
    const menuBarMoreIcon = (0, codicons_1.registerCodicon)('menubar-more', codicons_1.Codicon.more);
    var MenubarState;
    ...
    class MenuBar extends lifecycle_1.Disposable {
        constructor(container, options = {}) {
            ...
            this._register(DOM.addDisposableListener(this.container, DOM.EventType.KEY_DOWN, (e) => {
                ...
                const tabNav = platform_1.isMacintosh && this.options.compactMode === undefined;
                if (event.equals(15 /* LeftArrow */) || (tabNav && event.equals(2 /* Tab */ | 1024 /* Shift */))) {
                    this.focusPrevious();
                }
                else if (event.equals(17 /* RightArrow */) || (tabNav && event.equals(2 /* Tab */))) {
                    this.focusNext();
                }
        ...
        createOverflowMenu() {
            const label = this.options.compactMode !== undefined ? nls.localize(0, null) : nls.localize(1, null);
            ...
            this._register(DOM.addDisposableListener(buttonElement, DOM.EventType.KEY_UP, (e) => {
                let event = new keyboardEvent_1.StandardKeyboardEvent(e);
                let eventHandled = true;
                const triggerKeys = [3 /* Enter */];
                if (this.options.compactMode === undefined) {
                    triggerKeys.push(18 /* DownArrow */);
                }
                else {
                    triggerKeys.push(10 /* Space */);
                    triggerKeys.push(this.options.compactMode === menu_1.Direction.Right ? 17 /* RightArrow */ : 15 /* LeftArrow */);
                }
