...
define(["require", "exports", "vs/base/common/lifecycle", "vs/base/common/event", "vs/base/common/keyCodes", "vs/base/browser/keyboardEvent", "vs/base/browser/dom", "vs/base/common/arrays", "vs/base/browser/ui/list/listWidget", "vs/base/browser/event", "vs/base/common/platform", "vs/base/browser/markdownRenderer", "vs/nls!vs/base/browser/ui/selectBox/selectBoxCustom", "vs/css!./selectBoxCustom"], function (require, exports, lifecycle_1, event_1, keyCodes_1, keyboardEvent_1, dom, arrays, listWidget_1, event_2, platform_1, markdownRenderer_1, nls_1) {
    ...
    class SelectBoxList extends lifecycle_1.Disposable {
        ...
        createSelectList(parent) {
            ...
            const onSelectDropDownKeyDown = event_1.Event.chain((0, event_2.domEvent)(this.selectDropDownListContainer, 'keydown'))
            ...
            this._register(onSelectDropDownKeyDown.filter(e => e.keyCode === 16 /* UpArrow */).on(e => this.onUpArrow(e), this));
            this._register(onSelectDropDownKeyDown.filter(e => e.keyCode === 18 /* DownArrow */).on(e => this.onDownArrow(e), this));
            ...
            this._register(event_1.Event.chain((0, event_2.domEvent)(this.selectList.getHTMLElement(), 'mouseup'))
                .filter(() => this.selectList.length > 0)
        ...
        renderDescriptionMarkdown(text, actionHandler) {
            ...
            const renderedMarkdown = (0, markdownRenderer_1.renderMarkdown)({ value: text }, { actionHandler });
