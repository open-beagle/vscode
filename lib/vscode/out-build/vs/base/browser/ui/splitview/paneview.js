 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "vs/base/common/lifecycle", "vs/base/common/event", "vs/base/browser/event", "vs/base/browser/keyboardEvent", "vs/base/browser/dom", "vs/base/common/color", "./splitview", "vs/base/browser/browser", "vs/base/browser/dnd", "vs/nls!vs/base/browser/ui/splitview/paneview", "vs/css!./paneview"], function (require, exports, lifecycle_1, event_1, event_2, keyboardEvent_1, dom_1, color_1, splitview_1, browser_1, dnd_1, nls_1) {
    "use strict";
    ...
    class Pane extends lifecycle_1.Disposable {
        constructor(options) {
            ...
            this.ariaHeaderLabel = (0, nls_1.localize)(0, null, options.title);
        ...
        render() {
            ...
            this.updateHeader();
            const onHeaderKeyDown = event_1.Event.chain((0, event_2.domEvent)(this.header, 'keydown'))
            ...
            this._register((0, event_2.domEvent)(this.header, 'click')(e => {
    ...
    class PaneDraggable extends lifecycle_1.Disposable {
        constructor(pane, dnd, context) {
            ...
            this._register((0, event_2.domEvent)(pane.draggableElement, 'dragstart')(this.onDragStart, this));
            this._register((0, event_2.domEvent)(pane.dropTargetElement, 'dragenter')(this.onDragEnter, this));
            this._register((0, event_2.domEvent)(pane.dropTargetElement, 'dragleave')(this.onDragLeave, this));
            this._register((0, event_2.domEvent)(pane.dropTargetElement, 'dragend')(this.onDragEnd, this));
            this._register((0, event_2.domEvent)(pane.dropTargetElement, 'drop')(this.onDrop, this));
        }
        onDragStart(e) {
            var _a;
