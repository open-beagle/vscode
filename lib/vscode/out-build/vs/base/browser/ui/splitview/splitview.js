...
define(["require", "exports", "vs/base/common/lifecycle", "vs/base/common/event", "vs/base/common/types", "vs/base/common/numbers", "vs/base/common/arrays", "vs/base/browser/ui/sash/sash", "vs/base/common/color", "vs/base/browser/event", "vs/base/browser/dom", "vs/base/browser/ui/scrollbar/scrollableElement", "vs/base/common/scrollable", "vs/base/browser/ui/sash/sash", "vs/css!./splitview"], function (require, exports, lifecycle_1, event_1, types, numbers_1, arrays_1, sash_1, color_1, event_2, dom_1, scrollableElement_1, scrollable_1, sash_2) {
    ...
    class SplitView extends lifecycle_1.Disposable {
        ...
        onSashStart({ sash, start, alt }) {
            ...
            const disposable = (0, lifecycle_1.combinedDisposable)((0, event_2.domEvent)(document.body, 'keydown')(e => resetSashDragState(this.sashDragState.current, e.altKey)), (0, event_2.domEvent)(document.body, 'keyup')(() => resetSashDragState(this.sashDragState.current, false)));
