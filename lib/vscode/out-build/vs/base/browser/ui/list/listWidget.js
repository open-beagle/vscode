...
define(["require", "exports", "vs/base/common/lifecycle", "vs/base/common/types", "vs/base/common/arrays", "vs/base/common/decorators", "vs/base/common/platform", "vs/base/browser/touch", "vs/base/browser/keyboardEvent", "vs/base/common/event", "vs/base/browser/event", "./list", "./listView", "vs/base/common/color", "vs/base/common/objects", "vs/base/browser/ui/list/splice", "vs/base/common/numbers", "vs/base/common/filters", "vs/base/browser/ui/aria/aria", "vs/base/browser/dom", "vs/base/common/async", "vs/css!./list"], function (require, exports, lifecycle_1, types_1, arrays_1, decorators_1, platform, touch_1, keyboardEvent_1, event_1, event_2, list_1, listView_1, color_1, objects_1, splice_1, numbers_1, filters_1, aria_1, dom_1, async_1) {
    ...
    class KeyboardController {
        constructor(list, view, options) {
            ...
            const onKeyDown = event_1.Event.chain((0, event_2.domEvent)(view.domNode, 'keydown'))
    ...
    class TypeLabelController {
        ...
        enable() {
            ...
            const onChar = event_1.Event.chain((0, event_2.domEvent)(this.view.domNode, 'keydown'))
                .filter(e => !isInputElement(e.target))
    ...
    class List {
        constructor(user, container, virtualDelegate, renderers, _options = DefaultOptions) {
            ...
            this.onDidFocus = event_1.Event.map((0, event_2.domEvent)(this.view.domNode, 'focus', true), () => null);
            this.onDidBlur = event_1.Event.map((0, event_2.domEvent)(this.view.domNode, 'blur', true), () => null);
        ...
        get onContextMenu() {
            ...
            const fromKeyDown = event_1.Event.chain((0, event_2.domEvent)(this.view.domNode, 'keydown'))
                .map(e => new keyboardEvent_1.StandardKeyboardEvent(e))
                .filter(e => didJustPressContextMenuKey = e.keyCode === 58 /* ContextMenu */ || (e.shiftKey && e.keyCode === 68 /* F10 */))
                .map(event_2.stopEvent)
                .filter(() => false)
                .event;
            const fromKeyUp = event_1.Event.chain((0, event_2.domEvent)(this.view.domNode, 'keyup'))
        ...
        get onKeyDown() { return (0, event_2.domEvent)(this.view.domNode, 'keydown'); }
        get onKeyUp() { return (0, event_2.domEvent)(this.view.domNode, 'keyup'); }
        get onKeyPress() { return (0, event_2.domEvent)(this.view.domNode, 'keypress'); }
