...
define(["require", "exports", "vs/base/common/objects", "vs/base/common/lifecycle", "vs/base/browser/touch", "vs/base/common/event", "vs/base/browser/event", "vs/base/browser/ui/scrollbar/scrollableElement", "vs/base/common/scrollable", "./rangeMap", "./rowCache", "vs/base/common/decorators", "vs/base/common/range", "vs/base/common/arrays", "vs/base/browser/dnd", "vs/base/common/async", "vs/base/browser/browser", "vs/base/browser/dom"], function (require, exports, objects_1, lifecycle_1, touch_1, event_1, event_2, scrollableElement_1, scrollable_1, rangeMap_1, rowCache_1, decorators_1, range_1, arrays_1, dnd_1, async_1, browser_1, dom_1) {
    ...
    class ListView {
        constructor(container, virtualDelegate, renderers, options = DefaultOptions) {
            ...
            (0, event_2.domEvent)(this.rowsContainer, touch_1.EventType.Change)(e => this.onTouchChange(e), this, this.disposables);
            // Prevent the monaco-scrollable-element from scrolling
            // https://github.com/microsoft/vscode/issues/44181
            (0, event_2.domEvent)(this.scrollableElement.getDomNode(), 'scroll')(e => e.target.scrollTop = 0, null, this.disposables);
            event_1.Event.map((0, event_2.domEvent)(this.domNode, 'dragover'), e => this.toDragEvent(e))(this.onDragOver, this, this.disposables);
            event_1.Event.map((0, event_2.domEvent)(this.domNode, 'drop'), e => this.toDragEvent(e))(this.onDrop, this, this.disposables);
            (0, event_2.domEvent)(this.domNode, 'dragleave')(this.onDragLeave, this, this.disposables);
            (0, event_2.domEvent)(window, 'dragend')(this.onDragEnd, this, this.disposables);
        ...
        insertItemInDOM(index, beforeElement, row) {
            ...
            if (uri) {
                const onDragStart = (0, event_2.domEvent)(item.row.domNode, 'dragstart');
        ...
        // Events
        get onMouseClick() { return event_1.Event.map((0, event_2.domEvent)(this.domNode, 'click'), e => this.toMouseEvent(e)); }
        get onMouseDblClick() { return event_1.Event.map((0, event_2.domEvent)(this.domNode, 'dblclick'), e => this.toMouseEvent(e)); }
        get onMouseMiddleClick() { return event_1.Event.filter(event_1.Event.map((0, event_2.domEvent)(this.domNode, 'auxclick'), e => this.toMouseEvent(e)), e => e.browserEvent.button === 1); }
        get onMouseUp() { return event_1.Event.map((0, event_2.domEvent)(this.domNode, 'mouseup'), e => this.toMouseEvent(e)); }
        get onMouseDown() { return event_1.Event.map((0, event_2.domEvent)(this.domNode, 'mousedown'), e => this.toMouseEvent(e)); }
        get onMouseOver() { return event_1.Event.map((0, event_2.domEvent)(this.domNode, 'mouseover'), e => this.toMouseEvent(e)); }
        get onMouseMove() { return event_1.Event.map((0, event_2.domEvent)(this.domNode, 'mousemove'), e => this.toMouseEvent(e)); }
        get onMouseOut() { return event_1.Event.map((0, event_2.domEvent)(this.domNode, 'mouseout'), e => this.toMouseEvent(e)); }
        get onContextMenu() { return event_1.Event.map((0, event_2.domEvent)(this.domNode, 'contextmenu'), e => this.toMouseEvent(e)); }
        get onTouchStart() { return event_1.Event.map((0, event_2.domEvent)(this.domNode, 'touchstart'), e => this.toTouchEvent(e)); }
        get onTap() { return event_1.Event.map((0, event_2.domEvent)(this.rowsContainer, touch_1.EventType.Tap), e => this.toGestureEvent(e)); }
