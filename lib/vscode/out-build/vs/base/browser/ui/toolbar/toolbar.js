 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "vs/nls!vs/base/browser/ui/toolbar/toolbar", "vs/base/common/actions", "vs/base/browser/ui/actionbar/actionbar", "vs/base/common/lifecycle", "vs/base/common/types", "vs/base/common/codicons", "vs/base/common/event", "vs/base/browser/ui/dropdown/dropdownActionViewItem", "vs/css!./toolbar"], function (require, exports, nls, actions_1, actionbar_1, lifecycle_1, types_1, codicons_1, event_1, dropdownActionViewItem_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.ToolBar = void 0;
    const toolBarMoreIcon = (0, codicons_1.registerCodicon)('toolbar-more', codicons_1.Codicon.more);
    /**
                ...
                actionViewItemProvider: (action) => {
                    ...
                    if (action.id === ToggleMenuAction.ID) {
                        this.toggleMenuActionViewItem = new dropdownActionViewItem_1.DropdownMenuActionViewItem(action, action.menuActions, contextMenuProvider, {
                            ...
                            classNames: codicons_1.CSSIcon.asClassNameArray((_a = options.moreIcon) !== null && _a !== void 0 ? _a : toolBarMoreIcon),
