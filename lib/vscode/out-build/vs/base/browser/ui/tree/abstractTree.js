...
define(["require", "exports", "vs/base/common/lifecycle", "vs/base/browser/ui/list/listWidget", "vs/base/browser/dom", "vs/base/common/event", "vs/base/browser/keyboardEvent", "vs/base/browser/ui/tree/tree", "vs/base/browser/dnd", "vs/base/common/arrays", "vs/base/browser/ui/list/listView", "vs/base/browser/event", "vs/base/common/filters", "vs/base/browser/ui/tree/indexTreeModel", "vs/nls!vs/base/browser/ui/tree/abstractTree", "vs/base/common/async", "vs/base/common/platform", "vs/base/common/numbers", "vs/base/common/collections", "vs/base/browser/ui/tree/treeIcons", "vs/css!./media/tree"], function (require, exports, lifecycle_1, listWidget_1, dom_1, event_1, keyboardEvent_1, tree_1, dnd_1, arrays_1, listView_1, event_2, filters_1, indexTreeModel_1, nls_1, async_1, platform_1, numbers_1, collections_1, treeIcons_1) {
    ...
    class TypeFilterController {
        constructor(tree, model, view, filter, keyboardNavigationDelegate) {
            ...
            (0, event_2.domEvent)(this.domNode, 'dragstart')(this.onDragStart, this, this.disposables);
            ...
            (0, event_2.domEvent)(this.filterOnTypeDomNode, 'input')(this.onDidChangeFilterOnType, this, this.disposables);
        ...
        enable() {
            ...
            const onKeyDown = event_1.Event.chain((0, event_2.domEvent)(this.view.getHTMLElement(), 'keydown'))
                ...
                .event;
            const onClear = (0, event_2.domEvent)(this.clearDomNode, 'click');
        ...
        onDragStart() {
            ...
            (0, event_2.domEvent)(document, 'dragover')(onDragOver, null, disposables);
            (0, event_2.domEvent)(this.domNode, 'dragend')(onDragEnd, null, disposables);
