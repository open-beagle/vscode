define(["require", "exports", "assert", "vs/base/common/uri", "vs/base/common/platform"], function (require, exports, assert, uri_1, platform_1) {
    ...
    suite('URI', () => {
        ...
        test('http#toString', () => {
            assert.strictEqual(uri_1.URI.from({ scheme: 'http', authority: 'www.msft.com', path: '/my/path' }).toString(), 'http://www.msft.com/my/path');
            assert.strictEqual(uri_1.URI.from({ scheme: 'http', authority: 'www.msft.com', path: '/my/path' }).toString(), 'http://www.msft.com/my/path');
            assert.strictEqual(uri_1.URI.from({ scheme: 'http', authority: 'www.MSFT.com', path: '/my/path' }).toString(), 'http://www.msft.com/my/path');
            assert.strictEqual(uri_1.URI.from({ scheme: 'http', authority: '', path: 'my/path' }).toString(), 'http:/my/path');
            assert.strictEqual(uri_1.URI.from({ scheme: 'http', authority: '', path: '/my/path' }).toString(), 'http:/my/path');
            //http://a-test-site.com/#test=true
            assert.strictEqual(uri_1.URI.from({ scheme: 'http', authority: 'a-test-site.com', path: '/', query: 'test=true' }).toString(), 'http://a-test-site.com/?test%3Dtrue');
            assert.strictEqual(uri_1.URI.from({ scheme: 'http', authority: 'a-test-site.com', path: '/', query: '', fragment: 'test=true' }).toString(), 'http://a-test-site.com/#test%3Dtrue');
        });
        test('http#toString, encode=FALSE', () => {
            assert.strictEqual(uri_1.URI.from({ scheme: 'http', authority: 'a-test-site.com', path: '/', query: 'test=true' }).toString(true), 'http://a-test-site.com/?test=true');
            assert.strictEqual(uri_1.URI.from({ scheme: 'http', authority: 'a-test-site.com', path: '/', query: '', fragment: 'test=true' }).toString(true), 'http://a-test-site.com/#test=true');
