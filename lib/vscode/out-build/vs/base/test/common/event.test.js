define(["require", "exports", "assert", "vs/base/common/event", "vs/base/common/lifecycle", "vs/base/common/errors", "vs/base/common/async", "vs/base/common/cancellation"], function (require, exports, assert, event_1, lifecycle_1, errors_1, async_1, cancellation_1) {
    "use strict";
    ...
    suite('AsyncEmitter', function () {
        test('event has waitUntil-function', async function () {
            let emitter = new async_1.AsyncEmitter();
            emitter.event(e => {
    ...
    suite('Event utils', () => {
        ...
        suite('fromPromise', () => {
            ...
            test('should emit when done - setTimeout', async () => {
                let count = 0;
                const promise = (0, async_1.timeout)(5);
