...
define(["require", "exports", "sinon", "assert", "vs/base/common/decorators"], function (require, exports, sinon, assert, decorators_1) {
    "use strict";
    ...
    suite('Decorators', () => {
        ...
        test('memoize clear', () => {
            const memoizer = (0, decorators_1.createMemoizer)();
            let counter = 0;
            class Foo {
                get answer() {
                    return ++counter;
