 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "assert", "vs/base/browser/ui/tree/objectTreeModel"], function (require, exports, assert, objectTreeModel_1) {
    "use strict";
        ...
        test('issue #95641', () => {
            ...
            const filter = new class {
                filter(element, parentVisibility) {
                    ...
                    return fn(element) ? 1 /* Visible */ : parentVisibility;
                }
            };
