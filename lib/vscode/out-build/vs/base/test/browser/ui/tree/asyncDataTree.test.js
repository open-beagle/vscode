 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "assert", "vs/base/browser/ui/tree/asyncDataTree", "vs/base/common/async"], function (require, exports, assert, asyncDataTree_1, async_1) {
    "use strict";
    ...
    suite('AsyncDataTree', function () {
        ...
        test('issues #84569, #82629 - rerender', async () => {
            ...
            const a = model.get('a');
            const b = model.get('b');
            (_a = a.children) === null || _a === void 0 ? void 0 : _a.splice(0, 1, { id: 'b', suffix: '2' });
            await Promise.all([
