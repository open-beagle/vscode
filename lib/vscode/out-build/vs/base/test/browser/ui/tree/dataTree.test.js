 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "assert", "vs/base/browser/ui/tree/dataTree"], function (require, exports, assert, dataTree_1) {
    "use strict";
    ...
    suite('DataTree', function () {
        ...
        setup(() => {
            ...
            tree = new dataTree_1.DataTree('test', container, delegate, [renderer], dataSource, {
                identityProvider
            });
            tree.layout(200);
        });
