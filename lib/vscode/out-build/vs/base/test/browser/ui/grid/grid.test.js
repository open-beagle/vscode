 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "assert", "vs/base/browser/ui/grid/grid", "./util", "vs/base/common/objects", "vs/base/common/event"], function (require, exports, assert, grid_1, util_1, objects_1, event_1) {
    "use strict";
    ...
    suite('Grid', function () {
        ...
        test('getRelativeLocation', () => {
            assert.deepStrictEqual((0, grid_1.getRelativeLocation)(0 /* VERTICAL */, [0], 0 /* Up */), [0]);
            assert.deepStrictEqual((0, grid_1.getRelativeLocation)(0 /* VERTICAL */, [0], 1 /* Down */), [1]);
            assert.deepStrictEqual((0, grid_1.getRelativeLocation)(0 /* VERTICAL */, [0], 2 /* Left */), [0, 0]);
            assert.deepStrictEqual((0, grid_1.getRelativeLocation)(0 /* VERTICAL */, [0], 3 /* Right */), [0, 1]);
            assert.deepStrictEqual((0, grid_1.getRelativeLocation)(1 /* HORIZONTAL */, [0], 0 /* Up */), [0, 0]);
            assert.deepStrictEqual((0, grid_1.getRelativeLocation)(1 /* HORIZONTAL */, [0], 1 /* Down */), [0, 1]);
            assert.deepStrictEqual((0, grid_1.getRelativeLocation)(1 /* HORIZONTAL */, [0], 2 /* Left */), [0]);
            assert.deepStrictEqual((0, grid_1.getRelativeLocation)(1 /* HORIZONTAL */, [0], 3 /* Right */), [1]);
            assert.deepStrictEqual((0, grid_1.getRelativeLocation)(0 /* VERTICAL */, [4], 0 /* Up */), [4]);
            assert.deepStrictEqual((0, grid_1.getRelativeLocation)(0 /* VERTICAL */, [4], 1 /* Down */), [5]);
            assert.deepStrictEqual((0, grid_1.getRelativeLocation)(0 /* VERTICAL */, [4], 2 /* Left */), [4, 0]);
            assert.deepStrictEqual((0, grid_1.getRelativeLocation)(0 /* VERTICAL */, [4], 3 /* Right */), [4, 1]);
            assert.deepStrictEqual((0, grid_1.getRelativeLocation)(0 /* VERTICAL */, [0, 0], 0 /* Up */), [0, 0, 0]);
            assert.deepStrictEqual((0, grid_1.getRelativeLocation)(0 /* VERTICAL */, [0, 0], 1 /* Down */), [0, 0, 1]);
            assert.deepStrictEqual((0, grid_1.getRelativeLocation)(0 /* VERTICAL */, [0, 0], 2 /* Left */), [0, 0]);
            assert.deepStrictEqual((0, grid_1.getRelativeLocation)(0 /* VERTICAL */, [0, 0], 3 /* Right */), [0, 1]);
            assert.deepStrictEqual((0, grid_1.getRelativeLocation)(0 /* VERTICAL */, [1, 2], 0 /* Up */), [1, 2, 0]);
            assert.deepStrictEqual((0, grid_1.getRelativeLocation)(0 /* VERTICAL */, [1, 2], 1 /* Down */), [1, 2, 1]);
            assert.deepStrictEqual((0, grid_1.getRelativeLocation)(0 /* VERTICAL */, [1, 2], 2 /* Left */), [1, 2]);
            assert.deepStrictEqual((0, grid_1.getRelativeLocation)(0 /* VERTICAL */, [1, 2], 3 /* Right */), [1, 3]);
            assert.deepStrictEqual((0, grid_1.getRelativeLocation)(0 /* VERTICAL */, [1, 2, 3], 0 /* Up */), [1, 2, 3]);
            assert.deepStrictEqual((0, grid_1.getRelativeLocation)(0 /* VERTICAL */, [1, 2, 3], 1 /* Down */), [1, 2, 4]);
            assert.deepStrictEqual((0, grid_1.getRelativeLocation)(0 /* VERTICAL */, [1, 2, 3], 2 /* Left */), [1, 2, 3, 0]);
            assert.deepStrictEqual((0, grid_1.getRelativeLocation)(0 /* VERTICAL */, [1, 2, 3], 3 /* Right */), [1, 2, 3, 1]);
        });
        test('empty', () => {
        ...
        test('getNeighborViews should work on single view layout', function () {
            ...
            container.appendChild(grid.element);
            grid.layout(800, 600);
            assert.deepStrictEqual(grid.getNeighborViews(view1, 0 /* Up */), []);
            assert.deepStrictEqual(grid.getNeighborViews(view1, 3 /* Right */), []);
            assert.deepStrictEqual(grid.getNeighborViews(view1, 1 /* Down */), []);
            assert.deepStrictEqual(grid.getNeighborViews(view1, 2 /* Left */), []);
            assert.deepStrictEqual(grid.getNeighborViews(view1, 0 /* Up */, true), [view1]);
            assert.deepStrictEqual(grid.getNeighborViews(view1, 3 /* Right */, true), [view1]);
            assert.deepStrictEqual(grid.getNeighborViews(view1, 1 /* Down */, true), [view1]);
            assert.deepStrictEqual(grid.getNeighborViews(view1, 2 /* Left */, true), [view1]);
        });
        test('getNeighborViews should work on simple layout', function () {
            ...
            assert.deepStrictEqual(grid.getNeighborViews(view1, 0 /* Up */), []);
            assert.deepStrictEqual(grid.getNeighborViews(view1, 3 /* Right */), []);
            assert.deepStrictEqual(grid.getNeighborViews(view1, 1 /* Down */), [view2]);
            assert.deepStrictEqual(grid.getNeighborViews(view1, 2 /* Left */), []);
            assert.deepStrictEqual(grid.getNeighborViews(view1, 0 /* Up */, true), [view3]);
            assert.deepStrictEqual(grid.getNeighborViews(view1, 3 /* Right */, true), [view1]);
            assert.deepStrictEqual(grid.getNeighborViews(view1, 1 /* Down */, true), [view2]);
            assert.deepStrictEqual(grid.getNeighborViews(view1, 2 /* Left */, true), [view1]);
            assert.deepStrictEqual(grid.getNeighborViews(view2, 0 /* Up */), [view1]);
            assert.deepStrictEqual(grid.getNeighborViews(view2, 3 /* Right */), []);
            assert.deepStrictEqual(grid.getNeighborViews(view2, 1 /* Down */), [view3]);
            assert.deepStrictEqual(grid.getNeighborViews(view2, 2 /* Left */), []);
            assert.deepStrictEqual(grid.getNeighborViews(view2, 0 /* Up */, true), [view1]);
            assert.deepStrictEqual(grid.getNeighborViews(view2, 3 /* Right */, true), [view2]);
            assert.deepStrictEqual(grid.getNeighborViews(view2, 1 /* Down */, true), [view3]);
            assert.deepStrictEqual(grid.getNeighborViews(view2, 2 /* Left */, true), [view2]);
            assert.deepStrictEqual(grid.getNeighborViews(view3, 0 /* Up */), [view2]);
            assert.deepStrictEqual(grid.getNeighborViews(view3, 3 /* Right */), []);
            assert.deepStrictEqual(grid.getNeighborViews(view3, 1 /* Down */), []);
            assert.deepStrictEqual(grid.getNeighborViews(view3, 2 /* Left */), []);
            assert.deepStrictEqual(grid.getNeighborViews(view3, 0 /* Up */, true), [view2]);
            assert.deepStrictEqual(grid.getNeighborViews(view3, 3 /* Right */, true), [view3]);
            assert.deepStrictEqual(grid.getNeighborViews(view3, 1 /* Down */, true), [view1]);
            assert.deepStrictEqual(grid.getNeighborViews(view3, 2 /* Left */, true), [view3]);
        });
        test('getNeighborViews should work on a complex layout', function () {
            ...
            assert.deepStrictEqual(grid.getNeighborViews(view1, 0 /* Up */), []);
            assert.deepStrictEqual(grid.getNeighborViews(view1, 3 /* Right */), []);
            assert.deepStrictEqual(grid.getNeighborViews(view1, 1 /* Down */), [view2, view4]);
            assert.deepStrictEqual(grid.getNeighborViews(view1, 2 /* Left */), []);
            assert.deepStrictEqual(grid.getNeighborViews(view2, 0 /* Up */), [view1]);
            assert.deepStrictEqual(grid.getNeighborViews(view2, 3 /* Right */), [view4, view5]);
            assert.deepStrictEqual(grid.getNeighborViews(view2, 1 /* Down */), [view3]);
            assert.deepStrictEqual(grid.getNeighborViews(view2, 2 /* Left */), []);
            assert.deepStrictEqual(grid.getNeighborViews(view4, 0 /* Up */), [view1]);
            assert.deepStrictEqual(grid.getNeighborViews(view4, 3 /* Right */), []);
            assert.deepStrictEqual(grid.getNeighborViews(view4, 1 /* Down */), [view5]);
            assert.deepStrictEqual(grid.getNeighborViews(view4, 2 /* Left */), [view2]);
            assert.deepStrictEqual(grid.getNeighborViews(view5, 0 /* Up */), [view4]);
            assert.deepStrictEqual(grid.getNeighborViews(view5, 3 /* Right */), []);
            assert.deepStrictEqual(grid.getNeighborViews(view5, 1 /* Down */), [view3]);
            assert.deepStrictEqual(grid.getNeighborViews(view5, 2 /* Left */), [view2]);
            assert.deepStrictEqual(grid.getNeighborViews(view3, 0 /* Up */), [view2, view5]);
            assert.deepStrictEqual(grid.getNeighborViews(view3, 3 /* Right */), []);
            assert.deepStrictEqual(grid.getNeighborViews(view3, 1 /* Down */), []);
            assert.deepStrictEqual(grid.getNeighborViews(view3, 2 /* Left */), []);
        });
        test('getNeighborViews should work on another simple layout', function () {
            ...
            const view4 = new util_1.TestView(50, Number.MAX_VALUE, 50, Number.MAX_VALUE);
            grid.addView(view4, grid_1.Sizing.Distribute, view2, 3 /* Right */);
            assert.deepStrictEqual(grid.getNeighborViews(view4, 0 /* Up */), []);
            assert.deepStrictEqual(grid.getNeighborViews(view4, 3 /* Right */), []);
            assert.deepStrictEqual(grid.getNeighborViews(view4, 1 /* Down */), [view3]);
            assert.deepStrictEqual(grid.getNeighborViews(view4, 2 /* Left */), [view2]);
        });
        test('getNeighborViews should only return immediate neighbors', function () {
            ...
            const view4 = new util_1.TestView(50, Number.MAX_VALUE, 50, Number.MAX_VALUE);
            grid.addView(view4, grid_1.Sizing.Distribute, view2, 3 /* Right */);
            assert.deepStrictEqual(grid.getNeighborViews(view1, 3 /* Right */), [view2, view3]);
        });
    });
    ...
    suite('SerializableGrid', function () {
        ...
        test('createSerializedGrid - issue #85601, should not allow single children groups', () => {
            const serializedGrid = (0, grid_1.createSerializedGrid)({ orientation: 1 /* HORIZONTAL */, groups: [{ groups: [{}, {}], size: 0.5 }, { groups: [{}], size: 0.5 }] });
            const views = [];
