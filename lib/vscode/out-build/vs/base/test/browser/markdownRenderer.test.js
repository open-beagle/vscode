 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "assert", "vs/base/common/marked/marked", "vs/base/browser/markdownRenderer", "vs/base/common/htmlContent", "vs/base/common/uri", "vs/base/common/marshalling"], function (require, exports, assert, marked, markdownRenderer_1, htmlContent_1, uri_1, marshalling_1) {
    "use strict";
    ...
    suite('MarkdownRenderer', () => {
        suite('Images', () => {
            ...
            test('image width from title params', () => {
                let result = (0, markdownRenderer_1.renderMarkdown)({ value: `![image](someimageurl|width=100 'caption')` });
                assert.strictEqual(result.innerHTML, `<p><img src="someimageurl" alt="image" title="caption" width="100"></p>`);
            });
            test('image height from title params', () => {
                let result = (0, markdownRenderer_1.renderMarkdown)({ value: `![image](someimageurl|height=100 'caption')` });
                assert.strictEqual(result.innerHTML, `<p><img src="someimageurl" alt="image" title="caption" height="100"></p>`);
            });
            test('image width and height from title params', () => {
                let result = (0, markdownRenderer_1.renderMarkdown)({ value: `![image](someimageurl|height=200,width=100 'caption')` });
        ...
        suite('ThemeIcons Support On', () => {
            test('render appendText', () => {
                ...
                let result = (0, markdownRenderer_1.renderMarkdown)(mds);
