 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "assert", "vs/editor/common/commands/trimTrailingWhitespaceCommand", "vs/editor/common/core/position", "vs/editor/common/core/range", "vs/editor/common/core/selection", "vs/editor/test/browser/testCommand", "vs/editor/test/common/editorTestUtils"], function (require, exports, assert, trimTrailingWhitespaceCommand_1, position_1, range_1, selection_1, testCommand_1, editorTestUtils_1) {
    "use strict";
    ...
    function assertTrimTrailingWhitespaceCommand(text, expected) {
        return (0, editorTestUtils_1.withEditorModel)(text, (model) => {
