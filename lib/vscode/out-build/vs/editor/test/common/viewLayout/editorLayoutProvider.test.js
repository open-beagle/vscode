...
define(["require", "exports", "assert", "vs/editor/common/config/editorOptions", "vs/editor/common/config/commonEditorConfig"], function (require, exports, assert, editorOptions_1, commonEditorConfig_1) {
    ...
    suite('Editor ViewLayout - EditorLayoutProvider', () => {
        function doTest(input, expected) {
            ...
            options._write(46 /* glyphMargin */, input.showGlyphMargin);
            options._write(57 /* lineNumbersMinChars */, input.lineNumbersMinChars);
            options._write(54 /* lineDecorationsWidth */, input.lineDecorationsWidth);
            options._write(35 /* folding */, false);
            ...
            options._write(61 /* minimap */, minimapOptions);
            ...
            options._write(89 /* scrollbar */, scrollbarOptions);
            const lineNumbersOptions = {
                renderType: input.showLineNumbers ? 1 /* On */ : 0 /* Off */,
                renderFn: null
            };
            options._write(56 /* lineNumbers */, lineNumbersOptions);
            options._write(113 /* wordWrap */, 'off');
            options._write(116 /* wordWrapColumn */, 80);
            options._write(117 /* wordWrapOverride1 */, 'inherit');
            options._write(118 /* wordWrapOverride2 */, 'inherit');
            options._write(2 /* accessibilitySupport */, 'auto');
