...
define(["require", "exports", "assert", "vs/editor/common/modes/supports/tokenization"], function (require, exports, assert, tokenization_1) {
    ...
    suite('Token theme matching', () => {
        test('gives higher priority to deeper matches', () => {
            ...
            assert.deepStrictEqual(actual, new tokenization_1.ThemeTrieElementRule(0 /* None */, _D, _B));
        });
        test('can match', () => {
            let theme = tokenization_1.TokenTheme.createFromRawTokenTheme([
    ...
    suite('Token theme resolving', () => {
        ...
        test('always has defaults', () => {
            ...
            assert.deepStrictEqual(actual.getThemeTrieElement(), new tokenization_1.ExternalThemeTrieElement(new tokenization_1.ThemeTrieElementRule(0 /* None */, _A, _B)));
        });
        ...
        test('respects incoming defaults 3', () => {
            ...
            const _B = colorMap.getId('ffffff');
            assert.deepStrictEqual(actual.getColorMap(), colorMap.getColorMap());
            assert.deepStrictEqual(actual.getThemeTrieElement(), new tokenization_1.ExternalThemeTrieElement(new tokenization_1.ThemeTrieElementRule(2 /* Bold */, _A, _B)));
        });
        ...
        test('defaults are inherited', () => {
            ...
            assert.deepStrictEqual(actual.getColorMap(), colorMap.getColorMap());
            const root = new tokenization_1.ExternalThemeTrieElement(new tokenization_1.ThemeTrieElementRule(0 /* None */, _A, _B), {
        ...
        test('custom colors are first in color map', () => {
            let actual = tokenization_1.TokenTheme.createFromParsedTokenTheme([
                new tokenization_1.ParsedTokenThemeRule('var', -1, -1 /* NotSet */, 'F8F8F2', null)
            ], [
