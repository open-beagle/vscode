 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "assert", "vs/editor/common/core/position", "vs/editor/common/core/range", "vs/editor/common/core/token", "vs/editor/common/modes", "vs/editor/common/modes/nullMode", "vs/editor/common/viewModel/monospaceLineBreaksComputer", "vs/editor/common/viewModel/splitLinesCollection", "vs/editor/common/viewModel/viewModel", "vs/editor/test/common/mocks/testConfiguration", "vs/editor/test/common/editorTestUtils"], function (require, exports, assert, position_1, range_1, token_1, modes, nullMode_1, monospaceLineBreaksComputer_1, splitLinesCollection_1, viewModel_1, testConfiguration_1, editorTestUtils_1) {
    "use strict";
    ...
    suite('Editor ViewModel - SplitLinesCollection', () => {
        ...
        function withSplitLinesCollection(text, callback) {
            ...
            const wrappingInfo = config.options.get(127 /* wrappingInfo */);
            const fontInfo = config.options.get(40 /* fontInfo */);
            const wordWrapBreakAfterCharacters = config.options.get(114 /* wordWrapBreakAfterCharacters */);
            const wordWrapBreakBeforeCharacters = config.options.get(115 /* wordWrapBreakBeforeCharacters */);
            const wrappingIndent = config.options.get(119 /* wrappingIndent */);
            ...
            const linesCollection = new splitLinesCollection_1.SplitLinesCollection(model, lineBreaksComputerFactory, lineBreaksComputerFactory, fontInfo, model.getOptions().tabSize, 'simple', wrappingInfo.wrappingColumn, wrappingIndent);
    ...
    suite('SplitLinesCollection', () => {
        ...
        setup(() => {
            ...
            model = (0, editorTestUtils_1.createTextModel)(_text.join('\n'), undefined, new modes.LanguageIdentifier(LANGUAGE_ID, 0));
            // force tokenization
        ...
        function withSplitLinesCollection(model, wordWrap, wordWrapColumn, callback) {
            ...
            const wrappingInfo = configuration.options.get(127 /* wrappingInfo */);
            const fontInfo = configuration.options.get(40 /* fontInfo */);
            const wordWrapBreakAfterCharacters = configuration.options.get(114 /* wordWrapBreakAfterCharacters */);
            const wordWrapBreakBeforeCharacters = configuration.options.get(115 /* wordWrapBreakBeforeCharacters */);
            const wrappingIndent = configuration.options.get(119 /* wrappingIndent */);
            const lineBreaksComputerFactory = new monospaceLineBreaksComputer_1.MonospaceLineBreaksComputerFactory(wordWrapBreakBeforeCharacters, wordWrapBreakAfterCharacters);
            const linesCollection = new splitLinesCollection_1.SplitLinesCollection(model, lineBreaksComputerFactory, lineBreaksComputerFactory, fontInfo, model.getOptions().tabSize, 'simple', wrappingInfo.wrappingColumn, wrappingIndent);
    ...
    function createSplitLine(splitLengths, breakingOffsetsVisibleColumn, wrappedTextIndentWidth, isVisible = true) {
        return new splitLinesCollection_1.SplitLine(createLineBreakData(splitLengths, breakingOffsetsVisibleColumn, wrappedTextIndentWidth), isVisible);
    }
    function createLineBreakData(breakingLengths, breakingOffsetsVisibleColumn, wrappedTextIndentWidth) {
        ...
        return new viewModel_1.LineBreakData(sums, breakingOffsetsVisibleColumn, wrappedTextIndentWidth);
    }
