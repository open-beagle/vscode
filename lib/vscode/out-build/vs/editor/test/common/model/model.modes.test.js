 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "assert", "vs/editor/common/core/editOperation", "vs/editor/common/core/position", "vs/editor/common/core/range", "vs/editor/common/core/token", "vs/editor/common/modes", "vs/editor/common/modes/nullMode", "vs/editor/test/common/editorTestUtils"], function (require, exports, assert, editOperation_1, position_1, range_1, token_1, modes, nullMode_1, editorTestUtils_1) {
    "use strict";
    ...
    suite('Editor Model - Model Modes 1', () => {
        ...
        setup(() => {
            ...
            thisModel = (0, editorTestUtils_1.createTextModel)(TEXT, undefined, new modes.LanguageIdentifier(LANGUAGE_ID, 0));
        });
        teardown(() => {
            thisModel.dispose();
