define(["require", "exports", "assert", "vs/editor/common/core/range", "vs/editor/test/common/editorTestUtils"], function (require, exports, assert, range_1, editorTestUtils_1) {
    "use strict";
    ...
    suite('Editor Model - Model Edit Operation', () => {
        ...
        setup(() => {
            const text = LINE1 + '\r\n' +
                ...
                LINE4 + '\r\n' +
                LINE5;
            model = (0, editorTestUtils_1.createTextModel)(text);
        });
        teardown(() => {
            model.dispose();
        });
