define(["require", "exports", "assert", "vs/editor/standalone/browser/simpleServices", "vs/platform/contextkey/browser/contextKeyService", "vs/platform/instantiation/common/instantiationService", "vs/platform/instantiation/common/serviceCollection", "vs/platform/log/common/log", "vs/platform/telemetry/common/telemetryUtils"], function (require, exports, assert, simpleServices_1, contextKeyService_1, instantiationService_1, serviceCollection_1, log_1, telemetryUtils_1) {
    ...
    suite('StandaloneKeybindingService', () => {
        ...
        test('issue microsoft/monaco-editor#167', () => {
            ...
            let keybindingService = new TestStandaloneKeybindingService(contextKeyService, commandService, telemetryUtils_1.NullTelemetryService, notificationService, new log_1.NullLogService(), domElement);
