 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "vs/editor/common/controller/cursorCommon", "vs/editor/common/core/position", "vs/editor/common/core/range", "vs/base/common/strings", "vs/editor/common/controller/cursorAtomicMoveOperations"], function (require, exports, cursorCommon_1, position_1, range_1, strings, cursorAtomicMoveOperations_1) {
    "use strict";
    ...
    class MoveOperations {
        ...
        static leftPositionAtomicSoftTabs(model, lineNumber, column, tabSize) {
            ...
            const newPosition = cursorAtomicMoveOperations_1.AtomicTabMoveOperations.atomicPosition(lineContent, column - 1, tabSize, 0 /* Left */);
