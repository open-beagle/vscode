...
define(["require", "exports", "vs/base/common/network", "vs/base/common/resources", "vs/editor/common/modes/modesRegistry", "vs/platform/files/common/files"], function (require, exports, network_1, resources_1, modesRegistry_1, files_1) {
    ...
    exports.cssEscape = exports.detectModeId = exports.getIconClassesForModeId = exports.getIconClasses = void 0;
    ...
    function getIconClassesForModeId(modeId) {
        return ['file-icon', `${cssEscape(modeId)}-lang-file-icon`];
    }
    exports.getIconClassesForModeId = getIconClassesForModeId;
