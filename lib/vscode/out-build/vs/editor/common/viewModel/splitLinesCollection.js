...
define(["require", "exports", "vs/base/common/arrays", "vs/editor/common/core/position", "vs/editor/common/core/range", "vs/editor/common/model/textModel", "vs/editor/common/view/viewEvents", "vs/editor/common/viewModel/prefixSumComputer", "vs/editor/common/viewModel/viewModel"], function (require, exports, arrays, position_1, range_1, textModel_1, viewEvents, prefixSumComputer_1, viewModel_1) {
    ...
    class SplitLine {
        ...
        getInputStartOffsetOfOutputLineIndex(outputLineIndex) {
            return viewModel_1.LineBreakData.getInputOffsetOfOutputPosition(this._lineBreakData.breakOffsets, outputLineIndex, 0);
        }
        getInputEndOffsetOfOutputLineIndex(model, modelLineNumber, outputLineIndex) {
            ...
            return viewModel_1.LineBreakData.getInputOffsetOfOutputPosition(this._lineBreakData.breakOffsets, outputLineIndex + 1, 0);
        }
        ...
        getModelColumnOfViewPosition(outputLineIndex, outputColumn) {
            ...
            return viewModel_1.LineBreakData.getInputOffsetOfOutputPosition(this._lineBreakData.breakOffsets, outputLineIndex, adjustedColumn) + 1;
        }
        getViewPositionOfModelPosition(deltaLineNumber, inputColumn) {
            if (!this._isVisible) {
                throw new Error('Not supported');
            }
            let r = viewModel_1.LineBreakData.getOutputPositionOfInputOffset(this._lineBreakData.breakOffsets, inputColumn - 1);
        ...
        getViewLineNumberOfModelPosition(deltaLineNumber, inputColumn) {
            ...
            const r = viewModel_1.LineBreakData.getOutputPositionOfInputOffset(this._lineBreakData.breakOffsets, inputColumn - 1);
