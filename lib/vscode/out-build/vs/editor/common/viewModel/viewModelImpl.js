    ...
    class ViewModel extends lifecycle_1.Disposable {
        constructor(editorId, configuration, model, domLineBreaksComputerFactory, monospaceLineBreaksComputerFactory, scheduleAtNextAnimationFrame) {
            ...
            if (USE_IDENTITY_LINES_COLLECTION && this.model.isTooLargeForTokenization()) {
                ...
                const wrappingStrategy = options.get(120 /* wrappingStrategy */);
                const wrappingInfo = options.get(127 /* wrappingInfo */);
                const wrappingIndent = options.get(119 /* wrappingIndent */);
        ...
        getVisibleRangesPlusViewportAboveBelow() {
            const layoutInfo = this._configuration.options.get(126 /* layoutInfo */);
