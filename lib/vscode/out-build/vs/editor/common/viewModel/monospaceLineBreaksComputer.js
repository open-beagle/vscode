 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "vs/base/common/strings", "vs/editor/common/core/characterClassifier", "vs/editor/common/viewModel/viewModel"], function (require, exports, strings, characterClassifier_1, viewModel_1) {
    "use strict";
    ...
    class MonospaceLineBreaksComputerFactory {
        ...
        static create(options) {
            return new MonospaceLineBreaksComputerFactory(options.get(115 /* wordWrapBreakBeforeCharacters */), options.get(114 /* wordWrapBreakAfterCharacters */));
        }
    ...
    function createLineBreaks(classifier, lineText, tabSize, firstLineBreakColumn, columnsForFullWidthChar, wrappingIndent) {
        ...
        return new viewModel_1.LineBreakData(breakingOffsets, breakingOffsetsVisibleColumn, wrappedTextIndentLength);
    }
