 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "vs/nls!vs/editor/contrib/multicursor/multicursor", "vs/base/common/async", "vs/base/common/keyCodes", "vs/base/common/lifecycle", "vs/base/browser/ui/aria/aria", "vs/editor/browser/editorExtensions", "vs/editor/common/controller/cursorMoveCommands", "vs/editor/common/core/range", "vs/editor/common/core/selection", "vs/editor/common/editorContextKeys", "vs/editor/common/model", "vs/editor/common/model/textModel", "vs/editor/common/modes", "vs/editor/contrib/find/findController", "vs/platform/actions/common/actions", "vs/platform/theme/common/colorRegistry", "vs/platform/theme/common/themeService", "vs/platform/contextkey/common/contextkey"], function (require, exports, nls, async_1, keyCodes_1, lifecycle_1, aria_1, editorExtensions_1, cursorMoveCommands_1, range_1, selection_1, editorContextKeys_1, model_1, textModel_1, modes_1, findController_1, actions_1, colorRegistry_1, themeService_1, contextkey_1) {
    "use strict";
    ...
    class InsertCursorAbove extends editorExtensions_1.EditorAction {
        ...
        run(accessor, editor, args) {
            ...
            viewModel.setCursorStates(args.source, 3 /* Explicit */, cursorMoveCommands_1.CursorMoveCommands.addCursorUp(viewModel, previousCursorState, useLogicalLine));
    ...
    class InsertCursorBelow extends editorExtensions_1.EditorAction {
        ...
        run(accessor, editor, args) {
            ...
            viewModel.pushStackElement();
            const previousCursorState = viewModel.getCursorStates();
            viewModel.setCursorStates(args.source, 3 /* Explicit */, cursorMoveCommands_1.CursorMoveCommands.addCursorDown(viewModel, previousCursorState, useLogicalLine));
    ...
    class MultiCursorSession {
        ...
        _getNextMatch() {
            ...
            const nextMatch = this._editor.getModel().findNextMatch(this.searchText, lastAddedSelection.getEndPosition(), false, this.matchCase, this.wholeWord ? this._editor.getOption(112 /* wordSeparators */) : null, false);
            if (!nextMatch) {
                return null;
            }
        ...
        _getPreviousMatch() {
            ...
            const allSelections = this._editor.getSelections();
            const lastAddedSelection = allSelections[allSelections.length - 1];
            const previousMatch = this._editor.getModel().findPreviousMatch(this.searchText, lastAddedSelection.getStartPosition(), false, this.matchCase, this.wholeWord ? this._editor.getOption(112 /* wordSeparators */) : null, false);
            if (!previousMatch) {
                return null;
            }
        ...
        selectAll() {
            ...
            this.findController.highlightFindOptions();
            return this._editor.getModel().findMatches(this.searchText, true, false, this.matchCase, this.wholeWord ? this._editor.getOption(112 /* wordSeparators */) : null, false, 1073741824 /* MAX_SAFE_SMALL_INTEGER */);
        }
    }
    ...
    class MultiCursorSelectionController extends lifecycle_1.Disposable {
        ...
        selectAll(findController) {
            ...
            if (findState.isRevealed && findState.searchString.length > 0 && findState.isRegex) {
                matches = this._editor.getModel().findMatches(findState.searchString, true, findState.isRegex, findState.matchCase, findState.wholeWord ? this._editor.getOption(112 /* wordSeparators */) : null, false, 1073741824 /* MAX_SAFE_SMALL_INTEGER */);
            }
            else {
                this._beginSessionIfNeeded(findController);
                if (!this._session) {
    ...
    class MoveSelectionToNextFindMatchAction extends MultiCursorSelectionControllerAction {
        constructor() {
            super({
                ...
                kbOpts: {
                    kbExpr: editorContextKeys_1.EditorContextKeys.focus,
                    primary: (0, keyCodes_1.KeyChord)(2048 /* CtrlCmd */ | 41 /* KEY_K */, 2048 /* CtrlCmd */ | 34 /* KEY_D */),
                    weight: 100 /* EditorContrib */
                }
            });
        }
    ...
    class SelectionHighlighter extends lifecycle_1.Disposable {
        ...
        static _createState(isEnabled, editor) {
            ...
            return new SelectionHighlighterState(r.searchText, r.matchCase, r.wholeWord ? editor.getOption(112 /* wordSeparators */) : null, editor.getModel().getVersionId());
        }
        _setState(state) {
            ...
            const hasFindOccurrences = modes_1.DocumentHighlightProviderRegistry.has(model) && this.editor.getOption(68 /* occurrencesHighlight */);
