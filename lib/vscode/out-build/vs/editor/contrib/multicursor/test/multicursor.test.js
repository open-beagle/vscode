define(["require", "exports", "assert", "vs/base/common/event", "vs/editor/common/core/selection", "vs/editor/contrib/find/findController", "vs/editor/contrib/multicursor/multicursor", "vs/editor/test/browser/testCodeEditor", "vs/platform/instantiation/common/serviceCollection", "vs/platform/storage/common/storage"], function (require, exports, assert, event_1, selection_1, findController_1, multicursor_1, testCodeEditor_1, serviceCollection_1, storage_1) {
    "use strict";
    ...
    suite('Multicursor', () => {
        test('issue #2205: Multi-cursor pastes in reverse order', () => {
            (0, testCodeEditor_1.withTestCodeEditor)([
                ...
                editor.trigger('test', "paste" /* Paste */, {
                    text: '1\n2',
                    multicursorText: [
                        '1',
                        '2'
    ...
    suite('Multicursor selection', () => {
        ...
        test('issue #6661: AddSelectionToNextFindMatchAction can work with touching ranges', () => {
            (0, testCodeEditor_1.withTestCodeEditor)([
                ...
                editor.trigger('test', "type" /* Type */, { text: 'z' });
                assert.deepStrictEqual(editor.getSelections().map(fromRange), [
                    [1, 2, 1, 2],
                    [1, 3, 1, 3],
                    [2, 2, 2, 2],
