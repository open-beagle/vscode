 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "assert", "../outlineModel", "vs/editor/common/modes", "vs/editor/common/core/range", "vs/platform/markers/common/markers", "vs/editor/test/common/editorTestUtils", "vs/base/common/uri", "vs/base/common/cancellation"], function (require, exports, assert, outlineModel_1, modes_1, range_1, markers_1, editorTestUtils_1, uri_1, cancellation_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    suite('OutlineModel', function () {
        test('OutlineModel#create, cached', async function () {
            let model = (0, editorTestUtils_1.createTextModel)('foo', undefined, undefined, uri_1.URI.file('/fome/path.foo'));
            let count = 0;
            ...
            await outlineModel_1.OutlineModel.create(model, cancellation_1.CancellationToken.None);
