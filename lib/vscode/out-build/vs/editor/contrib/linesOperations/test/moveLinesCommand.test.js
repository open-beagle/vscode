define(["require", "exports", "vs/editor/common/core/selection", "vs/editor/common/modes", "vs/editor/common/modes/languageConfigurationRegistry", "vs/editor/contrib/linesOperations/moveLinesCommand", "vs/editor/test/browser/testCommand", "vs/editor/test/common/mocks/mockMode"], function (require, exports, selection_1, modes_1, languageConfigurationRegistry_1, moveLinesCommand_1, testCommand_1, mockMode_1) {
    ...
    function testMoveLinesDownCommand(lines, selection, expectedLines, expectedSelection) {
        (0, testCommand_1.testCommand)(lines, null, selection, (sel) => new moveLinesCommand_1.MoveLinesCommand(sel, true, 3 /* Advanced */), expectedLines, expectedSelection);
    }
    function testMoveLinesUpCommand(lines, selection, expectedLines, expectedSelection) {
        (0, testCommand_1.testCommand)(lines, null, selection, (sel) => new moveLinesCommand_1.MoveLinesCommand(sel, false, 3 /* Advanced */), expectedLines, expectedSelection);
    }
    function testMoveLinesDownWithIndentCommand(languageId, lines, selection, expectedLines, expectedSelection) {
        (0, testCommand_1.testCommand)(lines, languageId, selection, (sel) => new moveLinesCommand_1.MoveLinesCommand(sel, true, 4 /* Full */), expectedLines, expectedSelection);
    }
    function testMoveLinesUpWithIndentCommand(languageId, lines, selection, expectedLines, expectedSelection) {
        (0, testCommand_1.testCommand)(lines, languageId, selection, (sel) => new moveLinesCommand_1.MoveLinesCommand(sel, false, 4 /* Full */), expectedLines, expectedSelection);
    }
    ...
    class EnterRulesMode extends mockMode_1.MockMode {
        constructor() {
    ...
    EnterRulesMode._id = new modes_1.LanguageIdentifier('moveLinesEnterMode', 8);
    suite('Editor - contrib - Move Lines Command honors onEnter Rules', () => {
        test('issue #54829. move block across block', () => {
            ...
            testMoveLinesDownWithIndentCommand(mode.getLanguageIdentifier(), [
                ...
                '    }',
                '}'
            ], new selection_1.Selection(4, 9, 6, 10));
            mode.dispose();
        });
    });
});
