define(["require", "exports", "assert", "vs/editor/browser/controller/coreCommands", "vs/editor/common/core/position", "vs/editor/common/core/selection", "vs/editor/contrib/linesOperations/linesOperations", "vs/editor/test/browser/testCodeEditor", "vs/editor/test/common/editorTestUtils"], function (require, exports, assert, coreCommands_1, position_1, selection_1, linesOperations_1, testCodeEditor_1, editorTestUtils_1) {
    ...
    suite('Editor Contrib - Line Operations', () => {
        ...
        suite('DeleteAllLeftAction', () => {
            ...
            test('issue #36234: should push undo stop', () => {
                (0, testCodeEditor_1.withTestCodeEditor)([
                    ...
                    let deleteAllLeftAction = new linesOperations_1.DeleteAllLeftAction();
                    editor.setSelection(new selection_1.Selection(1, 1, 1, 1));
                    editor.trigger('keyboard', "type" /* Type */, { text: 'Typing some text here on line ' });
        ...
        suite('JoinLinesAction', () => {
            ...
            test('should push undo stop', function () {
                (0, testCodeEditor_1.withTestCodeEditor)([
                    ...
                    editor.trigger('keyboard', "type" /* Type */, { text: ' my dear' });
        ...
        test('Indenting on empty line should move cursor', () => {
            ...
            (0, testCodeEditor_1.withTestCodeEditor)(null, { model: model, useTabStops: false }, (editor) => {
                const indentLinesAction = new linesOperations_1.IndentLinesAction();
                editor.setPosition(new position_1.Position(1, 1));
                executeAction(indentLinesAction, editor);
                assert.strictEqual(model.getLineContent(1), '    ');
