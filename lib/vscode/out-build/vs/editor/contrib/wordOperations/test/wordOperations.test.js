 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "assert", "vs/editor/common/core/position", "vs/editor/common/core/selection", "vs/editor/contrib/wordOperations/test/wordTestUtils", "vs/editor/contrib/wordOperations/wordOperations", "vs/editor/test/browser/testCodeEditor", "vs/editor/browser/controller/coreCommands", "vs/editor/common/modes", "vs/editor/test/common/mocks/mockMode", "vs/editor/common/modes/languageConfigurationRegistry", "vs/editor/test/common/editorTestUtils"], function (require, exports, assert, position_1, selection_1, wordTestUtils_1, wordOperations_1, testCodeEditor_1, coreCommands_1, modes_1, mockMode_1, languageConfigurationRegistry_1, editorTestUtils_1) {
    "use strict";
    ...
    suite('WordOperations', () => {
        ...
        test('deleteWordLeft - issue #91855: Matching (quote, bracket, paren) doesn\'t get deleted when hitting Ctrl+Backspace', () => {
            const languageId = new modes_1.LanguageIdentifier('myTestMode', 5);
            class TestMode extends mockMode_1.MockMode {
                constructor() {
                    super(languageId);
            ...
            const model = (0, editorTestUtils_1.createTextModel)('a ""', undefined, languageId);
