...
define(["require", "exports", "vs/base/browser/dom", "vs/base/browser/event", "vs/base/browser/ui/aria/aria", "vs/base/browser/ui/scrollbar/scrollableElement", "vs/base/common/event", "vs/base/common/lifecycle", "vs/editor/common/services/modeService", "vs/editor/browser/core/markdownRenderer", "vs/editor/contrib/parameterHints/provideSignatureHelp", "vs/nls!vs/editor/contrib/parameterHints/parameterHintsWidget", "vs/platform/contextkey/common/contextkey", "vs/platform/opener/common/opener", "vs/platform/theme/common/colorRegistry", "vs/platform/theme/common/themeService", "vs/editor/contrib/parameterHints/parameterHintsModel", "vs/base/common/strings", "vs/base/common/codicons", "vs/base/common/types", "vs/platform/theme/common/theme", "vs/platform/theme/common/iconRegistry", "vs/css!./parameterHints"], function (require, exports, dom, event_1, aria, scrollableElement_1, event_2, lifecycle_1, modeService_1, markdownRenderer_1, provideSignatureHelp_1, nls, contextkey_1, opener_1, colorRegistry_1, themeService_1, parameterHintsModel_1, strings_1, codicons_1, types_1, theme_1, iconRegistry_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.ParameterHintsWidget = void 0;
    const $ = dom.$;
    const parameterHintsNextIcon = (0, iconRegistry_1.registerIcon)('parameter-hints-next', codicons_1.Codicon.chevronDown, nls.localize(0, null));
    const parameterHintsPreviousIcon = (0, iconRegistry_1.registerIcon)('parameter-hints-previous', codicons_1.Codicon.chevronUp, nls.localize(1, null));
    let ParameterHintsWidget = class ParameterHintsWidget extends lifecycle_1.Disposable {
        ...
        createParamaterHintDOMNodes() {
            ...
            const onPreviousClick = (0, event_1.stop)((0, event_1.domEvent)(previous, 'click'));
            this._register(onPreviousClick(this.previous, this));
            const onNextClick = (0, event_1.stop)((0, event_1.domEvent)(next, 'click'));
        ...
        render(hints) {
            ...
            if (activeParameter) {
                ...
                if (this.announcedLabel !== labelToAnnounce) {
                    aria.alert(nls.localize(2, null, labelToAnnounce));
    ...
    (0, themeService_1.registerThemingParticipant)((theme, collector) => {
        ...
        if (border) {
            const borderWidth = theme.type === theme_1.ColorScheme.HIGH_CONTRAST ? 2 : 1;
