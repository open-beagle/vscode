...
define(["require", "exports", "vs/nls!vs/editor/contrib/rename/rename", "vs/base/common/errors", "vs/platform/contextkey/common/contextkey", "vs/platform/progress/common/progress", "vs/editor/browser/editorExtensions", "vs/editor/common/editorContextKeys", "./renameInputField", "vs/editor/common/modes", "vs/editor/common/core/position", "vs/base/browser/ui/aria/aria", "vs/editor/common/core/range", "vs/editor/contrib/message/messageController", "vs/editor/browser/core/editorState", "vs/platform/notification/common/notification", "vs/editor/browser/services/bulkEditService", "vs/base/common/uri", "vs/editor/browser/services/codeEditorService", "vs/base/common/cancellation", "vs/base/common/lifecycle", "vs/base/common/async", "vs/platform/log/common/log", "vs/platform/instantiation/common/instantiation", "vs/platform/registry/common/platform", "vs/platform/configuration/common/configurationRegistry", "vs/editor/common/services/textResourceConfigurationService", "vs/base/common/types"], function (require, exports, nls, errors_1, contextkey_1, progress_1, editorExtensions_1, editorContextKeys_1, renameInputField_1, modes_1, position_1, aria_1, range_1, messageController_1, editorState_1, notification_1, bulkEditService_1, uri_1, codeEditorService_1, cancellation_1, lifecycle_1, async_1, log_1, instantiation_1, platform_1, configurationRegistry_1, textResourceConfigurationService_1, types_1) {
    ...
    class RenameSkeleton {
        ...
        async _provideRenameEdits(newName, i, rejects, token) {
            ...
            if (!result) {
                return this._provideRenameEdits(newName, i + 1, rejects.concat(nls.localize(0, null)), token);
            }
    ...
    let RenameController = class RenameController {
        ...
        async run() {
            ...
            try {
                ...
                messageController_1.MessageController.get(this.editor).showMessage(e || nls.localize(1, null), position);
                return undefined;
            }
            if (!loc) {
                return undefined;
            ...
            const renameOperation = (0, async_1.raceCancellation)(skeleton.provideRenameEdits(inputFieldResult.newName, this._cts.token), this._cts.token).then(async (renameResult) => {
                ...
                this._bulkEditService.apply(bulkEditService_1.ResourceEdit.convert(renameResult), {
                    ...
                    label: nls.localize(2, null, loc === null || loc === void 0 ? void 0 : loc.text),
                    quotableLabel: nls.localize(3, null, loc === null || loc === void 0 ? void 0 : loc.text),
                }).then(result => {
                    if (result.ariaSummary) {
                        (0, aria_1.alert)(nls.localize(4, null, loc.text, inputFieldResult.newName, result.ariaSummary));
                    }
                }).catch(err => {
                    this._notificationService.error(nls.localize(5, null));
                    this._logService.error(err);
                });
            }, err => {
                this._notificationService.error(nls.localize(6, null));
                this._logService.error(err);
            });
    ...
    // ---- api bridge command
    (0, editorExtensions_1.registerModelAndPositionCommand)('_executeDocumentRenameProvider', function (model, position, ...args) {
        const [newName] = args;
