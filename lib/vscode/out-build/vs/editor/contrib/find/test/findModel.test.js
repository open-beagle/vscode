 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "assert", "vs/editor/browser/controller/coreCommands", "vs/editor/common/core/position", "vs/editor/common/core/range", "vs/editor/common/core/selection", "vs/editor/common/model/pieceTreeTextBuffer/pieceTreeTextBufferBuilder", "vs/editor/common/model/textModel", "vs/editor/contrib/find/findModel", "vs/editor/contrib/find/findState", "vs/editor/test/browser/testCodeEditor", "vs/platform/undoRedo/common/undoRedoService", "vs/platform/dialogs/test/common/testDialogService", "vs/platform/notification/test/common/testNotificationService"], function (require, exports, assert, coreCommands_1, position_1, range_1, selection_1, pieceTreeTextBufferBuilder_1, textModel_1, findModel_1, findState_1, testCodeEditor_1, undoRedoService_1, testDialogService_1, testNotificationService_1) {
    "use strict";
        ...
        function findTest(testName, callback) {
            test(testName, () => {
                ...
                (0, testCodeEditor_1.withTestCodeEditor)([], {
                    model: new textModel_1.TextModel(factory, textModel_1.TextModel.DEFAULT_CREATION_OPTIONS, null, null, new undoRedoService_1.UndoRedoService(new testDialogService_1.TestDialogService(), new testNotificationService_1.TestNotificationService()))
