 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "vs/base/common/errors", "vs/editor/common/modes", "vs/editor/common/core/position", "vs/platform/contextkey/common/contextkey", "vs/base/common/cancellation", "vs/editor/common/core/range", "vs/base/common/filters", "vs/base/common/lifecycle", "vs/platform/actions/common/actions", "vs/editor/contrib/snippet/snippetParser", "vs/base/common/stopwatch", "vs/platform/commands/common/commands", "vs/base/common/types", "vs/base/common/uri", "vs/editor/common/services/resolverService", "vs/nls!vs/editor/contrib/suggest/suggest"], function (require, exports, errors_1, modes, position_1, contextkey_1, cancellation_1, range_1, filters_1, lifecycle_1, actions_1, snippetParser_1, stopwatch_1, commands_1, types_1, uri_1, resolverService_1, nls_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.showSimpleSuggestions = exports.getSuggestionComparator = exports.provideSuggestionItems = exports.CompletionItemModel = exports.setSnippetSuggestSupport = exports.getSnippetSuggestSupport = exports.CompletionOptions = exports.SnippetSortOrder = exports.CompletionItem = exports.suggestWidgetStatusbarMenu = exports.Context = void 0;
    exports.Context = {
        Visible: new contextkey_1.RawContextKey('suggestWidgetVisible', false, (0, nls_1.localize)(0, null)),
        DetailsVisible: new contextkey_1.RawContextKey('suggestWidgetDetailsVisible', false, (0, nls_1.localize)(1, null)),
        MultipleSuggestions: new contextkey_1.RawContextKey('suggestWidgetMultipleSuggestions', false, (0, nls_1.localize)(2, null)),
        MakesTextEdit: new contextkey_1.RawContextKey('suggestionMakesTextEdit', true, (0, nls_1.localize)(3, null)),
        AcceptSuggestionsOnEnter: new contextkey_1.RawContextKey('acceptSuggestionOnEnter', true, (0, nls_1.localize)(4, null)),
        HasInsertAndReplaceRange: new contextkey_1.RawContextKey('suggestionHasInsertAndReplaceRange', false, (0, nls_1.localize)(5, null)),
        InsertMode: new contextkey_1.RawContextKey('suggestionInsertMode', undefined, { type: 'string', description: (0, nls_1.localize)(6, null) }),
        CanResolve: new contextkey_1.RawContextKey('suggestionCanResolve', false, (0, nls_1.localize)(7, null)),
    };
    ...
    commands_1.CommandsRegistry.registerCommand('_executeCompletionItemProvider', async (accessor, ...args) => {
        ...
        try {
            ...
            const resolving = [];
            const completions = await provideSuggestionItems(ref.object.textEditorModel, position_1.Position.lift(position), undefined, { triggerCharacter, triggerKind: triggerCharacter ? 1 /* TriggerCharacter */ : 0 /* Invoke */ });
