 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "assert", "vs/editor/contrib/suggest/suggestMemory", "vs/editor/test/common/editorTestUtils", "vs/editor/contrib/suggest/test/completionModel.test"], function (require, exports, assert, suggestMemory_1, editorTestUtils_1, completionModel_test_1) {
    "use strict";
    ...
    suite('SuggestMemories', function () {
        ...
        setup(function () {
            ...
            buffer = (0, editorTestUtils_1.createTextModel)('This is some text.\nthis.\nfoo: ,');
            items = [
