...
define(["require", "exports", "vs/base/common/async", "vs/base/common/errors", "vs/base/common/event", "vs/base/common/lifecycle", "vs/editor/common/core/selection", "vs/editor/common/modes", "./completionModel", "./suggest", "vs/editor/contrib/snippet/snippetController2", "vs/base/common/cancellation", "vs/editor/common/services/editorWorkerService", "vs/editor/contrib/suggest/wordDistance", "vs/base/common/strings", "vs/platform/clipboard/common/clipboardService", "vs/platform/telemetry/common/telemetry", "vs/platform/log/common/log"], function (require, exports, async_1, errors_1, event_1, lifecycle_1, selection_1, modes_1, completionModel_1, suggest_1, snippetController2_1, cancellation_1, editorWorkerService_1, wordDistance_1, strings_1, clipboardService_1, telemetry_1, log_1) {
    "use strict";
    ...
    let SuggestModel = class SuggestModel {
        ...
        _onCursorChange(e) {
            ...
            if (this._state === 0 /* Idle */ && e.reason === 0 /* NotSet */) {
                ...
                if (this._editor.getOption(103 /* suggest */).snippetsPreventQuickSuggestions && snippetController2_1.SnippetController2.get(this._editor).isInSnippet()) {
        ...
        trigger(context, retrigger = false, onlyFrom, existing) {
            ...
            const completions = (0, suggest_1.provideSuggestionItems)(model, this._editor.getPosition(), new suggest_1.CompletionOptions(snippetSortOrder, itemKindFilter, onlyFrom), suggestCtx, this._requestToken.token);
        ...
        _onNewContext(ctx) {
            ...
            if (ctx.leadingWord.word.length !== 0 && ctx.leadingWord.startColumn > this._context.leadingWord.startColumn) {
                ...
                const inactiveProvider = new Set(modes_1.CompletionProviderRegistry.all(this._editor.getModel()));
