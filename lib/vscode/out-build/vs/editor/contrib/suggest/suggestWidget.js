...
define(["require", "exports", "vs/nls!vs/editor/contrib/suggest/suggestWidget", "vs/base/common/strings", "vs/base/browser/dom", "vs/base/common/event", "vs/base/common/errors", "vs/base/common/lifecycle", "vs/base/browser/ui/list/listWidget", "vs/platform/contextkey/common/contextkey", "./suggest", "vs/platform/theme/common/styler", "vs/platform/theme/common/themeService", "vs/platform/theme/common/colorRegistry", "vs/platform/storage/common/storage", "vs/base/common/async", "vs/platform/instantiation/common/instantiation", "./suggestWidgetDetails", "vs/editor/contrib/suggest/suggestWidgetStatus", "./suggestWidgetRenderer", "./resizable", "vs/editor/browser/widget/embeddedCodeEditorWidget", "vs/base/common/numbers", "vs/css!./media/suggest", "vs/base/browser/ui/codicons/codiconStyles", "vs/editor/contrib/symbolIcons/symbolIcons"], function (require, exports, nls, strings, dom, event_1, errors_1, lifecycle_1, listWidget_1, contextkey_1, suggest_1, styler_1, themeService_1, colorRegistry_1, storage_1, async_1, instantiation_1, suggestWidgetDetails_1, suggestWidgetStatus_1, suggestWidgetRenderer_1, resizable_1, embeddedCodeEditorWidget_1, numbers_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.SuggestContentWidget = exports.SuggestWidget = exports.editorSuggestWidgetHighlightForeground = exports.editorSuggestWidgetSelectedBackground = exports.editorSuggestWidgetForeground = exports.editorSuggestWidgetBorder = exports.editorSuggestWidgetBackground = void 0;
    /**
     * Suggest widget colors
     */
    exports.editorSuggestWidgetBackground = (0, colorRegistry_1.registerColor)('editorSuggestWidget.background', { dark: colorRegistry_1.editorWidgetBackground, light: colorRegistry_1.editorWidgetBackground, hc: colorRegistry_1.editorWidgetBackground }, nls.localize(0, null));
    exports.editorSuggestWidgetBorder = (0, colorRegistry_1.registerColor)('editorSuggestWidget.border', { dark: colorRegistry_1.editorWidgetBorder, light: colorRegistry_1.editorWidgetBorder, hc: colorRegistry_1.editorWidgetBorder }, nls.localize(1, null));
    exports.editorSuggestWidgetForeground = (0, colorRegistry_1.registerColor)('editorSuggestWidget.foreground', { dark: colorRegistry_1.editorForeground, light: colorRegistry_1.editorForeground, hc: colorRegistry_1.editorForeground }, nls.localize(2, null));
    exports.editorSuggestWidgetSelectedBackground = (0, colorRegistry_1.registerColor)('editorSuggestWidget.selectedBackground', { dark: colorRegistry_1.quickInputListFocusBackground, light: colorRegistry_1.quickInputListFocusBackground, hc: colorRegistry_1.quickInputListFocusBackground }, nls.localize(3, null));
    exports.editorSuggestWidgetHighlightForeground = (0, colorRegistry_1.registerColor)('editorSuggestWidget.highlightForeground', { dark: colorRegistry_1.listHighlightForeground, light: colorRegistry_1.listHighlightForeground, hc: colorRegistry_1.listHighlightForeground }, nls.localize(4, null));
    var State;
    (function (State) {
    ...
    let SuggestWidget = class SuggestWidget {
                ...
                accessibilityProvider: {
                    ...
                    getAriaLabel: (item) => {
                        if (item.isResolved && this._isDetailsVisible()) {
                            ...
                            return nls.localize(7, null, item.textLabel, docs);
                        }
                        else {
                            return item.textLabel;
                        }
                    },
                    getWidgetAriaLabel: () => nls.localize(8, null),
        ...
        showTriggered(auto, delay) {
            ...
            this._isAuto = !!auto;
            if (!this._isAuto) {
                this._loadingTimeout = (0, async_1.disposableTimeout)(() => this._setState(1 /* Loading */), delay);
            }
        }
        ...
        toggleDetails() {
            ...
            else if (((0, suggestWidgetDetails_1.canExpandCompletionItem)(this._list.getFocusedElements()[0]) || this._explainMode) && (this._state === 3 /* Open */ || this._state === 5 /* Details */ || this._state === 4 /* Frozen */)) {
        ...
        getLayoutInfo() {
            ...
            const itemHeight = (0, numbers_1.clamp)(this.editor.getOption(105 /* suggestLineHeight */) || fontInfo.lineHeight, 8, 1000);
    ...
    SuggestWidget.LOADING_MESSAGE = nls.localize(5, null);
    SuggestWidget.NO_SUGGESTIONS_MESSAGE = nls.localize(6, null);
