define(["require", "exports", "assert", "vs/editor/contrib/snippet/snippetParser"], function (require, exports, assert, snippetParser_1) {
    ...
    suite('SnippetParser', () => {
        test('Scanner', () => {
            ...
            assert.strictEqual(scanner.next().type, 14 /* EOF */);
            scanner.text('abc');
            assert.strictEqual(scanner.next().type, 9 /* VariableName */);
            assert.strictEqual(scanner.next().type, 14 /* EOF */);
            scanner.text('{{abc}}');
            assert.strictEqual(scanner.next().type, 3 /* CurlyOpen */);
            assert.strictEqual(scanner.next().type, 3 /* CurlyOpen */);
            assert.strictEqual(scanner.next().type, 9 /* VariableName */);
            assert.strictEqual(scanner.next().type, 4 /* CurlyClose */);
            assert.strictEqual(scanner.next().type, 4 /* CurlyClose */);
            assert.strictEqual(scanner.next().type, 14 /* EOF */);
            scanner.text('abc() ');
            assert.strictEqual(scanner.next().type, 9 /* VariableName */);
            assert.strictEqual(scanner.next().type, 10 /* Format */);
            assert.strictEqual(scanner.next().type, 14 /* EOF */);
            scanner.text('abc 123');
            assert.strictEqual(scanner.next().type, 9 /* VariableName */);
            assert.strictEqual(scanner.next().type, 10 /* Format */);
            assert.strictEqual(scanner.next().type, 8 /* Int */);
            assert.strictEqual(scanner.next().type, 14 /* EOF */);
            scanner.text('$foo');
            assert.strictEqual(scanner.next().type, 0 /* Dollar */);
            assert.strictEqual(scanner.next().type, 9 /* VariableName */);
            assert.strictEqual(scanner.next().type, 14 /* EOF */);
            ...
            assert.strictEqual(scanner.next().type, 0 /* Dollar */);
            assert.strictEqual(scanner.next().type, 9 /* VariableName */);
            assert.strictEqual(scanner.next().type, 12 /* Dash */);
            assert.strictEqual(scanner.next().type, 9 /* VariableName */);
            assert.strictEqual(scanner.next().type, 14 /* EOF */);
            scanner.text('${foo}');
            assert.strictEqual(scanner.next().type, 0 /* Dollar */);
            ...
            assert.strictEqual(scanner.next().type, 3 /* CurlyOpen */);
            assert.strictEqual(scanner.next().type, 8 /* Int */);
            assert.strictEqual(scanner.next().type, 1 /* Colon */);
            assert.strictEqual(scanner.next().type, 9 /* VariableName */);
            assert.strictEqual(scanner.next().type, 4 /* CurlyClose */);
            assert.strictEqual(scanner.next().type, 14 /* EOF */);
            scanner.text('\\${}');
            assert.strictEqual(scanner.next().type, 5 /* Backslash */);
            assert.strictEqual(scanner.next().type, 0 /* Dollar */);
            assert.strictEqual(scanner.next().type, 3 /* CurlyOpen */);
            assert.strictEqual(scanner.next().type, 4 /* CurlyClose */);
            ...
            assert.strictEqual(scanner.next().type, 3 /* CurlyOpen */);
            assert.strictEqual(scanner.next().type, 9 /* VariableName */);
            assert.strictEqual(scanner.next().type, 6 /* Forwardslash */);
            assert.strictEqual(scanner.next().type, 9 /* VariableName */);
            assert.strictEqual(scanner.next().type, 6 /* Forwardslash */);
            assert.strictEqual(scanner.next().type, 9 /* VariableName */);
            assert.strictEqual(scanner.next().type, 6 /* Forwardslash */);
