define(["require", "exports", "assert", "vs/editor/common/core/position", "vs/editor/common/core/range", "vs/editor/common/core/selection", "vs/editor/contrib/snippet/snippetParser", "vs/editor/contrib/snippet/snippetSession", "vs/editor/test/browser/testCodeEditor", "vs/editor/test/common/editorTestUtils"], function (require, exports, assert, position_1, range_1, selection_1, snippetParser_1, snippetSession_1, testCodeEditor_1, editorTestUtils_1) {
    "use strict";
    ...
    suite('SnippetSession', function () {
        ...
        setup(function () {
            model = (0, editorTestUtils_1.createTextModel)('function foo() {\n    console.log(a);\n}');
            editor = (0, testCodeEditor_1.createTestCodeEditor)({ model: model });
        ...
        test('Snippet tab stop selection issue #96545, snippets, transform adjacent to previous placeholder', function () {
            editor.getModel().setValue('');
            editor.setSelection(new selection_1.Selection(1, 1, 1, 1));
            const session = new snippetSession_1.SnippetSession(editor, '${1:{}${2:fff}${1/{/}/}');
            session.insert();
        ...
        test('Snippet tab stop selection issue #96545', function () {
            editor.getModel().setValue('');
            const session = new snippetSession_1.SnippetSession(editor, '${1:{}${2:fff}${1/[\\{]/}/}$0');
            session.insert();
        ...
        test('Selecting text from left to right, and choosing item messes up code, #31199', function () {
            ...
            new snippetSession_1.SnippetSession(editor, 'far', { overwriteBefore: 3, overwriteAfter: 0, adjustWhitespace: true, clipboardText: undefined, overtypingCapturer: undefined }).insert();
