define(["require", "exports", "assert", "vs/editor/common/core/selection", "vs/editor/contrib/snippet/snippetController2", "vs/editor/test/browser/testCodeEditor", "vs/platform/keybinding/test/common/mockKeybindingService", "vs/platform/log/common/log", "vs/editor/browser/controller/coreCommands", "vs/editor/test/common/editorTestUtils"], function (require, exports, assert, selection_1, snippetController2_1, testCodeEditor_1, mockKeybindingService_1, log_1, coreCommands_1, editorTestUtils_1) {
    "use strict";
    ...
    suite('SnippetController2', function () {
        ...
        setup(function () {
            ...
            model = (0, editorTestUtils_1.createTextModel)('if\n    $state\nfi');
        ...
        test('Must tab through deleted tab stops in snippets #31619', function () {
            ...
            editor.trigger('test', "cut" /* Cut */, null);
