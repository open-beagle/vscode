...
define(["require", "exports", "vs/nls!vs/editor/contrib/contextmenu/contextmenu", "vs/base/browser/dom", "vs/base/common/actions", "vs/base/common/lifecycle", "vs/editor/browser/editorExtensions", "vs/editor/common/editorContextKeys", "vs/platform/actions/common/actions", "vs/platform/contextkey/common/contextkey", "vs/platform/contextview/browser/contextView", "vs/platform/keybinding/common/keybinding", "vs/base/browser/ui/actionbar/actionViewItems"], function (require, exports, nls, dom, actions_1, lifecycle_1, editorExtensions_1, editorContextKeys_1, actions_2, contextkey_1, contextView_1, keybinding_1, actionViewItems_1) {
    "use strict";
    ...
    let ContextMenuController = class ContextMenuController {
        ...
        showContextMenu(anchor) {
            ...
            const menuActions = this._getMenuActions(this._editor.getModel(), actions_2.MenuId.EditorContext);
