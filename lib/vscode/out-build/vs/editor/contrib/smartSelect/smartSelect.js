 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "vs/base/common/arrays", "vs/base/common/cancellation", "vs/editor/browser/editorExtensions", "vs/editor/common/core/position", "vs/editor/common/core/range", "vs/editor/common/core/selection", "vs/editor/common/editorContextKeys", "vs/editor/common/modes", "vs/nls!vs/editor/contrib/smartSelect/smartSelect", "vs/platform/actions/common/actions", "vs/editor/contrib/smartSelect/wordSelections", "vs/editor/contrib/smartSelect/bracketSelections", "vs/platform/commands/common/commands", "vs/base/common/errors"], function (require, exports, arrays, cancellation_1, editorExtensions_1, position_1, range_1, selection_1, editorContextKeys_1, modes, nls, actions_1, wordSelections_1, bracketSelections_1, commands_1, errors_1) {
    "use strict";
    ...
    class SmartSelectController {
        ...
        async run(forward) {
            ...
            if (!this._state) {
                await provideSelectionRanges(model, selections.map(s => s.getPosition()), this._editor.getOption(99 /* smartSelect */), cancellation_1.CancellationToken.None).then(ranges => {
                    var _a;
    ...
    async function provideSelectionRanges(model, positions, options, token) {
    ...
    (0, editorExtensions_1.registerModelCommand)('_executeSelectionRangeProvider', function (model, ...args) {
        const [positions] = args;
        return provideSelectionRanges(model, positions, { selectLeadingAndTrailingWhitespace: true }, cancellation_1.CancellationToken.None);
    });
});
