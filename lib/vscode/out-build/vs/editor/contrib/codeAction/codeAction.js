 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "vs/base/common/arrays", "vs/base/common/cancellation", "vs/base/common/errors", "vs/base/common/lifecycle", "vs/base/common/uri", "vs/editor/browser/core/editorState", "vs/editor/common/core/range", "vs/editor/common/core/selection", "vs/editor/common/modes", "vs/editor/common/services/modelService", "./types", "vs/platform/progress/common/progress", "vs/platform/commands/common/commands"], function (require, exports, arrays_1, cancellation_1, errors_1, lifecycle_1, uri_1, editorState_1, range_1, selection_1, modes, modelService_1, types_1, progress_1, commands_1) {
    "use strict";
    ...
    commands_1.CommandsRegistry.registerCommand('_executeCodeActionProvider', async function (accessor, resource, rangeOrSelection, kind, itemResolveCount) {
        ...
        const codeActionSet = await getCodeActions(model, validatedRangeOrSelection, { type: 1 /* Invoke */, filter: { includeSourceActions: true, include } }, progress_1.Progress.None, cancellation_1.CancellationToken.None);
        const resolving = [];
