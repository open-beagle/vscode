...
define(["require", "exports", "vs/base/browser/dom", "vs/base/browser/globalMouseMoveMonitor", "vs/base/common/event", "vs/base/common/lifecycle", "vs/editor/common/model/textModel", "vs/nls!vs/editor/contrib/codeAction/lightBulbWidget", "vs/platform/keybinding/common/keybinding", "vs/platform/theme/common/themeService", "vs/platform/theme/common/colorRegistry", "vs/base/browser/touch", "vs/base/common/codicons", "vs/css!./lightBulbWidget"], function (require, exports, dom, globalMouseMoveMonitor_1, event_1, lifecycle_1, textModel_1, nls, keybinding_1, themeService_1, colorRegistry_1, touch_1, codicons_1) {
    "use strict";
    ...
    let LightBulbWidget = class LightBulbWidget extends lifecycle_1.Disposable {
        ...
        _updateLightBulbTitleAndIcon() {
            if (this.state.type === 1 /* Showing */ && this.state.actions.hasAutoFix) {
                ...
                if (preferredKb) {
                    this.title = nls.localize(0, null, preferredKb.getLabel());
                    return;
                }
            }
            // update icon
            ...
            if (kb) {
                this.title = nls.localize(1, null, kb.getLabel());
            }
            else {
                this.title = nls.localize(2, null);
            }
        }
        set title(value) {
