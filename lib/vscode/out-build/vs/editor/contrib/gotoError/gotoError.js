...
define(["require", "exports", "vs/nls!vs/editor/contrib/gotoError/gotoError", "vs/base/common/lifecycle", "vs/platform/contextkey/common/contextkey", "vs/editor/common/core/position", "vs/editor/common/core/range", "vs/editor/browser/editorExtensions", "vs/editor/common/editorContextKeys", "./gotoErrorWidget", "vs/editor/browser/services/codeEditorService", "vs/platform/actions/common/actions", "vs/base/common/codicons", "vs/platform/instantiation/common/instantiation", "vs/editor/contrib/gotoError/markerNavigationService", "vs/platform/theme/common/iconRegistry"], function (require, exports, nls, lifecycle_1, contextkey_1, position_1, range_1, editorExtensions_1, editorContextKeys_1, gotoErrorWidget_1, codeEditorService_1, actions_1, codicons_1, instantiation_1, markerNavigationService_1, iconRegistry_1) {
    "use strict";
        ...
        constructor() {
            super(true, false, {
                ...
                menuOpts: {
                    ...
                    icon: (0, iconRegistry_1.registerIcon)('marker-navigation-next', codicons_1.Codicon.chevronDown, nls.localize(1, null)),
                    group: 'navigation',
                    order: 1
                }
            });
    ...
    NextMarkerAction.LABEL = nls.localize(0, null);
        ...
        constructor() {
            super(false, false, {
                ...
                menuOpts: {
                    menuId: gotoErrorWidget_1.MarkerNavigationWidget.TitleMenu,
                    title: NextMarkerAction.LABEL,
                    icon: (0, iconRegistry_1.registerIcon)('marker-navigation-previous', codicons_1.Codicon.chevronUp, nls.localize(3, null)),
                    group: 'navigation',
                    order: 2
                }
            });
    ...
    PrevMarkerAction.LABEL = nls.localize(2, null);
