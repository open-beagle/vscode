...
define(["require", "exports", "vs/platform/contextkey/common/contextkey", "vs/platform/instantiation/common/instantiation", "vs/platform/instantiation/common/extensions", "vs/platform/keybinding/common/keybindingsRegistry", "vs/editor/browser/editorExtensions", "vs/editor/browser/services/codeEditorService", "vs/editor/common/core/range", "vs/base/common/lifecycle", "vs/base/common/event", "vs/nls!vs/editor/contrib/gotoSymbol/symbolNavigation", "vs/platform/keybinding/common/keybinding", "vs/platform/notification/common/notification", "vs/base/common/resources"], function (require, exports, contextkey_1, instantiation_1, extensions_1, keybindingsRegistry_1, editorExtensions_1, codeEditorService_1, range_1, lifecycle_1, event_1, nls_1, keybinding_1, notification_1, resources_1) {
    ...
    let SymbolNavigationService = class SymbolNavigationService {
        ...
        _showMessage() {
            ...
            const message = kb
                ? (0, nls_1.localize)(1, null, this._currentIdx + 1, this._currentModel.references.length, kb.getLabel())
                : (0, nls_1.localize)(2, null, this._currentIdx + 1, this._currentModel.references.length);
