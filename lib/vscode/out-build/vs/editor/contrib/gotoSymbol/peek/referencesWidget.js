...
define(["require", "exports", "vs/base/browser/dom", "vs/base/common/color", "vs/base/common/event", "vs/base/common/lifecycle", "vs/base/common/network", "vs/base/common/resources", "vs/editor/browser/widget/embeddedCodeEditorWidget", "vs/editor/common/core/range", "vs/editor/common/model/textModel", "vs/editor/common/services/resolverService", "vs/editor/contrib/gotoSymbol/peek/referencesTree", "vs/nls!vs/editor/contrib/gotoSymbol/peek/referencesWidget", "vs/platform/instantiation/common/instantiation", "vs/platform/label/common/label", "vs/platform/list/browser/listService", "vs/platform/theme/common/colorRegistry", "vs/platform/theme/common/themeService", "vs/editor/contrib/peekView/peekView", "../referencesModel", "vs/base/browser/ui/splitview/splitview", "vs/platform/undoRedo/common/undoRedo", "vs/platform/keybinding/common/keybinding", "vs/css!./referencesWidget"], function (require, exports, dom, color_1, event_1, lifecycle_1, network_1, resources_1, embeddedCodeEditorWidget_1, range_1, textModel_1, resolverService_1, referencesTree_1, nls, instantiation_1, label_1, listService_1, colorRegistry_1, themeService_1, peekView, referencesModel_1, splitview_1, undoRedo_1, keybinding_1) {
    "use strict";
    ...
    let ReferenceWidget = class ReferenceWidget extends peekView.PeekViewWidget {
        ...
        _fillBody(containerElement) {
            ...
            this._previewNotAvailableMessage = new textModel_1.TextModel(nls.localize(0, null), textModel_1.TextModel.DEFAULT_CREATION_OPTIONS, null, null, this._undoRedoService);
            // tree
        ...
        _onNewModel() {
            ...
            if (this._model.isEmpty) {
                this.setTitle('');
                this._messageContainer.innerText = nls.localize(1, null);
