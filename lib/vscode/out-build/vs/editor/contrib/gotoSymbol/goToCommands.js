...
define(["require", "exports", "vs/base/browser/ui/aria/aria", "vs/base/common/async", "vs/base/common/keyCodes", "vs/base/common/platform", "vs/editor/browser/editorBrowser", "vs/editor/browser/editorExtensions", "vs/editor/browser/services/codeEditorService", "vs/editor/common/core/position", "vs/editor/common/core/range", "vs/editor/common/editorContextKeys", "vs/editor/common/modes", "vs/editor/contrib/message/messageController", "vs/editor/contrib/peekView/peekView", "vs/editor/contrib/gotoSymbol/peek/referencesController", "vs/editor/contrib/gotoSymbol/referencesModel", "vs/nls!vs/editor/contrib/gotoSymbol/goToCommands", "vs/platform/actions/common/actions", "vs/platform/contextkey/common/contextkey", "vs/platform/notification/common/notification", "vs/platform/progress/common/progress", "./goToSymbol", "vs/platform/commands/common/commands", "vs/editor/browser/core/editorState", "vs/editor/contrib/gotoSymbol/symbolNavigation", "vs/base/browser/browser", "vs/base/common/uri", "vs/platform/instantiation/common/instantiation", "vs/base/common/types", "vs/editor/browser/widget/embeddedCodeEditorWidget"], function (require, exports, aria_1, async_1, keyCodes_1, platform_1, editorBrowser_1, editorExtensions_1, codeEditorService_1, corePosition, range_1, editorContextKeys_1, modes_1, messageController_1, peekView_1, referencesController_1, referencesModel_1, nls, actions_1, contextkey_1, notification_1, progress_1, goToSymbol_1, commands_1, editorState_1, symbolNavigation_1, browser_1, uri_1, instantiation_1, types_1, embeddedCodeEditorWidget_1) {
    ...
    class SymbolNavigationAction extends editorExtensions_1.EditorAction {
        ...
        run(accessor, editor) {
            ...
            const promise = (0, async_1.raceCancellation)(this._getLocationModel(model, pos, cts.token), cts.token).then(async (references) => {
        ...
        async _openReference(editor, editorService, reference, sideBySide, highlight) {
            ...
            let range = undefined;
            if ((0, modes_1.isLocationLink)(reference)) {
        ...
        _openInPeek(target, model) {
            ...
            if (controller && target.hasModel()) {
                controller.toggleWidget(target.getSelection(), (0, async_1.createCancelablePromise)(_ => Promise.resolve(model)), this._configuration.openInPeek);
            }
            else {
                model.dispose();
            }
    ...
    class DefinitionAction extends SymbolNavigationAction {
        async _getLocationModel(model, position, token) {
            return new referencesModel_1.ReferencesModel(await (0, goToSymbol_1.getDefinitionsAtPosition)(model, position, token), nls.localize(1, null));
        }
    ...
    registerGoToAction((_b = class OpenDefinitionToSideAction extends DefinitionAction {
            constructor() {
                super({
                    ...
                    kbOpts: {
                        kbExpr: editorContextKeys_1.EditorContextKeys.editorTextFocus,
                        primary: (0, keyCodes_1.KeyChord)(2048 /* CtrlCmd */ | 41 /* KEY_K */, goToDefinitionKb),
                        weight: 100 /* EditorContrib */
                    }
                });
    ...
    class DeclarationAction extends SymbolNavigationAction {
        async _getLocationModel(model, position, token) {
            return new referencesModel_1.ReferencesModel(await (0, goToSymbol_1.getDeclarationsAtPosition)(model, position, token), nls.localize(8, null));
        }
        _getNoResultFoundMessage(info) {
            return info && info.word
    ...
    class TypeDefinitionAction extends SymbolNavigationAction {
        async _getLocationModel(model, position, token) {
            return new referencesModel_1.ReferencesModel(await (0, goToSymbol_1.getTypeDefinitionsAtPosition)(model, position, token), nls.localize(16, null));
        }
        _getNoResultFoundMessage(info) {
            return info && info.word
    ...
    class ImplementationAction extends SymbolNavigationAction {
        async _getLocationModel(model, position, token) {
            return new referencesModel_1.ReferencesModel(await (0, goToSymbol_1.getImplementationsAtPosition)(model, position, token), nls.localize(22, null));
        }
        _getNoResultFoundMessage(info) {
            return info && info.word
    ...
    registerGoToAction(class GoToReferencesAction extends ReferencesAction {
        ...
        async _getLocationModel(model, position, token) {
            return new referencesModel_1.ReferencesModel(await (0, goToSymbol_1.getReferencesAtPosition)(model, position, true, token), nls.localize(32, null));
        }
    });
    registerGoToAction(class PeekReferencesAction extends ReferencesAction {
        ...
        async _getLocationModel(model, position, token) {
            return new referencesModel_1.ReferencesModel(await (0, goToSymbol_1.getReferencesAtPosition)(model, position, false, token), nls.localize(34, null));
        }
    });
    //#endregion
    ...
    class GenericGoToLocationAction extends SymbolNavigationAction {
        ...
        async _getLocationModel(_model, _position, _token) {
            return new referencesModel_1.ReferencesModel(this._references, nls.localize(36, null));
        }
        _getNoResultFoundMessage(info) {
    ...
    commands_1.CommandsRegistry.registerCommand({
        ...
        handler: (accessor, resource, position) => {
            ...
            return codeEditorService.openCodeEditor({ resource }, codeEditorService.getFocusedCodeEditor()).then(control => {
                ...
                const references = (0, async_1.createCancelablePromise)(token => (0, goToSymbol_1.getReferencesAtPosition)(control.getModel(), corePosition.Position.lift(position), false, token).then(references => new referencesModel_1.ReferencesModel(references, nls.localize(38, null))));
