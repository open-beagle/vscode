...
define(["require", "exports", "vs/nls!vs/editor/browser/widget/diffReview", "vs/base/browser/dom", "vs/base/browser/fastDomNode", "vs/base/browser/ui/actionbar/actionbar", "vs/base/browser/ui/scrollbar/scrollableElement", "vs/base/common/actions", "vs/base/common/lifecycle", "vs/editor/browser/config/configuration", "vs/editor/browser/editorExtensions", "vs/editor/browser/services/codeEditorService", "vs/editor/common/config/editorOptions", "vs/editor/common/core/lineTokens", "vs/editor/common/core/position", "vs/editor/common/view/editorColorRegistry", "vs/editor/common/viewLayout/viewLineRenderer", "vs/editor/common/viewModel/viewModel", "vs/platform/contextkey/common/contextkey", "vs/platform/theme/common/colorRegistry", "vs/platform/theme/common/themeService", "vs/base/common/codicons", "vs/platform/theme/common/iconRegistry", "vs/css!./media/diffReview"], function (require, exports, nls, dom, fastDomNode_1, actionbar_1, scrollableElement_1, actions_1, lifecycle_1, configuration_1, editorExtensions_1, codeEditorService_1, editorOptions_1, lineTokens_1, position_1, editorColorRegistry_1, viewLineRenderer_1, viewModel_1, contextkey_1, colorRegistry_1, themeService_1, codicons_1, iconRegistry_1) {
    ...
    const diffReviewInsertIcon = (0, iconRegistry_1.registerIcon)('diff-review-insert', codicons_1.Codicon.add, nls.localize(0, null));
    const diffReviewRemoveIcon = (0, iconRegistry_1.registerIcon)('diff-review-remove', codicons_1.Codicon.remove, nls.localize(1, null));
    const diffReviewCloseIcon = (0, iconRegistry_1.registerIcon)('diff-review-close', codicons_1.Codicon.close, nls.localize(2, null));
    class DiffReview extends lifecycle_1.Disposable {
        constructor(diffEditor) {
            ...
            this._actionBar.push(new actions_1.Action('diffreview.close', nls.localize(3, null), 'close-diff-review ' + themeService_1.ThemeIcon.asClassName(diffReviewCloseIcon), true, async () => this.hide()), { label: false, icon: true });
        ...
        _render() {
            ...
            configuration_1.Configuration.applyFontInfoSlow(container, modifiedOptions.get(40 /* fontInfo */));
            ...
            const getAriaLines = (lines) => {
                if (lines === 0) {
                    ...
                    return nls.localize(6, null, lines);
                }
            };
            ...
            header.setAttribute('aria-label', nls.localize(7, null, (diffIndex + 1), this._diffs.length, minOriginalLine, originalChangedLinesCntAria, minModifiedLine, modifiedChangedLinesCntAria));
        ...
        static _renderSection(dest, diffEntry, modLine, lineHeight, width, originalOptions, originalModel, originalModelOpts, modifiedOptions, modifiedModel, modifiedModelOpts) {
            ...
            const originalLayoutInfo = originalOptions.get(126 /* layoutInfo */);
            const originalLineNumbersWidth = originalLayoutInfo.glyphMarginWidth + originalLayoutInfo.lineNumbersWidth;
            const modifiedLayoutInfo = modifiedOptions.get(126 /* layoutInfo */);
            ...
            for (let i = 0; i <= cnt; i++) {
                ...
                if (lineContent.length === 0) {
                    lineContent = nls.localize(8, null);
                }
                let ariaLabel = '';
                switch (type) {
                    case 0 /* Equal */:
                        if (originalLine === modifiedLine) {
                            ariaLabel = nls.localize(9, null, lineContent, originalLine);
                        }
                        else {
                            ariaLabel = nls.localize(10, null, lineContent, originalLine, modifiedLine);
                        }
                        break;
                    case 1 /* Insert */:
                        ariaLabel = nls.localize(11, null, lineContent, modifiedLine);
                        break;
                    case 2 /* Delete */:
                        ariaLabel = nls.localize(12, null, lineContent, originalLine);
                        break;
                }
        ...
        static _renderLine(model, options, tabSize, lineNumber) {
            ...
            const r = (0, viewLineRenderer_1.renderViewLine2)(new viewLineRenderer_1.RenderLineInput((fontInfo.isMonospace && !options.get(27 /* disableMonospaceOptimizations */)), fontInfo.canUseHalfwidthRightwardsArrow, lineContent, false, isBasicASCII, containsRTL, 0, lineTokens, [], tabSize, 0, fontInfo.spaceWidth, fontInfo.middotWidth, fontInfo.wsmiddotWidth, options.get(102 /* stopRenderingLineAfter */), options.get(85 /* renderWhitespace */), options.get(79 /* renderControlCharacters */), options.get(41 /* fontLigatures */) !== editorOptions_1.EditorFontLigatures.OFF, null));
            return r.html;
        }
    }
