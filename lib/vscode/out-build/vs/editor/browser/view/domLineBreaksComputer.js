 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "vs/editor/common/core/stringBuilder", "vs/base/common/strings", "vs/editor/browser/config/configuration", "vs/editor/common/viewModel/viewModel"], function (require, exports, stringBuilder_1, strings, configuration_1, viewModel_1) {
    "use strict";
    var _a;
    ...
    function createLineBreaks(requests, fontInfo, tabSize, firstLineBreakColumn, wrappingIndent) {
        ...
        for (let i = 0; i < requests.length; i++) {
            ...
            result[i] = new viewModel_1.LineBreakData(breakOffsets, breakOffsetsVisibleColumn, wrappedTextIndentLength);
        }
