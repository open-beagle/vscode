...
define(["require", "exports", "vs/base/common/actions", "vs/platform/instantiation/common/descriptors", "vs/platform/instantiation/common/instantiation", "vs/platform/keybinding/common/keybindingsRegistry", "vs/platform/contextkey/common/contextkey", "vs/platform/commands/common/commands", "vs/base/common/lifecycle", "vs/base/common/event", "vs/platform/theme/common/themeService", "vs/base/common/iterator", "vs/base/common/linkedList", "vs/base/common/codicons"], function (require, exports, actions_1, descriptors_1, instantiation_1, keybindingsRegistry_1, contextkey_1, commands_1, lifecycle_1, event_1, themeService_1, iterator_1, linkedList_1, codicons_1) {
    "use strict";
    ...
    MenuId.TerminalContainerContext = new MenuId('TerminalContainerContext');
    MenuId.TerminalToolbarContext = new MenuId('TerminalToolbarContext');
    MenuId.TerminalTabsWidgetContext = new MenuId('TerminalTabsWidgetContext');
    MenuId.TerminalTabsWidgetEmptyContext = new MenuId('TerminalTabsWidgetEmptyContext');
    MenuId.TerminalSingleTabContext = new MenuId('TerminalSingleTabContext');
    ...
    class SyncActionDescriptor {
        constructor(ctor, id, label, keybindings, keybindingContext, keybindingWeight) {
            ...
            this._descriptor = (0, descriptors_1.createSyncDescriptor)(ctor, this._id, this._label);
        }
