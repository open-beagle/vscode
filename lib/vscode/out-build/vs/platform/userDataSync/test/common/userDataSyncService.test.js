 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "assert", "vs/platform/userDataSync/common/userDataSync", "vs/platform/userDataSync/test/common/userDataSyncClient", "vs/base/common/lifecycle", "vs/platform/files/common/files", "vs/platform/environment/common/environment", "vs/base/common/buffer", "vs/base/common/resources"], function (require, exports, assert, userDataSync_1, userDataSyncClient_1, lifecycle_1, files_1, environment_1, buffer_1, resources_1) {
    "use strict";
    ...
    suite('UserDataSyncService', () => {
        ...
        test('test sync status', async () => {
            ...
            await (await testObject.createSyncTask()).run();
            disposable.dispose();
            assert.deepStrictEqual(actualStatuses, ["syncing" /* Syncing */, "idle" /* Idle */, "syncing" /* Syncing */, "idle" /* Idle */, "syncing" /* Syncing */, "idle" /* Idle */, "syncing" /* Syncing */, "idle" /* Idle */, "syncing" /* Syncing */, "idle" /* Idle */]);
        });
        test('test sync conflicts status', async () => {
            ...
            assert.deepStrictEqual(testObject.conflicts.map(([syncResource]) => syncResource), ["settings" /* Settings */]);
        });
