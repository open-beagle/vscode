    ...
    let AbstractSynchroniser = class AbstractSynchroniser extends lifecycle_1.Disposable {
        ...
        async performSync(remoteUserData, lastSyncUserData, apply) {
            if (remoteUserData.syncData && remoteUserData.syncData.version > this.version) {
                ...
                throw new userDataSync_1.UserDataSyncError((0, nls_1.localize)(0, null, this.resource, this.version, remoteUserData.syncData.version), userDataSync_1.UserDataSyncErrorCode.IncompatibleLocalContent, this.resource);
            }
            try {
        ...
        async doSync(remoteUserData, lastSyncUserData, apply) {
            try {
                ...
                if (!this.syncPreviewPromise) {
                    this.syncPreviewPromise = (0, async_1.createCancelablePromise)(token => this.doGenerateSyncResourcePreview(remoteUserData, lastSyncUserData, apply, token));
                }
                const preview = await this.syncPreviewPromise;
        ...
        parseSyncData(content) {
            ...
            throw new userDataSync_1.UserDataSyncError((0, nls_1.localize)(1, null), userDataSync_1.UserDataSyncErrorCode.IncompatibleRemoteContent, this.resource);
        }
