...
define(["require", "exports", "vs/platform/instantiation/common/instantiation", "vs/base/common/lifecycle", "vs/platform/serviceMachineId/common/serviceMachineId", "vs/platform/environment/common/environment", "vs/platform/files/common/files", "vs/platform/storage/common/storage", "vs/platform/userDataSync/common/userDataSync", "vs/nls!vs/platform/userDataSync/common/userDataSyncMachines", "vs/platform/product/common/productService", "vs/base/common/platform", "vs/base/common/strings", "vs/base/common/event"], function (require, exports, instantiation_1, lifecycle_1, serviceMachineId_1, environment_1, files_1, storage_1, userDataSync_1, nls_1, productService_1, platform_1, strings_1, event_1) {
    "use strict";
    ...
    let UserDataSyncMachinesService = class UserDataSyncMachinesService extends lifecycle_1.Disposable {
        ...
        async renameMachine(machineId, name, manifest) {
            ...
            if (machine) {
                ...
                await this.writeMachinesData(machineData);
                if (machineData.machines.some(({ id }) => id === currentMachineId)) {
                    this.storageService.store(currentMachineNameKey, name, 0 /* GLOBAL */, 1 /* MACHINE */);
                }
            }
        }
        ...
        computeCurrentMachineName(machines) {
            ...
            const namePrefix = `${this.productService.nameLong} (${(0, platform_1.PlatformToString)(platform_1.isWeb ? 0 /* Web */ : platform_1.platform)})`;
        ...
        async readMachinesData(manifest) {
            ...
            if (machinesData.version !== UserDataSyncMachinesService.VERSION) {
                throw new Error((0, nls_1.localize)(0, null, this.productService.nameLong));
            }
            return machinesData;
        }
