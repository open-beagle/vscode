define(["require", "exports", "assert", "vs/base/common/keyCodes", "vs/platform/keybinding/common/usLayoutResolvedKeybinding"], function (require, exports, assert, keyCodes_1, usLayoutResolvedKeybinding_1) {
    ...
    suite('KeybindingLabels', () => {
        function assertUSLabel(OS, keybinding, expected) {
            const usResolvedKeybinding = new usLayoutResolvedKeybinding_1.USLayoutResolvedKeybinding((0, keyCodes_1.createKeybinding)(keybinding, OS), OS);
        ...
        test('Windows US label', () => {
            ...
            // chord
            assertUSLabel(1 /* Windows */, (0, keyCodes_1.KeyChord)(2048 /* CtrlCmd */ | 31 /* KEY_A */, 2048 /* CtrlCmd */ | 32 /* KEY_B */), 'Ctrl+A Ctrl+B');
        });
        test('Linux US label', () => {
            // no modifier
            ...
            assertUSLabel(3 /* Linux */, 256 /* WinCtrl */ | 31 /* KEY_A */, 'Super+A');
            // two modifiers
            ...
            assertUSLabel(3 /* Linux */, 2048 /* CtrlCmd */ | 256 /* WinCtrl */ | 31 /* KEY_A */, 'Ctrl+Super+A');
            assertUSLabel(3 /* Linux */, 1024 /* Shift */ | 512 /* Alt */ | 31 /* KEY_A */, 'Shift+Alt+A');
            assertUSLabel(3 /* Linux */, 1024 /* Shift */ | 256 /* WinCtrl */ | 31 /* KEY_A */, 'Shift+Super+A');
            assertUSLabel(3 /* Linux */, 512 /* Alt */ | 256 /* WinCtrl */ | 31 /* KEY_A */, 'Alt+Super+A');
            // three modifiers
            assertUSLabel(3 /* Linux */, 2048 /* CtrlCmd */ | 1024 /* Shift */ | 512 /* Alt */ | 31 /* KEY_A */, 'Ctrl+Shift+Alt+A');
            assertUSLabel(3 /* Linux */, 2048 /* CtrlCmd */ | 1024 /* Shift */ | 256 /* WinCtrl */ | 31 /* KEY_A */, 'Ctrl+Shift+Super+A');
            assertUSLabel(3 /* Linux */, 2048 /* CtrlCmd */ | 512 /* Alt */ | 256 /* WinCtrl */ | 31 /* KEY_A */, 'Ctrl+Alt+Super+A');
            assertUSLabel(3 /* Linux */, 1024 /* Shift */ | 512 /* Alt */ | 256 /* WinCtrl */ | 31 /* KEY_A */, 'Shift+Alt+Super+A');
            // four modifiers
            assertUSLabel(3 /* Linux */, 2048 /* CtrlCmd */ | 1024 /* Shift */ | 512 /* Alt */ | 256 /* WinCtrl */ | 31 /* KEY_A */, 'Ctrl+Shift+Alt+Super+A');
            // chord
            assertUSLabel(3 /* Linux */, (0, keyCodes_1.KeyChord)(2048 /* CtrlCmd */ | 31 /* KEY_A */, 2048 /* CtrlCmd */ | 32 /* KEY_B */), 'Ctrl+A Ctrl+B');
        });
        test('Mac US label', () => {
            // no modifier
            ...
            // chord
            assertUSLabel(2 /* Macintosh */, (0, keyCodes_1.KeyChord)(2048 /* CtrlCmd */ | 31 /* KEY_A */, 2048 /* CtrlCmd */ | 32 /* KEY_B */), '⌘A ⌘B');
            // special keys
        ...
        test('Aria label', () => {
            ...
            assertAriaLabel(3 /* Linux */, 2048 /* CtrlCmd */ | 1024 /* Shift */ | 512 /* Alt */ | 256 /* WinCtrl */ | 31 /* KEY_A */, 'Control+Shift+Alt+Super+A');
        ...
        test('Electron Accelerator label', () => {
            ...
            assertElectronAcceleratorLabel(1 /* Windows */, (0, keyCodes_1.KeyChord)(2048 /* CtrlCmd */ | 31 /* KEY_A */, 2048 /* CtrlCmd */ | 32 /* KEY_B */), null);
            assertElectronAcceleratorLabel(3 /* Linux */, (0, keyCodes_1.KeyChord)(2048 /* CtrlCmd */ | 31 /* KEY_A */, 2048 /* CtrlCmd */ | 32 /* KEY_B */), null);
            assertElectronAcceleratorLabel(2 /* Macintosh */, (0, keyCodes_1.KeyChord)(2048 /* CtrlCmd */ | 31 /* KEY_A */, 2048 /* CtrlCmd */ | 32 /* KEY_B */), null);
        ...
        test('User Settings label', () => {
            ...
            assertElectronAcceleratorLabel(2 /* Macintosh */, 2048 /* CtrlCmd */ | 1024 /* Shift */ | 512 /* Alt */ | 256 /* WinCtrl */ | 31 /* KEY_A */, 'ctrl+shift+alt+cmd+a');
            // electron cannot handle chords
            assertElectronAcceleratorLabel(1 /* Windows */, (0, keyCodes_1.KeyChord)(2048 /* CtrlCmd */ | 31 /* KEY_A */, 2048 /* CtrlCmd */ | 32 /* KEY_B */), 'ctrl+a ctrl+b');
            assertElectronAcceleratorLabel(3 /* Linux */, (0, keyCodes_1.KeyChord)(2048 /* CtrlCmd */ | 31 /* KEY_A */, 2048 /* CtrlCmd */ | 32 /* KEY_B */), 'ctrl+a ctrl+b');
            assertElectronAcceleratorLabel(2 /* Macintosh */, (0, keyCodes_1.KeyChord)(2048 /* CtrlCmd */ | 31 /* KEY_A */, 2048 /* CtrlCmd */ | 32 /* KEY_B */), 'cmd+a cmd+b');
        });
        test('issue #91235: Do not end with a +', () => {
            assertUSLabel(1 /* Windows */, 2048 /* CtrlCmd */ | 512 /* Alt */ | 6 /* Alt */, 'Ctrl+Alt');
        });
    });
});
