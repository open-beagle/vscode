define(["require", "exports", "assert", "vs/base/common/keyCodes", "vs/base/common/platform", "vs/platform/contextkey/common/contextkey", "vs/platform/keybinding/common/keybindingResolver", "vs/platform/keybinding/common/resolvedKeybindingItem", "vs/platform/keybinding/common/usLayoutResolvedKeybinding"], function (require, exports, assert, keyCodes_1, platform_1, contextkey_1, keybindingResolver_1, resolvedKeybindingItem_1, usLayoutResolvedKeybinding_1) {
    ...
    suite('KeybindingResolver', () => {
        ...
        test('resolve key', function () {
            ...
            let runtimeKeybinding = (0, keyCodes_1.createSimpleKeybinding)(keybinding, platform_1.OS);
            ...
            assert.strictEqual(keybindingResolver_1.KeybindingResolver.contextMatchesRules(createContext({ bar: 'baz' }), contextRules), true);
            assert.strictEqual(keybindingResolver_1.KeybindingResolver.contextMatchesRules(createContext({ bar: 'bz' }), contextRules), false);
        ...
        test('contextIsEntirelyIncluded', () => {
            const assertIsIncluded = (a, b) => {
                assert.strictEqual(keybindingResolver_1.KeybindingResolver.whenIsEntirelyIncluded(contextkey_1.ContextKeyExpr.deserialize(a), contextkey_1.ContextKeyExpr.deserialize(b)), true);
            };
            const assertIsNotIncluded = (a, b) => {
                assert.strictEqual(keybindingResolver_1.KeybindingResolver.whenIsEntirelyIncluded(contextkey_1.ContextKeyExpr.deserialize(a), contextkey_1.ContextKeyExpr.deserialize(b)), false);
            };
        ...
        test('resolve command', function () {
            ...
            let items = [
                ...
                _kbItem((0, keyCodes_1.KeyChord)(2048 /* CtrlCmd */ | 55 /* KEY_Y */, 56 /* KEY_Z */), 'fifth', null),
                // This one has no keybinding
                _kbItem(0, 'sixth', null),
                _kbItem((0, keyCodes_1.KeyChord)(2048 /* CtrlCmd */ | 41 /* KEY_K */, 2048 /* CtrlCmd */ | 51 /* KEY_U */), 'seventh', null),
                _kbItem((0, keyCodes_1.KeyChord)(2048 /* CtrlCmd */ | 41 /* KEY_K */, 2048 /* CtrlCmd */ | 41 /* KEY_K */), 'seventh', null),
                _kbItem((0, keyCodes_1.KeyChord)(2048 /* CtrlCmd */ | 41 /* KEY_K */, 2048 /* CtrlCmd */ | 51 /* KEY_U */), 'uncomment lines', null),
                _kbItem((0, keyCodes_1.KeyChord)(2048 /* CtrlCmd */ | 41 /* KEY_K */, 2048 /* CtrlCmd */ | 33 /* KEY_C */), 'comment lines', null),
                _kbItem((0, keyCodes_1.KeyChord)(2048 /* CtrlCmd */ | 37 /* KEY_G */, 2048 /* CtrlCmd */ | 33 /* KEY_C */), 'unreachablechord', null),
            ...
            let testKey = (commandId, expectedKeys) => {
                ...
                for (let i = 0, len = lookupResult.length; i < len; i++) {
                    const expected = new usLayoutResolvedKeybinding_1.USLayoutResolvedKeybinding((0, keyCodes_1.createKeybinding)(expectedKeys[i], platform_1.OS), platform_1.OS);
            ...
            let testResolve = (ctx, _expectedKey, commandId) => {
                const expectedKey = (0, keyCodes_1.createKeybinding)(_expectedKey, platform_1.OS);
            ...
            testKey('fourth', []);
            testKey('fifth', [(0, keyCodes_1.KeyChord)(2048 /* CtrlCmd */ | 55 /* KEY_Y */, 56 /* KEY_Z */)]);
            testResolve(createContext({}), (0, keyCodes_1.KeyChord)(2048 /* CtrlCmd */ | 55 /* KEY_Y */, 56 /* KEY_Z */), 'fifth');
            testKey('seventh', [(0, keyCodes_1.KeyChord)(2048 /* CtrlCmd */ | 41 /* KEY_K */, 2048 /* CtrlCmd */ | 41 /* KEY_K */)]);
            testResolve(createContext({}), (0, keyCodes_1.KeyChord)(2048 /* CtrlCmd */ | 41 /* KEY_K */, 2048 /* CtrlCmd */ | 41 /* KEY_K */), 'seventh');
            testKey('uncomment lines', [(0, keyCodes_1.KeyChord)(2048 /* CtrlCmd */ | 41 /* KEY_K */, 2048 /* CtrlCmd */ | 51 /* KEY_U */)]);
            testResolve(createContext({}), (0, keyCodes_1.KeyChord)(2048 /* CtrlCmd */ | 41 /* KEY_K */, 2048 /* CtrlCmd */ | 51 /* KEY_U */), 'uncomment lines');
            testKey('comment lines', [(0, keyCodes_1.KeyChord)(2048 /* CtrlCmd */ | 41 /* KEY_K */, 2048 /* CtrlCmd */ | 33 /* KEY_C */)]);
            testResolve(createContext({}), (0, keyCodes_1.KeyChord)(2048 /* CtrlCmd */ | 41 /* KEY_K */, 2048 /* CtrlCmd */ | 33 /* KEY_C */), 'comment lines');
