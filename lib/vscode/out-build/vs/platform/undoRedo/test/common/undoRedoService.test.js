 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "assert", "vs/platform/undoRedo/common/undoRedoService", "vs/platform/dialogs/test/common/testDialogService", "vs/platform/notification/test/common/testNotificationService", "vs/platform/undoRedo/common/undoRedo", "vs/base/common/uri", "vs/base/test/common/mock"], function (require, exports, assert, undoRedoService_1, testDialogService_1, testNotificationService_1, undoRedo_1, uri_1, mock_1) {
    "use strict";
