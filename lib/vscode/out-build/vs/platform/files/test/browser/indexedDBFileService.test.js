 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "assert", "vs/platform/files/common/fileService", "vs/base/common/network", "vs/base/common/uri", "vs/platform/files/common/files", "vs/platform/log/common/log", "vs/base/common/lifecycle", "vs/platform/files/browser/indexedDBFileSystemProvider", "vs/base/common/types", "vs/base/common/resources", "vs/base/common/buffer"], function (require, exports, assert, fileService_1, network_1, uri_1, files_1, log_1, lifecycle_1, indexedDBFileSystemProvider_1, types_1, resources_1, buffer_1) {
    "use strict";
    ...
    suite('IndexedDB File Service', function () {
        ...
        const userdataURIFromPaths = (paths) => (0, resources_1.joinPath)(uri_1.URI.from({ scheme: network_1.Schemas.userData, path: testDir }), ...paths);
        ...
        const reload = async () => {
            ...
            logFileProvider = (0, types_1.assertIsDefined)(await new indexedDBFileSystemProvider_1.IndexedDB().createFileSystemProvider(network_1.Schemas.file, indexedDBFileSystemProvider_1.INDEXEDDB_LOGS_OBJECT_STORE));
            disposables.add(service.registerProvider(logSchema, logFileProvider));
            disposables.add(logFileProvider);
            userdataFileProvider = (0, types_1.assertIsDefined)(await new indexedDBFileSystemProvider_1.IndexedDB().createFileSystemProvider(logSchema, indexedDBFileSystemProvider_1.INDEXEDDB_USERDATA_OBJECT_STORE));
            disposables.add(service.registerProvider(network_1.Schemas.userData, userdataFileProvider));
