define(["require", "exports", "assert", "vs/platform/configuration/common/configurationModels", "vs/platform/configuration/common/configurationRegistry", "vs/platform/registry/common/platform", "vs/base/common/uri", "vs/platform/workspace/common/workspace", "vs/base/common/path", "vs/platform/workspace/test/common/testWorkspace"], function (require, exports, assert, configurationModels_1, configurationRegistry_1, platform_1, uri_1, workspace_1, path_1, testWorkspace_1) {
    "use strict";
    ...
    suite('AllKeysConfigurationChangeEvent', () => {
        test('changeEvent', () => {
            ...
            const workspace = new testWorkspace_1.Workspace('a', [new workspace_1.WorkspaceFolder({ index: 0, name: 'a', uri: uri_1.URI.file('file1') }), new workspace_1.WorkspaceFolder({ index: 1, name: 'b', uri: uri_1.URI.file('file2') }), new workspace_1.WorkspaceFolder({ index: 2, name: 'c', uri: uri_1.URI.file('folder3') })]);
            let testObject = new configurationModels_1.AllKeysConfigurationChangeEvent(configuration, workspace, 1 /* USER */, null);
