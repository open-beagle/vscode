...
define(["require", "exports", "electron", "vs/platform/log/common/log", "vs/platform/state/node/state", "vs/base/common/event", "vs/platform/instantiation/common/instantiation", "vs/platform/lifecycle/common/lifecycle", "vs/base/common/platform", "vs/base/common/lifecycle", "vs/base/common/async", "vs/base/common/types", "vs/base/common/process"], function (require, exports, electron_1, log_1, state_1, event_1, instantiation_1, lifecycle_1, platform_1, lifecycle_2, async_1, types_1, process_1) {
    "use strict";
    ...
    let LifecycleMainService = class LifecycleMainService extends lifecycle_2.Disposable {
        constructor(logService, stateService) {
            ...
            this._onBeforeUnloadWindow = this._register(new event_1.Emitter());
            this.onBeforeUnloadWindow = this._onBeforeUnloadWindow.event;
        ...
        beginOnWillShutdown() {
            ...
            this.pendingWillShutdownPromise = async_1.Promises.settled(joiners).then(() => undefined, err => this.logService.error(err));
        ...
        registerWindow(window) {
            const windowListeners = new lifecycle_2.DisposableStore();
            // track window count
            this.windowCounter++;
            // Window Will Load
        ...
        onBeforeUnloadWindowInMain(window, reason) {
            ...
            return (0, lifecycle_1.handleVetos)(vetos, err => this.logService.error(err));
        }
