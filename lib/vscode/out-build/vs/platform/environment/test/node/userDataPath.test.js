 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "assert", "vs/platform/environment/node/argv", "vs/platform/environment/node/userDataPath"], function (require, exports, assert, argv_1, userDataPath_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    suite('User data path', () => {
        test('getUserDataPath - default', () => {
            const path = (0, userDataPath_1.getUserDataPath)((0, argv_1.parseArgs)(process.argv, argv_1.OPTIONS));
        ...
        test('getUserDataPath - --user-data-dir', () => {
            ...
            const path = (0, userDataPath_1.getUserDataPath)(args);
