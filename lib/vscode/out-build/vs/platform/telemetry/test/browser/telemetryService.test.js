    ...
    suite('TelemetryService', () => {
        ...
        class JoinableTelemetryService extends telemetryService_1.TelemetryService {
            constructor(config, configurationService) {
                super(Object.assign(Object.assign({}, config), { sendErrorTelemetry: true }), configurationService);
                this.promises = [];
            }
            join() {
        ...
        test('Error events', sinon.test(async function () {
        ...
        // 		}
        // 	}));
        test('Handle global errors', sinon.test(async function () {
        ...
        test('Error Telemetry removes PII from filename with spaces', sinon.test(async function () {
            let errorStub = sinon.stub();
            window.onerror = errorStub;
        ...
        test('Unexpected Error Telemetry removes PII', sinon.test(async function () {
            let origErrorHandler = Errors.errorHandler.getUnexpectedErrorHandler();
            Errors.setUnexpectedErrorHandler(() => { });
            try {
                let settings = new ErrorTestingSettings();
        ...
        test('Uncaught Error Telemetry removes PII', sinon.test(async function () {
            let errorStub = sinon.stub();
            window.onerror = errorStub;
            let settings = new ErrorTestingSettings();
            let testAppender = new TestTelemetryAppender();
        ...
        test('Unexpected Error Telemetry removes PII but preserves Code file path', sinon.test(async function () {
            let origErrorHandler = Errors.errorHandler.getUnexpectedErrorHandler();
            Errors.setUnexpectedErrorHandler(() => { });
            try {
                let settings = new ErrorTestingSettings();
        ...
        test('Uncaught Error Telemetry removes PII but preserves Code file path', sinon.test(async function () {
            let errorStub = sinon.stub();
            window.onerror = errorStub;
            let settings = new ErrorTestingSettings();
            let testAppender = new TestTelemetryAppender();
        ...
        test('Unexpected Error Telemetry removes PII but preserves Code file path with node modules', sinon.test(async function () {
            let origErrorHandler = Errors.errorHandler.getUnexpectedErrorHandler();
            Errors.setUnexpectedErrorHandler(() => { });
            try {
                let settings = new ErrorTestingSettings();
        ...
        test('Unexpected Error Telemetry removes PII but preserves Code file path when PIIPath is configured', sinon.test(async function () {
            let origErrorHandler = Errors.errorHandler.getUnexpectedErrorHandler();
            Errors.setUnexpectedErrorHandler(() => { });
            try {
                let settings = new ErrorTestingSettings();
        ...
        test('Uncaught Error Telemetry removes PII but preserves Code file path when PIIPath is configured', sinon.test(async function () {
            let errorStub = sinon.stub();
            window.onerror = errorStub;
            let settings = new ErrorTestingSettings();
            let testAppender = new TestTelemetryAppender();
        ...
        test('Unexpected Error Telemetry removes PII but preserves Missing Model error message', sinon.test(async function () {
            let origErrorHandler = Errors.errorHandler.getUnexpectedErrorHandler();
            Errors.setUnexpectedErrorHandler(() => { });
            try {
                let settings = new ErrorTestingSettings();
        ...
        test('Uncaught Error Telemetry removes PII but preserves Missing Model error message', sinon.test(async function () {
            let errorStub = sinon.stub();
            window.onerror = errorStub;
            let settings = new ErrorTestingSettings();
            let testAppender = new TestTelemetryAppender();
        ...
        test('Unexpected Error Telemetry removes PII but preserves No Such File error message', sinon.test(async function () {
            let origErrorHandler = Errors.errorHandler.getUnexpectedErrorHandler();
            Errors.setUnexpectedErrorHandler(() => { });
            try {
                let settings = new ErrorTestingSettings();
        ...
        test('Uncaught Error Telemetry removes PII but preserves No Such File error message', sinon.test(async function () {
            let origErrorHandler = Errors.errorHandler.getUnexpectedErrorHandler();
            Errors.setUnexpectedErrorHandler(() => { });
            try {
                let errorStub = sinon.stub();
